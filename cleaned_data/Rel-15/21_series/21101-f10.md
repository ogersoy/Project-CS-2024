...
# 1 Scope
The present document identifies the 3GPP system specifications for Release 15.
The specifications and reports of this Release have a major version number 15
(i.e. 15.x.y). The listed Specifications are required to build a system based
...
https://portal.3gpp.org/Specifications.aspx?q=1&tbid=All&releases=190&draft=False&underCC=True&withACC=False&withBCC=False&tech=2&numberNYA=False
