...
MGC to MGW
+----------------------+----------------------+----------------------+ | Address Information | Control information | Bearer information | +----------------------+----------------------+----------------------+ | Local Descriptor { | Transaction ID | Local Descriptor { | | | | | | Port = ? | Termination ID = ? | Codec List | | | | | | IP Address = ? | []{.underline} | RTP Payloads | | | | | | IP Version = IPv4 or | [If Context | RtcpbwRS | | IPv6 | Req | | | | uested:]{.underline} | RtcpbwRR | | } | | | | | Context ID = ? | If ICE is applied: | | Remote Descriptor { | | | | | []{.underline} | ICE host candidate | | Port | | request | | | If MPS call/session: | | | IP Address | | ICE password request | | | Priority Indicator = | | | IP Version = IPv4 or | x | ICE Ufrag request | | IPv6 | | | | | []{.underline} | If SDPCapNeg is | | } | | signalled to the | | | [If Context | gateway: | | | Pr | | | | ovided:]{.underline} | SDPCapNeg | | | | configuration | | | Context ID = c1 | | | | | } | | | If IP Interface | | | | Type: | Remote Descriptor { | | | | | | | IP interface = \"IP | Codec List | | | interface type\" | | | | | RTP Payloads | | | If Resources for | | | | multiple Codecs | RtcpbwRS | | | shall be reserved: | | | | | RtcpbwRR | | | Reserve_Value | | | | | If RTCP APP messages | | | If CTM call and | allowed | | | Access Termination: | | | | | Allowed RTCP APP | | | State= ctmstate | message | | | | | | | Transport= | types | | | ctmtransport | | | | | If ICE is applied: | | | Version= ctmtext | | | | version | ICE received | | | | candidate | | | N | | | | otificationRequested | ICE received | | | (Event ID = x, | password | | | | | | | \"termination | ICE received Ufrag | | | heartbeat\") | | | | | (NOTE 3) | | | If indication on | | | | Bearer Released | If SDPCapNeg is | | | requested: | signalled to the | | | | gateway: | | | N | | | | otificationRequested | SDPCapNeg | | | (Event ID = x, \"BNC | configuration | | | Release (Cause)\") | | | | -- as defined in | } | | | ITU‑T Recommendation | | | | Q.1950 | If data call other | | | | than SCUDIF | | | If multiple IP | multimedia call and | | | realms: IP realm | Anchor MGW Network | | | Identifier = | Termination: | | | required IP realm | | | | identifier | PLMN bearer | | | | capability = | | | If indication on | PLMN capability | | | Protocol Negotiation | | | | Result requested: | If GSM data call | | | | other than SCUDIF | | | N | multimedia call and | | | otificationRequested | Anchor MGW Network | | | (Event ID = x, | Termination: | | | \"Prot Negotiation | | | | Result\") | GSM channel coding = | | | | coding | | | If indication on | | | | Rate Change | | | | requested: | | | | | | | | N | | | | otificationRequested | | | | (Event ID = x, | | | | \"RateChange\") | | | | | | | | If access | | | | termination and | | | | notification on CTM | | | | negotiation result | | | | requested: | | | | | | | | N | | | | otificationRequested | | | | (Event ID = x, \" | | | | connchange \") | | | | | | | | If diffserv required | | | | (NOTE 1):- | | | | | | | | Diffserv Code Point | | | | | | | | If tagging behaviour | | | | | | | | Diffserv Tagging | | | | Behaviour | | | | | | | | If Remote Source | | | | Address Filtering | | | | required (NOTE 1):- | | | | | | | | Remote Source | | | | Address Filtering | | | | | | | | If Remote Source | | | | Address range | | | | required:- | | | | | | | | Remote Source | | | | Address Mask | | | | | | | | If Remote Source | | | | Port Filtering | | | | | | | | required:- | | | | | | | | Remote Source Port | | | | Filtering | | | | | | | | If individual port:- | | | | | | | | Remote Source Port | | | | | | | | If range of ports: | | | | | | | | Remote Source Port | | | | Range | | | | | | | | If Media Inactivity | | | | Detection Required | | | | (NOTE 1): | | | | | | | | N | | | | otificationRequested | | | | (Event ID = x, | | | | \"Media Inactivity | | | | Detection (Media | | | | Inactivity Detection | | | | Time, Media | | | | Inactivity Detection | | | | Direction) \") | | | | (NOTE2) | | | | | | | | If Sustainable Data | | | | Rate Policing | | | | Required (NOTE 1):- | | | | | | | | Policing Required | | | | | | | | Sustainable Data | | | | Rate | | | | | | | | Maximum Burst Size | | | | | | | | If peak data rate | | | | policing (NOTE 1) | | | | | | | | Policing Required | | | | | | | | Peak Data Rate | | | | | | | | If Delay Variation | | | | required | | | | | | | | Delay Variation | | | | Tolerance | | | | | | | | If RTCP handling | | | | required (NOTE 1): | | | | | | | | RTCP allocation | | | | | | | | If ECN Endpoint | | | | support required | | | | | | | | ECN Enable = | | | | \"True\" | | | | | | | | Initiation Method = | | | | \"ECN Initiation | | | | | | | | Method\" | | | | | | | | If notification of | | | | ECN Failure | | | | | | | | Report: | | | | | | | | N | | | | otificationRequested | | | | (Event ID | | | | | | | | = x,\"ECN Failure\") | | +----------------------+----------------------+----------------------+ | NOTE 1: Only for | | | | terminations with | | | | border control | | | | functions support. | | | | | | | | NOTE 2: The event | | | | parameters \"Media | | | | Inactivity Detection | | | | Time\" and \"Media | | | | Inactivity Detection | | | | Direction\" are | | | | optional. | | | | | | | | NOTE 3: The support | | | | of ICE received | | | | candidate, ICE | | | | received password, | | | | ICE received Ufrag | | | | are optional for ICE | | | | lite, as specified | | | | in | | | | 3G | | | | PP TS 29.292 [60]. | | | +----------------------+----------------------+----------------------+
When the processing of command (1) is complete, the MGW initiates the
following procedure.
Table 14.2.53.2: ADD.resp(Reserve and Configure RTP Connection Point
Acknowledge) MGW to MGC
+----------------------+---------------------+----------------------+ | Address Information | Control information | Bearer information | +----------------------+---------------------+----------------------+ | Local Descriptor { | Transaction ID | Local Descriptor { | | | | | | Port | Termination ID | Codec List | | | | | | IP Address | Context ID | RTP Payloads | | | | | | IP Version | | RtcpbwRS | | | | | | } | | RtcpbwRR | | | | | | Remote Descriptor { | | If ICE is applied: | | | | | | Port | | ICE host candidate | | | | | | IP Address | | ICE password | | | | | | IP Version | | ICE Ufrag | | | | | | } NOTE | | If ICE lite | | | | implementation | | | | | | | | ICE lite indication | | | | | | | | If SDPCapNeg is | | | | signalled to the | | | | gateway: | | | | | | | | SDPCapNeg | | | | configuration | | | | | | | | } | | | | | | | | Remote Descriptor { | | | | | | | | Codec List | | | | | | | | RTP Payloads | | | | | | | | RtcpbwRS | | | | | | | | RtcpbwRR | | | | | | | | If SDPCapNeg is | | | | signalled to the | | | | gateway: | | | | | | | | SDPCapNeg | | | | configuration | | | | | | | | } NOTE | +----------------------+---------------------+----------------------+ | NOTE: Sending of the | | | | Remote Descriptor is | | | | optional | | | +----------------------+---------------------+----------------------+
...
\- Modification of Link Characteristics Bearer Capabiltity package (see
subclause 15.2.4);
\- Enhanced Circuit Switched Data package (see subclause 15.2.5);
\- Cellular Text telephone Modem Text Transport package (see subclause
15.2.6);
...
* * *
Profile name: Threegbicsn Version: 7
* * *
