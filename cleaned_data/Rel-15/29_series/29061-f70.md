...
0-9 As specified in 3GPP TS 29.274 [81]\ 10-50 Spare for future use\ 51 NR\
52-100 Spare for future use\ 101 IEEE 802.16e\ 102 3GPP2 eHRPD\ 103 3GPP2
HRPD\ 104 3GPP2 1xRTT\ 105 3GPP2 UMB\ 106-255 Spare for future use
The value 51 does not apply for the present specification. For specifications
referencing the present RADIUS VSA, the value shall only apply if it is
explicitely endorsed within the referencing specification.
...
0 -- NR
1-15 -- spare, reserved for future use
Bit 5 to bit 8 of octet 3 is spare and reserved for future use.
