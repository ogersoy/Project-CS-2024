...
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE type and | Semantics | | | | | reference | description | +----------------+----------+-------+----------------+----------------+ | Direction of | M | | ENUMERATED | | | Altitude | | | (Height, | | | | | | Depth) | | +----------------+----------+-------+----------------+----------------+ | Altitude | M | | INTEGER ( | The relation | | | | | | between the | | | | | 0..2^15^-1) | value (N) and | | | | | | the altitude | | | | | | (a) in meters | | | | | | it describes | | | | | | is N ≤ a \ _> Macro eNB | M | | BIT STRING | Equal to the | | > ID_ | | | (20) | 20 leftmost | | | | | | bits of the | | | | | | _Cell | | | | | | Identity_ IE | | | | | | contained in | | | | | | the _E-UTRAN | | | | | | CGI_ IE (see | | | | | | clause 7.4.4) | | | | | | of each cell | | | | | | served by the | | | | | | eNB | +----------------+----------+-------+----------------+----------------+ | > _> Home eNB | M | | BIT STRING | Equal to the | | > ID_ | | | (28) | _Cell | | | | | | Identity_ IE | | | | | | contained in | | | | | | the _E-UTRAN | | | | | | CGI_ IE (see | | | | | | clause 7.4.4) | | | | | | of the cell | | | | | | served by the | | | | | | eNB | +----------------+----------+-------+----------------+----------------+ | > _> Short | M | | BIT STRING | Equal to the | | > Macro eNB | | | (18) | 18 leftmost | | > ID_ | | | | bits of the | | | | | | _Cell | | | | | | Identity_ IE | | | | | | contained in | | | | | | the _E-UTRAN | | | | | | CGI_ IE (see | | | | | | clause 7.4.4) | | | | | | of each cell | | | | | | served by the | | | | | | eNB | +----------------+----------+-------+----------------+----------------+ | > _> Long | M | | BIT STRING | Equal to the | | > Macro eNB | | | (21) | 21 leftmost | | > ID_ | | | | bits of the | | | | | | _Cell | | | | | | Identity_ IE | | | | | | contained in | | | | | | the _E-UTRAN | | | | | | CGI_ IE (see | | | | | | clause 7.4.4) | | | | | | of each cell | | | | | | served by the | | | | | | eNB | +----------------+----------+-------+----------------+----------------+
...
+-------------+----------+-------------+-------------+-------------+ | IE/Group | Presence | Range | IE type and | Semantics | | Name | | | reference | description | +=============+==========+=============+=============+=============+ | **Ciphering | M | | | | | Data** | | | | | +-------------+----------+-------------+-------------+-------------+ | > ** | M | 1..\Ciphering | | CipherSet\> | | | | > Data | | | | | | > Set** | | | | | +-------------+----------+-------------+-------------+-------------+
...
+-------------+----------+-------------+-------------+-------------+ | IE/Group | Presence | Range | IE type and | Semantics | | Name | | | reference | description | +=============+==========+=============+=============+=============+ | **Ciphering | M | | | This IE | | Data Ack** | | | | contains | | | | | | the list of | | | | | | ciphering | | | | | | set IDs for | | | | | | which the | | | | | | MME is | | | | | | sending an | | | | | | ackn | | | | | | owledgement | +-------------+----------+-------------+-------------+-------------+ | > ** | M | 1..\Ciphering | | CipherSet\> | | | | > Set ID** | | | (0..65535) | | +-------------+----------+-------------+-------------+-------------+
...
+-------------+----------+-------------+-------------+-------------+ | IE/Group | Presence | Range | IE type and | Semantics | | Name | | | reference | description | +=============+==========+=============+=============+=============+ | **Ciphering | M | | | | | Data Error | | | | | | Report** | | | | | +-------------+----------+-------------+-------------+-------------+ | > ** | M | 1..\Ciphering | | CipherSet\> | | | | > Data | | | | | | > Error | | | | | | > Report | | | | | | > | | | | | | Contents** | | | | | +-------------+----------+-------------+-------------+-------------+
...
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE type and | Semantics | | | | | reference | description | +================+==========+=======+================+================+ | **Ciphering | M | | | | | Data Error | | | | | | Report | | | | | | Contents** | | | | | +----------------+----------+-------+----------------+----------------+ | > | M | | INTEGER | This IE | | **> Ciphering | | | | contains the | | > Set ID** | | | (0..65535) | list of | | | | | | ciphering set | | | | | | IDs for which | | | | | | the MME is | | | | | | sending an | | | | | | a | | | | | | cknowledgement | +----------------+----------+-------+----------------+----------------+ | > **> Storage | M | | ENUMERATED ( | | | > outcome** | | | | | | | | | Successful, | | | | | | Failed | | | | | | | | | | | | ) | | +----------------+----------+-------+----------------+----------------+
...
* * *
IE/Group Name Presence Range IE type and reference Semantics description
High Accuracy Altitude M INTEGER (-64000..128000) The relation between the IE
