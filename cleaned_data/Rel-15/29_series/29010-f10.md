...
Transfer of information:
The SNA Access Information is transferred to 3G_MSC-B in:
\- the Relocation Request RANAP message encapsulated in the Prepare Handover
request MAP message.
#### 4.8.5.12 UESBI
This information shall be stored by 3G_MSC-B and sent to an RNS in Relocation
Request during the basic inter-MSC relocation or when 3G_MSC-B performs a
...
This subclause defines a mapping of S1AP and NGAP cause values used in
connection with inter RAT Handover to avoid different mappings in different
implementations.
...
protection algorithms not supported Miscellaneous Cause O&M Intervention
Miscellaneous Cause O&M Intervention Any other value Radio Network Layer Cause
...
Resources Available in Target Cell Miscellaneous Cause O&M Intervention
Miscellaneous Cause O&M Intervention Any other value Radio Network Layer Cause
