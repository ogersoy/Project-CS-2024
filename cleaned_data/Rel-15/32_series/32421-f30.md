...
networks and Radio Link Failure (RLF) reporting across EPS networks and 5G
networks.
...
21.905 [8] , 32.130 [13], 23.501 [15], 38.300 [16] and the following apply:
...
[8], 32.101 [1] , 32.130 [13] , 23.501 [15], 38.300 [16] and the following
apply:
