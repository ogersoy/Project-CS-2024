...
F~DL,low~ -- 85 \ e.r.p. (dBm) = e.i.r.p. (dBm) − 2.15 Ref. ITU-R SM. 329 ANNEX 1 [9]
...
+----------------------+----------------------+----------------------+ | **Frequency** | **Minimum |** Minimum | | | requirement | requirement (e.r.p.) | | | (e.r.p.)/ Reference | / Reference | | | Bandwidth**| Bandwidth** | | | | | | | **Idle mode** | **Traffic mode** | +======================+======================+======================+ | 30 MHz ≤ f \ BW~Channel~: Channel bandwidth as defined in TS 36.101 [11].
...
corresponding to 3 V rms, at a transfer impedance of 15 Ω;
