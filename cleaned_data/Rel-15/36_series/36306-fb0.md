...
shall also indicate support of w _akeUpSignal-r15_. This feature is only
applicable if the UE supports _ce-ModeA-r13_ or if the UE supports any _ue-
Category-NB_.
...
TDD-r15_ shall also indicate support of _wakeUpSignal-TDD-r15_. This feature
is only applicable if the UE supports _ce-ModeA-r13_.
...
This field defines whether the UE supports configuration of validity area for
...
feature shall also support _ca-IdleModeMeasurements-r15_.
...
Optimisation, as defined in TS 24.301 [28] and any _ue-Category-NB_. If a UE
of this release supports multiple DRBs, the UE shall support two simultaneous
DRBs.
#### 4.3.8.6 Void
#### 4.3.8.7 _earlyData-UP-r15_
This field defines whether the UE supports EDT for User Plane CIoT EPS
...
activated SCell state, as defined in TS 36.321 [4] and TS 36.331 [5].
...
NB_.
### 6.8.4 EDT for Control Plane CIoT EPS Optimization
It is optional for UE to support EDT for Control Plane CIoT EPS optimizations,
as defined in TS 24.301 [28]. This feature is only applicable if the UE
supports _ce-ModeA-r13,_ or for FDD if the UE supports any _ue-Category-NB_.
### 6.8.5 Void
### 6.8.6 Enhanced PHR
...
### 6.17.2 DL channel quality reporting
It is optional for UE to support DL channel quality reporting of the serving
cell for FDD, as specified in TS 36.331 [5]. This feature is only applicable
