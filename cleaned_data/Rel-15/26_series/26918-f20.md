...
the original sound-field, being very similar to a standard "crossed cardioid"
stereo recording (typical crossed-cardioid recordings make use of a pair of
cardioid microphones at ±45°, whereas the FL and FR signals represent
...
to "Excellent" quality range is achievable at bitrates from 64kbps (2x32kbps)
to 192kbps (2x96kbps). In that range a quality increase is observed that is
commensurate with increased bitrate.
Clause 6.1.7 shows that the 3GPP EVS codec can be used to encode super-
wideband FOA B-format representations obtaining MUSHRA scores in the "Good" to
"Excellent" quality range with increasing quality from 4x24.4 kbit/s to 4x96
kbit/s compared to uncoded FOA. This shows the potential of using the 3GPP EVS
codec for FOA-based VR audio services for conversational and streaming use
cases.
