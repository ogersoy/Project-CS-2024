...
### 8.7.1 General
The echo loss (EL) presented by the GSM, 3G, LTE or WLAN networks at the POI
...
receiving to handle the variation in packet receiver timing. To minimize the
additional latency introduced by the jitter buffer, adaptation is used to
minimize delay while preventing packet losses due to packet delivery timing
variations. See clause 8 of TS 26.114 [39] for the definition of jitter buffer
and minimum performance requirements on JBM.
...
with the rate of production of the packets containing the speech frames.
...
production of the packets containing the speech frames.
