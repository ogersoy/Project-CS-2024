...
the MCPTT server is contained in 3GPP TS 23.379 [16].
...
group on request. The dynamic data is described in subclause 10.1.5.5.
...
data request from the MC service client to the MC service server.
...
data response from the MC service server to the MC service client.
...
partner MC system
Editor\'s note: It is for FFS how the MC service UE obtains migration
...
+---------------------------+------------+---------------------------+ | Information element | Status | Description | +---------------------------+------------+---------------------------+ | MC service group ID | M | MC service group ID of | | | | the group | | | (see NOTE) | | +---------------------------+------------+---------------------------+ | NOTE: If the Result | | | | information element | | | | indicates failure then | | | | the value of MC service | | | | group ID information | | | | element has no meaning. | | | +---------------------------+------------+---------------------------+
...
+---------------------------+------------+---------------------------+ | Information element | Status | Description | +---------------------------+------------+---------------------------+ | MC service group ID | O | MC service group ID of | | | | the temporary group | | | (see NOTE) | | +---------------------------+------------+---------------------------+ | MC service list | O | List of MC services whose | | | | service communications | | | | are to be enabled on this | | | | temporary group | +---------------------------+------------+---------------------------+ | Result | M | Indicates the success or | | | | failure of group regroup | +---------------------------+------------+---------------------------+ | NOTE: Shall be present if | | | | the Result information | | | | element indicates that | | | | the group regroup | | | | operation is successful. | | | | Otherwise MC service | | | | group ID shall not be | | | | present. | | | +---------------------------+------------+---------------------------+
...
communications are to be enabled on this temporary group.
* * *
...
+--------------------------+--------------+--------------------------+ | Information element | Status | Description | +--------------------------+--------------+--------------------------+ | MC service group ID | M | MC service group ID of | | | | the group | +--------------------------+--------------+--------------------------+ | MC service group | O | Configuration | | configuration | | information for the MC | | information | (see NOTE 1) | service group | +--------------------------+--------------+--------------------------+ | Failure reason | O | Indicates reason for | | | | failure to provide MC | | | (see NOTE 2) | service group | | | | configuration | | | | information | +--------------------------+--------------+--------------------------+ | NOTE 1: Shall be present | | | | if the request can be | | | | fulfilled by the group | | | | management server in the | | | | primary MC system of the | | | | MC service group. | | | | | | | | NOTE 2: Shall be present | | | | if the request cannot be | | | | fulfilled by the group | | | | management server in the | | | | primary MC system of the | | | | MC service group. | | | +--------------------------+--------------+--------------------------+
...
priority of the constituent groups. If MC service types of the groups being
combined are not identical, group management server determines the overlapping
part and stores the MC service list for the temporary group.
...
\- If security policy of the MC system allows a temporary group to include
groups from other primary MC systems, group regrouping containing groups with
multiple MC systems can only take place if:
\- none of the groups to be regrouped are temporary groups; and
\- the groups to be regrouped are not already regrouped into another temporary
group; and
\- the MC service server in which the regrouping is performed is the MC
service server (controlling role) for all MC service groups involved in the
regrouping; or
\- the MC service server in which the regrouping is performed is an MC service
server (participating role) for at least one of the MC service groups and the
primary MC system of at least one MC service group allows floor control for
the set of regrouped groups to be deferred to the MC service server
(controlling role) of the temporary group.
\- If security policy of the MC system does not allow a temporary group to
include groups from other MC systems, regrouping of groups with members
spanning multiple MC systems can only take place if:
\- none of the groups to be regrouped are temporary groups;
\- the groups to be regrouped are not already regrouped into another temporary
group; and
\- the MCPTT system in which the regrouping is performed is the MC service
server (controlling role) for all MC service groups involved in the
regrouping.
...
+-----------------------------+--------+-----------------------------+ | Information element | Status | Description | +-----------------------------+--------+-----------------------------+ | MC service ID (see NOTE 1) | M | The MC service ID of the | | | | migrating MC service user | | | | provided by the partner MC | | | | system. | +-----------------------------+--------+-----------------------------+ | MC service ID | M | The MC service ID of the | | | | migrating MC service user | | | | in the primary MC system of | | | | the MC service user. | +-----------------------------+--------+-----------------------------+ | MC service user profile | M | The MC service user profile | | index (see NOTE 2) | | index of the selected MC | | | | service user profile. | +-----------------------------+--------+-----------------------------+ | NOTE 1: The MC service ID | | | | is provided by the identity | | | | management server in the | | | | partner MC system during | | | | authentication of the | | | | migrating MC service user. | | | | | | | | NOTE 2: The MC service user | | | | profle index refers to the | | | | MC service user profile | | | | provided by the primary MC | | | | system of the MC service | | | | user that has been selected | | | | by the MC service user in | | | | order to request migrated | | | | MC service on the partner | | | | MC system. | | | +-----------------------------+--------+-----------------------------+
...
of the migrating MC service user.
...
##### 10.7.3.7.1 General
This subclause specifies service continuity scenario when MBMS bearers are
...
information, and receive notification of group policy.
...
affiliates the user from the MC service group.
...
+--------------------------+--------------+--------------------------+ | Information element | Status | Description | +--------------------------+--------------+--------------------------+ | MC service ID | M | Identity of the | | | | requesting authorized MC | | | (see NOTE 1) | service user (e.g. MCPTT | | | | ID, MCVideo ID, MCData | | | | ID) | +--------------------------+--------------+--------------------------+ | MC service ID | M | Identity of the | | | | requested MC service | | | (see NOTE 1) | user (e.g. MCPTT ID, | | | | MCVideo ID, MCData ID) | +--------------------------+--------------+--------------------------+ | Immediate Report | O | Indicates whether an | | Indicator | | immediate location | | | (see NOTE 2) | report is required | +--------------------------+--------------+--------------------------+ | Requested non-emergency | O | Identifies what location | | location information | | information is | | | (see NOTE 2) | requested, except for | | | | emergency or imminent | | | | peril calls or emergency | | | | alerts | +--------------------------+--------------+--------------------------+ | Requested emergency | O | Identifies what location | | location information | | information is | | | (see NOTE 2) | requested, for emergency | | | | or imminent peril calls | | | | or emergency alerts | +--------------------------+--------------+--------------------------+ | Triggering criteria in | O | Identifies when the | | non- emergency cases | | client will send the | | | (see NOTE 2) | location report in | | | | non-emergency cases | +--------------------------+--------------+--------------------------+ | Triggering criteria in | O | Identifies when the | | emergency cases | | client will send the | | | (see NOTE 2) | location report in | | | | emergency cases | +--------------------------+--------------+--------------------------+ | Minimum time between | O | Defaults to 0 if absent | | consecutive reports | | and 0 for emergency | | | (see NOTE 2) | calls, imminent peril | | | | calls and emergency | | | | alerts | +--------------------------+--------------+--------------------------+ | NOTE 1: The identity of | | | | the requesting MC | | | | service user and the | | | | requested MC service | | | | user should belong to | | | | the same MC service. | | | | E.g. if requesting MC | | | | service user is using a | | | | MCPTT ID, then the | | | | requested MC service | | | | user identity should be | | | | an MCPTT ID. | | | | | | | | NOTE 2: At least one of | | | | these rows shall be | | | | present. | | | +--------------------------+--------------+--------------------------+
...
7\. The receiving MC service clients send the MC service emergency alert
cancel response to the MC service server to acknowledge the MC service
emergency alert cancel. For a multicast call scenario, these acknowledgements
are not sent.
...
1\. MC service client 1 sends an MC service emergency alert cancel
...
2\. MC service users are notified of the MC service emergency alert
...
#### 10.13.2.1 Functional alias information query request
Table 10.13.2.1-1 describes the information functional alias information query
request from the MC service client to the MC service server.
Table 10.13.2.1-1: Functional alias information query request
* * *
Information element Status Description MC service ID M The identity of the MC
service user who performs the query. MC service ID M The identity of the MC
service user to be queried.
* * *
#### 10.13.2.2 Functional alias information query response
Table 10.13.2.2-1 describes the information functional alias information query
response from the MC service server to the MC service client.
Table 10.2.2.17-1: Functional alias information query response
* * *
Information element Status Description MC service ID M The identity of the MC
service user who performs the query. MC service ID M The identity of the MC
service user to be queried. Query result M The functional alias information
retrieved from the functional alias management server, i.e. the list of
activated functional alias identities of the MC service user.
* * *
...
notification from the MC service server to the MC service client.
...
a certain MC service user.
Figure 10.13.3-1: Active functional alias list query
1\. The MC service client of the MC service user requests a list of active
functional aliases for a certain MC service user from the MC service server by
sending a functional alias information query request. The MC service ID is
included.
...
requested active functional alias information based on the MC service ID.
3\. The MC service server sends a functional alias information query response
including the active functional alias information to the MC service client.
