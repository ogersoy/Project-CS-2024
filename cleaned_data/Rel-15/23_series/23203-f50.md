...
with the PCC rule for the voice media.
NOTE 11: Based on local configuration, the PCRF sets the Maximum Packet Loss
...
Editor\'s note: It is FFS how to refer to SA WG4 specification for setting
Maximum Packet Loss Rate based on local configuration.
