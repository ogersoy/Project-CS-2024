...
[36] Void.
[37] TS 23.501: \"System architecture for the 5G System (5GS)\".
...
NOTE 3: In this Release, SRVCC for IMS emergency call from NG-RAN to CS is not
supported.
...
NOTE 4: In this Release, DR-VCC support for IMS emergency call from PS to CS
Access Transfer is only supported if the UE has valid subscription.
NOTE 5: The CS to PS Access transfer for IMS emergency call SRVCC or DRVCC is
...
IMS emergency session is active session.
...
early dialogue phase (i.e. pre-alerting or alerting) with E-STN-SR
1\. MSC Server initiates the session transfer with the E-STN-SR and it
includes the equipment identifier.
2\. The I-CSCF routes the INVITE directly to the EATF via I5 by using similar
procedures to that defined in TS 23.228 [4] for PSI based Application Server
