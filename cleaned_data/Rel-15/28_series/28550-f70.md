...
## 7.4 Void
## 7.5 Management service components used for configurable performance
measurement control
The MnS components used for configurable performance measurement control are
listed in table 7.5-1. The configurable performance measurement control
...
Table 7.5-1: MnS components used for configurable performance measurement
control
+----------------------+----------------------+----------------------+ | Management purpose | Management service | Management service | | | component type A | component type B | +----------------------+----------------------+----------------------+ | Configurable | Following | Following IOCs | | performance | oper | defined in | | measurement control | ations/notifications | performance | | for NE/NF | defined in Clause | measurement control | | | 11.1.1 in TS | NRM fragment in TS | | | 28.532[7]: | 28.622 [5] /TS | | | | 28.541[3]: | | | Operations: | | | | | - | | | - createMOI | MeasurementControl | | | | | | | - getMOIAttributes | - | | | | MeasurementReader | | | - | | | | modifyMOIAttributes | - ManagedElement | | | | or concrete | | | - deleteMOI | ManagedFunction | | | | | | | Notifications: | | | | | | | | - notifyMOICreation | | | | | | | | - | | | | notifyMOIA | | | | ttributeValueChanges | | | | | | | | - notifyMOIDeletion | | | | | | | | - notifyMOIChanges | | +----------------------+----------------------+----------------------+ | Configurable | Following | Following IOCs | | performance | oper | defined in | | measurement control | ations/notifications | performance | | for Network Slice | defined in Clause | measurement control | | | 11.1.1 in TS | NRM fragment in TS | | | 28.532[7]: | 28.622 [5] /TS | | | | 28.541[3]: | | | Operations: | | | | | - | | | - createMOI | MeasurementControl | | | | | | | - getMOIAttributes | - | | | | MeasurementReader | | | - | | | | modifyMOIAttributes | - NetworkSlice | | | | | | | - deleteMOI | | | | | | | | Notifications: | | | | | | | | - notifyMOICreation | | | | | | | | - | | | | notifyMOIA | | | | ttributeValueChanges | | | | | | | | - notifyMOIDeletion | | | | | | | | - notifyMOIChanges | | +----------------------+----------------------+----------------------+ | Configurable | Following | Following IOCs | | performance | oper | defined in | | measurement control | ations/notifications | performance | | for | defined in Clause | measurement control | | NetworkSliceSubnet | 11.1.1 in TS | NRM fragment in TS | | | 28.532[7]: | 28.622 [5] / TS | | | | 28.541[3]: | | | Operations: | | | | | - | | | - createMOI | MeasurementControl | | | | | | | - getMOIAttributes | - | | | | MeasurementReader | | | - | | | | modifyMOIAttributes | - | | | | NetworkSliceSubnet | | | - deleteMOI | | | | | | | | Notifications: | | | | | | | | - notifyMOICreation | | | | | | | | - | | | | notifyMOIA | | | | ttributeValueChanges | | | | | | | | - notifyMOIDeletion | | | | | | | | - notifyMOIChanges | | +----------------------+----------------------+----------------------+ | Configurable | Following | Following IOCs | | performance | oper | defined in | | measurement control | ations/notifications | performance | | for SubNetwork | defined in Clause | measurement control | | | 11.1.1 in TS | NRM fragment in TS | | | 28.532[7]: | 28.622 [5]: | | | | | | | Operations: | - | | | | MeasurementControl | | | - createMOI | | | | | - | | | - getMOIAttributes | MeasurementReader | | | | | | | - | - SubNetwork | | | modifyMOIAttributes | | | | | | | | - deleteMOI | | | | | | | | Notifications: | | | | | | | | - notifyMOICreation | | | | | | | | - | | | | notifyMOIA | | | | ttributeValueChanges | | | | | | | | - notifyMOIDeletion | | | | | | | | - notifyMOIChanges | | +----------------------+----------------------+----------------------+
...
* * *
**Table 8.2.1.2.3.2-3: Data str** uctures supported by the GET response body
on this resource
...
##### 8.2.1.3.2 URI
{MnSRoot}/PerfMeasJobCtrlMnS/{MnSVersion}/measJobs/{jobId}
The resource URI variables a defined in the following table.
...
This method shall support the request data structures, the response data
structures and response codes specified in the following tables.
**Table 8.2.1.3.3.2-2: Data structures supported by the DELETE request body**
on this resource
* * *
**Data type** **Description** **SQ** n/a n/a n/a
* * *
**Table 8.2.1.3.3.2-3: Data structures supported by the DELETE re** sponse
...
(stream target).
{width="6.727777777777778in" height="4.663888888888889in"}
Figure D.1.1-1
...
MnS producer;
2) by the NRM fragment-based measurement control service
1b. The MnS consumer selects the correct MeasurementControl MOI for new
measurement collection, as a system may have multiple MeasurementControl MOIs;
1c. If necessary, the MnS consumer modifies the MeasurementControl MOI by
invoking the modifyMOI operation towards the MnS producer;
1d. The MnS consumer creates a new MeasurementReader MOI under the selected
MeasurementControl MOI for collecting the measurements, by invoking the
createMOI operation towards the MnS producer; or
1e. The MnS consumer modifies an existing MeasurementReader MOI under the
selected MeasurementControl MOI to add new measurements to be collected, by
invoking the modifyMOI operation towards the MnS producer.
...
MC -> MP : 1a. createMeasurementJob\n(measurement control parameters)
else NRM fragment based MnS
MC --> MC: 1b. Select MeasurementControl MOI
Opt Update the selected MeasurementControl MOI if necessary
MC -> MP: 1c: modifyMOI\n(for MeasurementControl MOI)
end
alt create new MOI for collecting measurements
MC -> MP : 1d. createMOI\n(for MeasurementReader IOC)
Else update existing MOI for collecting new measurements
MC -> MP : 1e. modifyMOI\n(for MeasurementReader MOI)
end
end
...
{width="6.776388888888889in" height="4.327083333333333in"}
Figure D.2.1-1
1\. The consumer of MnS for measurement control requests the MnS producer to
...
producer;
2) by the NRM fragment-based measurement control service
1b. The MnS consumer selects the correct MeasurementControl MOI for
terminating the measurement collection, as a system may have multiple
MeasurementControl MOIs;
1c. If necessary, the MnS consumer modifies the MeasurementControl MOI by
invoking the modifyMOI operation towards the MnS producer;
1d. The MnS consumer deletes an MeasurementReader MOI under the selected
MeasurementControl MOI for terminating the measurements collection, by
invoking the deleteMOI operation towards the MnS producer;
1e. The MnS consumer modifies an MeasurementReader MOI with deletion of the
measurements that do not need to be collected anymore, by invoking the
modifyMOI operation towards the MnS producer.
...
## E.2 Performance assurance service
{
\"openapi\": \"3.0.1\",
\"info\": {
\"title\": \"TS 28.550 Performance Measurement Job Control Service\",
\"version\": \"15.8.0\",
\"description\": \"OAS 3.0.1 specification of the Performance Measurement Job
Control Service\"
},
\"externalDocs\": {
\"description\": \"3GPP TS 28.550 V15.8.0; Performance assurance\",
...
\"variables\": {
\"MnSRoot\": {
\"description\": \"See subclause 4.4.2 of TS 32.158\",
...
\"description\": \"To create a measurement job the representation of the
measurement job is POSTed on the /measJobs collection resource.\",
\"requestBody\": {
\"required\": true,
\"content\": {
\"application/json\": {
...
the newly created measurement job resource shall be returned.\",
\"content\": {
\"application/json\": {
\"schema\": {
...
\"responses\": {
\"200\": {
\"description\": \"Success case (\\\"200 OK\\\"). The resource identified in
the path for retrieval is returned in the response message body. \",
\"content\": {
\"application/json\": {
\"schema\": {
\"\$ref\": \"#/components/schemas/measJobsRetrieval-ResponseType\"
...
\"description\": \"The measurement job is deleted by deleting the
corresponding measurement job resource. The resource to be deleted is
...
\"responses\": {
\"204\": {
\"description\": \"Success case (\\\"204 No Content\\\"). The measurement job
...
## E.3 Void
###### ## Annex F (normative): ASN.1 definition for performance data stream
units
# F.1 ASN.1 definition rule
...
15.6 to 15.11 in ITU-T Rec X.691 [17], the leading bit of the bit string value
