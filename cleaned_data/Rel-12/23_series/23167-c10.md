...
possible over at least a cellular access network, a fixed broadband access and
a nomadic access.
...
NOTE 2: Subject to local regulation, any supported media can be used during a
...
cases where the UE is using GPRS (UTRAN), EPS (UTRAN and E-UTRAN) or fixed
broadband access for the emergency service.
...
X X X EPS (UTRAN and E-UTRAN) X X X
* * *
