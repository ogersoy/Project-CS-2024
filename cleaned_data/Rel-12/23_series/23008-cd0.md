...
Active Time Value for PSM is defined in 3GPP TS 23.401[74] and 3GPP TS
23.060[21]. Active Time Value for PSM is temporary data conditionaly stored in
...
stored in the HSS and in the ProSe Application Server. Absence of the ProSe
Function identity in HSS indicates that the UE is not registered for ProSe.
## 3.14 Void
...
Active Time Value for PSM 2.13.148 - - C - T GPRS CAMEL Subscription
Information (GPRS-CSI) 2.14.1.10/2.14.4.4 C - C - C MO Short Message Service
CAMEL Subscription Information(MO-SMS-CSI) 2.14.1.8/2.14.4.1 C - C - C MT
...
[Digest Nonce]{.underline} [3.3.2.1]{.underline} - C - - T [Digest
HA1]{.underline} 3.3.2.2 C C - - P [Digest Nextnonce]{.underline} 3.3.2.3 - C
- - T Authentication Pending Flag 3.3.2.5 C - - - T Line Identifier List
3.3.3.1 C C - - P Server Capabilities 3.4.1 C - - - P S-CSCF Reassignment
...
ProSe Function Identity 3.13.8 C - - - C T
* * *
#