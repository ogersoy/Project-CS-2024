...
selected CN operator is available to serve the_ _UE\'s_ _location. Furthermore
the UE does not change to another CN node as long as the selected CN node is
...
\- If the UE for the opposite domain does not comes from an operator
