...
Authentication and Authorization Request message.- The 3GPP AAA Proxy shall
handle the non-3GPP access network as untrusted and marks the trust
relationship as \"untrusted\".
...
In the case of a Trusted WLAN, it shall contain the SSID of the WLAN and,
unless otherwise determined by the TWAN operator's policies, it shall contain
...
off timer to be sent to the UE.
...
Result-Code shall be set to DIAMETER_AUTHORIZATION_REJECTED.
3) Check if there was request for an APN received. If not, the default APN of
the user is selected to be used during the actual authentication and
...
+-------------------+-------------------+-------------------+-------+ | Attribute Name | Reference | Comments | M-bit | +-------------------+-------------------+-------------------+-------+ | Auth-Request-Type | IETF RFC 3588 | | | | | [7] | | | +-------------------+-------------------+-------------------+-------+ | ** | IETF RFC 4006 | | | | Subscription-ID** | [20] | | | +-------------------+-------------------+-------------------+-------+ | EAP-M | IETF RFC 4072 | | | | aster-Session-Key | [5] | | | +-------------------+-------------------+-------------------+-------+ | EAP-Payload | IETF RFC 4072 | | | | | [5] | | | +-------------------+-------------------+-------------------+-------+ | Re- | IETF RFC 3588 | | | | Auth-Request-Type | [7] | | | +-------------------+-------------------+-------------------+-------+ | Session-Timeout | IETF RFC 3588 | | | | | [7] | | | +-------------------+-------------------+-------------------+-------+ | User-Name | IETF RFC 3588 | | | | | [7] | | | +-------------------+-------------------+-------------------+-------+ | MIP6-Agent-Info | IETF RFC 5447 | | | | | [6] | | | +-------------------+-------------------+-------------------+-------+ | A | 3GPP TS 29.272 | | | | PN-OI-Replacement | [29] | | | +-------------------+-------------------+-------------------+-------+ | S | 3GPP TS 29.229 | | | | upported-Features | [24] | | | +-------------------+-------------------+-------------------+-------+ | Feature-List-ID | 3GPP TS 29.229 | See section | | | | [24] | 7.2.3.2 | | +-------------------+-------------------+-------------------+-------+ | Feature-List | 3GPP TS 29.229 | See section | | | | [24] | 7.2.3.3 | | +-------------------+-------------------+-------------------+-------+ | 3GPP-Chargin | 3GPP TS 29.061 | | | | g-Characteristics | [31] | | | +-------------------+-------------------+-------------------+-------+ | UE | 3GPP TS 29.212 | | | | -Local-IP-Address | [23] | | | +-------------------+-------------------+-------------------+-------+ | OC-S | IET | See section | | | upported-Features | F RFC 7683 [47] | 8.2.3.22 | | +-------------------+-------------------+-------------------+-------+ | OC-OLR | IET | See section | | | | F RFC 7683 [47] | 8.2.3.23 | | +-------------------+-------------------+-------------------+-------+ | NOTE 1: The M-bit | | | | | settings for | | | | | re-used AVPs | | | | | override those of | | | | | the defining | | | | | specifications | | | | | that are | | | | | referenced. | | | | | Values include: | | | | | \"Must set\", | | | | | \"Must not set\". | | | | | If the M-bit | | | | | setting is blank, | | | | | then the defining | | | | | specification | | | | | applies. | | | | | | | | | | NOTE 2: If the | | | | | M-bit is set for | | | | | an AVP and the | | | | | receiver does not | | | | | understand the | | | | | AVP, it shall | | | | | return a | | | | | rejection. If the | | | | | M-bit is not set | | | | | for an AVP, the | | | | | receiver shall | | | | | not return a | | | | | rejection, | | | | | whether or not it | | | | | understands the | | | | | AVP. If the | | | | | receiver | | | | | understands the | | | | | AVP but the M-bit | | | | | value does not | | | | | match with the | | | | | definition in | | | | | this table, the | | | | | receiver shall | | | | | ignore the M-bit. | | | | +-------------------+-------------------+-------------------+-------+
Only those AVP initially defined in this reference point and for this
procedure are described in the following subchapters.
...
The HSS shall also make use of this procedure to request the identity,
location information and UE local time zone of the access network where the UE
is currently attached. In this case, the HSS shall set the Access-Network-
| \ | | | | | | | | | [4]. | | | | | | | | | | | | | | | | | | NOTE | | | | | | | | | 2: If | | | | | | | | | the | | | | | | | | | M-bit | | | | | | | | | is | | | | | | | | | set | | | | | | | | | for | | | | | | | | | an | | | | | | | | | AVP | | | | | | | | | and | | | | | | | | | the | | | | | | | | | rec | | | | | | | | | eiver | | | | | | | | | does | | | | | | | | | not | | | | | | | | | under | | | | | | | | | stand | | | | | | | | | the | | | | | | | | | AVP, | | | | | | | | | it | | | | | | | | | shall | | | | | | | | | r | | | | | | | | | eturn | | | | | | | | | a | | | | | | | | | rejec | | | | | | | | | tion. | | | | | | | | | If | | | | | | | | | the | | | | | | | | | M-bit | | | | | | | | | is | | | | | | | | | not | | | | | | | | | set | | | | | | | | | for | | | | | | | | | an | | | | | | | | | AVP, | | | | | | | | | the | | | | | | | | | rec | | | | | | | | | eiver | | | | | | | | | shall | | | | | | | | | not | | | | | | | | | r | | | | | | | | | eturn | | | | | | | | | a | | | | | | | | | rejec | | | | | | | | | tion, | | | | | | | | | wh | | | | | | | | | ether | | | | | | | | | or | | | | | | | | | not | | | | | | | | | it | | | | | | | | | u | | | | | | | | | nders | | | | | | | | | tands | | | | | | | | | the | | | | | | | | | AVP. | | | | | | | | | If | | | | | | | | | the | | | | | | | | | rec | | | | | | | | | eiver | | | | | | | | | u | | | | | | | | | nders | | | | | | | | | tands | | | | | | | | | the | | | | | | | | | AVP | | | | | | | | | but | | | | | | | | | the | | | | | | | | | M-bit | | | | | | | | | value | | | | | | | | | does | | | | | | | | | not | | | | | | | | | match | | | | | | | | | with | | | | | | | | | the | | | | | | | | | defin | | | | | | | | | ition | | | | | | | | | in | | | | | | | | | this | | | | | | | | | t | | | | | | | | | able, | | | | | | | | | the | | | | | | | | | rec | | | | | | | | | eiver | | | | | | | | | shall | | | | | | | | | i | | | | | | | | | gnore | | | | | | | | | the | | | | | | | | | M | | | | | | | | | -bit. | | | | | | | | +-------+-------+-------+-------+------+-----+-------+-------+
...
Attach/Handover indication and/or PCO.
...
proceed with the establishment of the S2a connectivity.
...
(i.e. IPv4 and/or IPv6). The Result-Code AVP in the DEA message is set to
DIAMETER_MULTI_ROUND_AUTH. The TWAN-S2a-Connectivity Indicator is not set in
the DEA-Flags AVP.
7\. The TWAN forwards the EAP payload to the UE.
8\. The UE sends the EAP Response/AKA'-Challenge in which it also indicates
the requested connection mode. In this example, the UE requests the MCM.
...
and/or non-seamless WLAN offload, and the WLCP key for WLCP signalling
protection.\ \ Dependent on the authorizations received from the 3GPP AAA
server, the UE may subsequently initiate the establishement of PDN connections
to access the EPC and/or proceeed with non-seamless WLAN offload.
...
The 3GGP AAA server can consider some messages with a lower or a higher
priority; lower priority messages will be candidates for throttling before
higher priority messages.
The 3GGP AAA server can take into account if it has already registered the
user:
  * if the user is not already registered in the 3GGP AAA server, the 3GGP AAA server gives a lower priority to the MAR command to be sent to the HSS. This will correspond to the following cases:
\- the user is not registered for non 3GPP access in the HSS and is doing an
attach on a non 3GPP access;
\- the user is not registered for non 3GPP access in the HSS and is doing an
hand over from a 3GPP access; if the MAR command is throttled, the PDN
...
\- if the user is registered in the 3GPP AAA server, the 3GGP AAA server gives
...
given to this SAR;
\- in a restoration procedure due to the failure of the old 3GGP AAA server,
...
priority; lower priority messages will be candidates for throttling before
higher priority messages.The reacting node can take into account the following
considerations:
\- if the user has no existing context in the reacting node, thereacting node
