...
Spending Limit Request procedure in clause 4.5.3When the PCRF provides a new
subscribed policy counter identifier list, the OCS shall remove any policy
counter identifiers no longer in the list from association with the Sy session
such that the OCS will no longer notify the PCRF of those policy counter state
changes.
...
+--------------------+-----------------------+-----------------------+ | Attribute Name | Reference | Description | +--------------------+-----------------------+-----------------------+ | Subscription-Id | IETF RFC 4006 [5] | The identification of | | | | the subscription | | | | (IMSI, MSISDN, etc) | +--------------------+-----------------------+-----------------------+ | Logical-Access-ID | E | Contains a Circuit‑ID | | | TSI TS 283 034 [17] | (as defined in | | | | I | | | | ETF RFC 3046 [18]). | | | | The Logical Access ID | | | | may explicitly | | | | contain the identity | | | | of the Virtual Path | | | | and Virtual Channel | | | | carrying the traffic. | | | | Applicable only for | | | | Fixed Broadband | | | | Access network | | | | convergence as | | | | defined in annex A. | | | | | | | | This AVP shall have | | | | the 'M' bit cleared. | +--------------------+-----------------------+-----------------------+ | Physical-Access-ID | E | Identifies the | | | TSI TS 283 034 [17] | physical access to | | | | which the user | | | | equipment is | | | | connected. Includes a | | | | port identifier and | | | | the identity of the | | | | access node where the | | | | port resides. | | | | Applicable only for | | | | Fixed Broadband | | | | Access network | | | | convergence as | | | | defined in annex A. | | | | | | | | This AVP shall have | | | | the 'M' bit cleared. | +--------------------+-----------------------+-----------------------+
