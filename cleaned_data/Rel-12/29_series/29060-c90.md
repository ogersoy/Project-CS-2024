...
required for this user, as specified in 3GPP TS 23.380 [57].
...
\"Request accepted\".
At most 5 Authentication Triplet information elements or Authentication
Quintuplet information elements may be included in the message if the Cause
contains the value \"Request accepted\".
The optional Private Extension contains vendor or operator specific
information.
...
7.7.115 Private Extension Optional 7.7.46
* * *
...
from that provided by the underlying network service (e.g. IP). During a Gn/Gp
SGSN to S4-SGSN RAU procedure (see subclause 6.9.2.1 of 3GPP TS 23.060 [4])
when a Direct Tunnel is established by the S4-SGSN, or during a Gn/Gp SGSN to
MME TAU procedure (see annex D.3.6 in 3GPP TS 23.401 [47]), the S4-SGSN or
...
The optional Private Extension contains vendor or operator specific
information.
Table 7.5B.1.1.1: Information Elements in MS Info Change Reporting
* * *
Information element Presence requirement Reference IMSI Conditional 7.7.2
...
received in the MS Info Change Notification Request message and if the GGSN
supports the Linked NSAPI IE in this message. This IE indicates the SGSN that
the MS Info Change Notification Request message per PDN connection is
supported by the GGSN.
...
The optional Private Extension contains vendor or operator specific
information.
Table 7.5B.1.2.1: Information Elements in MS Info Change Reporting Response
* * *
Information element Presence requirement Reference Cause Mandatory 7.7.1 IMSI
...
restricted for the subscriber\" 231 For future use 232-240 Cause values
reserved for GPRS charging protocol use (see GTP\' in 3GPP TS 32.295 [33])
241-255 NOTE: With this coding, bits 8 and 7 of the Cause Value respectively
indicate whether the message was a request or a response, and whether the
...
* * *
     ...
     1        Type=193 (Decimal)                                                                        
     2-3      Length                                                                                    
     4-n      Spare                Spare   PCRI   VB     RetLoc   CPSR   CCRSI   Unauthenticated IMSI
* * *
...
Mode IE during handover/RAU procedures CT#59 29.060 11.6.0 0927r2 Rel-12
12.0.0 GTPv1 deferred IPv4 address allocation 0928r1 Corrections to
descriptions of RFSP Index 0929r1 Clarification on IE Type Value in the GTP
signalling message 0935r1 Clean up the references CT#60 29.060 12.0.0 0947r2
Rel-12 12.1.0 ULI Timestamp 0944r3 Clarification on the use of eARP IE 0942r3
Clarification on how to indicate UE has left a CSG cell 0941r1 SIPTO at the
local network CT#61 29.060 12.1.0 0950r2 Rel-12 12.2.0 Enforcing access
restriction during I-RAT RAU/TAU procedures 0960r2 Correction to the condition
of inclusion of the RAT Type IE 0961r2 SIPTO at the Local Network 0962r1 GERAN
Iu Mode 0964r2 ULI Timestamp IE format CT#62 29.060 12.2.0 0965 Rel-12 12.3.0
Correction on the occurrence of LHN ID with NSAPI 0966 Core Network Operator
selection origin 0968r1 Correct BSSGP Cause value 0969 Resolving ambiguity of
SGSN Number IE encoding 0970r1 Clarification on encoding of bit rates when
converting bits per second received over Diameter and MAP interfaces to kilo
bits per second over GTPv1. 0971r1 Cause IE condition in the Delete PDP
Context Request CT#63 29.060 12.3.0 0978r1 Rel-12 12.4.0 RFSP index encoding
during inter SGSN mobility procedure 0982r1 Update the ULI Timestamp IE format
0975r2 CSG Membership Indication values 0979r2 PLMN ID communicated to the
HPLMN in network sharing 0980 MS Info Change Notification CT#64 29.060 12.4.0
0983r1 Rel-12 12.5.0 Number of authentication vectors in the MM Context IE
0984r1 Context Response with P-TMSI Signature mismatch 0985r1 Correction on
encoding of Selected PLMN ID and Target Identification 0986r1 Correction of
reference of transparent container CT#65 29.060 12.5.0 0992r1 Rel-12 12.6.0
Corrections to E-UTRAN to GERAN PS Handover 0987 P-CSCF Restoration Indication
0988r2 ULI change reporting when RAB/user plane is established 0993 Dual
Address Bearer Flag 0994r1 Correct procedure name for PDN connection
deactivation CT#66 29.060 12.6.0 0998r2 Rel-12 12.7.0 Target Cell
Identification in E-UTRAN to GERAN PS Handover 0999r1 RANAP cause in
Relocation Cancel Request 1000r1 Data forwarding during Gn SGSN to S4-SGSN RAU
1001r1 IEs order in MBMS Registration Response and MS Info Change Notification
Response 1002r1 Removal of invalid description on spare bits in MBMS UE
Context IE 1003r2 MS Info Change Reporting Action IE 1004r3 Terminology
cleanup for Location Change Reporting CT#67 29.060 12.7.0 1010 Rel-12 12.8.0
Reserved Extension Header Value for GTP-U