...
additional screening capabilities as defined in3GPP TS 24.229 [5] clause
5.10.6.
...
session\" as specified in IETF RFC 3959 [96] shall be supported at II-NNI, if
the early session model is supported.
...
3GPP TS 24.292 [121] and the support of the SUBSCRIBE request and associated
NOTIFY requests for subscribing to the conference event package is not a
requirement at the II-NNI in this release of the technical specification.
...
\"cause\" header field parameter set to \"487\" in the SIP re-INVITE request
shall be supported at the roaming II-NNI.
The Reason header field containing the protocol value set to \"SIP\" and
\"cause\" header field parameter set to \"503\" in the SIP BYE request shall
be supported at the roaming II-NNI.
...
IETF RFC 6809 [143] in a SIP INVITE request and in non-100 provisional
responses and the 2xx response to the INVITE request or in the UPDATE request
and in the 2xx response to the UPDATE request shall be supported at the
roaming II-NNI.
The Target-Dialog header field in the INVITE request shall be supported at the
roaming II-NNI.
...
The g.3gpp.mid-call feature-capability indicator according to 3GPP TS 24.237
[131] annex C included in the Feature-Caps header field of the INVITE request,
in responses to the INVITE request and in any target refresh request and in
non-100 provisional responses or the 2xx response to target refresh request
shall be supported at the roaming II-NNI.
...
responses to the SIP INVITE request shall be supported at the roaming II-NNI.
...
the INVITE request and in responses to the SIP INVITE request shall be
supported at the roaming II-NNI.
...
field of the SIP INVITE request shall be supported at the roaming II-NNI.
...
field of the INVITE request, in responses to the SIP INVITE request and in any
...
of the SIP 200 (OK) response to INVITE request shall be supported at the
roaming II-NNI.
...
Contact [51] o do 24 Relayed-Charge [5] n/a dn/a 25 Request-Disposition [51] o
do 26 Require [13] n/a dn/a 27 Resource-Priority [78] o IF table 6.1.3.1/73
THEN do (NOTE) 28 Route [13] c dc 29 Session-ID [124] m IF table 6.1.3.1/94
THEN dm (NOTE) 30 Timestamp [13] o do 31 To [13] m dm 32 User-Agent [13] o do
33 Via [13] m dm NOTE: If the capability specified in table 6.1.3.1 is not
supported over the II-NNI, the IBCF in the receiving network can omit or
...
[13], [39] o do 31 Referred-By [53], [39] o do 32 Relayed-Charge [5] n/a dn/a
33 Request-Disposition [51], [39] o do 34 Require [13], [39] o do 35 Resource-
Priority [78], [39] o IF table 6.1.3.1/73 THEN do (NOTE) 36 Route [13], [39] o
do 37 Security-Client [47], [39] o dn/a 38 Security-Verify [47], [39] o dn/a
39 Session-ID [124] m IF table 6.1.3.1/94 THEN dm (NOTE) 40 Subject [13], [39]
o do 41 Supported [13], [39] o do 42 Timestamp [13], [39] o do 43 To [13],
[39] m dm 44 User-Agent [13], [39] o do 45 Via [13], [39] m dm dc1: request
...
Function-Addresses [24] o dn/a 30 P-Charging-Vector [24] o IF table 6.1.3.1/38
THEN dm (NOTE) 31 P-Preferred-Identity [44] o dn/a 32 Privacy [34] o do 33
Proxy-Authorization [13], [20] o IF table 6.1.3.1/7 THEN do (NOTE) 34 Proxy-
Require [13], [20] o do 35 Reason [48] o IF table 6.1.3.1/40 THEN do (NOTE) 36
Record-Route [13], [20] o do 37 Referred-By [53] o do 38 Reject-Contact [51] o
do 39 Relayed-Charge [5] n/a dn/a 40 Request-Disposition [51] o do 41 Require
[13], [20] o do 42 Resource-Priority [78] o IF table 6.1.3.1/73 THEN do (NOTE)
43 Route [13], [20] c dc 44 Security-Client [47] o dn/a 45 Security-Verify
[47] o dn/a 46 Session-ID [124] m IF table 6.1.3.1/94 THEN dm (NOTE) 47
Subscription-State [20] m dm 48 Supported [13], [20] o do 49 Timestamp [13],
[20] o do 50 To [13], [20] m dm 51 User-Agent [13], [20] o do 52 Via [13],
[20] m dm 53 Warning [13], [20] o do NOTE: If the capability specified in
...
31 Referred-By [53] o do 32 Reject-Contact [51] o do 33 Relayed-Charge [5] n/a
dn/a 34 Request-Disposition [51] o do 35 Require [13], [18] c dc 36 Resource-
Priority [78] o IF table 6.1.3.1/73 THEN do (NOTE) 37 Route [13], [18] c dc 38
Session-ID [124] m IF table 6.1.3.1/94 THEN dm (NOTE) 39 Supported [13], [18]
o do 40 Timestamp [13], [18] o do 41 To [13], [18] m dm 42 User-Agent [13],
[18] o do 43 Via [13], [18] m dm dc1: request invoked due to CAT to first 18x
response with P-Early-Media header field cancelling \"CAT service\" provided
by terminating AS AND (non-roaming II-NNI OR loopback traversal scenario OR
...
History-Info [25] o IF table 6.1.3.1/50 AND request outside an existing dialog
THEN do (NOTE) 23 Max-Breadth [79] o do 24 Max-Forwards [13] m dm 25 MIME-
Version [13] o do 26 Organization [13] o do 27 P-Access-Network-Info [24],
[24B] o IF table 6.1.3.1/36 THEN do (NOTE) 28 P-Charging-Function-Addresses
[24] o dn/a 29 P-Charging-Vector [24] o dm 30 P-User-Database [60] o dn/a 31
P-Visited-Network-ID [24] o dm 32 Path [43] o dm 33 Privacy [34] o dn/a 34
Proxy-Authorization [13] o do 35 Proxy-Require [13] o do 36 Reason [48] o IF
table 6.1.3.1/40 THEN do (NOTE) 37 Recv-Info [39] o IF table 6.1.3.1/17 THEN
do (NOTE) 38 Referred-By [53] o do 39 Relayed-Charge [5] n/a dn/a 40 Request-
Disposition [51] o do 41 Require [13] c dm 42 Resource-Priority [78] o IF
table 6.1.3.1/73 THEN do (NOTE) 43 Route [13] c dc 44 Security-Client [47] o
dn/a 45 Security-Verify [47] o dn/a 46 Session-ID [124] m IF table 6.1.3.1/94
THEN dm (NOTE) 47 Supported [13] o dm 48 Timestamp [13] o do 49 To [13] m dm
50 User-Agent [13] o do 51 Via [13] m dm NOTE: If the capability specified in
table 6.1.3.1 is not supported over the II-NNI, the IBCF in the receiving
network can omit or modify the SIP header fields in the received SIP message
prior to forwarding the SIP message as specified in TS 24.229 [5] clause
5.10.6.2.
...
Relayed-Charge [5] n/a dn/a 40 Request-Disposition [51] o do 41 Require [13],
[23] c dc 42 Resource-Priority [78] o IF table 6.1.3.1/73 THEN do (NOTE) 43
Route [13], [23] c dc 44 Security-Client [47] o dn/a 45 Security-Verify [47] o
dn/a 46 Session-Expires [52] o do 47 Session-ID [124] m IF table 6.1.3.1/94
THEN dm (NOTE) 48 Supported [13], [23] o do 49 Timestamp [13], [23] o do 50 To
[13], [23] m dm 51 User-Agent [13], [23] o do 52 Via [13], [23] m dm NOTE: If
...
of simultaneous connections in case of reuse of the existing connections). No  
...
assisted mid-call feature) and the use of IMS Centralized Services (ICS). No
* * *
