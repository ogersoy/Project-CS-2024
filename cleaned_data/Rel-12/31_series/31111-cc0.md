...
[31] Void.
> [32] ETSI TS 102 223 V12.3.0: \"Smart Cards; Card Application Toolkit\".
>
...
activation parameters or IMS URI 8.1, 8.14 or 8.17 or 8.72 or 8.98 or 8.108 M
Y B Capability configuration parameters 1 8.4 O N C Subaddress 8.3 O N D
Location information 8.19 C N E Capability configuration parameters 2 8.4 O N
F
* * *
\- Device identities: the ME shall set the device identities to:
source: ME;
...
EPS PDN connection activation parameters or IMS URI: only one data object
shall be sent to the UICC:
...
> 24.229[52], to which the ME is proposing setting up the communication.
...
activation parameters or EPS PDN connection activation parameters or IMS URI
8.1, 8.14 or 8.17 or 8.72 or 8.98 or 8.108 O N A Capability configuration
parameters 1 8.4 O N B Subaddress 8.3 O N C Alpha identifier 8.2 O N D BC
repeat indicator 8.42 C N E Capability configuration parameters 2 8.4 O N F
* * *
\- Call control result:
Contents:
...
activation parameters or IMS URI: Only one data object may be included if the
UICC requests the call (or supplementary service or USSD operation or PDP
context/EPS PDN connection activation or IMS communication establishment)
...
present, then the ME shall assume that neither the SIP URI nor the tel URI are
to be modified.
...
1 8.1 M Y B Address data object 2 8.1 M Y C Location information 8.19 C Y D
* * *
\- Device identities: the ME shall set the device identities to:
source: ME;
destination: UICC.
...
\- Location information: this data object contains the identification (MCC,
MNC, LAC, Cell Identity) of the current serving cell of the UE. This data
object shall be present if the short message is sent over GERAN, UTRAN or
E-UTRAN.
Response parameters/data.
It is permissible for the UICC to provide no response data, by responding with
SW1/SW2 = \'90 00\'. If the UICC does not provide any response data, then this
...
Length (A+B+C) - M Y 1 or 2 Address data object 1 8.1 O (see note) N A Address
data object 2 8.1 O (see note) N B Alpha identifier 8.2 O N C NOTE: The UICC
shall provide the two optional address data objects if it has set the MO Short
Message control result to \"allowed with modifications\".
* * *
...
Direction: ME to UICC.
The command header is specified in TS 31.101 [Error: Reference source not
found3].
Command parameters/data.
* * *
...
length 1 byte), and terminal shall set the event to:
  * MT call.
Device identities: the ME shall set the device identities to:
  * source: network;
  * destination: UICC.
...
the terminal in the call setup message. If the Calling Party number is
included in the call setup message, the terminal shall include the Address
object. Otherwise the terminal shall not include the Address object.
Subaddress: The Subaddress data object holds the Calling Party Subaddress as
received by the terminal in the call setup message. If the Calling Party
Subaddress is included in the call setup message, the terminal shall include
the Subaddress object, otherwise the terminal shall not include the Subaddress
object.
IMS URI: The IMS URI data object is a SIP or TEL URI of the Calling Party
received by the terminal in the call setup message. This data object will be
present only if the \"URI support by UICC\" Service is present in the USIM or
the ISIM Service Table. The IMS URI data object shall contain the SIP URI or
tel URI indicated in the P-Asserted-Identity field as defined in TS 24.229
[52]. In case the P-Asserted-Identity field is missing the SIP URI or tel URI
indicated in the From header field shall be used. If the IMS URI is too long
to be included (i.e. the value part of the IMS URI data object is longer than
239 octets), the ME shall not include the IMS URI data object.
Response parameters/data:
  * none.
...
\- PLMN ID: If the UE is camping on a CSG or Hybrid cell that is listed in the
Allowed CSG list or the Operator CSG list, this data object may be present,
and, if present, shall contain the PLMN identity of the current serving CSG or
Hybrid cell.
Response parameters/data: None for this type of ENVELOPE command.
...
(see TS 24.334 [61]) in the UICC. This is performed using the ENVELOPE (ProSe
Report).
...
Command parameters/data.
* * *
Description Clause M/O/C Min Length ProSe Report tag 9.1 M Y 1 Length (A or
A+B or A+C) - M Y 1 or 2 Device identities 8.7 M Y A ProSe Report 8.128 M Y B
Last Envelope 8.79 C N C
* * *
\- Device identities: the ME shall set the device identities to:
\- source: ME;
\- destination: UICC.
\- ProSe Report Data: This data object contains the location information.
...
* * *
Byte(s) Description Length 1 E-UTRAN Inter-frequency Network Measurement
Results tag 1 2 Length (X) of bytes following 1 3 -- 6 Frequency value 4 7 --
to X+6 Measurement Report information X
* * *
...
* * *
Byte(s) Description Length 1 ProSe Report Data Tag 1 2 to (X+1) Length X (1 or
2) X+2 to X+1+Y ProSe Report Data Y
* * *
  * Contents:
Contains the ProSe Report
  * Coding:
> Coded according to the XML schema defined in TS 24.334 [61] with \ pc3ch-message> element as the root element and one
> \ element inside it.
# 9 Tag values
...
+-------------+-------------+-------------+-------------+-------------+ | Description | Length of | Tag value, | Tag | Reassign | | | tag | bits 1-7 | | (see NOTE) | | | | (Range: | (CR and Tag | | | | | \'01\' - | value) | | | | | \'7E\') | | | +-------------+-------------+-------------+-------------+-------------+ | SS string | 1 | \'09\' | \'09\' or | yes | | tag | | | \'89\' | | +-------------+-------------+-------------+-------------+-------------+ | PLMN ID tag | 1 | \'09\' | \'09\' or | yes | | | | | \'89\' | | +-------------+-------------+-------------+-------------+-------------+ | USSD string | 1 | \'0A\' | \'0A\' or | yes | | tag | | | \'8A\' | | +-------------+-------------+-------------+-------------+-------------+ | SMS TPDU | 1 | \'0B\' | \'0B\' or | yes | | tag | | | \'8B\' | | +-------------+-------------+-------------+-------------+-------------+ | Cell | 1 | \'0C\' | \'0C\' or | yes | | Broadcast | | | \'8C\' | | | page tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | Cause tag | 1 | \'1A\' | \'1A\' or | yes | | | | | \'9A\' | | +-------------+-------------+-------------+-------------+-------------+ | BCCH | 1 | \'1D\' | \'1D\' or | yes | | channel | | | \'9D\' | | | list tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | BC Repeat | 1 | \'2A\' | \'2A\' or | yes | | Indicator | | | \'AA\' | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | Timing | 1 | \'2E\' | \'2E\' or | yes | | Advance tag | | | \'AE\' | | +-------------+-------------+-------------+-------------+-------------+ | PDP context | 1 | '52' | '52' or | yes | | Activation | | | 'D2' | | | parameters | | | | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | UT | 1 | \'69\' | \'69\' or | yes | | RAN/E-UTRAN | | | \'E9\' | | | Measurement | | | | | | Qualifier | | | | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | I-WLAN | 1 | \'4A\' | \'4A\' or | yes | | Identifier | | | \'CA\' | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | I-WLAN | 1 | \'4B\' | \'4B\' or | yes | | Access | | | \'CB\' | | | Status tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | PLMNwAcT | 1 | \'72\' | \'72\' or | yes | | List tag | | | \'F2\' | | +-------------+-------------+-------------+-------------+-------------+ | Routing | 1 | \'73\' | \'73\' or | yes | | Area | | | \'F3\' | | | Information | | | | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | Up | 1 | \'74\' | \'74\' or | yes | | date/Attach | | | \'F4\' | | | Type tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | ProSe | | | | | | Report Data | | | | | | Tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | Rejection | 1 | \'75\' | \'75\' or | yes | | Cause Code | | | \'F5\' | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | G | 1 | \'76\' | \'76\' or | yes | | eographical | | | \'F6\' | | | Location | | | | | | Parameters | | | | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | IARI tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | GAD shapes | 1 | \'77\' | \'77\' or | yes | | tag | | | \'F7\' | | +-------------+-------------+-------------+-------------+-------------+ | IMPU list | | | | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | NMEA | 1 | \'78\' | \'78\' or | yes | | sentence | | | \'F8\' | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | IMS | | | | | | Status-Code | | | | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | PLMN List | 1 | \'79\' | \'79\' or | yes | | tag | | | \'F9\' | | +-------------+-------------+-------------+-------------+-------------+ | E-UTRAN | | | | | | Inte | | | | | | r-frequency | | | | | | Network | | | | | | Measurement | | | | | | Results tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | EPS PDN | 1 | \'7C\' | \'7C\' or | yes | | connection | | | \'FC\' | | | Activation | | | | | | parameters | | | | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | Tracking | 1 | \'7D\' | \'7D\' or | yes | | Area | | | \'FD\' | | | Ide | | | | | | ntification | | | | | | tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | CSG ID list | 1 | \'7E\' | \'7E\' or | yes | | tag | | | \'FE\' | | +-------------+-------------+-------------+-------------+-------------+ | CSG cell | 1 | \'55\' | \'55\' or | yes | | selection | | | \'D5\' | | | status tag | | | | | +-------------+-------------+-------------+-------------+-------------+ | CSG ID tag | 1 | \'56\' | \'56\' or | yes | | | | | \'D6\' | | +-------------+-------------+-------------+-------------+-------------+ | HNB name | 1 | \'57\' | \'57\' or | yes | | tag | | | \'D7\' | | +-------------+-------------+-------------+-------------+-------------+ | IMS URI tag | 1 | \'31\' | \'31\' or | yes | | | | | \'B1\' | | +-------------+-------------+-------------+-------------+-------------+ | NOTE: | | | | | | Starting | | | | | | from | | | | | | Release 10, | | | | | | tag values | | | | | | are | | | | | | assigned in | | | | | | a context | | | | | | specific | | | | | | manner, | | | | | | i.e. the | | | | | | same tag | | | | | | value can | | | | | | be used for | | | | | | different | | | | | | data | | | | | | objects, | | | | | | provided | | | | | | that the | | | | | | object can | | | | | | be uniquely | | | | | | identified | | | | | | from the | | | | | | context of | | | | | | the | | | | | | proactive | | | | | | command or | | | | | | ENVELOPE | | | | | | command in | | | | | | which it is | | | | | | used.\ | | | | | | The column | | | | | | \ | | | | | | "Reassign\" | | | | | | indicates | | | | | | whether it | | | | | | is expected | | | | | | that a tag | | | | | | can be | | | | | | reassigned | | | | | | in a | | | | | | context | | | | | | specific | | | | | | manner | | | | | | (yes), | | | | | | whether | | | | | | that is not | | | | | | recommended | | | | | | (NR) | | | | | | because of | | | | | | potential | | | | | | future | | | | | | conflicts | | | | | | or if this | | | | | | shall not | | | | | | be done | | | | | | (no). | | | | | +-------------+-------------+-------------+-------------+-------------+
