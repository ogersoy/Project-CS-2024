...
2) to provide an end-to-end (e2e) media security solution for RTP based media
to satisfy major user categories
...
###### ## Annex K: MIKEY general extension payload for message proof-of-origin
...
## N.2.1 General
According to ETF RFC 8826 [39], all RTP traffic generated or received by a
