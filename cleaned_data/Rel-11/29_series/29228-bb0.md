...
\- If the Public User Identity is currently registered with only one Private
User Identity, the HSS shall check whether th Public User Identity is included
in the information element Identities with Emergency Registrations returned by
S-CSCF in the response.
...
Priviledged-Sender-Indication LIA Flags LIA-Flags
* * *
# A.4 Message flows
...
be either:
  ...
  * A non distinct Public User Identity, i.e. not explicitly provisioned in HSS[.]{.underline}
