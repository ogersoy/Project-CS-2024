...
case of GPRS / UMTS (PS domain) intercepted at the GSN under a separate
...
(TFT) Handover indication Failed Bearer Modification reason
* * *
...
specified in [22]. In case of change of MME, the new MME shall send the event,
...
bearer QoS Traffic Aggregate Description Failed Bearer Modification reason
...
* * *
Observed MSISDN Observed IMSI Observed ME id Event Type Event Time Event Date
Network Element Identifier Location Information APN PDN type IAs (if
applicable) EPS bearer identity of the default bearer
* * *
...
* * *
Observed MN NAI Observed IMSI Event Type Event Date Event Time Correlation
number Network Element Identifier APN Initiator Location Information
* * *
...
* * *
Observed MN NAI Observed IMSI Event Type Event Date Event Time Network Element
Identifier Revocation trigger UE address info Correlation number Location
Information
* * *
...
* * *
Observed MN NAI Observed IMSI Event Type Event Date Event Time Network Element
Identifier Home Address Foreign domain address Correlation number
* * *
...
Observed MN NAI Observed MSISDN Observed IMEI Event Type Event Time Event Date
Network Element Identifier Correlation number Lifetime UE Address Info Access
Technology Type Additional Parameters Session modification failure reason
Serving Network Handover indicator DHCPv4 Address Allocation Indication
Location information
* * *
...
* * *
Observed MN NAI Observed IMSI Event Type Event Time Event Date Correlation
number Network Element Identifier Lifetime Session modification failure reason
Home address Care of Address APN Requested IPv6 Home Prefix
* * *
...
Interception in the PDN-GW shall be based on IMSI or NAI.
NOTE: The NAI may be a temporary ID, therefore the use of IMSI is recommended.
For the delivery of the CC and IRI, the PDN-GW provides correlation number and
target identity to the DF2 and DF3 which is used there in order to select the
different LEAs where the product shall be delivered.
...
Observed MN NAI Observed IMSI Event Type Event Time Event Date Correlation
number Network Element Identifier Lifetime Failed attach reason Access
Technology Type Handoff Indicator APN UE Address Info Additional Parameters
* * *
...
Observed MN NAI Observed IMSI Event Type Event Time Event Date Correlation
number Network Element Identifier Lifetime Failed attach reason Home address
Care of Address APN Requested IPv6 Home Prefix
* * *
...
* * *
Observed MN NAI Observed IMSI Event Type Event Time Event Date Correlation
number Network Element Identifier APN
* * *
...
* * *
Observed MN NAI Observed IMSI Event Type Event Time Event Date Correlation
number Network Element Identifier Home address Initiator Care of Address
* * *
...
* * *
Observed MN NAI Observed IMSI Event Type Event Date Event Time Network Element
Identifier Revocation trigger UE address info Correlation number
* * *
...
Identifier Correlation number Lifetime UE Address Info Access Technology Type
Additional Parameters Session failure modification reason Handover indicator
* * *
...
* * *
Observed MN NAI Observed IMSI Event Type Event Time Event Date Correlation
number Network Element Identifier Lifetime Session failure modification reason
Home address Care of Address APN Requested IPv6 Home Prefix
* * *
