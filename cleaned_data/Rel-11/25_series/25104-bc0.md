...
and receives single or multiple carriers simultaneously **within each
...
base station.
NOTE: There may be multiple instances of sub-blocks within Base Station a RF
Bandwidth.
...
α Roll-off factor
E~b~ Average energy per information bit E~c~ Total energy per PN chip
...
gap.
The interfering signal frequency offset shall be as in Table 6.21.
