...
Received Synch Uplink Timing Deviation | Conditional 1.28Mcps TDD |  |  |  |  |  |  |  |   
MAC –c/sh SDU Length |  |  |  |  |  |  |  |  |   
...
[FDD - Bits 2 of New IE Flags in RACH DATA FRAME indicates if the _Extended
...
Bits 3 through 6 of New IE Flags in HS-DSCH DATA FRAME TYPE 2 shall be set to
0.
...
(1) or not (0).
Bit 1 of New IE Flags in E-DCH DATA FRAME is reserved and shall not be
allocated in this version of the specification.
...
IE shall be igored by the receiver.
Bits 1 and 3 through 6 of New IE Flags in E-DCH DATA FRAME shall be set to 0.
...
Bit 0 of New IE Flags in FACH FLOW CONTROL FRAME indicates if the _Extended
S-RNTI_ IE is present (1) or not (0). If the _Extended S-RNTI_ IE is included,
the _S-RNTI_ IE shall be igored by the receiver.
