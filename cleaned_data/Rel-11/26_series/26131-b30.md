...
in figure 0. These are the air interface and the point of interconnect (POI).
NOTE 1: Includes DTX functionality.
NOTE 2: Connection to PSTN should include electrical echo control (EEC).
Figure 0: 3G Interfaces for specification and testing of terminal acoustic
characteristics
