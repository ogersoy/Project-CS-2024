...
with _Reliable Inter RAT Handover Info_ IE missing or set to "0"; in this case
the BSS shall replace the _Inter RAT Handover Info_ received from the source
BSS with the new value received from the SGSN in the PS-HANDOVER-COMPLETE-ACK
PDU.
