...
the BS core and test specifications, based upon the outcome of study item.
# 5 Scenarios for PIM
## 5.1 Site scenarios
...
the second category of bands, due to the "small" duplex gap, the own receiver
...
Wide Area (WA) base station deployment:
