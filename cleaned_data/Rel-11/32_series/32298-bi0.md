...
[230] 3GPP TS 29.338: \"Diameter based protocols to support SMS capable MMEs
\".
[231]- [299] void
...
together with Service Identification reporting.
...
Network Code) serving the UE.The MCC and MNC are coded as described for
'Routing Area Identity' in TS 29.060 [75].
...
I-WLAN access, this shall be the GPRS Charging ID, for EPS, this shall be the
...
##### 5.1.2.2.25A Local GW Inserted Indication
...
##### 5.1.3.1.33A List of NNI Information
...
destination in a transmitted SIP INVITE or non-session related SIP MESSAGE
request.
...
value \" unknown \". For further information on the Transit IOI exchange via
SIP signalling please refer to TS 24.229 [210].
...
AoC information is defined in 5.1.3.1.3A.
...
mobileDomain (0) gsm-Network (1) modules (3) map-ER-DataTypes (17) version13
(13)}
\-- from TS 29.002 [214]
ObjectInstance
...
gsm-Access (2) modules (3) ss-DataTypes (2) version13 (13)}
**\--** from TS 24.080 [209]
DefaultCallHandling,
DefaultSMS-Handling,
...
(0) gsm-Network (1) modules (3) map-CH-DataTypes (13) version13 (13) }
\-- from TS 29.002 [214]
AddressString,
BasicServiceCode,
IMEI,
...
mobileDomain (0) gsm-Network (1) modules (3) map-LCS-DataTypes (25) version13
(13) }
\-- from TS 29.002 [214]
...
FROM CAP-datatypes {itu-t(0) identified-organization (4) etsi (0) mobileDomain
(0)
...
RAIdentity
FROM MAP-CommonDataTypes {itu-t identified-organization (4) etsi (0)
mobileDomain (0)gsm-Network (1) modules (3) map-CommonDataTypes (18) version13
(13)}
\-- from TS 29.002 [214]
CallReferenceNumber
FROM MAP-CH-DataTypes {itu-t identified-organization (4) etsi (0) mobileDomain
