...
[2] and [3], the requirements for the present IRP: UTRAN Network Resources
IRP.
# 2 References
...
D. IRP-related requirements in 3GPP TS 32.511 [4].
In addition to the above, the following more specific requirements apply:
  1. The NRM defined by this IRP shall contain UTRAN specific MOCs and related definitions, supporting UTRAN network entities, which shall include FDD and TDD mode aspects.
```{=html}
``` 1\. The NRM defined by this IRP shall support management of UMTS-GSM
inter-system handover.
  1. The NRM defined by this IRP shall support management of UMTS-EPS inter-system handover.
  2. The NRM defined by this IRP shall support management of Inter-Radio Access Technology Automatic Neighbour Relation (IRAT ANR) from UTRAN to E-UTRAN, from UTRAN to GERAN.
  3. The NRM defined by this IRP shall support management of Intra-UTRAN Automatic Neighbour Relation (ANR).
#