...
+----------------+----------------+----------------+----------------+ | Time | Event | Notification | Selected | | | | | notification | | | | | content *) | +----------------+----------------+----------------+----------------+ | T1 | Outage of cell | _n | notificationId | | | 1. COC is done | otifyNewAlarm, | =notiAlCell1;\ | | | for this cell. | originated by | correlatedN | | | | EUt | otifications={ | | | | ranGenericCell | }; | | | | instance | | | | | representing | notific | | | | cell 1._ | ationId=COC1;\ | | | | | correlatedN | | | | notifyAttrib | otifications={ | | | | uteValueChange | notiAlCell1};\ | | | | of | cell1.cOCSt | | | | CellO | atus.state=**c | | | | utageCompensat | OCActivating;\ | | | | ionInformation |** c | | | | instance name | ell1.cOCStatus | | | | contained in | .errorList={}; | | | | EUt | | | | | ranGenericCell | | | | | instance | | | | | representing | | | | | cell 1. | | +----------------+----------------+----------------+----------------+ | T2 | COC | notifyAttrib | n | | | reconfigures | uteValueChange | otificationId= | | | cell 2 | of | avcCell2comp;\ | | | | EUt | cor | | | | ranGenericCell | relatedNotific | | | | instance | ations={COC1}; | | | | representing | | | | | cell 2. | cell2.cOCStatu | | | | | s.state=**cOCC | | | | | ompensating;** | +----------------+----------------+----------------+----------------+ | T3 | COC | notifyAttrib | n | | | reconfigures | uteValueChange | otificationId= | | | cell 3 | of | avcCell3comp;\ | | | | EUt | cor | | | | ranGenericCell | relatedNotific | | | | instance | ations={COC1}; | | | | representing | cell3.cOCStatu | | | | cell 3. | s.state=**cOCC | | | | | ompensating;** | +----------------+----------------+----------------+----------------+ | T4 | COC tries to | notifyAttrib | notific | | | reconfigure | uteValueChange | ationId=COC2;\ | | | cell 4 without | of | corr | | | success | CellO | elatedNotifica | | | | utageCompensat | tions={COC1};\ | | | | ionInformation | cell1.cOCSta | | | | instance name | tus.state=**cO | | | | contained in | CActivating** ; | | | | EUt | | | | | ranGenericCell | cell1. | | | | instance | cOCStatus.erro | | | | representing | rList={cell4}; | | | | cell 1. | | +----------------+----------------+----------------+----------------+ | Case: COC | | | | | successful | | | | +----------------+----------------+----------------+----------------+ | T5a | COC function | notifyAttrib | notifica | | | decides, that | uteValueChange | tionId=COC5a;\ | | | no further | of | corr | | | actions are | CellO | elatedNotifica | | | necessary. | utageCompensat | tions={COC1};\ | | | | ionInformation | cell1.c | | | | instance | OCStatus.state | | | | contained in | =**cOCActive;\ | | | | EUt |** cell1. | | | | ranGenericCell | cOCStatus.erro | | | | instance | rList={cell4}; | | | | representing | | | | | cell 1. | | +----------------+----------------+----------------+----------------+ | T6a | Outage of cell | _notif |_ n | | | 1 ends | yClearedAlarm, | otificationId= | | | | originated by | clearAlCell1;\ | | | | EUt | correlatedN | | | | ranGenericCell | otifications={ | | | | instance | notiA | | | | representing | lCell1,COC1};_| | | | cell 1._ | | | | | | Notifica | | | | notifyAttrib | tionId=COC6a;\ | | | | uteValueChange | co | | | | of | rrelatedNotifi | | | | CellO | cations={COC1, | | | | utageCompensat | COC5a,c | | | | ionInformation | learAlCell1};\ | | | | instance name | cell1.cOCStat | | | | contained in | us.state=**cOC | | | | EUt | Deactivating;\ | | | | ranGenericCell |** c | | | | instance | ell1.cOCStatus | | | | representing | .errorList={}; | | | | cell 1. | | +----------------+----------------+----------------+----------------+ | T7a | COC tries to | In case of | Notifica | | | reconfigure | unsuccessful | tionId=COC7a;\ | | | cell 2 without | rec | co | | | success | onfiguration:\ | rrelatedNotifi | | | | notifyAttrib | cations={COC1, | | | | uteValueChange | COC5a,COC6a,c | | | | of | learAlCell1};\ | | | | CellO | c | | | | utageCompensat | ell1.cOCStatus | | | | ionInformation | .state=**cOCDe | | | | instance name | activating;** \ | | | | contained in | cell1.cOCS | | | | EUt | tatus.errorLis | | | | ranGenericCell | t**={cell2};** | | | | instance | | | | | representing | cell2.cOC | | | | cell 1. | Status.state=_| | | | |_ cOCDeactive;\ | | | | | ** | +----------------+----------------+----------------+----------------+ | T8a | COC | notifyAttrib | n | | | reconfigures | uteValueChange | otificationId= | | | cell 3 | of | av | | | | EUt | cCell3decomp;\ | | | | ranGenericCell | co | | | | instance | rrelatedNotifi | | | | representing | cations={COC1, | | | | cell 3. | COC5a, | | | | | avcCell3comp}; | | | | notifyAttrib | | | | | uteValueChange | Notifica | | | | of | tionId=COC8a;\ | | | | CellO | co | | | | utageCompensat | rrelatedNotifi | | | | ionInformation | cations={COC1, | | | | instance name | c | | | | contained in | learAlCell1};\ | | | | EUt | cell1.cOC | | | | ranGenericCell | Status.state=_| | | | instance |_ cOCDeactive;\ | | | | representing | **cell1. | | | | cell 1. | cOCStatus.erro | | | | | rList={cell2}; | | | | | | | | | | cell3.cOCS | | | | | tatus.state=** | | | | | cOCDeactive;**| +----------------+----------------+----------------+----------------+ | Case: COC not | | | | | successful | | | | +----------------+----------------+----------------+----------------+ | T5b | COC function | notifyAttrib | Notifica | | | decides, that | uteValueChange | tionId=COC5b;\ | | | compensation | of | corr | | | was not | CellO | elatedNotifica | | | successful | utageCompensat | tions={COC1};\ | | | | ionInformation | cell1.c | | | | instance name | OCStatus.state | | | | contained in | =** cOCActive;\ | | | | EUt | **cell1. | | | | ranGenericCell | cOCStatus.erro | | | | instance | rList={cell4}; | | | | representing | | | | | cell 1. | | +----------------+----------------+----------------+----------------+ | T6b | Outage of cell |_notif |_ n | | | 1 ends | yClearedAlarm, | otificationId= | | | | originated by | clearAlCell1;\ | | | | EUt | correlatedN | | | | ranGenericCell | otifications={ | | | | instance | notiA | | | | representing | lCell1,COC1};_| | | | cell 1._ | | | | | | Notifica | | | | notifyAttrib | tionId=COC6b;\ | | | | uteValueChange | co | | | | of | rrelatedNotifi | | | | CellO | cations={COC1, | | | | utageCompensat | c | | | | ionInformation | learAlCell1};\ | | | | instance name | cell1.cOCStat | | | | contained in | us.state=**cOC | | | | EUt | Deactivating;\ | | | | ranGenericCell | **c | | | | instance | ell1.cOCStatus | | | | representing | .errorList={}; | | | | cell 1. | | +----------------+----------------+----------------+----------------+ | T7b | COC | notifyAttrib | n | | | reconfigures | uteValueChange | otificationId= | | | cell 2 | of | av | | | | EUt | cCell2decomp;\ | | | | ranGenericCell | co | | | | instance | rrelatedNotifi | | | | representing | cations={COC1, | | | | cell 2. | COC5b, | | | | | avcCell2comp}; | | | | | | | | | | cell2.cOCS | | | | | tatus.state=** | | | | | cOCDeactive;**| +----------------+----------------+----------------+----------------+ | T8b | COC | notifyAttrib | n | | | reconfigures | uteValueChange | otificationId= | | | cell 3 | of | av | | | | EUt | cCell3decomp;\ | | | | ranGenericCell | co | | | | instance | rrelatedNotifi | | | | representing | cations={COC1, | | | | cell 3. | COC5b, | | | | | avcCell3comp}; | | | | notifyAttrib | | | | | uteValueChange | Notifica | | | | of | tionId=COC8b;\ | | | | CellO | co | | | | utageCompensat | rrelatedNotifi | | | | ionInformation | cations={COC1, | | | | instance name | c | | | | contained in | learAlCell1};\ | | | | EUt | cell1.cOC | | | | ranGenericCell | Status.state=_| | | | instance |_ cOCDeactive;\ | | | | representing | **c | | | | cell 1. | ell1.cOCStatus | | | | | .errorList={}; | | | | | | | | | | cell3.cOCS | | | | | tatus.state=**| | | | | cOCDeactive;** | +----------------+----------------+----------------+----------------+
*) Remarks:
...
The notificationId's are only examples.
#