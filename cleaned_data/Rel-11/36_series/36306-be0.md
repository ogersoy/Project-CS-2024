...
### 7.1.1 SSAC
It is mandatory to support Service Specific Access Control as specified in TS
36.331 [5, 5.3.3.10] for UEs which are IMS voice capable in LTE.
### 7.1.2 CSFB Access Barring Control
It is mandatory to support CSFB Access Barring Control as specified in TS
36.331 [5, 5.3.3.2] for UEs which are supporting CSFB to UTRA or GERAN.
