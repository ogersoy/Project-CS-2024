...
the Permanent User Identity assigned by the 3GPP AAA Server when Network Based
Mobility is used shall not include this digit either.
...
The username part format of the Root NAI shall comply with IETF RFC 4187 [50]
for use with EAP AKA. For EAP AKA\', see IETF RFC 5448 [82], the Root NAI
shall comply with IETF RFC 4187 [50] except that the username part of the NAI
shall be prepended with single digit \"6\".
When the username part of Decorated NAI includes the IMSI, it shall be built
...
## 23.1 Introduction
This clause describes some information needed to access the Relay Node OAM
system as specified in TS 36.300 [91]. For more information on the
\".3gppnetwork.org\" domain name and its applicability, see Annex D of the
present document.
