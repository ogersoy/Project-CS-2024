...
(OFCS), the Traffic Detection Function (TDF) and the Subscription Profile
Repository (SPR) or the User Data Repository (UDR). Figures 5.11-1 through to
5.11-4 describe the non-roaming and roaming architecture for PCC.
