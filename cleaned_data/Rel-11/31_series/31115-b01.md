...
the Receiving Entity shall verify the authenticity of the Sending Entity. If
the authentication of the Sending Entity fails, no further processing related
to the Proof of Receipt shall take place.
