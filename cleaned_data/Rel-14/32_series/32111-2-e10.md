...
4) In case IRPAgent have not issued the notifyChangedAlarm in time or in the
case IRPManager ignores the notifyChangedAlarm received, for examples...
5) IRPManager issues acknowledgeAlarms of alarmId=6 with
...
\- IRPManager wrongly concludes that it had acknowledged alarm=6 with
perceivedSeverity=minor.
\- IRPAgent wrongly concludes that alarmId=6 with perceivedSeverity=critical
had been acknowledged.
\- Other IRPManagers will see alarmId=6 with perceivedSeverity=critical being
acknowledged (and possibly taken care of) by an IRPManager.
#