...
The provisions of ETSI TS 102 221 [1] clause 11.1.1.4.6 apply, with the
exception of provisions relative to \'Platform to Platform CAT Secured APDU\'
and clause 11.1.1.4.6.10.
...
intervals no longer than:
  * when the extended DRX cycle bit in the EF~AD~ is set to 1: the > maximum between the interval negotiated with the UICC (see TS > 31.111 [8]) and the extended idle mode DRX cycle received from > the network (see TS 24.008 [6])
