...
\--N
NeighbourCellIdentityList ::= SEQUENCE (SIZE(0..maxnoofAdditionalNeighbours))
OF NeighbourIdentity
...
AdditionalNeighbourInfoList ::= SEQUENCE
(SIZE(1..maxnoofAdditionalNeighbours)) OF HNBConfigInfo
