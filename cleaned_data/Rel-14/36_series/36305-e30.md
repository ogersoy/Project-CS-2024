...
UE positioning method capabilities from the UE, as described in subclause
7.1.2.1.
...
This subclause defines the information (e.g., assistance data, vertical
position and/or measurement data) that may be transferred between E-UTRAN
elements.
...
pressure sensor assistance data defined in subclause 8.6.2.2.
...
This subclause defines the information (e.g., assistance data, position,
...
{width="5.342361111111111in" height="2.252083333333333in"}
...
{width="4.659722222222222in" height="1.7479166666666666in"}
...
{width="4.873611111111111in" height="1.757638888888889in"}
...
{width="4.659722222222222in" height="1.4944444444444445in"}
...
{width="4.746527777777778in" height="1.4993055555555554in"}
...
data defined in subclause 8.9.2.2.
...
+------------------------+-------------------+---------+-------+ | Positioning Protocol: | RRLP | RRC | LPP | | | | | | | | (GSM/GPRS/WCDMA/\ | (WCDMA) | (LTE) | | | LTE/WLAN/WiMAX) | | | +------------------------+-------------------+---------+-------+ | Positioning Method: | | | | +------------------------+-------------------+---------+-------+ | A-GPS (A-GANSS) SET | P | P | P | | Assisted | | | | +------------------------+-------------------+---------+-------+ | A-GPS (A-GANSS) SET | P | P | P | | Based | | | | +------------------------+-------------------+---------+-------+ | Autonomous GPS/GANSS | P | P | P | +------------------------+-------------------+---------+-------+ | Enhanced Cell ID | P | P | P | +------------------------+-------------------+---------+-------+ | Enhanced Observed Time | P (GSM only) | NA | NA | | Difference (E-OTD) | | | | +------------------------+-------------------+---------+-------+ | Observed Time | NA | P | P | | Difference of Arrival | | | | | (OTDOA) ^NOTE\ 1^ | | | | +------------------------+-------------------+---------+-------+ | Barometric Pressure | NA | P | P | | Sensors | | | | +------------------------+-------------------+---------+-------+ | WLAN | NA | P | P | +------------------------+-------------------+---------+-------+ | Bluetooth | NA | P | P | +------------------------+-------------------+---------+-------+ | TBS ^NOTE\ 2^ | NA | P | P | +------------------------+-------------------+---------+-------+ | NOTE 1: This includes | | | | | TBS positioning based | | | | | on PRS signals, which | | | | | is only supported in | | | | | LPP (LTE). | | | | | | | | | | NOTE 2: TBS | | | | | positioning based on | | | | | MBS signals. | | | | +------------------------+-------------------+---------+-------+
...
EMBED Word.Picture.8 {width="6.027777777777778in"
