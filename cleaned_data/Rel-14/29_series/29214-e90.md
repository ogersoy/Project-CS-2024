...
anonymous IMS emergency sessions. See 3GPP TS 23.167 [53] for futher
information.
...
## A.15.1 General
Within the framework of MCVideo, when the SIP Core (3GPP TS 23.281 [5x]) is
implemented by an IMS core network, if the P-CSCF receives a SIP request
message including a Resource-Priority header field with a namespace field and
