...
* * *
Information element name Mapping to Diameter AVP Cat. Description KeyName-NAI
User-Name M This information element shall contain the KeyName-NAI (as defined
in clause 19.3.8 of 3GPP TS 23.003 [14]) in the context of EAP re-
...
> emergency services. The Permanent User Identity IE in the answer shall
> contain the IMEI in Emergency NAI for Limited Service State format as
> defined in clause 19 of 3GPP TS 23.003 [14];
\- otherwise the 3GPP AAA Server shall reject the request with the
Experimental-Result-Code set as specified for authentication failures in this
clause.
...
initiated by the ePDG to retrieve the most up to date WLAN Location
Information stored at the 3GPP AAA Server, when the 3GPP AAA server has sent
WLAN Location Information during the initial Authentication and Authorization
procedure and the ePDG has detected a change of the outer IP address of the UE
(see clause 4.5.7.2.8 of 3GPP TS 23.402 [3]).
