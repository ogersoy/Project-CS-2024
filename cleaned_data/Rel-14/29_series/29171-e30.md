...
Type O ENUMERATED (lte-wb, nb-iot, ...) This IE provides the serving RAT type.
* * *
...
\-- id-Ciphering-Data INTEGER ::= 28 : defined in a later release
\-- id-Ciphering-Data-Ack INTEGER ::= 29 : defined in a later release
\-- id-Ciphering-Data-Error-Report INTEGER ::= 30 : defined in a later release
