...
in the External-Identifier AVP if populated in the subscription.
...
Network Access Mode does not allow PS services), or
...
does not allow PS services anymore; the HSS may set the Reattach-Required flag
in order to request the MME or the SGSN to trigger an immediate reattachment
of the UE.
...
AVP in the Subscription-Data AVP.
...
configured at the MME/SGSN and the IWK-SCEF, as specified in clause 7.2.2.2 of
3GPP TS 29.336 [54].
...
+----------------+----------------+----------------+--------------+ | Attribute Name | Reference | Comments | M-bit | +----------------+----------------+----------------+--------------+ | Ser | IETF RFC 5778 | See clause | | | vice-Selection | [20] | 7.3.36 | | +----------------+----------------+----------------+--------------+ | 3 | 3GPP TS 29.061 | See 3GPP TS | | | GPP-Charging-C | [21] | 32.251 [33] | | | haracteristics | | Annex A and | | | | | 3GPP TS 32.298 | | | | | [22] clause | | | | | 5.1.2.2.7 | | | | | | | | | | This attribute | | | | | holds the EPS | | | | | PDN Connection | | | | | Charging | | | | | C | | | | | haracteristics | | | | | data for an | | | | | EPS APN | | | | | Configuration, | | | | | or the PDP | | | | | context | | | | | Charging | | | | | C | | | | | haracteristics | | | | | for GPRS PDP | | | | | context, or | | | | | the Subscribed | | | | | Charging | | | | | C | | | | | haracteristics | | | | | data for the | | | | | subscriber | | | | | level 3GPP | | | | | Charging | | | | | Ch | | | | | aracteristics; | | | | | refer to 3GPP | | | | | TS 23.008 | | | | | [30]. | | +----------------+----------------+----------------+--------------+ | Supp | 3GPP TS 29.229 | | | | orted-Features | [9] | | | +----------------+----------------+----------------+--------------+ | F | 3GPP TS 29.229 | | | | eature-List-ID | [9] | | | +----------------+----------------+----------------+--------------+ | Feature-List | 3GPP TS 29.229 | See clause | | | | [9] | 7.3.10 | | +----------------+----------------+----------------+--------------+ | Served-Pa | 3GPP TS 32.299 | holds the PDN | | | rty-IP-Address | [8] | IP Address of | | | | | the user | | +----------------+----------------+----------------+--------------+ | QoS-Cl | 3GPP TS 29.212 | | | | ass-Identifier | [10] | | | +----------------+----------------+----------------+--------------+ | A | 3GPP TS 29.212 | See clause | | | llocation-Rete | [10] | 7.3.40 | | | ntion-Priority | | | | +----------------+----------------+----------------+--------------+ | Priority-Level | 3GPP TS 29.212 | | | | | [10] | | | +----------------+----------------+----------------+--------------+ | Pre-empt | 3GPP TS 29.212 | | | | ion-Capability | [10] | | | +----------------+----------------+----------------+--------------+ | Pre-emption | 3GPP TS 29.212 | | | | -Vulnerability | [10] | | | +----------------+----------------+----------------+--------------+ | Max-Requeste | 3GPP TS 29.214 | | | | d-Bandwidth-DL | [11] | | | +----------------+----------------+----------------+--------------+ | Max-Requeste | 3GPP TS 29.214 | | | | d-Bandwidth-UL | [11] | | | +----------------+----------------+----------------+--------------+ | RAT-Type | 3GPP TS 29.212 | See clause | Must set | | | [10] | 7.3.13 | | +----------------+----------------+----------------+--------------+ | MSISDN | 3GPP TS 29.329 | | | | | [25] | | | +----------------+----------------+----------------+--------------+ | M | IETF RFC 5447 | | | | IP6-Agent-Info | [26] | | | +----------------+----------------+----------------+--------------+ | MIP-Home | IETF RFC 4004 | | | | -Agent-Address | [27] | | | +----------------+----------------+----------------+--------------+ | MIP-H | IETF RFC 4004 | | | | ome-Agent-Host | [27] | | | +----------------+----------------+----------------+--------------+ | PDP-Address | 3GPP TS 32.299 | | | | | [8] | | | +----------------+----------------+----------------+--------------+ | Confi | 3GPP TS 29.229 | See clause | | | dentiality-Key | [9] | 7.3.57 | | +----------------+----------------+----------------+--------------+ | Integrity-Key | 3GPP TS 29.229 | See clause | | | | [9] | 7.3.58 | | +----------------+----------------+----------------+--------------+ | Visited-Netw | 3GPP TS 29.229 | See clause | Must not set | | ork-Identifier | [9] | 7.3.105 | | +----------------+----------------+----------------+--------------+ | GMLC-Address | 3GPP TS 29.173 | See clause | Must not set | | | [37] | 7.3.109 | | +----------------+----------------+----------------+--------------+ | User-C | 3GPP TS 32.299 | | Must not set | | SG-Information | [8] | | | +----------------+----------------+----------------+--------------+ | ProSe-Sub | 3GPP TS 29.344 | See clause | Must not set | | scription-Data | [49] | 7.3.180 | | +----------------+----------------+----------------+--------------+ | OC-Supp | IETF RFC 7683 | See clause | Must not set | | orted-Features | [50] | 7.3.178 | | +----------------+----------------+----------------+--------------+ | OC-OLR | IETF RFC 7683 | See clause | Must not set | | | [50] | 7.3.179 | | +----------------+----------------+----------------+--------------+ | SCE | 3GPP TS 29.336 | | Must not set | | F-Reference-ID | [54] | | | +----------------+----------------+----------------+--------------+ | SCEF-ID | 3GPP TS 29.336 | | Must not set | | | [54] | | | +----------------+----------------+----------------+--------------+ | AESE-Communi | 3GPP TS 29.336 | see clause | Must not set | | cation-Pattern | [54] | 7.3.193 | | +----------------+----------------+----------------+--------------+ | Communicati | 3GPP TS 29.336 | see clause | Must not set | | on-Pattern-set | [54] | 7.3.194 | | +----------------+----------------+----------------+--------------+ | Mo | 3GPP TS 29.336 | See clause | Must not set | | nitoring-Event | [54] | 7.3.195 | | | -Configuration | | | | +----------------+----------------+----------------+--------------+ | Monitorin | 3GPP TS 29.336 | See clause | Must not set | | g-Event-Report | [54] | 7.3.196 | | +----------------+----------------+----------------+--------------+ | U | 3GPP TS 29.336 | See clause | Must not set | | E-Reachability | [54] | 7.3.197 | | | -Configuration | | | | +----------------+----------------+----------------+--------------+ | eNodeB-ID | 3GPP TS 29.217 | See clause | Must not set | | | [56] | 7.3.198 | | +----------------+----------------+----------------+--------------+ | SC | 3GPP TS 29.336 | | Must not set | | EF-Reference-I | [54] | | | | D-for-Deletion | | | | +----------------+----------------+----------------+--------------+ | M | 3GPP TS 29.336 | | Must not set | | onitoring-Type | [54] | | | +----------------+----------------+----------------+--------------+ | Maximum-Num | 3GPP TS 29.336 | | Must not set | | ber-of-Reports | [54] | | | +----------------+----------------+----------------+--------------+ | Monit | 3GPP TS 29.336 | | Must not set | | oring-Duration | [54] | | | +----------------+----------------+----------------+--------------+ | Charged-Party | 3GPP TS 29.336 | | Must not set | | | [54] | | | +----------------+----------------+----------------+--------------+ | U | 3GPP TS 29.336 | | Must not set | | E-Reachability | [54] | | | | -Configuration | | | | +----------------+----------------+----------------+--------------+ | Locati | 3GPP TS 29.336 | | Must not set | | on-Information | [54] | | | | -Configuration | | | | +----------------+----------------+----------------+--------------+ | Rea | 3GPP TS 29.336 | | Must not set | | chability-Type | [54] | | | +----------------+----------------+----------------+--------------+ | Maximum | 3GPP TS 29.336 | | Must not set | | -Response-Time | [54] | | | +----------------+----------------+----------------+--------------+ | Reachabili | 3GPP TS 29.336 | | Must not set | | ty-Information | [54] | | | +----------------+----------------+----------------+--------------+ | Mo | 3GPP TS 29.336 | | Must not set | | nitoring-Event | [54] | | | | -Config-Status | | | | +----------------+----------------+----------------+--------------+ | Supp | 3GPP TS 29.336 | see clause | Must not set | | orted-Services | [54] | 7.3.199 | | +----------------+----------------+----------------+--------------+ | Supported-Mon | 3GPP TS 29.336 | see clause | Must not set | | itoring-Events | [54] | 7.3.200 | | +----------------+----------------+----------------+--------------+ | DRMP | IETF RFC 7944 | see clause | Must not set | | | [57] | 7.3.203 | | +----------------+----------------+----------------+--------------+ | Reference-ID | 3GPP TS 29.336 | | Must not set | | -Validity-Time | [54] | | | +----------------+----------------+----------------+--------------+ | Maximum-UE-Ava | 3GPP TS 29.338 | see clause | Must not set | | ilability-Time | [48] | 5.3.3.22 | | +----------------+----------------+----------------+--------------+ | Emer | 3GPP TS 29.273 | | | | gency-Services | [59] | | | +----------------+----------------+----------------+--------------+ | Load | IETF R | See clause | Must not set | | | FC 8583 [60] | 7.3.211 | | +----------------+----------------+----------------+--------------+ | Exte | 3GPP TS | See clause | Must not set | | nded-eNodeB-ID | 29.217 [56] | 7.3.218 | | +----------------+----------------+----------------+--------------+ | Exter | 3GPP TS | | Must not set | | nal-Identifier | 29.336 [54] | | | +----------------+----------------+----------------+--------------+ | Loss-Of-Conne | 3GPP TS | | Must not set | | ctivity-Reason | 29.336 [54] | | | +----------------+----------------+----------------+--------------+ | NOTE 1: The | | | | | M-bit settings | | | | | for re-used | | | | | AVPs override | | | | | those of the | | | | | defining | | | | | specifications | | | | | that are | | | | | referenced. | | | | | Values | | | | | include: | | | | | \"Must set\", | | | | | \"Must not | | | | | set\". If the | | | | | M-bit setting | | | | | is blank, then | | | | | the defining | | | | | specification | | | | | applies. | | | | | | | | | | NOTE 2: If the | | | | | M-bit is set | | | | | for an AVP and | | | | | the receiver | | | | | does not | | | | | understand the | | | | | AVP, it shall | | | | | return a | | | | | rejection. If | | | | | the M-bit is | | | | | not set for an | | | | | AVP, the | | | | | receiver shall | | | | | not return a | | | | | rejection, | | | | | whether or not | | | | | it understands | | | | | the AVP. If | | | | | the receiver | | | | | understands | | | | | the AVP but | | | | | the M-bit | | | | | value does not | | | | | match with the | | | | | definition in | | | | | this table, | | | | | the receiver | | | | | shall ignore | | | | | the M-bit. | | | | +----------------+----------------+----------------+--------------+
...
Not Allowed 6 NB-IoT Not Allowed 7 Enhanced Coverage Not Allowed NOTE: Bits
