...
Number-of-UEs 3GPP TS 29.154 [25] Must not set
* * *
...
query the current settings of the Enhanced-Coverage-Restriction. NOTE: Bits
...
additional RIR command(s). NOTE: Bits not defined in this table shall be
cleared by the sender and discarded by the receiver of the command.
* * *
