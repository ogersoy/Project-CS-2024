...
E-UTRAN (WB-S1 mode), E-UTRAN(NB-S1 mode), UTRAN, GERAN or GERAN EC-GSM-IoT
associated with each entry in the PLMN Selector lists.
...
domains. Details are specified in TS 23.122 [3] and TS 25.304 [10]. Not all
RATs need to support this functionality.
## 4.2 Allocation
...
configure 3GPP PS Data Off Exempt Services for its subscribers.
NOTE 2: The updating of configured 3GPP Data Off Exempt Services in the UEs is
not guaranteed to take effect in real time.
The user should be made aware of the operator services that are 3GPP PS Data
Off Exempt Services.
NOTE: The system can support falling back to operate over the CS domain in
