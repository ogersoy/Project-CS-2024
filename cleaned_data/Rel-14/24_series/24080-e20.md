...
itu-t identified-organization (4) etsi (0) mobileDomain (0) gsm-Network (1)
modules (3)
map-CommonDataTypes (18) version17 (17)}
LocationType,
...
The terminationCause identifier refers to the cause of cancellation of the
periodic location procedure by the MS.
...
The positioningProtocolPDU identifier refers to the UE positioning information
...
information for periodic and triggered event reports for the MS.
