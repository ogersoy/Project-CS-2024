...
a) the UE can be configured with an indication whether SMS over IP is a 3GPP
PS data off exempt service; and
...
methods:
1) the EF~3GPPPSDATAOFF~ file described in 3GPP TS 31.102 [19]; and
2) the SMSoIP_exempt node of 3GPP TS 24.167 [8A].
...
NOTE: Which of the bullets 1), and 2) the UE performs is influenced by other
