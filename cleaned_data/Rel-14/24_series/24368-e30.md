...
is a 3GPP PS data off exempt service.
\- Occurrence: One
\- Format: bool
\- Access Types: Get, Replace
\- Values: 0, 1
...
protocol is a 3GPP PS data off exempt service.
\- Occurrence: One
\- Format: bool
\- Access Types: Get, Replace
\- Values: 0, 1
0 - Indicates that the bearer independent protocol is not a 3GPP PS data off
exempt service (see 3GPP TS 31.111 [7]).
...
\
\
\List of services which are exempted of 3GPP PS data off.\
\
\
\
\
...
\
\
\Device management over PS which is a 3GPP PS data off exempt
service.\
\
\text/plain\
\
