...
imminent peril group call cancel request. For a multicast scenario, these
...
initiation and emergency state cancel remain in this specification is FFS.
...
group cancel from the MCPTT client to other MCPTT clients.
...
Table 10.6.3.2.5-1: MCPTT emergency alert request
* * *
Information Element Status Description MCPTT ID M The identity of the alerting
...
the MCPTT client to the MCPTT server and from the MCPTT server to the MCPTT
client.
...
5\. The receiving MCPTT client 2 removes all stroed information about the
...
invoke a locally initiated ambienct listening call to be set up at the
...
5\. The MCPTT server provides the ambient listening call release response to
MCPTT client 2.
6\. MCPTT client 1 stops transmiting media to MCPTT client 2..
...
of display of aliases associated with the MCPTT ID (on/off) [R-5.8-003] of of
3GPP TS 22.280 [17] 3GPP TS 22.280 [17] Configuration of display of Selected
MCPTT Group (on/off) [R-5.8-003] of 3GPP TS 22.280 [17] Configuration of
display of Mission Critical Organization name (on/off) [R-6.8.7.4.1-003] of
3GPP TS 22.280 [17] Configuration of the notification of an emergency alert
* * *
#