...
+--------------------------------------------+ | Parameter | +--------------------------------------------+ | Message Identifier | +--------------------------------------------+ | Serial Number | +--------------------------------------------+ | CB Data {Warning Message Content E-UTRAN}, | | | | Data Coding Scheme | +--------------------------------------------+
...
##### 9.4.3.2.4 CB Data
This parameter contains the content of the warning message. It consists of the
parameters contained in the \"_Warning Message Content E-UTRAN\"_ IE (see
subclause 9.3.35) of the WRITE-REPLACE-WARNING-REQUEST Request message
received from the CBC (see subclause 9.2.16). It is encoded as specified in
subclause 9.4.2.2.5.
