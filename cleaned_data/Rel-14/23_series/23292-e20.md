...
to handle the CS authentication. The I‑CSCF initiates standard procedures for
S‑CSCF location/allocation and forwards the REGISTER to S-CSCF.
...
MSRN.
7\. The MGCF initiates an INVITE towards the I‑CSCF in the visited IMS of the
UE B.
