...
NOTE 2: In this Release, DR-VCC support for IMS emergency call from PS to CS
Access Transfer is only supported if the UE has valid subscription.
NOTE 3: The CS to PS Access transfer for IMS emergency call SRVCC or DRVCC is
