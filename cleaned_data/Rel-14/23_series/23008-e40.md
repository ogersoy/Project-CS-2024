...
UE Usage Type is permanent data and conditionally stored in HSS, MME and SGSN.
...
### 2.13.173 Acknowledgement Of Downlink NAS Data PDUs flag
...
External Identifier in the subscription that is applicable for Monitoring
Event Configuration (MONTE).
The External Identifier for Monitoring Event Configuration is permanent
...
* * *
PARAMETER Subclause HSS MME SGSN SGW PGW SCEF TYPE IMSI 2.1.1.1 C C C - - C P
MSISDN 2.1.2 C C C - - C P External Identifier set 2.1.10 C - - - - C P Access
Point Name 2.13.6 C C C - - C P Robust Header Compression Context 2.23.1 - C -
- - - T MME F-TEID for S11 (user plane) 2.23.3 - C - C - - T S-GW F-TEID for
S11 (userplane) 2.23.4 - C - C - - T Serving-PLMN-Rate-Control 2.23.5 - C - C
C C P APN-Rate-Control 2.23.6 - - - - C C P Not Reachable for NIDD Flag 2.23.7
- C C - - - T SCEF-ID 3.14.3 C C C - - C P SCEF-Realm 3.14.19 C C C - - C P
EPS Bearer Id 2.13.66 - C C - - C T Acknowledgement-Of-Downlink-NAS-Data-PDUs
flag 2.13.173 C C - - - - P
* * *
