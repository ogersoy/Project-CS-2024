...
all test conditions should be ≥ [3.5]
> N-MOS-LQO~fb~
...
> G-MOS-LQO~fb~
\- No requirement.
NOTE: Values in [] are provisional pending implementation of test equipment
supporting the new objective predictor; brackets are expected to be removed in
future.
...
26.132.NOTE: Values in [] are provisional pending implementation of test
equipment supporting the new objective predictor; brackets are expected to be
removed in future.
## 7.11 Delay
