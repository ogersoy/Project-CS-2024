...
[31] Void.
> [32] ETSI TS 102 223 V9.4.0: \"Smart Cards; Card Application Toolkit\".
>
...
applications\".
[52] 3GPP TS 25.304: \"User Equipment (UE) procedures in idle mode and
procedures for cell reselection in connected mode\".
[53] 3GPP TS 36.304: \"Evolved Universal Terrestrial Radio Access (E-UTRA);
...
supplementary service control strings and USSD strings or PDP context
parameters or PDN connection parameters are first passed to a USIM application
before the ME sets up the call, the supplementary service operation or the
USSD operation or establishes the PDP context or the PDN connection. The ME
shall also pass to the USIM application at the same time its current serving
cell. The USIM application has the ability to allow, bar or modify the call,
the supplementary service operation or, the USSD operation or PDP context
activation or PDN connection activation by another context activation. The
USIM application also has the ability to replace a call request, a
supplementary service operation or a USSD operation by another call request or
...
See ETSI TS 102 223 [32] clause 6.4.28.
### 6.4.29 RECEIVE DATA
...
activation parameters 8.1, 8.14 or 8.17 or 8.72 or 8.98 M Y B Capability
configuration parameters 1 8.4 O N C Subaddress 8.3 O N D Location information
8.19 M N E Capability configuration parameters 2 8.4 O N F
* * *
\- Device identities: the ME shall set the device identities to:
source: ME;
destination: UICC.
\- Address or SS string or USSD string or PDP context activation parameters or
EPS PDN connection activation parameters: only one data object shall be sent
to the UICC:
...
> are used, as defined in TS 24.008 [9].
>
> For an EPS PDN connection activation, the PDN Connectivity Request
> parameters are used, as defined in TS 24.310 [46]
...
activation parameters or EPS PDN connection activation parameters 8.1, 8.14 or
8.17 or 8.72 or 8.98 O N A Capability configuration parameters 1 8.4 O N B
Subaddress 8.3 O N C Alpha identifier 8.2 O N D BC repeat indicator 8.42 C N E
Capability configuration parameters 2 8.4 O N F
* * *
\- Call control result:
Contents:
...
activation parameters: Only one data object may be included if the UICC
requests the call (or supplementary service or USSD operation or PDP
context/EPS PDN connection activation) details to be modified:
...
PDN Connection Activation that is beyond the ME\'s capabilities (e.g. the UICC
requests a QoS that the ME cannot handle), then the ME shall not activate the
EPS PDN Connection at all.
...
contain CSG id of the current CSG or Hybrid cell. In all other cases this data
object shall not be present.
...
shall contain the broadcasted HNB name of the current CSG or Hybrid cell. In
all other cases this data object shall not be present.
Response parameters/data: None for this type of ENVELOPE command.
...
absent.
For E-UTRAN:
> intra-frequency & inter-RAT (GERAN): the Network Measurement Results are
> coded as for the _MeasurementReport_ information element as defined in the
> ASN.1 description of TS 36.331 [49], according to the following:
...
## 8.56 Channel status
See ETSI TS 102 223 [32] clause 8.56.
...
* * *
Byte(s) Description Length 1 PDP context Activation parameters tag 1 2 Length
(X) 1 3 to X+2 PDP context Activation parameters X
* * *
...
Length (X) 1 3 to X+2 EPS PDN connection Activation parameters X
* * *
...
> REQUEST message is too large (i.e. greater than 219-L, where L is the length
> of the Access point name Information Element), the ME may decide not to
> include the \"Protocol configuration options\" inside the \"EPS PDN
...
Y+3 to Y+X+2 CSG ID List X (X>1)
* * *
CSG ID List:
* * *
...
Operator CSG list
\- \'01\' = camped on a CSG or Hybrid cell in the Allowed CSG list or the
Operator CSG list
...
> ignored.
>
> Bits b7 and b8 indicate the CSG selection mechanism used; see TS 25.304 [52]
> and TS 36.304 [53].
* * *
        b8   b7   b6   b5   b4   b3   b2   b1   
                                                ...
                                                Result of another CSG slection type
* * *
## 8.102 CSG ID
* * *
...
+----------------+---------------+----------------+----------------+ | Description | Length of tag | Tag value, | Tag | | | | bits 1-7 | | | | | (Range: \'01\' | (CR and Tag | | | | - \'7E\') | value) | +----------------+---------------+----------------+----------------+ | SS string tag | 1 | \'09\' | \'09\' or | | | | | \'89\' | +----------------+---------------+----------------+----------------+ | USSD string | 1 | \'0A\' | \'0A\' or | | tag | | | \'8A\' | +----------------+---------------+----------------+----------------+ | SMS TPDU tag | 1 | \'0B\' | \'0B\' or | | | | | \'8B\' | +----------------+---------------+----------------+----------------+ | Cell Broadcast | 1 | \'0C\' | \'0C\' or | | page tag | | | \'8C\' | +----------------+---------------+----------------+----------------+ | Cause tag | 1 | \'1A\' | \'1A\' or | | | | | \'9A\' | +----------------+---------------+----------------+----------------+ | Transaction | 1 | \'1C\' | \'1C\' or | | identifier tag | | | \'9C\' | +----------------+---------------+----------------+----------------+ | BCCH channel | 1 | \'1D\' | \'1D\' or | | list tag | | | \'9D\' | +----------------+---------------+----------------+----------------+ | BC Repeat | 1 | \'2A\' | \'2A\' or | | Indicator tag | | | \'AA\' | +----------------+---------------+----------------+----------------+ | Timing Advance | 1 | \'2E\' | \'2E\' or | | tag | | | \'AE\' | +----------------+---------------+----------------+----------------+ | PDP context | 1 | '52' | '52' or 'D2' | | Activation | | | | | parameters tag | | | | +----------------+---------------+----------------+----------------+ | UTRAN/E-UTRAN | 1 | \'69\' | \'69\' or | | Measurement | | | \'E9\' | | Qualifier tag | | | | +----------------+---------------+----------------+----------------+ | I-WLAN | 1 | \'4A\' | \'4A\' or | | Identifier tag | | | \'CA\' | +----------------+---------------+----------------+----------------+ | I-WLAN Access | 1 | \'4B\' | \'4B\' or | | Status tag | | | \'CB\' | +----------------+---------------+----------------+----------------+ | PLMNwAcT List | 1 | \'72\' | \'72\' or | | tag | | | \'F2\' | +----------------+---------------+----------------+----------------+ | Routing Area | 1 | \'73\' | \'73\' or | | Information | | | \'F3\' | | Tag | | | | +----------------+---------------+----------------+----------------+ | Update/Attach | 1 | \'74\' | \'74\' or | | Type Tag | | | \'F4\' | +----------------+---------------+----------------+----------------+ | Rejection | 1 | \'75\' | \'75\' or | | Cause Code Tag | | | \'F5\' | +----------------+---------------+----------------+----------------+ | Geographical | 1 | \'76\' | \'76\' or | | Location | | | \'F6\' | | Parameters Tag | | | | +----------------+---------------+----------------+----------------+ | GAD shapes Tag | 1 | \'77\' | \'77\' or | | | | | \'F7\' | +----------------+---------------+----------------+----------------+ | NMEA sentence | 1 | \'78\' | \'78\' or | | tag | | | \'F8\' | +----------------+---------------+----------------+----------------+ | PLMN List tag | 1 | \'79\' | \'79\' or | | | | | \'F9\' | +----------------+---------------+----------------+----------------+ | EPS PDN | 1 | \'7C\' | \'7C\' or | | connection | | | \'FC\' | | Activation | | | | | parameters tag | | | | +----------------+---------------+----------------+----------------+ | Tracking Area | 1 | \'7D\' | \'7D\' or | | Identification | | | \'FD\' | +----------------+---------------+----------------+----------------+ | CSG ID list | 1 | \'7E\' | \'7E\' or | | Tag | | | \'FE\' | +----------------+---------------+----------------+----------------+ | CSG cell | 1 | \'55\' | \'55\' or | | selection | | | \'D5\' | | status | | | | +----------------+---------------+----------------+----------------+ | CSG ID | 1 | \'56\' | \'56\' or | | | | | \'D6\' | +----------------+---------------+----------------+----------------+ | HNB name | 1 | \'57\' | \'57\' or | | | | | \'D7\' | +----------------+---------------+----------------+----------------+
...
discovery) Event download : CSG cell selection
* * *
