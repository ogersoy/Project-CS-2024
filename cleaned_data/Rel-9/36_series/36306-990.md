...
This field defines whether the UE supports enhanced dual layer (PDSCH
transmission mode 8) for TDD.
NOTE: Enhanced dual layer should be supported by Rel-9 UEs supporting TDD.
#### 4.3.4.6 Void
#### 4.3.4.7 Void
#### 4.3.4.8 Void
#### 4.3.4.9 Void
...
#### 4.3.12 _rach-Report_
This parameter defines whether the UE supports delivery of _rachReport_ upon
request from the network.
### 4.3.13 IMS Voice parameters
#### 4.3.13.1 _voiceOver-PS-HS-UTRA-FDD_
...
#### 4.3.13.2 _voiceOver-PS-HS-UTRA-TDD128_
...
#### 4.3.13.3 _srvcc-FromUTRA-FDD-ToGERAN_
...
#### 4.3.13.4 _srvcc-FromUTRA-FDD-ToUTRA-FDD_
Only applicable if the UE supports UTRA FDD. This parameter defines whether
the UE supports SRVCC handover from UTRA FDD PS HS to UTRA FDD CS.
#### 4.3.13.5 _srvcc-FromUTRA-TDD128-ToGERAN_
...
GERAN CS.
#### 4.3.13.6 _srvcc-FromUTRA-TDD128-ToUTRA-TDD128_
Only applicable if the UE supports UTRA TDD 1.28Mcps. This parameter defines
...
## 6.4 SON features
### 6.4.1 Radio Link Failure Report
It is optional for UE to support indication of _rlf-InfoAvailable_ and
delivery of _rlf-Report_ upon request from the network as specified in [5].
## 6.5 Positioning features
### 6.5.0 UE Rx -- Tx time difference
It is optional for UE to support _ue-RxTxTimeDiffResult_ as specified in
[5][13].
## 6.6 Void
## 6.7 Void
## 6.8 Void
