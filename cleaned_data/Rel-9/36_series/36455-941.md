...
#### 8.2.2.1 General
This procedure is used by the eNB to notify the E-SMLC that a measurement
previously requested with the E-CID Measurement Initiation procedure can no
longer be reported.
#### 8.2.2.2 Successful Operation
Figure 8.2.2.2-1: E-CID Measurement Failure Indication.
Upon reception of the E-CID MEASUREMENT FAILURE INDICATION message, the E-SMLC
shall consider that the E-CID measurement for the UE has been terminated by
the eNB.
...
Figure 8.2.3.2-1: E-CID Measurement Reporting procedure.
...
Figure 8.2.4.2-1: E-CID Measurement Reporting Control procedure.
...
#### 8.2.5.1 General
The purpose of OTDOA Information Exchange procedure is to allow the E-SMLC to
request the eNB to transfer OTDOA information to the E-SMLC.
...
can be configured and reported with one message. Value is 63.
* * *
* * *
