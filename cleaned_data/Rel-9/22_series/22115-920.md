...
It shall be possible to charge for Inter-UE Transfer of media components
across multiple IMS UEs belonging to the same user.
### 5.2.12 IMS Emergency sessions
Charging information for Emergency IMS Sessions may be collected from the
serving network node for off-line charging.
Note: Online charging support is envisaged to be supported after 3GPP Release
10.
