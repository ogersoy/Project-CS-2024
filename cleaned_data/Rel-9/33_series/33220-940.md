...
may be secured using TLS as specified in RFC 2246 [28];
...
> CipherSuites in TLS V1.0 [28] and PSK Ciphersuites for TLS [27].
...
as defined in OMA Certificate and CRL Profile [31] with the exception that the
SHA-1 and SHA-256 hash functions shall be mandatory to support. For security
reasons, the use of SHA-1 is not recommended for newly created certificates
and CRLs.
