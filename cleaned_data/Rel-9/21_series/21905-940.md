...
UE.
**Allowed CSG list** : A list stored in the UE under both user and operator
control, containing the CSG identities and associated PLMN identities of the
...
**Equivalent HPLMN:** Any of the PLMN entries contained in the Equivalent
HPLMN list.
...
**Operator CSG list** : A list stored in the UE under exclusive Operator
control, containing the CSG identities and associated PLMN identities of the
CSGs to which the subscriber belongs.
...
**Repeater:** A \"repeater\" is a radio transceiver used to extend the
transmission of a base station beyond its normal range.
