...
* * *
Profile name: threegIq Version: 1
* * *
## 5.2 Summary
...
Indicator** No (NOTE)  
**Emergency Indicator** Yes YES/NO **IEPS Indicator** No NA **ContextAttribute
Descriptor** No NA **ContextIdList Parameter** No NA **AND/OR Context
Attribute** No NA NOTE: This Context Attribute parameter is allowed in ETSI
TISPAN Ia Profile version 3.
* * *
## 5.6 Terminations
...
+--------------------+---------------+---------+--------------------+ | Optional Packages: | | | | +--------------------+---------------+---------+--------------------+ | Package Name | PackageID | Version | Support dependent | | | | | on: | +--------------------+---------------+---------+--------------------+ | Inactivity Timer | it, (0x0045) | 1 | MGC polling by MG. | | (ITU-T | | | | | Recommendation | | | Only applicable | | H.248.14 [11]) | | | for UDP transport. | +--------------------+---------------+---------+--------------------+ | Media Gateway | ocp, (0x0051) | 1 | Support of message | | Overload Control | | | throttling, based | | (ITU-T | | | on rate | | Recommendation | | | limitation, from | | H.248.11 [13]) | | | MGC towards MG. | +--------------------+---------------+---------+--------------------+ | Media Gateway | chp, (0x0029) | 1 | Support of message | | Resource | | | throttling, based | | Congestion | | | on percentage | | Handling Package | | | limitation, from | | (see ITU-T | | | MGC towards MG. | | Recommendation | | | | | H.248.10 [14] ) | | | | +--------------------+---------------+---------+--------------------+ | IP realm | ipra (0x00e0) | 1 | Support of | | availability | | | mechanisms | | (ITU-T | | | allowing the MGC | | Recommendation | | | to discover the IP | | H.248.41 Amendment | | | realms that are | | 1) [8] | | | available at the | | | | | MG at a certain | | | | | time and allowing | | | | | the MG to inform | | | | | the MGC about any | | | | | changes in the | | | | | availability of | | | | | realms. | +--------------------+---------------+---------+--------------------+ | **Application Data | adid (0x009c) | 1 |** MGC requires to | | Inactivity | | | be explicitly | | Detection (**ITU-T | | | informed of a | | Recommendation | | | cessation of an | |** H.248.40 | | | application data | | [**24**])**| | | flow.** | +--------------------+---------------+---------+--------------------+
...
* * *
Transaction defined in 3GPP TS 23.334 [23] Supported Comment Reserve AGW
Connection Point Mandatory See 5.17.2.2 Configure AGW Connection Point
Mandatory See 5.17.2.3 Reserve and Configure AGW Connection Point Mandatory
See 5.17.2.4 Release AGW Termination Mandatory See 5.17.2.5 Termination
Heartbeat Indication Mandatory See 5.17.2.6 IP Bearer Released Mandatory See
5.17.2.7 Media Inactivity Notification Optional See 5.17.2.8 Change Through
Connection Mandatory See 5.17.2.9
* * *
