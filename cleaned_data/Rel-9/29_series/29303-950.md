...
mode to E-UTRAN Inter RAT handover and the GERAN A/Gb mode to E-UTRAN Inter
RAT handover , t he MME is selected based on the target cell where the UE has
just moved into. The MME has the new target eNodeB cell ID (eCID) and TAI
