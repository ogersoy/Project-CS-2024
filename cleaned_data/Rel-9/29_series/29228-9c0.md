...
be either:
  ...
  * A non distinct Specific Public User Identity , i.e. not explicitly provisioned in HSS.
...
Wildcarded IMPU. It and contains the Wildcarded Public User Identity that
matched the Public User Identity. This Wildcarded Public User identity shall
be sent as stored in the HSS, that is, including the delimiter described in
3GPP TS 23.003 [17].
...
The file CxDataType_Rel9.xsd, attached to this specification, contains the XML
