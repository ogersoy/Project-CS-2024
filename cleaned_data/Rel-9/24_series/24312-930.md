...
The validity of the policy takes into account ValidityArea, Roaming, PLMN and
...
\- Access Types: Get, Replace
\- Values: \
The leaf format and usage is defined in subclause 5.18.
...
\- Access Types: Get, Replace
\- Values: \
The leaf format and usage is defined in subclause 5.18A.
...
\- Access Types: Get, Replace
\- Values: \
The leaf format and usage is defined in subclause 5.18B.
...
### 5.77A _\ _/DiscoveryInformation/_\ _/PLMN
The PLMN leaf indicates a PLMN code of the operator which created this
discovery information.
\- Occurrence: One
\- Format: chr
...
\- Values: \
The Longitude is defined in subclause 6.1 of 3GPP TS 23.032 [3A].
## 5.102D _\ /_ UE_Location _/_ RPLMN
