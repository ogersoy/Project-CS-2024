...
exceed the maximum levels specified in Table 6.6.2.5.1-1 below, where:
...
+----------------+----------------+----------------+----------------+ | Frequency | Frequency | Minimum | Measurement | | offset of | offset of | requirement | bandwidth | | measurement | measurement | | | | filter ‑3dB | filter centre | | | | point, ∆f | frequency, | | | | | f_offset | | | +----------------+----------------+----------------+----------------+ | 0 MHz ≤ ∆f \ where BW~F1~ represents the test signal RF bandwidth, or channel bandwidth
> in case of single carrier.
##### 6.7.4.2.2 Additional minimum requirement (BC2) test procedure
1) Set the BS to transmit the test signal according to clause 5 for
requirement 6.6.1 at maximum output power according to the applicable test
configuration.
...
the allocated downlink operating band.
...
level shall not exceed the unwanted emission limits in subclause 6.6 in the
presence of a wanted signal and an interfering signal according to Table
6.7.1‑1 in TS 37.104 [2] for BS operation in BC1, BC2 and BC3. The measurement
may be limited to frequencies on which third and fifth order intermodulation
products appear, considering the width of these products.
#### 6.7.5.2 Additional test requirement (BC2)
In the frequency range relevant for this test, the transmitter intermodulation
level shall not exceed the unwanted emission limits in subclause 6.6 in the
presence of a wanted signal and an interfering signal according to Table
6.7.2-1 in TS 37.104 [2] for BS operation in BC2. The measurement may be
limited to frequencies on which third and fifth order intermodulation products
appear, considering the width of these products.
#### 6.7.5.3 Additional test requirement (BC3)
In the frequency range relevant for this test, the transmitter intermodulation
level shall not exceed the unwanted emission limits in subclause 6.6 in the
presence of a wanted signal and an interfering signal according to Table
6.7.3-1 in TS 37.104 [2] for BS operation in BC3. The measurement may be
limited to frequencies on which third and fifth order intermodulation products
appear, considering the width of these products.
...
3) Measure the performance of the wanted signal at the BS receiver, as defined
...
7.5.5.2-1.
2) The CW interfering signal shall be swept with a step size of 1 MHz within
the specified range.
3) Measure the performance of the wanted signal at the BS receiver, as defined
...
NOTE: The frequency range from F~BW\ RF,DL,low~ -10 MHz to F~BW\ RF,_,DLhigh~
...
subclause 7.2 in TS 37.104. For E-UTRA channel bandwidths 10, 15 and 20 MHz
this requirement shall apply only for a FRC A1-3 mapped to the frequency range
at the channel edge adjacent to the interfering signals.\  
...
NOTE*: P~REFSENS~ depends on the RAT and on the channel bandwidth, see
subclause 7.2 in TS 37.104.\  
\"x\" is equal to 6 in case of E-UTRA or UTRA wanted signals and equal to 3 in
case of GSM/EDGE wanted signal.
* * *
Table 7.7.5.2-2: Interfering signals for narrowband intermodulation
requirement
+----------------------+----------------------+----------------------+ | RAT of the carrier | Interfering signal | Type of interfering | | adjacent to the high | centre frequency | signal | | (low) edge of the RF | offset from the RF | | | bandwidth | bandwidth edge | | | | [kHz] | | +----------------------+----------------------+----------------------+ | E-UTRA 1.4 MHz | ±260 (BC1 and BC3) | CW | | | /\ | | | | ±270 (BC2) | | +----------------------+----------------------+----------------------+ | | ±970 (BC1 and BC3) | 1.4 MHz E-UTRA | | | /\ | signal, 1 RB* | | | ±790 (BC2) | | +----------------------+----------------------+----------------------+ | E-UTRA 3 MHz | ±260 (BC1 and BC3) | CW | | | /\ | | | | ±270 (BC2) | | +----------------------+----------------------+----------------------+ | | ±960 (BC1 and BC3) | 3.0 MHz E-UTRA | | | /\ | signal, 1 RB* | | | ±780 (BC2) | | +----------------------+----------------------+----------------------+ | E-UTRA 5 MHz | ±360 | CW | +----------------------+----------------------+----------------------+ | | ±1060 | 5 MHz E-UTRA signal, | | | | 1 RB* | +----------------------+----------------------+----------------------+ | E-UTRA 10 MHz | ±325 | CW | | | | | | (**) | | | +----------------------+----------------------+----------------------+ | | ±1240 | 5 MHz E-UTRA signal, | | | | 1 RB* | +----------------------+----------------------+----------------------+ | E-UTRA 15 MHz | ±380 | CW | | | | | | (**) | | | +----------------------+----------------------+----------------------+ | | ±1600 | 5MHz E-UTRA signal, | | | | 1 RB* | +----------------------+----------------------+----------------------+ | E-UTRA 20 MHz | ±345 | CW | | | | | | (**) | | | +----------------------+----------------------+----------------------+ | | ±1780 | 5MHz E-UTRA signal, | | | | 1 RB* | +----------------------+----------------------+----------------------+ | UTRA FDD | ±345 (BC1 and BC2) | CW | +----------------------+----------------------+----------------------+ | | ±1780 (BC1 and BC2) | 5MHz E-UTRA signal, | | | | 1 RB* | +----------------------+----------------------+----------------------+ | GSM/EDGE | ±340 | CW | +----------------------+----------------------+----------------------+ | | ±880 | 5MHz E-UTRA signal, | | | | 1 RB* | +----------------------+----------------------+----------------------+ | 1.28Mcps UTRA TDD | ±190 (BC3) | CW | +----------------------+----------------------+----------------------+ | | ±970 (BC3) | 1.4 MHz E-UTRA | | | | signal, 1 RB* | +----------------------+----------------------+----------------------+ | NOTE*: Interfering | | | | signal consisting of | | | | one resource block | | | | positioned at the | | | | stated offset, the | | | | channel bandwidth of | | | | the interfering | | | | signal is located | | | | adjacently to the RF | | | | bandwidth edge. | | | | | | | | NOTE**: This | | | | requirement shall | | | | apply only for an | | | | E-UTRA FRC A1-3 | | | | mapped to the | | | | frequency range at | | | | the channel edge | | | | adjacent to the | | | | interfering signals. | | | +----------------------+----------------------+----------------------+
...
+----------------+----------------+----------------+----------------+ | Test | Minimum | Test | Test | | | requirement in | Tolerance\ | requirement | | | TS 37.104 | (TT) | | +----------------+----------------+----------------+----------------+ | 6.2.1 Base | UTRA and | 0.7 dB | Formula: Upper | | Station | E-UTRA | | limit + TT, | | maximum output | | 0.7 dB | Lower limit - | | power | In normal | | TT | | | conditions: | 1.0 dB | | | | | | In normal | | | within ±2 dB | 1.0 dB | conditions: | | | of | | | | | m | | within +2.7 dB | | | anufacturer\'s | | and -2.7 dB of | | | rated output | | the | | | power | | m | | | | | anufacturer\'s | | | In extreme | | rated output | | | conditions: | | power | | | | | | | | within ±2.5 dB | | In extreme | | | of | | conditions: | | | m | | | | | anufacturer\'s | | within +3.2 dB | | | rated output | | and -3.2 dB of | | | power | | the | | | | | m | | | GSM/EDGE | | anufacturer\'s | | | | | rated output | | | In normal | | power | | | conditions: | | | | | | | In normal | | | within ±2 dB | | conditions: | | | of | | | | | m | | within +3.0 dB | | | anufacturer\'s | | and -3.0 dB of | | | rated output | | the | | | power | | m | | | | | anufacturer\'s | | | In extreme | | rated output | | | conditions: | | power | | | | | | | | within ±2.5 dB | | In extreme | | | of | | conditions: | | | m | | | | | anufacturer\'s | | within +3.5 dB | | | rated output | | and -3.5 dB of | | | power | | the | | | | | m | | | | | anufacturer\'s | | | | | rated output | | | | | power | +----------------+----------------+----------------+----------------+ | 6.4 Transmit | -85 dBm/MHz. | 2 dB | Formula: | | ON/OFF power | | | Minimum | | | | | Requirement + | | | | | TT | +----------------+----------------+----------------+----------------+ | 6.6.1.5.1 | Maximum level | 0 dB | Formula: | | Transmitter | defined in | | Minimum | | spurious | Table | | Requirement + | | emissions, | 6.6.1.1.1-1 of | | TT | | Mandatory | TS 37.104 | | | | Requirements | [2]. | | | +----------------+----------------+----------------+----------------+ | 6.6.1.5.2 | Maximum level | 0 dB | Formula: | | Transmitter | defined in | | Minimum | | spurious | Table | | Requirement + | | emissions, | 6.6.1.1.2-1 of | | TT | | Mandatory | TS 37.104 | | | | Requirements | [2]. | | | +----------------+----------------+----------------+----------------+ | 6.6.1.5.3 | Maximum level | 0 dB | Formula: | | Transmitter | defined in | | Minimum | | spurious | Table | | Requirement + | | emissions, | 6.6.1.1.3-1 of | | TT | | Additional BC2 | TS 37.104 | | | | Requirement | [2]. | | | +----------------+----------------+----------------+----------------+ | 6.6.1.5.4 | Maximum level | 0 dB | Formula: | | Transmitter | defined in | | Minimum | | spurious | Table | | Requirement + | | emissions, | 6.6.1.2.1-1 of | | TT | | Protection of | TS 37.104 | | | | BS receiver | [2]. | | | +----------------+----------------+----------------+----------------+ | 6.6.1.5.5 | Maximum level | 0 dB | Formula: | | Transmitter | defined in | | Minimum | | spurious | Tables | | Requirement + | | emissions, | 6.6.1.3.1-1 | | TT | | Additional | and | | | | spurious | 6.6.1.3.1-2 of | | | | emission | TS 37.104 | | | | requirements | [2]. | | | +----------------+----------------+----------------+----------------+ | 6.6.1.5.6 | Maximum level | 0 dB | Formula: | | Transmitter | defined in | | Minimum | | spurious | Table | | Requirement + | | emissions,\ | 6.6.1.4.1-1 of | | TT | | Co-location | TS 37.104 | | | | | [2]. | | | +----------------+----------------+----------------+----------------+ | 6.6.2 | [For BC1 and | 1.5 dB | Formula: | | Operating band | BC2 | | Minimum | | unwanted | :]{.underline} | 1.5 dB | requirement + | | emissions | | | TT | | | []{.underline} | 0 dB | | | | | | -12.5 | | | Offset \< 1 | 1.5 dB | dBm/30kHz to\ | | | MHz | | -24.5 | | | | 1.5 dB | dBm/30kHz | | | -14dBm/30kHz | | | | | to | | -11.5 dBm/1 | | | -26dBm/30kHz | | MHz | | | | | | | | 1 MHz ≤ Offset | | -15 dBm/1 MHz | | | \<10 MHz\ | | | | | -13 dBm/1 MHz | | 3.5 dBm/30kHz | | | | | to | | | 10 MHz ≤ | | | | | Offsets\ | | 6.5 dBm/30 kHz | | | -15 dBm/1 MHz | | | | | | | -12.5 | | | [For BC2 with | | dBm/30kHz to\ | | | adjacent | | 3.5 dBm/30 kHz | | | GSM/EDGE or | | | | | E-UTRA 1.4 and | | | | | 3 MHz | | | | | carriers | | | | | :]{.underline} | | | | | | | | | | []{.underline} | | | | | | | | | | Offset \< 0.05 | | | | | MHz | | | | | | | | | | 2 dBm/30kHz | | | | | to\ | | | | | 5 dBm/30 kHz | | | | | | | | | | 0.05 MHz ≤ | | | | | Offset | | | | | | | | | | -14 dBm/30kHz | | | | | to\ | | | | | 2 dBm/30 kHz | | | +----------------+----------------+----------------+----------------+ | 6.6.3 Occupied | BW~Channel~ | 0 kHz | Formula: | | bandwidth | for E-UTRA | | Minimum | | | | | Requirement + | | | 5 MHz for UTRA | | TT | | | FDD | | | | | | | | | | 1.6 MHz for | | | | | UTRA TDD | | | +----------------+----------------+----------------+----------------+ | 6.7 | Wanted signal | 0 dB | Formula: Ratio | | Transmitter | level - | | + TT | | in | interferer | | | | termodulation\ | level = 30 dB | | Wanted signal | | (interferer | | | level - | | requirements) | | | interferer | | | | | level = 30 + 0 | | This tolerance | | | dB | | applies to the | | | | | stimulus and | | | | | not the | | | | | measurements | | | | | defined in | | | | | 6.6.1, 6.6.2 | | | | | and 6.6.4. | | | | +----------------+----------------+----------------+----------------+
