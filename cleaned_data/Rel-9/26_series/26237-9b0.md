...
> NOTE 2: In the pull mode, the session transfer is initiated by UE-2. Pull
> mode is not in the scope of Rel-9 and will be handled in a later Release.
## 16.1 Push mode
...
[41].
{width="6.629861111111111in" height="6.0in"}
Figure 34: Inter UE session transfer.
...
23\. PSS session teardown between UE-1 and PSS server according to clause
8.2.6.1.1.
