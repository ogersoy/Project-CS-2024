...
**.**
# 1 Scope
The present document provides the XML file format definition for the HeNS
...
The overall architectural feature of HeNS Network Resource Model IRP is
specified in 3GPP TS 32.782 [2]. This clause specifies features that are
...
The following XML schema hensNrm.xsd is the NRM-specific schema for the HeNS
Network Resources IRP NRM defined in 3GPP TS 32.782 [1]:
\\ \ \\ \ \
\\
\\
\\
