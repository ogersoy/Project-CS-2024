...
the NGAP Location Reporting Control procedure in TS 23.502 [3] can be used
...
to attempt instead. Solution #13 answers to items a - d) of this Key Issue. In
addition, the same solution helps to solve also item e) as well by ensuring
...
impacts to the 5GSUE, RAN and 5G-CN.So far, no show stoppers have been found
from SA2 related aspects. As RAN dependencies have been identified in both
solution #1 and solution #12, RAN groups need to evaluate these solutions.
