...
9\. MCPTT server implicitly de-affilates MCPTT clients to the group. The group
management server releases the temporary group ID. This step is optional.
