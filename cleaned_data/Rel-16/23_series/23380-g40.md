...
ATCF-Management-URI contained in the SIP REGISTER request is different from
previously stored one, the SCC-AS shall update the locally stored ATCF-Path-
URI or the ATCF-Management-URI as well as that stored in the HSS as Repository
Data with the new received value._
...
applies for service request. And SCC-AS is optionally enhanced to upload SRVCC
related information as Repository Data from the HSS and notify the ATCF with
new _ATU-STI._
