...
session establishment failure occurs. Pre-Shared Key O This information
element is present if the MRFC wants that the media is protected using TLS
tunnel established with MIKEY-TICKET procedures. It indicates the Traffic-
Encrypting key associated with the Crypto Session that shall be used in TLS
handshake. Configure BFCP Termination Ack MRFP Context M This information
element indicates the context where the command was executed. Bearer
Termination M This information element indicates the Bearer Termination where
the command was executed. NOTE: The above procedure may be combined with other
procedures in ADD or MOD commands.
* * *
