...
* * *
Attribute Name Support Qualifier isReadable isWritable isInvariant
isNotifyable pLMNIdList M T T F T tACList M T T F T
* * *
...
* * *
Attribute Name Support Qualifier isReadable isWritable isInvariant
isNotifyable pLMNIdList M T T F T mMEC M T T F T **Attribute related to role**  
mMEPool M T T F T
* * *
...
#### 4.3.28.1 Definition
This IOC represents Serving Gateway control plane functionality. For more
information about the SGW-C, see 3GPP TS 23.214 [23].
#### 4.3.28.2 Attributes
* * *
Attribute Name Support Qualifier isReadable isWritable isInvariant
isNotifyable pLMNIdList M T T F T tACList M T T F T
...
#### 4.3.30.1 Definition
This IOC represents SGW-C functionality controlled by another IRPAgent. For
...
#### 4.3.31.1 Definition
This IOC represents SGW-U functionality controlled by another IRPAgent. For
more information about the SGW-U, see 3GPP TS 23.214 [23].
#### 4.3.31.2 Attributes
* * *
Attribute Name Support Qualifier isReadable isWritable isInvariant
isNotifyable pLMNIdList M T T F T tACList M T T F T
