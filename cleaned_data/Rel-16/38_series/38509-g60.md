...
Octets and power back-off X~max,_PCell\_ ~ are defined below in Section 6.11.
...
* * *
Protocol discriminator TS 24.007 [7], subclause 11.2.3.1.1 M V ½ Skip
indicator TS 24.007 [7], subclause 11.2.3.1.2 M V ½ Message type M V 1 UE
...
Information Element Reference Presence Format Length Protocol discriminator TS
24.007 [5], subclause 11.2.3.1.1 M V ½ Skip indicator TS 24.007 [5], subclause
11.2.3.1.2 M V ½ Message type M V 1 NR Sidelink PSCCH Packet Counter(s) Value
...
drop of the secondary component carrier(s) due to priorization rules in
...
component carrier fom P~CMAX,_f,c.\_ ~This ensure sufficient power allocation
is possible on the secondary component carrier(s)
This message is only sent in the direction SS to UE.
Information Element Reference Presence Format Length
* * *
Protocol discriminator TS 24.007 [7], subclause 11.2.3.1.1 M V ½ Skip
indicator TS 24.007 [7], subclause 11.2.3.1.2 M V ½ Message type M V 1 TOTAL
