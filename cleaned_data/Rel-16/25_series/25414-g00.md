...
A dynamic Payload Type (IETF RFC 1890 [23]) shall be used. Values in the Range
between 96 and 127 shall be used. The value shall be ignored in the receiving
entity.
...
A single Iu UP PDU, as described in TS 25.415 [24], shall be transported as
RTP payload.
#### 5.1.3.4 RTCP
