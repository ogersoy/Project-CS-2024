...
procedure. The assistance information included in the RRLP Positioning
...
the when the RRLP MTA message indicates Extended Access Burst method or RLC
Data Block method is to be used) to be used during the TA estimation procedure
(see 3GPP TS 49.031[22]). The MS autonomously selects the set of cells for
performing the Multilateration Timing Advance procedure which may include a
subset of the cells identified by the assistance information. The provisioning
of assistance data improves the location accuracy for the Multilateration
Timing Advance procedure and decreases the energy consumed in the MS to
