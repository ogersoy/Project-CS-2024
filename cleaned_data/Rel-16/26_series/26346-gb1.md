...
capability as defined in ETSI TS 103 720 [148], clause 10.3. 28 NOTE 1: \"LTE-
based 5G Broadcast\" refers to 3GPP TR 36.976 [149] \"Overall description of
...
_P_ = 512:
Table B.4.4.2-1
**Max source block size _B_** **_G_** **Symbol size _T_** **_G∙T_**
* * *
...
allocation name \"3GPP MBMS SACH\" is specified in IANA's IPv6 Multicast
Address Space Registry [154] and described below, and the specific value
\'FF02:0:0:0:0:0:0:177\' is assigned by this specification for use in
conjunction with other pre-defined session parameters to enable the discovery
and acquisition of a Service Announcement service which in turn indicates the
availability of ROM service(s).
> (Requester) Full Name: Charles Lo
(Requester) E-mail: clo@qti.qualcomm.com
Local Scope: No
Permanence: Yes
...
{width="6.0in" height="2.7847222222222223in"}
...
\
\
> \ schemaLocation=\"USD-Rel-07-schema-snippet.xsd\"/>
>
> \ schemaLocation=\"USD-Rel-08-schema-snippet.xsd\"/>
>
> \ schemaLocation=\"USD-Rel-09-schema-snippet.xsd\"/>
>
> \ schemaLocation=\"USD-Rel-12-schema-snippet.xsd\"/>
>
> \ schemaLocation=\"USD-Rel-14-schema-snippet.xsd\"/>
>
> \ schemaLocation=\"USD-Rel-15-schema-snippet.xsd\"/>
>
> \ schemaLocation=\"USD-Rel-16-schema-snippet.xsd\"/>
\
\
\
\
...
**SDP Parameter** **Required** **Optional** **Not Applicable**
**Clarification**
* * *
...
applicable for NRT content.** QoE metrics As defined in clauses 8.3.2.1 and
8.4 Alternative TMGI As defined in clause 7.3.2.12
...
required to support the unicast fallback described in this section.
# M.2 Guidelines
...
segment), as illustrated in figure x.
