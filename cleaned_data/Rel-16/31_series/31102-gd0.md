...
NAS security context storage for multiple registration
* * *
...
context storage for multiple registration
* * *
...
to 5.3.1.54 and tables 5.3.1.31 to 5.3.1.54 of 3GPP TS 24.588 [113].
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  | EFTVCONFIG |  | EFXCAPConfigData |  | EFEARFCNList |  | EFMuDMiDConfigData |  |  |  |  |  |  |  |   
|  |  |  |  |  | '6FFB' |  | '6FFC' |  | '6FFD' |  | '6FFE' |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
...
> EF~5GSN3GPPNSC~.
If service n°xxx is \"available\" in addition, the ME shall associate the NAS
...
in the 5G LOCI file for the same access type (e.g. EF~5GS3GPPNSC~) and the 5GS
