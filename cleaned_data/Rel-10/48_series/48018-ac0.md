...
The BSS shall not initiate the PS handover required procedure in the case of
an MOCN configuration if the Rerouting procedure is ongoing.
...
NULL) being linked with the SON Transfer Application in use.
The rules specified in this sub-clause apply when the _RIM Application
...
octet 1 IEI  
octet 2, 2a Length Indicator  
octet 3 Spare Spare Spare Spare Spare MOCN Gigabit Interface PS Handover
* * *
...
This information element provides control information for the MOCN rerouting
procedure. It indicates that the CN shall include in the answer either
Redirection Indication IE or Redirection Completed IE.
The element coding is:
...
This information element provides control information for the MOCN rerouting
procedure. It indicates that the CN requests rerouting by the BSS to another
CN operator. The Reroute Reject cause is given.
...
24.008 [11]) 0 0 0 1 0 0 1 0 Reserved \" \" 1 1 1 1 1 1 1 1 Reserved
* * *
### 11.3.113 Redirection Completed
This information element provides control information for the MOCN rerouting
procedure. It indicates that the reroute procedure is completed.
The element coding is:
...
used by the source RAT to specify the E-UTRA frequencies to be reported back
to the source RAT (each of them associated with a measurement bandwidth), the
minimum radio quality and the period of time that the measurements should last
before triggering a _HO Report_ for unnecessary handover to another RAT.
...
The element coding is:
Table 11.3.116: Source Cell ID IE
* * *
                 8                        7   6   5   4   3   2   1
Octet 1 IEI  
Octet 2 Length Indicator  
