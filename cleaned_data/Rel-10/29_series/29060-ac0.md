...
operator policy permits reporting of the User Location Change change to the
operator of the GGSN, the SGSN shall include this Extension Header in all
...
Even if there is no path is in use, a GSN or RNC shall be prepared to receive
...
PLMN. The LAC and RAC components shall be populated by the SGSN with the value
...
The SGSN may include the User Location Information IE, MS Time Zone IE,
IMEI(SV) IE and the CAMEL Charging Information Container IE, User CSG
...
not support the CSG Information Change Reporting. 3GPP TS 23.060 [4] (e.g.
subclause 9.2.2.1) defines the SGSN shall send the MS Info Change Reporting
Support Indication to the GGSN. In such case SGSN shall use the CSG Change
Reporting Support Indication for CSG Information Reporting even if stage 2
refers to MS Info Change Reporting Support Indication.
...
shall be populated with the MCC and MNCof the serving PLMN of the MS. The LAC
...
ignored.
The SGSN may include the User Location Information IE and MS Time Zone IE,
User CSG Information if they are available (see sub-clause 15.1.1a of 3GPP TS
23.060 [4] for more information). If the User Location Information IE is
...
Information information element, if MS Info Change Reporting mechanism has
been started by the GGSN.
...
Optional 7.7.52 Extended Common Flags Optional 7.7.93 Private Extension
Optional 7.7.46
* * *
...
be included per APN and PDP address. The NSAPI shall be the value assigned to
any PDP Context that is associated with the APN/PDP Address.
...
one occurrence of this IE may be included per PDP address and APN. Any of the
NSAPI values may be used that are associated with the given APN/PDP Address.
...
Optional 7.7.104 Higher bitrates than 16 Mbps flag Optional 7.7.105 Private
Extension Optional 7.7.46
* * *
...
C-MSISDN Optional 7.7.110 Extended RANAP Cause Optional 7.7.111 Private
Extension Optional 7.7.46
* * *
...
Context(s) associated with same PDP address and APN. It indicates that the
GGSN is requesting UE to re-initiate the PDP Context Activation procedure for
...
target RNC. Octets 4-n shall contain a non-transparent copy of the
corresponding IEs (see subclause 7.7.2) and be encoded as specified in Figure
51 below. The \"Target RNC-ID\" part of the \"Target ID\" parameter is
...
Octets 4 to n shall contain one of the following information, depending on the
...
\"Selected PLMN Identity\" as specified in 3GPP TS 25.413 [7].
* * *
              Bits                                                 
     Octets   8                        7   6   5   4   3   2   1   
     1        Type = 164 (Decimal)                                 
...
* * *
     ...
     1         Type = 186 (Decimal)                                                                        
     2-3       Length (Decimal)                                                                            
     4-7       Common Tunnel Endpoint Identifier                                                           
...
signalling priority indications received from the UE for the associated PDP
address and APN.
...
Signalling Priority Indication with NSAPI and the FQDN information element
where several occurrences of each type are allowed.
* * *
              Bits                                                 
     Octets   8                        7   6   5   4   3   2   1   
     1 -- m   GTP header                                           
...
Notification Request correction for dual address PDP
CT#54 29.060 10.3.0 0840r3 Rel-10 10.4.0 Referencing Information Elements
defined outside GTP 0844r2 MBMS IP Multicast Distribution 0850r2 New PDP type
due to network preference 0853r1 IMEI not known cause 0855r1 PDP context for
emergency call 0848r1 Defining the fixed number of octets for extendable IEs
CT#55 29.060 10.4.0 0860 Rel-10 10.5.0 Handover to CSG cell with emergency
bearer 0863 Pre-Rel-7 QoS description correction 0870r1 Missing CSG
Information Reporting Action IE in CPC and UPC response messages 0880r2 Higher
bitrates than 16 Mbps flag 0872r1 Location change reporting support indication
related correction 0874r1 Inclusion of ULI and MS Time Zone IEs in DPC Request
0877r1 Max MBR/APN-AMBR in enhanced SRNS relocation procedure CT#56 29.060
10.5.0 0903r2 Rel-10 10.6.0 Providing Serving Network Information to the GGSN
0888r1 GGSN TEID and IP address in the Update PDP Context Response message
CT#58 29.060 10.6.0 0916r1 Rel-10 10.7.0 Removal of Maximum MBR/APN-AMBR CT#59
29.060 10.7.0 0931r1 Rel-10 10.8.0 Addition of PS to CS handover indication in
Delete PDP Context Request CT#61 29.060 10.8.0 0958r2 Rel-10 10.9.0 Correction
to the condition of inclusion of the RAT Type IE