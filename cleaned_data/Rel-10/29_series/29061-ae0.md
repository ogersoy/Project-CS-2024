...
If the GGSN/P-GW detects a failure in P-CSCF address(es) being used by the
...
RADIUS Accounting shall be used according to RFC 2866 [39] , RFC 3162 [50] and
RFC 4818 [97].
...
29.274 [81] (for the P-GW in GTP/PMIP S5/S8, S2b), the MCC shall be 3 digits
and the MNC shall be either 2 or 3 digits. There shall be no padding
...
0-7 As specified in 3GPP TS 29.274 [81]\ 8-100 Spare for future use\ 101 IEEE
...
+-------------+-------------+-------------+-------------+-------------+ | Attr # | Attribute | Description | Content | Presence | | | Name | | | Requirement | +-------------+-------------+-------------+-------------+-------------+ | 1 | User-Name | Username | String | Optional | | | | provided by | | | | | | the user | | | | | | (extracted | | | | | | from the | | | | | | PCO field | | | | | | of the | | | | | | Create PDP | | | | | | Context | | | | | | Request | | | | | | message) or | | | | | | PPP | | | | | | aut | | | | | | hentication | | | | | | phase (if | | | | | | PPP PDP | | | | | | type is | | | | | | used). If | | | | | | no username | | | | | | is | | | | | | available a | | | | | | generic | | | | | | username, | | | | | | c | | | | | | onfigurable | | | | | | on a per | | | | | | APN basis, | | | | | | shall be | | | | | | present. If | | | | | | the | | | | | | User-Name | | | | | | has been | | | | | | sent in the | | | | | | Ac | | | | | | cess-Accept | | | | | | message, | | | | | | this | | | | | | user-name | | | | | | shall be | | | | | | used in | | | | | | preference | | | | | | to the | | | | | | above | | | +-------------+-------------+-------------+-------------+-------------+ | 8 | Framed | User IPv4 | IPv4 | Conditional | | | -IP-Address | address | | Note 2 | +-------------+-------------+-------------+-------------+-------------+ | 97 | Framed- | User IPv6 | IPv6 | Conditional | | | IPv6-Prefix | prefix | | Note 2 | +-------------+-------------+-------------+-------------+-------------+ | 123 | Delegated- | Delegated | IPv6 | Conditional | | | IPv6-Prefix | IPv6 prefix | | Note 4 | | | | to the | | | | | | user. | | | +-------------+-------------+-------------+-------------+-------------+ | 96 | Framed-I | User IPv6 | IPv6 | Conditional | | | nterface-Id | Interface | | | | | | Identifier | | Notes 1and | | | | | | 2 | +-------------+-------------+-------------+-------------+-------------+ | 44 | Acct | User | GGSN/P-GW | Mandatory | | | -Session-Id | session | IP address | | | | | identifier. | (IPv4 or | | | | | | IPv6) and | | | | | | Charging-ID | | | | | | c | | | | | | oncatenated | | | | | | in a UTF-8 | | | | | | encoded | | | | | | hexadecimal | | | | | | characters. | | | | | | | | | | | | (Note 3) | | +-------------+-------------+-------------+-------------+-------------+ | 26/10415 | 3GPP | Sub | See | Optional | | | Vend | -attributes | subclause | | | | or-Specific | according | 16.4.7 | | | | | to | | | | | | subclause | | | | | | 16.4.7. | | | +-------------+-------------+-------------+-------------+-------------+ | NOTE 1: | | | | | | Included if | | | | | | the prefix | | | | | | alone is | | | | | | not unique | | | | | | for the | | | | | | user. This | | | | | | may be the | | | | | | case, for | | | | | | example, if | | | | | | a static | | | | | | IPv6 | | | | | | address is | | | | | | assigned. | | | | | | | | | | | | NOTE 2: | | | | | | Either IPv4 | | | | | | or IPv6 | | | | | | add | | | | | | ress/prefix | | | | | | attribute | | | | | | shall be | | | | | | present. | | | | | | See | | | | | | subclause | | | | | | 16.3.4. | | | | | | | | | | | | NOTE 3: The | | | | | | GGSN/P-GW | | | | | | IP address | | | | | | is the same | | | | | | one that is | | | | | | used in the | | | | | | CDRs | | | | | | created by | | | | | | the | | | | | | GGSN/P-GW. | | | | | | | | | | | | NOTE 4: | | | | | | Delegated | | | | | | IPv6 prefix | | | | | | shall be | | | | | | present if | | | | | | the user | | | | | | was | | | | | | delegated | | | | | | an IPv6 | | | | | | prefix from | | | | | | a local | | | | | | pool. | | | | | +-------------+-------------+-------------+-------------+-------------+
...
to send the Accounting-Request (START). For GTP-based S5/S8/S2b, if accounting
is used per IP-CAN bearer, the EPS bearer ID will identify the particular
bearer this accounting message refers to. The Accounting-Request message also
...
The STA command, defined in IETF RFC3588 (DIAMETER BASE) [66], is indicated by
the Command-Code field set to 275 and the 'R' bit cleared in the Command Flags
field, is sent in response to an STR command.
The relevant AVPs that are of use for the SGmb interface are detailed in the
ABNF description below. Other valid AVPs for this command are not used for
SGmb purposes and should be ignored by the receiver or processed according to
the relevant specifications.
