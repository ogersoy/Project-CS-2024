...
access to IMS Service n°96 Non-Access Stratum configuration by USIM
* * *
...
Length (see note 1) Z M Z byte Bearer Description Value -- M Note 1: coded
according to ISO/IEC 8825-1 [35].
* * *
Any unused bytes shall be set to \'FF\'.
...
> record number in EF~CSGT~ that shall be displayed as the CSG Type.
\- HNB Name indication
Contents:
...
> range \'01\' to \'FE\' indicates the record number in EF~HNBN~ that shall be
> displayed as the HNB name.
\- CSG ID
Contents:
