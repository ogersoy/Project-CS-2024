...
### 6.3.39 MscPool
#### 6.3.39.1 Definitions
This IOC represents the MSC server pool. For more information about the MSC
server pool, see 3GPP TS 23.002 [15]
#### 6.3.39.2 Attributes
* * *
Attribute name Support Qualifier Read Qualifier Write Qualifier id M M -
mscPool-MscServerFunction M M - mscPool-MscPoolArea M M -
* * *
#### 6.3.39.3 Notifications
The common notifications defined in subclause 6.7 are valid for this IOC,
without exceptions or additions.
### 6.3.40 MscPoolArea
#### 6.3.40.1 Definition
This IOC represents MSC Pool Area. For more information about the MSC Pool
Area, see 3GPP TS 23.002 [9]. Key concepts related to MSC Pool Area are:
...
* * *
Attribute name Support Qualifier Read Qualifier Write Qualifier id M M -
lacList M M - pLMNIdList O M - mscPoolArea-MscPool M M -
* * *
### 6.3.41 SgsnPool
#### 6.3.41.1 Definitions
This IOC represents the SGSN pool. For more information about the SGSN pool,
see 3GPP TS 23.002 [15]
#### 6.3.41.2 Attributes
* * *
Attribute name Support Qualifier Read Qualifier Write Qualifier id M M -
sgsnPool-SgsnFunction M M -
* * *
#### 6.3.41.3 Notifications
The common notifications defined in subclause 6.7 are valid for this IOC,
without exceptions or additions.
### 6.3.42 SgsnPoolArea
#### 6.3.42.1 Definitions
This IOC represents SGSN Pool Area. For more information about the SGSN Pool
Area, see 3GPP TS 23.002 [9]. Key concept related to SGSN Pool Area is:
  * An SGSN Pool Area is defined as an area within which an UE may be served without the need to change the serving SGSN. It is a collection of complete Routing Areas (RAs).
#### 6.3.42.2 Attributes
* * *
Attribute name Support Qualifier Read Qualifier Write Qualifier id M M -
racList M M - pLMNIdList O M - sgsnPoolArea-SgsnPool M M -
* * *
#### 6.3.42.3 Notifications
The common notifications defined in subclause 6.7 are valid for this IOC,
without exceptions or additions.
