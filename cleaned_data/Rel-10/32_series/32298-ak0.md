...
The field needs not be available for prefix length of 64 bits, as in this case
...
the conference. It\'s just for Billing Domain\'s information in each CDR, e.g.
...
(0) gsm-Access (2) modules (3) ss-DataTypes (2) version13 (13)}
**\--** from TS 24.080 [209]
DefaultCallHandling,
DefaultSMS-Handling,
...
mobileDomain (0) gsm-Network (1) modules (3) map-CH-DataTypes (13) version13
(13) }
\-- from TS 29.002 [214]
AddressString,
BasicServiceCode,
...
(0)}
BasicService
FROM Basic-Service-Elements { itu-t(0) identified-organization (4) etsi (0)
...
ServiceKey
FROM MAP-MS-DataTypes { itu-t identified-organization (4) etsi (0)
mobileDomain (0)gsm-Network (1) modules (3) map-MS-DataTypes (11) version13
(13)}
\-- from TS 29.002 [214]
IMEI,
IMSI,
...
localSequenceNumbers [20] LocalSequenceNumber OPTIONAL,
