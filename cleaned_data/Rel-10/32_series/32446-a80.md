...
32.442 [5]).
This Solution Set specification is related to 3GPP TS 32.442 V10. 7.X.
# 2 References
...
[6] 3GPP TS 32.441: \"Telecommunication management; Trace Management
...
[19] 3GPP TS 32.421: \"Telecommunication management; Subscriber and Equipment
Trace; Concept and requirements\".
[20] 3GPP TS 32.422: \"Telecommunication management; Subscriber and equipment
...
VENDORMAXIMUM};
enum TraceTarget {IMSI, IMEI, IMEISV, PUBLIC_ID, UTRAN_CELL, E-UTRAN_CELL,
eNB, RNC};
...
LOGGING_DURATION, ANONYMIZATION_OF_MDT_DATA, REASON};
...
in TraceIRPConstDefs::DNSet mdtAreaScope,
...
out TraceIRPConstDefs::DNSet mdtAreaScope,
...
{width="6.69375in" height="2.4256944444444444in"}{width="6.683333333333334in"
height="4.695138888888889in"}
{width="6.689583333333333in"
height="5.542361111111111in"}{width="5.364583333333333in"
...
traceCollectionEntityAddress CM jobType jobType M mdtAreaScope mdtAreaScope CM
...
measurementQuantity measurementQuantity CM unsupportedList unsupportedList M
status status M
* * *
...
jobType jobType M mdtAreaScope mdtAreaScope CM listOfMeaurements
listOfMeaurements CM reportingTrigger reportingTrigger CM reportInterval
reportInterval CM reportAmount reportAmount CM eventThreshold eventThreshold
CM loggingInterval loggingInterval CM loggingDuration loggingDuration CM
anonymizationOfMDTData anonymizationOfMDTData CM measurementQuantity
measurementQuantity CM status status M
* * *
