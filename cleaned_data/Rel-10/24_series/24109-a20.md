...
identifier;
\- the password used in the digest calculations shall be the NAF specific key
...
take place inside a server-authenticated TLS (as described in RFC 2246 [11])
tunnel in which case TLS session has been established before step 1.
...
> protocol are specified in IETF TLS related specifications such as IETF RFC
> 2246 [11] and IETF RFC 3546 [18].
...
> handshake messages. For details, see RFC 2246 [11].
5\. **Zn: NAF specific key procedure**
...
bootstrapping transaction identifier is encoded in the
