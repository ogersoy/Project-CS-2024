...
the Iu-RELOCATION-REQUEST message. If the UE fails the CSG membership check
...
check the CSG membership of the UE for the target CSG cell before generating
the MAP-PREPARE-HANDOVER request. If the UE fails the CSG membership check for
the target cell as described in subclause 4.1.1, MSC-A shall send an
...
check the CSG membership of the UE for the target CSG cell before generating
the MAP-PREPARE-HANDOVER request. If the UE fails the CSG membership check for
the target cell as described in subclause 4.3.1, 3G_MSC-A shall send an IU-
RELOCATION-PREPARATION-FAILURE to RNS-A.
3G_MSC‑B will return the MAP-PREPARE-HANDOVER response after having retrieved
