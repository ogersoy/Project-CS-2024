...
#### 5.5.1.4 Bearer Activation / Modification / Deactivation
...
#### 5.5.1.6 Mobility to macro network
...
#### 5.5.1.7 UE Attach without HeNB GW
...
> send GW Control Session [Termination to BPCF t]{.underline}o terminate the
> S9* session.
...
> Session [Termination Ack to]{.underline} the H(e)NB Policy Function.
