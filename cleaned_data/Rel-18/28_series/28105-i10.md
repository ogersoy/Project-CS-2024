...
The IOC MLEntityRepository represents the repository that contains the ML
entities .
...
* * *
Attribute name Support Qualifier isReadable isWritable **isInvariant**
isNotifyable mLRepositoryId M T F F F
* * *
##### 7.2a.2.2.3 Attribute constraints
None.
##### 7.2a.2.2.4 Notifications
...
32.156 [13].
{width="6.688194444444444in" height="2.613888888888889in"}
