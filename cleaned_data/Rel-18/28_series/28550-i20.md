...
This method shall support the URI query parameters specified in the following
table.
**Table 8.2.1.3.3.2-1: URI query parameters supported by the DELETE method on
this resour** ce
* * *
**Name** **Data type** **Description** **SQ**
* * *
This method shall support the request data structures, the response data
structures and response codes specified in the following tables.
**Table 8.2.1.3.3.2-2: Data structures supported by the DELETE request body on
t** his resource
* * *
**Data type** **Description** **SQ** n/a n/a n/a
* * *
...
This clause specifies the abstract syntax notation one (ASN.1) definition for
the Performance Data Stream Units (see Annex C) as Payload data of WebSocket
Data frame.
...
###### ## Annex I (normative): GPB schema for performance data stream units
...
###### ## Annex J (Informative): Example of ASN.1 Streaming of PMs
This annex provides an example for ASN.1 schema for Performance Data Stream
Units.
PDSUs ::= {
PDSU {
{
streamId ::= 123123,
granularityPeriodEndTime ::= 20230301141430,
...
{
stringValue ::= \"This is example String\"
},
{
subCounters {
{
...
{
streamId ::= 122323,
granularityPeriodEndTime ::= 20230301181130,
standardizedMeasResults {
{
integerValue ::= 1122
},
