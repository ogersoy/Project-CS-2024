...
3GPP TS 24.628 [11].
If the Resource-Priority header field was received in the incoming INVITE
request, then, if allowed by local policy, the AS shall set the Resource-
Priority header field value of the outgoing INVITE request based upon the
Resource-Priority header field value in the incoming INVITE request.
