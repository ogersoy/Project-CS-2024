...
BM‑SC to be used to push the file via xMB‑U. The MCData server ingests the
content into the BM‑SC after the MBMS session is established and steps 6 to 8
are performed.
