...
### 4.4.1 Introduction
There are no SCP specific addtions to clause 4.4.1 of TS 33.117 [3].
### 4.4.2 Port Scanning
There are no SCP specific addtions to clause 4.4.2 of TS 33.117 [3].
### 4.4.3 Vulnerability scanning
There are no SCP specific addtions to clause 4.4.3 of TS 33.117 [3].
...
layer, for SCP, the following interface and protocols are in the scope of the
testing:
