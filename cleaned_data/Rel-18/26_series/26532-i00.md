...
_expedite_ _boolean_ 0..1 If present and _true_ , this data report contains UE
data requiring expedited processing by the recipient.
...
Collection AF are located in different trust domains, e.g., the former entity
resides within the trusted domain and the latter entity resides outside the
trusted domain (as in clause A.3 or A 4 of TS 26.531 [7]), the NEF shall be
employed to mediate the interactions between them, via the
_Nnef_DataReporting_ service API specified in TS 29.522 [27].
\- In the event that the AS and the Data Collection AF are located in
different trust domains, e.g., the former entity resides within the trusted
domain and the latter entity resides outside the trusted domain (as in clause
A.4 of TS 26.531 [7]), the NEF shall be employed to mediate the interactions
between them, via the _Nnef_Data‌Reporting_ service API specified in TS 29.522
[27].
