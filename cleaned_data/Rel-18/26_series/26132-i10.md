...
### 7.7.5 Acoustic echo control in an electrical interface UE
...
P.581) and the spectrum is not altered.
The spectrum at the MRP and the actual level at the MRP (measured in
1/3-octaves) are used as references to determine the sending sensitivity SmJ.
b) The hands-free terminal is setup as described in clause 5. The sending
sensitivity shall be calculated from each band of the 20 frequencies given in
table A.2 of ITU‑T Recommendation P.79 Annex A [16], bands 1 to 20. For the
calculation, the averaged measured level at the electrical reference point for
...
Delay and Loss profile Compensation value
* * *
dly_profile_20msDRX_10pct_BLER_e2e 30 ms
...
Shift Offset Z~e~ [mm] Offset Y~e~ [mm] Type
* * *
S0 0 0 Mandatory S1 0 -10 Mandatory S2 +10 0 Mandatory S3 0 +10 Mandatory S4
-10 0 Mandatory S5 +10 -10 Recommended S6 +10 +10 Recommended S7 -10 +10
Recommended S8 -10 -10 Recommended
