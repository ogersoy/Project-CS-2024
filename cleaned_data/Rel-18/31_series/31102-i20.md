...
[118] 3GPP TS 24.575: \"5G System; Multicast/Broadcast UE pre-configuration
Management Object (MO)\".
[119] 3GPP TS 38.101-1: \"NR; User Equipment (UE) radio transmission and
reception; Part 1: Range 1 Standalone\".
[120] 3GPP TS 38.101-2: \"NR; User Equipment (UE) radio transmission and
...
Identifier for SNPN (NID) Service n°147 5MBS UE pre-configuration Service
n°148 UE configured for using \"Operator controlled signal threshold per
access technology\"
* * *
...
Contents:
The additional NAS configuration parameters contains some of the NAS
configuration parameters defined in TS 24.368 [65].
Coding:
        b8   b7   b6   b5   b4   b3   b2   b1
* * *
                                                b1 value to be interpreted as defined for DefaultNSSAIInclusionMode leaf in clause 5.10zz4 of 3GPP TS 24.368 \[65\].
                                                RFU (see TS 31.101 \[11\])
...
### 4.2.115 EF~OCST~ (\"Operator controlled signal threshold per access
technology\")
If service n°148 is \"available\", this file shall be present.
The file EF~OCST~ contains the indication of whether SENSE is enabled by the
operator. It also contains \"Operator controlled signal threshold per access
technology\" parameters as specified in 3GPP TS 23.122 [31].
+----------------------+----------------------+----------+---------+ | Identifier: \'6F02\' | Structure: | Optional | | | | transparent | | | +======================+======================+==========+=========+ | File size: X bytes, | Update activity: low | | | | (X≥1) | | | | +----------------------+----------------------+----------+---------+ | Access Conditions: | | | | | | | | | | READ PIN | | | | | | | | | | UPDATE ADM | | | | | | | | | | ACTIVATE ADM | | | | | | | | | | DEACTIVATE ADM | | | | +----------------------+----------------------+----------+---------+ | Bytes | Description | M/O | Length | +----------------------+----------------------+----------+---------+ | 1 | SENSE enabled by | M | 1 | | | operator | | | +----------------------+----------------------+----------+---------+ | 2 -- X+1 | \"Operator | M | X bytes | | | controlled signal | | | | | threshold per access | | | | | technology\" | | | | | parameter TLV object | | | +----------------------+----------------------+----------+---------+
...
* * *
     b8   b7   b6   b5   b4   b3   b2   b1   
                                             Value \'1\' indicates Operator has configured UE to use SENSE, hence UE shall use the Operator controlled signal threshold per access technology parameters as described in 3GPP TS 23.122 \[31\].
                                             RFU, bit = 0
* * *
\- Operator controlled signal threshold per access technology parameter TLV
data object:
* * *
Description Value M/O/C Length (bytes) _Operator controlled signal threshold
per access technology_ tag \'80\' M 1 Length 3n M Note Access Technology 1 --
C 2 Operator controlled signal threshold per access technology 1 -- C 1 ...  
Access Technology n -- C 2 Operator controlled signal threshold per access
technology n -- C 1
Note: The length is coded according to ISO/IEC 8825-1 [35]
* * *
\- Access Technology:
Contents:
\- Specific Access Technology of the PLMN for which an operator controlled
signal threshold per access technology is defined.
Coding:
\- See EF~PLMNwACT~ for coding.
> NOTE 1: For each entry, one and only one access technology should be
> configured. If the same access technology is configured in more than one
> entry, only the first one should be used by the ME. If no access technology
> is configured in an entry the Operator controlled signal threshold per
> access technology should be ignored by the ME.
\- Operator controlled signal threshold per access technology:
Contents:
\- Operator controlled signal threshold per access technology value for an
access technology.
Coding:
\- Operator controlled signal threshold per access technology value for a
specified access technology is coded on 1 byte using hexadecimal coding. The
Operator controlled signal threshold per access technology value is to be
interpreted as Dezibel Milliwatt (dBm).
NOTE 2: For instance the value \"-105dBm\" is coded as \'69\' in hexadecimal,
the value \"-80dBm\" is coded as \'50\' in hexadecimal. If signal threshold is
configured as \'FF\' then ME shall ignore this value.
NOTE 3: The considered range of the \"Operator controlled signal threshold per
access technology\" is between the cell selection criterion and the high
quality signal defined for an access technology. (see TS 23.122 [31])
Unused bytes shall be set to \'FF\'.
...
+-------------+--------------+---------------------------------------+ | > Services | | | +=============+==============+=======================================+ | > Contents: | Service n°1: | 5G ProSe configuration data for | | | | direct discovery | +-------------+--------------+---------------------------------------+ | | Service n°2: | 5G ProSe configuration data for | | | | direct communication | +-------------+--------------+---------------------------------------+ | | Service n°3: | 5G ProSe configuration data for | | | | UE-to-network relay UE | +-------------+--------------+---------------------------------------+ | | Service n°4: | 5G ProSe configuration data for | | | | remote UE | +-------------+--------------+---------------------------------------+ | | Service n°5: | 5G ProSe configuration data for usage | | | | information reporting | +-------------+--------------+---------------------------------------+ | | Service n°6: | 5G ProSe configuration data for | | | | UE-to-UE relay UE | +-------------+--------------+---------------------------------------+ | | Service n°7: | 5G ProSe configuration data for end | | | | UE | +-------------+--------------+---------------------------------------+
...
> 3GPP TS 24.555 [115].
#### 4.4.13.8 EF~5G_PROSE_U2URU~ (5G ProSe configuration data for UE-to-UE
relay UE)
If service n°139 is \"available\" in the USIM Service Table and service n°6 is
\"available\" in EF~5G_PROSE_ST~, this file shall be present. This EF contains
5G ProSe policy for UE-to-UE relay UE. The format of the 5G ProSe policy for
UE-to-UE relay UE are specified in 3GPP TS 24.555 [115].
+----------------------+----------------------+----------+---------+ | Identifier: \'4F07\' | Structure: | Optional | | | | Transparent | | | +======================+======================+==========+=========+ | SFI: \'07\' | | | | +----------------------+----------------------+----------+---------+ | File size: X bytes | Update activity: low | | | | bytes, (X ≥ 46) | | | | +----------------------+----------------------+----------+---------+ | Access Conditions: | | | | | | | | | | READ PIN | | | | | | | | | | UPDATE ADM | | | | | | | | | | DEACTIVATE ADM | | | | | | | | | | ACTIVATE ADM | | | | +----------------------+----------------------+----------+---------+ | Bytes | Description | M/O | Length | +----------------------+----------------------+----------+---------+ | 1 to X | 5G ProSe | M | X bytes | | | configuration data | | | | | for UE-to-UE relay | | | | | UE TLV objects | | | +----------------------+----------------------+----------+---------+
The 5G ProSe configuration data for UE-to-UE relay UE data object parameters
tags:
* * *
Description Tag Value 5G ProSe configuration data for UE-to-UE relay UE Tag
\'A0\' Validity timer Tag \'85\' Served by NG-RAN Tag \'80\' Not served by NG-
RAN Tag \'81\' Default destination layer-2 IDs for sending the discovery
signalling for announcement and for receiving the discovery signalling for
solicitation Tag \'99\' User info ID for discovery Tag \'8E\' RSC info list
Tag \'8B\' Default destination layer-2 ID(s) for sending or receiving the
direct communication for 5G ProSe UE-to-UE relay communication with integrated
discovery Tag \'9A\'
* * *
The 5G ProSe configuration data for UE-to-UE relay UE contents:
+-------------------------+--------+-----+----------------+ | Description | Value | M/O | Length (bytes) | +-------------------------+--------+-----+----------------+ | 5G ProSe configuration | \'A0\' | M | 1 | | data for UE-to-UE relay | | | | | UE Tag | | | | +-------------------------+--------+-----+----------------+ | Length | Note 1 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Validity timer Tag | \'85\' | M | 1 | +-------------------------+--------+-----+----------------+ | Length | 5 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Validity timer | -- | M | 5 | | information | | | | +-------------------------+--------+-----+----------------+ | Served by NG-RAN Tag | \'80\' | M | 1 | +-------------------------+--------+-----+----------------+ | Length | X1 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Served by NG-RAN | -- | M | X1 | | information | | | | +-------------------------+--------+-----+----------------+ | Not served by NG-RAN | \'81\' | M | 1 | | Tag | | | | +-------------------------+--------+-----+----------------+ | Length | X2 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Not served by NG-RAN | -- | M | X2 | | information | | | | +-------------------------+--------+-----+----------------+ | Default destination | \'99\' | M | 1 | | layer-2 IDs for sending | | | | | the discovery | | | | | signalling for | | | | | announcement and for | | | | | receiving the discovery | | | | | signalling for | | | | | solicitation Tag | | | | +-------------------------+--------+-----+----------------+ | Length | X3 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Default destination | -- | M | X3 | | layer-2 IDs for sending | | | | | the discovery | | | | | signalling for | | | | | announcement and for | | | | | receiving the discovery | | | | | signalling for | | | | | solicitation | | | | | information | | | | +-------------------------+--------+-----+----------------+ | User info ID for | \'8E\' | M | 1 | | discovery Tag | | | | +-------------------------+--------+-----+----------------+ | Length | 6 | M | Note 2 | +-------------------------+--------+-----+----------------+ | User info ID for | -- | M | 6 | | discovery information | | | | +-------------------------+--------+-----+----------------+ | RSC info list Tag | \'8B\' | M | 1 | +-------------------------+--------+-----+----------------+ | Length | X4 | M | Note 2 | +-------------------------+--------+-----+----------------+ | RSC info list | -- | M | X4 | | information | | | | +-------------------------+--------+-----+----------------+ | Default destination | \'9A\' | M | 1 | | layer-2 ID(s) for | | | | | sending or receiving | | | | | the direct | | | | | communication for 5G | | | | | ProSe UE-to-UE relay | | | | | communication with | | | | | integrated discovery | | | | | Tag | | | | +-------------------------+--------+-----+----------------+ | Length | X5 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Default destination | -- | M | X5 | | layer-2 ID(s) for | | | | | sending or receiving | | | | | the direct | | | | | communication for 5G | | | | | ProSe UE-to-UE relay | | | | | communication with | | | | | integrated discovery | | | | | information | | | | +-------------------------+--------+-----+----------------+ | Note 1: This is the | | | | | total size of the | | | | | constructed TLV object. | | | | | | | | | | Note 2: The length is | | | | | coded according to | | | | | ISO/IEC 8825-1 [35]. | | | | +-------------------------+--------+-----+----------------+
\- Validity timer Tag \'85\'
Contents:
> The Validity timer information contains the timer for controlling the
> validity of 5G ProSe configuration data for UE-to-UE relay UE.
Coding:
> The Validity timer information is encoded as shown in figure 5.8.2.1 and
> table 5.8.2.1 of 3GPP TS 24.555 [115].
\- Served by NG-RAN Tag \'80\'
Contents:
> The Served by NG-RAN information contains 5G ProSe configuration data for
> UE-to-UE relay UE when the UE is served by NG-RAN.
Coding:
> The Served by NG-RAN information is encoded as shown in figures 5.8.2.2 to
> 5.8.2.4 and tables 5.8.2.2 to 5.8.2.4 of 3GPP TS 24.555 [115].
\- Not served by NG-RAN Tag \'81\'
Contents:
> The Not served by NG-RAN information contains 5G ProSe configuration data
> for UE-to-UE relay UE when the UE is not served by NG-RAN.
Coding:
> The Not served by NG-RAN information is encoded as shown in figures 5.8.2.5
> to 5.8.2.11a and tables 5.8.2.5 to 5.8.2.11a of 3GPP TS 24.555 [115].
\- Default destination layer-2 IDs for sending the discovery signalling for
announcement and for receiving the discovery signalling for solicitation Tag
\'99\'
Contents:
> The Default destination layer-2 IDs for sending the discovery signalling for
> announcement and for receiving the discovery signalling for solicitation
> information contains the default destination layer-2 IDs for sending the
> discovery signalling for announcement and for receiving the discovery
> signalling for solicitation.
Coding:
> The Default destination layer-2 IDs for sending the discovery signalling for
> announcement and for receiving the discovery signalling for solicitation
> information is encoded as shown in figure 5.8.2.11b and table 5.8.2.11b of
> 3GPP TS 24.555 [115].
\- User info ID for discovery Tag \'8E\'
Contents:
> The User info ID for discovery information contains the user info ID for 5G
> ProSe UE-to-UE relay UE.
Coding:
> The User info ID for discovery information is encoded as shown in figure
> 5.8.2.1 and table 5.8.2.1 of 3GPP TS 24.555 [115].
\- RSC info list Tag \'8B\'
Contents:
> The RSC info list information contains a list of RSCs related parameters.
Coding:
> The RSC info list information is encoded as shown in figures 5.8.2.12 to
> 5.8.2.14 and tables 5.8.2.12 to 5.8.2.14 of 3GPP TS 24.555 [115].
\- Default destination layer-2 ID(s) for sending or receiving the direct
communication for 5G ProSe UE-to-UE relay communication with integrated
discovery Tag \'9A\'
Contents:
> The Default destination layer-2 ID(s) for sending or receiving the direct
> communication for 5G ProSe UE-to-UE relay communication with integrated
> discovery information contains the default destination layer-2 ID(s) for
> sending or receiving the direct communication for 5G ProSe UE-to-UE relay
> communication with integrated discovery.
Coding:
> The Default destination layer-2 ID(s) for sending or receiving the direct
> communication for 5G ProSe UE-to-UE relay communication with integrated
> discovery information is encoded as shown in figure 5.8.2.15 and table
> 5.8.2.15 of 3GPP TS 24.555 [115].
#### 4.4.13.9 EF~5G_PROSE_EU~ (5G ProSe configuration data for end UE)
If service n°139 is \"available\" in the USIM Service Table and service n°7 is
\"available\" in EF~5G_PROSE_ST~, this file shall be present. This EF contains
5G ProSe policy for end UE. The format of the 5G ProSe policy for end UE are
specified in 3GPP TS 24.555 [115].
+----------------------+----------------------+----------+---------+ | Identifier: \'4F08\' | Structure: | Optional | | | | Transparent | | | +======================+======================+==========+=========+ | SFI: \'08\' | | | | +----------------------+----------------------+----------+---------+ | File size: X bytes | Update activity: low | | | | bytes, (X ≥ 46) | | | | +----------------------+----------------------+----------+---------+ | Access Conditions: | | | | | | | | | | READ PIN | | | | | | | | | | UPDATE ADM | | | | | | | | | | DEACTIVATE ADM | | | | | | | | | | ACTIVATE ADM | | | | +----------------------+----------------------+----------+---------+ | Bytes | Description | M/O | Length | +----------------------+----------------------+----------+---------+ | 1 to X | 5G ProSe | M | X bytes | | | configuration data | | | | | for end UE TLV | | | | | objects | | | +----------------------+----------------------+----------+---------+
The 5G ProSe configuration data for end UE data object parameters tags:
* * *
Description Tag Value 5G ProSe configuration data for end UE Tag \'A0\'
Validity timer Tag \'85\' Served by NG-RAN Tag \'80\' Not served by NG-RAN Tag
\'81\' Default destination layer-2 IDs for sending the discovery signalling
for solicitation and for receiving the discovery signalling for announcement
Tag \'9B\' User info ID for discovery Tag \'8E\' RSC info list Tag \'8B\'
Default destination layer-2 ID(s) for sending or receiving the direct
communication for 5G ProSe UE-to-UE relay communication with integrated
discovery Tag \'9A\'
* * *
The 5G ProSe configuration data for end relay UE contents:
+-------------------------+--------+-----+----------------+ | Description | Value | M/O | Length (bytes) | +-------------------------+--------+-----+----------------+ | 5G ProSe configuration | \'A0\' | M | 1 | | data for UE-to-UE relay | | | | | UE Tag | | | | +-------------------------+--------+-----+----------------+ | Length | Note 1 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Validity timer Tag | \'85\' | M | 1 | +-------------------------+--------+-----+----------------+ | Length | 5 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Validity timer | -- | M | 5 | | information | | | | +-------------------------+--------+-----+----------------+ | Served by NG-RAN Tag | \'80\' | M | 1 | +-------------------------+--------+-----+----------------+ | Length | X1 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Served by NG-RAN | -- | M | X1 | | information | | | | +-------------------------+--------+-----+----------------+ | Not served by NG-RAN | \'81\' | M | 1 | | Tag | | | | +-------------------------+--------+-----+----------------+ | Length | X2 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Not served by NG-RAN | -- | M | X2 | | information | | | | +-------------------------+--------+-----+----------------+ | Default destination | \'9B\' | M | 1 | | layer-2 IDs for sending | | | | | the discovery | | | | | signalling for | | | | | solicitation and for | | | | | receiving the discovery | | | | | signalling for | | | | | announcement Tag | | | | +-------------------------+--------+-----+----------------+ | Length | X3 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Default destination | -- | M | X3 | | layer-2 IDs for sending | | | | | the discovery | | | | | signalling for | | | | | solicitation and for | | | | | receiving the discovery | | | | | signalling for | | | | | announcement | | | | | information | | | | +-------------------------+--------+-----+----------------+ | User info ID for | \'8E\' | M | 1 | | discovery Tag | | | | +-------------------------+--------+-----+----------------+ | Length | 6 | M | Note 2 | +-------------------------+--------+-----+----------------+ | User info ID for | -- | M | 6 | | discovery information | | | | +-------------------------+--------+-----+----------------+ | RSC info list Tag | \'8B\' | M | 1 | +-------------------------+--------+-----+----------------+ | Length | X4 | M | Note 2 | +-------------------------+--------+-----+----------------+ | RSC info list | -- | M | X4 | | information | | | | +-------------------------+--------+-----+----------------+ | Default destination | \'9A\' | M | 1 | | layer-2 ID(s) for | | | | | sending or receiving | | | | | the direct | | | | | communication for 5G | | | | | ProSe UE-to-UE relay | | | | | communication with | | | | | integrated discovery | | | | | Tag | | | | +-------------------------+--------+-----+----------------+ | Length | X5 | M | Note 2 | +-------------------------+--------+-----+----------------+ | Default destination | -- | M | X5 | | layer-2 ID(s) for | | | | | sending or receiving | | | | | the direct | | | | | communication for 5G | | | | | ProSe UE-to-UE relay | | | | | communication with | | | | | integrated discovery | | | | | information | | | | +-------------------------+--------+-----+----------------+ | Note 1: This is the | | | | | total size of the | | | | | constructed TLV object. | | | | | | | | | | Note 2: The length is | | | | | coded according to | | | | | ISO/IEC 8825-1 [35]. | | | | +-------------------------+--------+-----+----------------+
\- Validity timer Tag \'85\'
Contents:
> The Validity timer information contains the timer for controlling the
> validity of 5G ProSe configuration data for end UE.
Coding:
> The Validity timer information is encoded as shown in figure 5.9.2.1 and
> table 5.9.2.1 of 3GPP TS 24.555 [115].
\- Served by NG-RAN Tag \'80\'
Contents:
> The Served by NG-RAN information contains 5G ProSe configuration data for
> end UE when the UE is served by NG-RAN.
Coding:
> The Served by NG-RAN information is encoded as shown in figures 5.9.2.2 and
> tables 5.9.2.2 of 3GPP TS 24.555 [115].
\- Not served by NG-RAN Tag \'81\'
Contents:
> The Not served by NG-RAN information contains 5G ProSe configuration data
> for end UE when the UE is not served by NG-RAN.
Coding:
> The Not served by NG-RAN information is encoded as shown in figures 5.9.2.3
> to 5.9.2.9a and tables 5.9.2.3 to 5.9.2.9a of 3GPP TS 24.555 [115].
\- Default destination layer-2 IDs for sending the discovery signalling for
solicitation and for receiving the discovery signalling for announcement Tag
\'9B\'
Contents:
> The Default destination layer-2 IDs for sending the discovery signalling for
> solicitation and for receiving the discovery signalling for announcement
> information contains the default destination layer-2 IDs for sending the
> discovery signalling for solicitation and for receiving the discovery
> signalling for announcement.
Coding:
> The Default destination layer-2 IDs for sending the discovery signalling for
> solicitation and for receiving the discovery signalling for announcement
> information is encoded as shown in figure 5.9.2.9b and table 5.9.2.9b of
> 3GPP TS 24.555 [115].
\- User info ID for discovery Tag \'8E\'
Contents:
> The User info ID for discovery information contains the user info ID for 5G
...
Coding:
> The User info ID for discovery information is encoded as shown in figure
> 5.9.2.1 and table 5.9.2.1 of 3GPP TS 24.555 [115].
\- RSC info list Tag \'8B\'
Contents:
> The RSC info list information contains a list of RSCs related parameters.
Coding:
> The RSC info list information is encoded as shown in figures 5.9.2.10 to
> 5.9.2.12 and tables 5.9.2.10 to 5.9.2.12 of 3GPP TS 24.555 [115].
\- Default destination layer-2 ID(s) for sending or receiving the direct
communication for 5G ProSe UE-to-UE relay communication with integrated
discovery Tag \'9A\'
Contents:
...
> The Default destination layer-2 ID(s) for sending or receiving the direct
> communication for 5G ProSe UE-to-UE relay communication with integrated
> discovery information is encoded as shown in figure 5.9.2.13 and table
> 5.9.2.13 of 3GPP TS 24.555 [115].
### 4.4.14 Contents of files at the DF 5MBS UE pre-configuration level
#### 4.4.14.1 Introduction
This clause describes the additional files that are used for UE pre-
configuration for 5MBS service configuration.
DF~5MBSUECONFIG~ shall be present at the ADF~USIM~ level if service nº147 is
\"available\" in the EF~UST~ (USIM Service Table).
#### 4.4.14.2 EF~5MBSUECONFIG~ (5MBS UE pre-configuration)
If service n°147 is \"available\" in EF~UST~, this file shall be present. This
EF contains the configuration of the parameters related to UE pre-
configuration for 5MBS service.
+----------------------+-----------------------+----------+--------+ | Identifier: \'4F01\' | Structure: | Optional | | | | transparent | | | +======================+=======================+==========+========+ | SFI: Optional | | | | +----------------------+-----------------------+----------+--------+ | File size: ≥ X bytes | Update activity: low | | | +----------------------+-----------------------+----------+--------+ | Access Conditions: | | | | | | | | | | READ ALWAYS | | | | | | | | | | UPDATE ADM | | | | | | | | | | DEACTIVATE ADM | | | | | | | | | | ACTIVATE ADM | | | | +----------------------+-----------------------+----------+--------+ | Bytes | Description | M/O | Length | +----------------------+-----------------------+----------+--------+ | 1 to X | UE pre-configuration | O | X | | | for PLMN 5MBS data | | | | | object | | | +----------------------+-----------------------+----------+--------+
\- UE pre-configuration for PLMN 5MBS data object is coded as follows:
Description value M/O Length
* * *
PLMN 5MBS pre-configuration data object tag 1 \'A0\' O 1 Length L1 O note PLMN
5MBS pre-configuration value 1 O L1 PLMN 5MBS pre-configuration data object
tag 2 \'A0\' O 1 Length L2 O note PLMN 5MBS pre-configuration value 2 O L2 ...  
PLMN 5MBS pre-configuration data object tag N \'A0\' O 1 Length LN O note PLMN
5MBS pre-configuration value N O LN NOTE: The length is coded according to
ISO/IEC 8825-1 [35].
\- PLMN 5MBS pre-configuration data object:
Contents:
* * *
Description M/O PLMN TLV M TMGI List TLV O NR-ARFCN List TLV O
* * *
\- PLMN TLV
Contents:
> As described in 3GPP TS 24.575 [118], the identity of the PLMN for which the
> 5MBS UE pre-configuration service applies.
* * *
Description Value M/O Length (bytes) PLMN TLV Tag \'80\' M 1 Length 3 or 9 M 1
PLMN value --- M 3 or 9
* * *
> The PLMN value is coded:
* * *
1 to 3 PLMN (MCC and MNC) M 3 bytes 4 to 9 NID O 6 bytes
* * *
Coding:
> MCC and MNC according to 3GPP TS 24.008 [9].
>
> NID assignment mode and NID value according to 3GPP TS 24.502 [117] clause
> 9.2.7 octets 3 to 8.
\- TMGI List TLV
Contents:
> List of TMGIs.
Coding:
* * *
Description Value M/O Length (bytes) TMGI List Tag \'81\' M 1 Length 9n M Note
TMGI entry #1 --- M 9 TMGI entry #2 --- O 9 ...  
TMGI entry #n --- O 9 NOTE: The length is coded according to ISO/IEC 8825-1
[35]
* * *
\- TMGI entry
Contents:
...
\- TMGI
Contents:
> The structure of the TMGI is defined in 3GPP TS 23.003 [25].
>
> Coding:
>
> TMGI is coded in 6 bytes:
\- bytes 1 to 3: contain the MBMS Service ID, with the first digit coded in
the most significant nibble of the first byte, and the last digit coded in the
least significant nibble of the third byte (see octets 3 to 5 in the subclause
10.5.6.13 of 3GPP TS 24.008 [9]).
\- bytes 4 to 6: contain the MCC and MNC values of the TMGI, coded as octets 6
to 8 in the subclause 10.5.6.13 of 3GPP TS 24.008 [9].
\- USD File Id
Contents:
> File identifier of the EF~5MBSUEUSD~ inside the DF~5MBSUECONFIG~ containing
> a User Service Description (USD).
Coding:
> According to 3GPP TS 31.101 [11].
\- Service type
Contents:
> Type of service for which the entry is valid.
Coding:
* * *
        b8   b7   b6   b5   b4   b3   b2   b1   
                                                For MBS Service Announcement Service. This is equivalent to an entry in the TMGIListForSA leaf in 3GPP TS 24.575 \[118\].
                                                For MBS User Service. This is equivalent to an entry in the TMGIListForService leaf in 3GPP TS 24.575 \[118\].
                                                RFU
* * *
\- NR-ARFCN List TLV
Contents:
> List of NR-ARFCN value(s) of MBS frequency.
Coding:
* * *
Description Value M/O Length (bytes) NR-ARFCN List Tag \'82\' M 1 Length 4m M
Note NR-ARFCN #1 --- M 4 NR-ARFCN #2 --- O 4 ...  
NR-ARFCN #m --- O 4 NOTE: The length is coded according to ISO/IEC 8825-1 [35]
* * *
Each NR-ARFCN is coded in 4 bytes, as specified in 3GPP TS 38.101-1 [119] and
3GPP TS 38.101-2 [120].
> Unused bytes shall be set to \'FF\'.
#### 4.4.14.3 EF~5MBSUSD~ (5MBS User Service Description)
This file contains the User Service Description (USD) associated with one or
more entries in the EF~5MBSUECONFIG~.
Multiple EF~5MBSUSD~ files may exist in the DF, each one associated with a
different entry in EF~5MBSUECONFIG~.
The ME retrieves this file identifier from the EF~5MBSUECONFIG~.
+----------------------+------------------------+----------+---------+ | Identifier: \'4FXX\' | Structure: transparent | Optional | | +======================+========================+==========+=========+ | File size: ≥ L bytes | Update activity: low | | | +----------------------+------------------------+----------+---------+ | Access Conditions: | | | | | | | | | | READ PIN | | | | | | | | | | UPDATE ADM | | | | | | | | | | DEACTIVATE ADM | | | | | | | | | | ACTIVATE ADM | | | | +----------------------+------------------------+----------+---------+ | Bytes | Description | M/O | Length | +----------------------+------------------------+----------+---------+ | 1 to L | USD TLV data object | M | L bytes | +----------------------+------------------------+----------+---------+
USD TLV data object:
* * *
Description Value M/O/C Length (bytes) USD tag \'80\' M 1 Length X M Note USD
-- M X NOTE: The length is coded according to ISO/IEC 8825-1 [35]
* * *
USD:
Contents:
\- User Service Description (USD).
Coding:
\- According to 3GPP TS 26.346 [99] clause J.1.
> Unused bytes shall be set to \'FF\'.
The identifier \'4FXX\' shall be different from one 5MBS User Service
Description file to another. For the range of \'XX\', see 3GPP TS 31.101 [11].
The value of \'XX\' shall be greater than 7. The length Z may be different
from one 5MBS User Service Description file to another.
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  | EF5G_ProSe_UIR |  | EF5G_ProSe_U2URU '4F07' |  | EF5G_ProSe_EU  
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  | '4F06' |  |  |  | '4F08' |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
...
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  | EF5MBSUECONFIG '4F01' |  | EF5MBSUSD '4FXX' |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
|  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |   
...
### 5.3.54 5MBS UE pre-configuration
Requirement: Service n°147 \"available\".
Request: The ME performs the reading procedure with EF~5MBSUECONFIG~ and any
referenced EF~5MBSUSD.~
...
### 5.17.6 5G ProSe configuration data for UE-to-UE relay UE
Requirement: service n°139 is \"available\" in the USIM Service Table and
service n°6 is \"available\" in the 5G ProSe Service Table.
Request: The ME performs the reading procedure with EF~5G_PROSE_U2URU~.
### 5.17.7 5G ProSe configuration data for end UE
Requirement: service n°139 is \"available\" in the USIM Service Table and
service n°7 is \"available\" in the 5G ProSe Service Table.
Request: The ME performs the reading procedure with EF~5G_PROSE_EU~.
...
## 5.21 SENSE related procedures
### 5.21.1 SENSE parameter related procedure
Requirement: Service n°148 is \"available\".
Request: The ME performs the reading procedure with EF~OCST~.
The ME shall follow the procedures as specified in 3GPP TS 23.122 [31] for the
\"Operator controlled signal threshold per access technology\".
# 6 Security features
