...
Access Network (E UTRAN) to the Core Network of the SAE system.
# 2 References
...
described in [2]. This subclause specifies only the architecture of the S1
...
cell.
### 5.11.4 Delivery of Warning messages
This function provides the capability to start the delivery of warning
notification messages related to alerts (earthquake, tsunami, etc..). ETWS is
the E-UTRAN service related to warning deliveries.
...
Editor\'s Note: Protocol Structure following the structure defined in [2].
## 6.1 General
