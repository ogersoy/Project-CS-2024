...
information (CQI), another for HARQ-ACK (acknowledgement) and scheduling
...
In case one of the transport blocks is disabled as specified in subclause
...
block has previously been transmitted using two layers with open-loop spatial
multiplexing.
...
+--------------+------------------------------------------------------+ | **CFI** | CFI codeword | | | | | | \ | +--------------+------------------------------------------------------+ | 1 | \ | +--------------+------------------------------------------------------+ | 2 | \ | +--------------+------------------------------------------------------+ | 3 | \ | +--------------+------------------------------------------------------+ | 4 (Reserved) | \ | +--------------+------------------------------------------------------+
...
The HARQ indicator is coded according to Table 5.3.5-1, where for a positive
