...
S1AP is developed in accordance to the general principles stated in [2] and
[3].
# 2 References
...
[1].
**CSG Cell** : an E-UTRAN cell broadcasting a CSG Identifier.
...
other interfaces is specified in stage 2 specifications (e.g. [11] and [14]).
...
**eNB UE S1AP ID:** as defined in [2].
**MME UE S1AP ID:** as defined in [2].
**E-RAB: as defined in** [2].
...
E-RAB between a UE and an eNB. There is an one-to-one mapping between the
E-RAB and the Data Radio Bearer.
...
definition in **[23.401]. For a received UE associated S1-AP message the** MME
identifies **the** associated UE based on the **MME UE S1AP ID** IE and
**the** eNB identifies **the** associated UE based on the **_eNB UE S1AP ID_**
IE _._ **The UE-associated logical S1-connection may exist before the S1 UE
context is setup in eNB.**
## 3.2 Symbols
-
## 3.3 Abbreviations
...
MME CONFIGURATION TRANSFER Cell Traffic Trace CELL TRAFFIC TRACE
* * *
...
lower priority E-RAB which is marked as \"pre-emptable\". Whilst the process
...
this E-RAB shall be included in the pre-emption process.
...
unsuccessful establishment e.g.: \"Radio resources not available\", \"Failure
...
should be precise enough to enable the MME to know the reason for an
unsuccessful modification e.g.: \"Radio resources not available\", \"Failure
in the Radio Interface Procedure\".
...
QoS Parameters_ IE which contains a _QCI_ IE indicating a GBR bearer (as
defined in [13]) for a E-RAB previously configured as a non-GBR bearer (as
defined in [13]), and which does not contain the _GBR QoS Information_ IE, the
eNB shall consider the modification of the corresponding E-RAB as failed.
...
UE.
\- pass the value contained in the _E-RAB ID_ IE and the _NAS-PDU_ received
...
UE context and use it as defined in [14].
...
\- store the received Security Key in the UE context and take it into use as
defined in [15].
For the Intial Context Setup an initial value for the Next Hop Chaining Count
...
present in the INITIAL CONTEXT SETUP REQUEST message to determine a target
cell for handover. If the _Handover Restriction List_ IE is not contained in
the INITIAL CONTEXT SETUP REQUEST message, the eNB shall consider that no
roaming area nor access restriction applies to the UE.
...
message and then act as defined in [17].
...
(as defined in [13]), and which does not contain the _GBR QoS Information_ IE,
...
of EEA0 in all UEs [15], do not match any allowed algorithms defined in the
configured list of allowed encryption algorithms in the eNB [15], the eNB
...
Algorithms_ IE in the _UE Security Capabilities_ IE, do not match any allowed
algorithms defined in the configured list of allowed integrity protection
algorithms in the eNB [15] or if **all bits in** _Integrity Protection
Algorithms_ IE **are equal to 0** , the eNB shall reject the procedure using
the INITIAL CONTEXT SETUP FAILURE message.
...
E-UTRAN generated reason (e.g. \"TX2~RELOCOverall~ Expiry\"). The procedure
...
value e.g. \"User Inactivity\", \"Radio Connection With UE Lost\" for the
requested UE-associated logical S1-connection release.
...
initiated the establishment of a new UE-associated logical S1-connection. The
procedure uses UE-associated S1 connection.
...
The MME provides the _cause_ IE set to \"Load Balancing TAU Required\" in the
UE CONTEXT RELEASE COMMAND message sent to the eNB for all load balancing and
...
> with the initial value of NCC as defined in [15].
\- store the _Subscriber Profile ID for RAT/Frequency priority_ IE and use it
as defined in [14].
...
Target RNC Transparent Container_ IE definition as specified in [19] and the
source eNB shall include the _UE History Information_ IE in the _Source RNC to
Target RNC Transparent Container_ IE. If the handover is to GERAN A/Gb mode
then the _Source to Target Transparent Container_ IE shall be encoded
according to the definition of the _Source BSS to Target BSS Transparent
Container_ IE.
...
definition as specified in [19]. In case of inter-system handover to GERAN
A/Gb mode, the _Target to Source Transparent Container_ IE shall be encoded
according to the _Target BSS to Source BSS Transparent Container_ IE
definition as described in [18].
...
\"DL forwarding proposed\", it indicates that the source eNB proposes
...
shall handle it as specified in [11].
The source eNB shall include the _SRVCC HO Indication_ IE in the HANDOVER
REQUIRED message if the SRVCC operation is needed as defined in [9]. The
source eNB shall indicate to the MME in the _SRVCC HO Indication_ IE if the
handover shall be prepared for PS and CS domain or only for CS domain. The
_SRVCC HO Indication_ IE is set according to the target cell capability. In
case the target system is GERAN without DTM HO support, the source eNB shall
indicate CS only in the _SRVCC HO Indication_ IE. Otherwise, the source eNB
shall indicate PS and CS in the _SRVCC HO Indication_ IE. In case of inter-
system handover from E-UTRAN, the source eNB shall indicate in the _Target ID_
IE, in case of inter-system handover to UTRAN, the Target RNC-ID of the RNC,
in case of inter-system handover to GERAN A/Gb mode the Cell Global Identity
(including the Routing Area Code) of the cell in the target system.
...
Container_ IEs and encode the information in the _Source to Target Transparent
Container_ IE according to the definition of the _Old BSS to New BSS
information_ IE as specified in [23].
...
Target BSS Transparent Container_ IE as described in [18]. The second shall be
encoded according to the definition of the _Old BSS to New BSS information_ IE
as specified in [23].
...
Transparent Container_ IE as specified in [19] and the source eNB shall
include the _UE History Information_ IE in the _Source RNC to Target RNC
...
the definition of the _Layer 3 Information_ IE as specified in [23].
In case the SRVCC operation is performed, _SRVCC HO Indication_ IE in the
HANDOVER REQUIRED message indicates that handover shall be prepared for PS and
CS domain, and if
\- the target system is GERAN with DTM HO support, then the corresponding
HANDOVER COMMAND message shall contain the _Target to Source Transparent
Container_ IE and the _Target to Source Transparent Container_ _Secondary_ IE.
The first IE shall be encoded according to the definition of the _Layer 3
Information_ IE as specified in [23]. The second IE shall be encoded according
to the definition of the _Target BSS to Source BSS Transparent Container_ IE
as specified in [18].
...
If the eNB receives some E-RAB ID included in the **_E-RABs Subject to
Forwarding List_** _IE without any associated DL GTP-TEID and DL Transport
Layer Address pair or UL GTP-TEID and UL Transport Layer Address pair, it
shall terminate the procedure as a logical error._
...
List_ IE, which may contain roaming area or access restrictions.
If the _Handover Restriction List_ IE is contained in the HANDOVER REQUEST
message, the target eNB shall store this information in the UE context.
The eNB shall use the information in _Handover Restriction List_ IE if present
in the HANDOVER REQUEST message to determine a target cell for handover. If
the _Handover Restriction List_ IE is not contained in the HANDOVER REQUEST
message, the target eNB shall consider that no access restriction applies to
the UE.
...
the UE context and use it as defined in [9].
...
derive the security configuration as specified in [15]
...
context and use it as defined in [14].
...
forwarding_ IE is set to \"DL forwarding proposed\", the target eNB may
include the _DL GTP-TEID IE_ and the _DL Transport Layer Address_ IE IE within
the _E-RABs Admitted List IEs_ IE of the HANDOVER REQUEST ACKNOWLEDGE message
indicating that it accepts the proposed forwarding of downlink data for this
bearer.
...
If the target eNB receives a HANDOVER REQUEST message containing RRC Container
IE that does not include required information as specified in [16], the target
eNB shall send the HANDOVER FAILURE message to the MME.
...
in [13]), and which does not contain the _GBR QoS Information_ IE, the eNB
shall not admit the corresponding E-RAB.
...
of EEA0 in all UEs [15], do not match any allowed algorithms defined in the
configured list of allowed encryption algorithms in the eNB [15], the eNB
shall reject the procedure using the HANDOVER FAILURE message.
If the supported algorithms for integrity defined in the _Integrity Protection
Algorithms_ IE in the _UE Security Capabilities_ IE, do not match any allowed
algorithms defined in the configured list of allowed integrity protection
algorithms in the eNB [15] or if **all bits in** _Integrity Protection
...
use it for the next X2 handover or Intra eNB handovers as specified in [15].
...
subsequent actions and the MME to behave as described in [11].
...
eNB shall use it according to [20].
The Allowed CSG ID List of the paged UE (_CSG Id List_ IE) may be included in
the PAGING message if respective subscription information is available for
that UE. If present, the E-UTRAN shall, if possible, avoid to send paging UEs
within CSG cells for which the UE has no subscription.
...
The eNB shall use the information in _Handover Restriction List_ IE if present
in the DOWNLINK NAS TRANSPORT message to determine a target cell for handover.
...
information, the eNB shall consider that no access restriction applies to the
UE.
...
e.g. \"Unknown MME UE S1AP ID\", \"Unknown eNB UE S1AP\" or \"Unknown pair of
UE S1AP ID\".
...
If the S1 SETUP FAILURE messages include the _Time To Wait_ IE the eNB shall
...
If the MME receives the _CDMA2000 HO Required Indication_ IE set to \"true\"
in UPLINK S1 CDMA2000 TUNNELING message the MME should send the necessary
...
shall forward the received information to the CDMA2000 1xRTT RAT. The MME
shall forward the received _CDMA2000 Sector ID_ IE and _CDMA2000-PDU_ IE to
the proper destination node in the CDMA2000 RAT.
**Interactions with E-RAB Management procedures:**
...
appropriate cause value e.g. \"S1 intra system Handover Triggered\", \"S1
inter system Handover Triggered\" to the MME.
...
Address pair in the DOWNLINK S1 CDMA2000 TUNNELING message, it shall terminate
the procedure as a logical error.
...
message to the eNB as described in [10].
...
order to inform the MME that a Location Reporting Control procedure has
failed. The procedure uses UE-associated signalling.
...
#### 8.12.1.1 General
The purpose of Write-Replace Warning procedure is to start and overwrite the
...
warning message being broadcast, the eNB shall replace the warning message
being broadcast with the newly received one for that area.
...
process the Primary Notification according to [16].
...
included in the WRITE-REPLACE WARNING REQUEST message, the eNB shall broadcast
the Secondary Notification according to the value of the _Repetition Period_
IE and _Number of Broadcasts Requested_ IE and process the Secondary
Notification according to [16].
The eNB ends the procedure by sending a WRITE-REPLACE WARNING RESPONSE to the
MME.
...
If a value \"0\" is received in the _Number of Broadcast Requested_ IE, the
eNB shall not broadcast the received warning message.
If a value \"0\" is received in the _Repetition Period_ IE, the eNB shall not
...
transferred by the core network.
...
Request_ IE set to \"X2 TNL Configuration Info\", it may transfer back the
requested information towards the eNB indicated in _the Source eNB-ID_ IE of
the _SON Configuration Transfer_ IE by initiating the eNB Configuration
Transfer procedure.
If the eNB receives the _SON Information_ IE containing the _SON Information
Reply_ IE containing the X2 transport layer addresses as an answer to a former
request, it may use it to initiate the X2 TNL establishment.
...
Direction: eNB → MME
+---------+---------+---------+---------+---------+---------+---------+ | I | P | Range | IE type | Se | Crit | A | | E/Group | resence | | and | mantics | icality | ssigned | | Name | | | re | desc | | Crit | | | | | ference | ription | | icality | +---------+---------+---------+---------+---------+---------+---------+ | Message | M | | 9.2.1.1 | | YES | reject | | Type | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | **MME | M | | 9.2.3.3 | | YES | ignore | | UE S1AP | | | | | | | | ID** | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | **eNB | M | | 9.2.3.4 | | YES | ignore | | UE S1AP | | | | | | | | ID** | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | * | O |
ID** | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | > ** | O | | 9.2.3.4 | | -- | -- | | >>eNB | | | | | | | | > UE | | | | | | | | > S1AP | | | | | | | | > ID** | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | Crit | O | | 9 | | YES | ignore | | icality | | | .2.1.21 | | | | | Diag | | | | | | | | nostics | | | | | | | +---------+---------+---------+---------+---------+---------+---------+
* * *
Range bound Explanation maxnoofIndividualS1ConnectionsToReset Maximum no. of
UE-associated logical S1-connections allowed to reset in one message. Value is
256.
...
Direction: eNB → MME
+---------+---------+---------+---------+---------+---------+---------+ | I | P | Range | IE type | Se | Crit | A | | E/Group | resence | | and | mantics | icality | ssigned | | Name | | | re | desc | | Crit | | | | | ference | ription | | icality | +---------+---------+---------+---------+---------+---------+---------+ | Message | M | | 9.2.1.1 | | YES | reject | | Type | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | * | M | | 9 | | YES | reject | | _Global | | | .2.1.37 | | | | | eNB | | | | | | | | ID_ * | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | eNB | O | | Printab | | YES | ignore | | Name | | | leStrin | | | | | | | | g(1..15 | | | | | | | | 0,...) | | | | +---------+---------+---------+---------+---------+---------+---------+ | Su | | 1..\ | | Su | GLOBAL | reject | | pported | |  | | TAs in | | | | | | | | the eNB | | | +---------+---------+---------+---------+---------+---------+---------+ | > >TAC | M | | 9.2.3.7 | Broa | - | | | | | | | dcasted | | | | | | | | TAC | | | +---------+---------+---------+---------+---------+---------+---------+ | > >Br | | 1..\ PLMNs | | PLMNs> | | PLMNs | | | +---------+---------+---------+---------+---------+---------+---------+ | > \ | M | | 9.2.3.8 | | | | | >>PLMN | | | | | | | | > I | | | | | | | | dentity | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | CSG Id | | 0 to \ | | | | | +---------+---------+---------+---------+---------+---------+---------+ | > >CSG | M | | 9 | | | | | > Id | | | .2.1.62 | | | | +---------+---------+---------+---------+---------+---------+---------+ | Default | M | | 9 | | YES | ignore | | paging | | | .2.1.16 | | | | | DRX | | | | | | | +---------+---------+---------+---------+---------+---------+---------+
* * *
...
* * *
IE/Group Name Presence Range IE type and reference Semantics description
Criticality Assigned Criticality Message Type M 9.2.1.1 YES reject MME Name O
PrintableString(1..150,...) YES ignore Served GUMMEIs 1..\ The
LTE related pool configuration is included on the first place in the list.
GLOBAL reject >Served PLMNs 1..\ \-  
>>PLMN Identity M 9.2.3.8 -  
>Served GroupIDs 1..\ \-  
>>MME Group ID M OCTET STRING (2) -  
>Served MMECs 1..\ \-  
>>MME Code M 9.2.3.12 -  
Relative MME Capacity M 9.2.3.17 YES ignore Criticality Diagnostics O 9.2.1.21
YES ignore
* * *
* * *
...
association.
Direction: eNB → MME
+---------+---------+---------+---------+---------+---------+---------+ | I | P | Range | IE type | Se | Crit | A | | E/Group | resence | | and | mantics | icality | ssigned | | Name | | | re | desc | | Crit | | | | | ference | ription | | icality | +---------+---------+---------+---------+---------+---------+---------+ | Message | M | | 9.2.1.1 | | YES | reject | | Type | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | eNB | O | | Printab | | YES | ignore | | Name | | | leStrin | | | | | | | | g(1..15 | | | | | | | | 0,...) | | | | +---------+---------+---------+---------+---------+---------+---------+ | Su | | 0..\ | | Su | GLOBAL | reject | | pported | |  | | TAs in | | | | | | | | the eNB | | | +---------+---------+---------+---------+---------+---------+---------+ | \>TAC | M | | 9.2.3.7 | Broa | \\- | | | | | | | dcasted | | | | | | | | PLMNs | | | +---------+---------+---------+---------+---------+---------+---------+ | > >Br | | 1..\ PLMNs | | PLMNs> | | edPLMNs | | | +---------+---------+---------+---------+---------+---------+---------+ | > \ | M | | 9.2.3.8 | | - | | | >>PLMN | | | | | | | | > I | | | | | | | | dentity | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | CSG Id | | 0 to \ | | | | | +---------+---------+---------+---------+---------+---------+---------+ | > >CSG | M | | 9 | | | | | > Id | | | .2.1.62 | | | | +---------+---------+---------+---------+---------+---------+---------+ | Default | O | | 9 | | YES | ignore | | paging | | | .2.1.16 | | | | | DRX | | | | | | | +---------+---------+---------+---------+---------+---------+---------+
* * *
Range bound Explanation maxnoofTACs Maximum no. of TACs. Value is 256.
...
IE/Group Name Presence Range IE type and reference Semantics description
Criticality Assigned Criticality Message Type M 9.2.1.1 YES reject MME Name O
PrintableString(1..150,...) YES ignore Served GUMMEIs 0..\ The
LTE related pool configuration is included on the first place in the list.
GLOBAL reject >Served PLMNs 1..\ \-  
>>PLMN Identity M 9.2.3.8 -  
>Served GroupIDs 1..\ \-  
>>MME GroupID M OCTET STRING (2) -  
>Served MMECs 1..\ \-  
>>MME Code M 9.2.3.12 - - Relative MME Capacity O 9.2.3.17 YES reject
* * *
* * *
Range bound Explanation maxnoofPLMNsPer MME Maximum no. of PLMNs per MME.
Value is 32. maxnoofRATs Maximum no. of RATs. Value is 8. maxnoofGroupIDs
...
Direction: MME → eNB
+---------+---------+---------+---------+---------+---------+---------+ | I | P | Range | IE type | Se | Crit | A | | E/Group | resence | | and | mantics | icality | ssigned | | Name | | | re | desc | | Crit | | | | | ference | ription | | icality | +---------+---------+---------+---------+---------+---------+---------+ | Message | M | | 9.2.1.1 | | YES | ignore | | Type | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | **MME | M | | 9.2.3.3 | | YES | reject | | UE S1AP | | | | | | | | ID** | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | **eNB | M | | 9.2.3.4 | | YES | reject | | UE S1AP | | | | | | | | ID** | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | * | O | | | | YES | ignore | | _E-RABs | | | | | | | | Subject | | | | | | | | to | | | | | | | | For | | | | | | | | warding | | | | | | | | List_ _| | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | > __\ | |__1 to | | | EACH | ignore | | >E-RABs | | \ | | maxnoof | | | | | | Subject | | E-R | | | | | | > to | | ABs>__| | | | | | > For | | | | | | | | warding | | | | | | | | > Item | | | | | | | | > IEs_ _| | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | > > | M | | 9.2.1.2 | | - | | | >E-RAB | | | | | | | | > ID | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | > | O | | 9.2.2
| | | E-RAB Modify, | | | | | | E-RAB Release, | | | | | | E-RAB Release | | | | | | Indication, | | | | | | Initial | | | | | | Context Setup, | | | | | | Paging, | | | | | | Downlink NAS | | | | | | transport, | | | | | | Initial UE | | | | | | Message, | | | | | | Uplink NAS | | | | | | transport, | | | | | | Reset, Error | | | | | | Indication, | | | | | | NAS Non | | | | | | Delivery | | | | | | Indication, S1 | | | | | | Setup, UE | | | | | | Context | | | | | | Release | | | | | | Request , UE | | | | | | Context | | | | | | Release, | | | | | | Downlink S1 | | | | | | CDMA2000 | | | | | | Tunneling, | | | | | | Uplink S1 | | | | | | CDMA2000 | | | | | | Tunneling; UE | | | | | | Context | | | | | | Modification, | | | | | | UE Capability | | | | | | Info | | | | | | Indication, | | | | | | eNB Status | | | | | | Transfer, MME | | | | | | Status | | | | | | Transfer, | | | | | | Deactivate | | | | | | Trace, Trace | | | | | | Start, Trace | | | | | | Failure | | | | | | Indication, | | | | | | eNB | | | | | | Configuration | | | | | | Update, MME | | | | | | Configuration | | | | | | Update, | | | | | | Location | | | | | | Reporting | | | | | | Control, | | | | | | Location | | | | | | Reporting | | | | | | Failure | | | | | | Indication, | | | | | | Location | | | | | | Report, | | | | | | Overload | | | | | | Start, | | | | | | Overload Stop, | | | | | | Private | | | | | | Message, | | | | | | Write-Replace | | | | | | Warning, eNB | | | | | | Direct | | | | | | Information | | | | | | Transfer, MME | | | | | | Direct | | | | | | Information | | | | | | Transfer, Cell | | | | | | Traffic Trace, | | | | | | eNB | | | | | | Configuration | | | | | | Transfer, MME | | | | | | Configuration | | | | | | Transfer, ...) | | +----------------+----------+-------+----------------+----------------+ | > >Type of | M | | CHOICE | | | > Message | | | (Initi | | | | | | ating Message, | | | | | | Succe | | | | | | ssful Outcome, | | | | | | Unsucce | | | | | | ssful Outcome, | | | | | | ...) | | +----------------+----------+-------+----------------+----------------+
#### 9.2.1.2 E-RAB ID
...
triggered The action is due to a CS fallback that has been triggered UE Not
Available for PS Service The action is requested due to a Cell Change Order
that has been triggered Radio resources not available No requested radio
resources are available Invalid QoS combination The action was failed because
of invalid QoS combination. Inter-RAT Redirection The release is requested due
to inter-RAT redirection. Failure in the Radio Interface Procedure Radio
interface procedure has failed Interaction with other procedure The action is
due to an ongoing interaction with another procedure Unknown E-RAB ID The
action failed because the E-RAB ID is unknown in the eNB Multiple E-RAB ID
Instances The action failed because multiple instance of the same E-RAB had
been provided to the eNB Encryption and/or integrity protection algorithms not
supported The eNB is unable to support any of the encryption and/or integrity
protection algorithms supported by the UE. S1 Intra system Handover triggered
The action is due to a S1 intra system handover that has been triggered. S1
Inter system Handover triggered The action is due to a S1 inter system
handover that has been triggered. X2 Handover triggered The action is due to
an X2 handover that has been triggered. Redirection towards 1xRTT The release
is requested due to redirection towards a 1xRTT system. Not supported QCI
Value The E-RAB setup failed because the requested QCI is not supported.
* * *
* * *
...
of the Establishment Cause IE defined in [16]
...
+---------+---------+-------+---------+---------+---------+---------+ | I | P | Range | IE type | Se | Crit | A | | E/Group | resence | | and | mantics | icality | ssigned | | Name | | | re | desc | | Crit | | | | | ference | ription | | icality | +---------+---------+-------+---------+---------+---------+---------+
| | | | | | +---------+---------+-------+---------+---------+---------+---------+
...
+---------+---------+---------+---------+---------+---------+---------+ | I | P | Range | IE type | Se | Crit | A | | E/Group | resence | | and | mantics | icality | ssigned | | Name | | | re | desc | | Crit | | | | | ference | ription | | icality | +---------+---------+---------+---------+---------+---------+---------+ | RRC | M | | OCTET | I | - | - | | Co | | | STRING | ncludes | | | | ntainer | | | | the RRC | | | | | | | | H | | | | | | | | andover | | | | | | | | Prep | | | | | | | | aration | | | | | | | | Info | | | | | | | | rmation | | | | | | | | message | | | | | | | | as | | | | | | | | defined | | | | | | | | in | | | | | | | | su | | | | | | | | bclause | | | | | | | | 10.2.2 | | | | | | | | of | | | | | | | | [16]. | | | +---------+---------+---------+---------+---------+---------+---------+ | Target | M | | E-UTRAN | | - | - | | Cell ID | | | CGI | | | | | | | | | | | | | | | | 9 | | | | | | | | .2.1.38 | | | | +---------+---------+---------+---------+---------+---------+---------+ | Sub | O | | 9 | | - | - | | scriber | | | .2.1.39 | | | | | Profile | | | | | | | | ID for | | | | | | | | RAT/Fr | | | | | | | | equency | | | | | | | | p | | | | | | | | riority | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | E-RABs | O | | | | | | | Info | | | | | | | | rmation | | | | | | | | List | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | \ | | **1 to | | | EACH | ignore | | >E-RABs | | \** | | | | | +---------+---------+---------+---------+---------+---------+---------+ | > | M | | 9.2.1.2 | | - | - | | >E-RAB | | | | | | | | ID | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | >>DL | O | | 9 | | - | - | | For | | | .2.3.14 | | | | | warding | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | **UE | M | | 9 | | - | - | | History | | | .2.1.42 | | | | | Inform | | | | | | | | ation** | | | | | | | +---------+---------+---------+---------+---------+---------+---------+
* * *
Range bound Explanation maxnoofE-RABs Maximum no. of E-RABs for one UE. Value
is 256.
* * *
...
E-UTRA Handover Command message as defined in subclause 10.2.2 of [16]. - -
* * *
...
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE type and | Semantics | | | | | reference | description | +----------------+----------+-------+----------------+----------------+ | **E-RAB Level | | | | | | QoS | | | | | | Parameters** | | | | | +----------------+----------+-------+----------------+----------------+ | >QCI | M | | INTEGER | QoS Class | | | | | (0..255) | Identifier | | | | | | defined in | | | | | | [11]. | | | | | | | | | | | | Coding | | | | | | specified in | | | | | | [13] | +----------------+----------+-------+----------------+----------------+ | > >Allocation | M | | 9.2.1.60 | | | > and | | | | | | > Retention | | | | | | > Priority | | | | | +----------------+----------+-------+----------------+----------------+ | > >GBR QoS | O | | 9.2.1.18 | This IE | | > Information | | | | applies to GBR | | | | | | bearers only | | | | | | and shall be | | | | | | ignored | | | | | | otherwise. | +----------------+----------+-------+----------------+----------------+
#### 9.2.1.16 Paging DRX
This IE indicates the Paging DRX as defined in [20].
* * *
IE/Group Name Presence Range IE type and reference Semantics description
...
downlink and uplink.
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE type and | Semantics | | | | | reference | description | +----------------+----------+-------+----------------+----------------+ | > E-RAB | M | | Bit Rate | **Desc**.: | | > Maximum Bit | | | 9.2.1.19 | This IE | | > Rate | | | | indicates the | | > Downlink | | | | maximum | | | | | | downlink E-RAB | | | | | | Bit Rate (i.e. | | | | | | from the EPC | | | | | | to E-UTRAN) | | | | | | for this | | | | | | bearer. | +----------------+----------+-------+----------------+----------------+ | > E-RAB | M | | Bit Rate | **Desc**.: | | > Maximum Bit | | | 9.2.1.19 | This IE | | > Rate Uplink | | | | indicates the | | | | | | maximum uplink | | | | | | E-RAB Bit Rate | | | | | | (i.e. from the | | | | | | E-UTRAN to the | | | | | | EPC) for this | | | | | | bearer. | +----------------+----------+-------+----------------+----------------+ | E-RAB | M | | Bit Rate | **Desc**.: | | Guaranteed Bit | | | 9.2.1.19 | This IE | | Rate Downlink | | | | indicates the | | | | | | downlink | | | | | | guaranteed | | | | | | E-RAB Bit Rate | | | | | | (provided that | | | | | | there is data | | | | | | to deliver) | | | | | | from the EPC | | | | | | to the E-UTRAN | | | | | | for this | | | | | | bearer. | +----------------+----------+-------+----------------+----------------+ | > E-RAB | M | | Bit Rate | **Desc**.: | | > Guaranteed | | | 9.2.1.19 | This IE | | > Bit Rate | | | | indicates the | | > Uplink | | | | uplink | | | | | | guaranteed | | | | | | E-RAB Bit Rate | | | | | | (provided that | | | | | | there is data | | | | | | to deliver) | | | | | | from the | | | | | | E-UTRAN to the | | | | | | EPC for this | | | | | | bearer | +----------------+----------+-------+----------------+----------------+
#### 9.2.1.19 Bit Rate
...
MME to the eNB.
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE type and | Semantics | | | | | reference | description | +----------------+----------+-------+----------------+----------------+ | **UE Aggregate | | | |** Desc**.: | | Maximum Bit | | | | | | Rate** | | | | Applicable for | | | | | | non-GBR E-RABs | +----------------+----------+-------+----------------+----------------+ | > >UE | M | | Bit Rate | **Desc**.: | | > Aggregate | | | 9.2.1.19 | This IE | | > Maximum Bit | | | | indicates the | | > Rate | | | | UE Aggregate | | > Downlink | | | | Maximum Bit | | | | | | Rate in the | | | | | | downlink | | | | | | direction | +----------------+----------+-------+----------------+----------------+ | > >UE | M | | Bit Rate | **Desc**.: | | > Aggregate | | | 9.2.1.19 | This IE | | > Maximum Bit | | | | indicates the | | > Rate Uplink | | | | UE Aggregate | | | | | | Maximum Bit | | | | | | Rate in the | | | | | | uplink | | | | | | direction | +----------------+----------+-------+----------------+----------------+
...
section 10).
+-------------+----------+-------------+-------------+-------------+ | IE/Group | Presence | Range | IE type and | Semantics | | Name | | | reference | description | +-------------+----------+-------------+-------------+-------------+ | > Procedure | O | | INTEGER | Procedure | | > Code | | | (0..255) | Code is to | | | | | | be used if | | | | | | Criticality | | | | | | Diagnostics | | | | | | is part of | | | | | | Error | | | | | | Indication | | | | | | procedure, | | | | | | and not | | | | | | within the | | | | | | response | | | | | | message of | | | | | | the same | | | | | | procedure | | | | | | that caused | | | | | | the error | +-------------+----------+-------------+-------------+-------------+ | > | O | | ENUMERATED | The | | Triggering | | | (initiating | Triggering | | > Message | | | message, | Message is | | | | | successful | used only | | | | | outcome, | if the | | | | | u | Criticality | | | | | nsuccessful | Diagnostics | | | | | outcome) | is part of | | | | | | Error | | | | | | Indication | | | | | | procedure. | +-------------+----------+-------------+-------------+-------------+ | > Procedure | O | | ENUMERA | This | | > | | | TED(reject, | Procedure | | Criticality | | | ignore, | Criticality | | | | | notify) | is used for | | | | | | reporting | | | | | | the | | | | | | Criticality | | | | | | of the | | | | | | Triggering | | | | | | message | | | | | | ( | | | | | | Procedure). | +-------------+----------+-------------+-------------+-------------+ | > ** | | 0 to | | | | Information | | \ Element | | errors> | | | | > | | | | | | Criticality | | | | | | > Di | | | | | | agnostics** | | | | | +-------------+----------+-------------+-------------+-------------+ | > >IE | M | | ENUMERA | The IE | | > | | | TED(reject, | Criticality | | Criticality | | | ignore, | is used for | | | | | notify) | reporting | | | | | | the | | | | | | criticality | | | | | | of the | | | | | | triggering | | | | | | IE. The | | | | | | value | | | | | | \'ignore\' | | | | | | shall not | | | | | | be used. | +-------------+----------+-------------+-------------+-------------+ | > >IE ID | M | | INTEGER | The IE ID | | | | | (0..65535) | of the not | | | | | | understood | | | | | | or missing | | | | | | IE | +-------------+----------+-------------+-------------+-------------+ | > >Type of | M | | ENU | | | > Error | | | MERATED(not | | | | | | understood, | | | | | | missing, | | | | | | ...) | | +-------------+----------+-------------+-------------+-------------+
* * *
...
This IE defines area roaming or access restrictions for handover. If the eNB
receives the Handover Restriction List, it shall overwrite previously received
restriction information.
+-------------+-------------+-------------+-------------+-------------+ | > | * | **Range** | **IE type |** Semantics | | **IE/Group | *Presence** | | and | de | | > Name**| | | reference** | scription**| +-------------+-------------+-------------+-------------+-------------+ | > **Serving | **M** | | **9.2.3.8** | | | > PLMN**| | | | | +-------------+-------------+-------------+-------------+-------------+ | > * | | 0..\ | | PLMNs in | | > PLMNs** | | | | addition to | | | | | | Serving | | | | | | PLMN.**| | | | | | | | | | | | This list | | | | | | corresponds | | | | | | to the list | | | | | | of | | | | | | \ | | | | | | "equivalent | | | | | | PLMNs\" as | | | | | | defined in | | | | | | [TS | | | | | | 24.008]. | +-------------+-------------+-------------+-------------+-------------+ | > **>PLMN | M | | 9.2.3.8 | | | > | | | | | | Identity**| | | | | +-------------+-------------+-------------+-------------+-------------+ | > | | 0..\ TAs** | | NsPlusOne> | | res | | | | | | trictions**| +-------------+-------------+-------------+-------------+-------------+ | > **>PLMN | M | | 9.2.3.8 | The PLMN of | | > | | | | forbidden | | Identity**| | | | TACs | +-------------+-------------+-------------+-------------+-------------+ | > ** | | 1..\Forbidden | | fForbTACs\> | | | | > TACs** | | | | | +-------------+-------------+-------------+-------------+-------------+ | > | M | | 9.2.3.7 | The TAC of | | **> >TAC** | | | | the | | | | | | forbidden | | | | | | TAI | +-------------+-------------+-------------+-------------+-------------+ | > | | 0..\ LAs** | | NsPlusOne> | | RAT roaming | | | | | | res | | | | | | trictions**| +-------------+-------------+-------------+-------------+-------------+ | > **>PLMN | M | | 9.2.3.8 | | | > | | | | | | Identity**| | | | | +-------------+-------------+-------------+-------------+-------------+ | > ** | | 1..\Forbidden | | fForbLACs\> | | | | > LACs** | | | | | +-------------+-------------+-------------+-------------+-------------+ | > | M | | OCTET | | | **> >LAC** | | | STRING(2) | | +-------------+-------------+-------------+-------------+-------------+ | > | O | | ENUM | * | | **Forbidden | | | ERATED(ALL, | *inter-3GPP | | > inter | | | GERAN, | and 3GPP2 | | > RATs** | | | UTRAN, | RAT access | | | | | CDMA2000, | res | | | | | ...) | trictions** | +-------------+-------------+-------------+-------------+-------------+
* * *
...
Sector ID as specified in 3GPP2 C.S0024 [27]. If the RAT type is 1x RTT, this
IE is encoded as the Reference Cell ID IE in 3GPP2 A.S0008 [25].
* * *
...
provided for 1-hop security, see [15].**
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE Type and | Semantics | | | | | Reference | Description | +----------------+----------+-------+----------------+----------------+ | Next Hop | M | | INTEGER (0..7) | Next Hop | | Chaining Count | | | | Chaining | | | | | | Counter (NCC) | | | | | | defined in | | | | | | [15]. For | | | | | | inter-RAT | | | | | | Handover into | | | | | | LTE the _Next | | | | | | Hop Chaining | | | | | | Count_ IE | | | | | | takes the | | | | | | value defined | | | | | | for NCC at | | | | | | initial setup, | | | | | | i.e. _Next Hop | | | | | | Chaining | | | | | | Count_ IE = | | | | | | \"0\". | +----------------+----------+-------+----------------+----------------+ | Next-Hop NH | M | | 9.2.1.41 | The NH | | | | | | together with | | | | | Security Key | the NCC is | | | | | | used to derive | | | | | | the security | | | | | | configuration | | | | | | as defined in | | | | | | [15]. For | | | | | | inter RAT | | | | | | Handover the | | | | | | _Next-Hop NH_ | | | | | | IE is the KeNB | | | | | | to be used in | | | | | | the new | | | | | | configuration. | +----------------+----------+-------+----------------+----------------+
...
UERadioAccessCapabilityInformation message as defined in 10.2.2 of [16]
* * *
...
to send certain handover preparation information [8] to the CDMA2000 RAT.
(true, ...)
* * *
#### 9.2.1.30 1xRTT MEID
Void.
...
to the 1xCS IWS [8] and is transparent to MME.
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE type and | Semantics | | | | | reference | description | +----------------+----------+-------+----------------+----------------+ | CDMA2000 1xRTT | M | | OCTET STRING | This IE is a | | RAND | | | | Random | | | | | | Challenge that | | | | | | is used for | | | | | | authentication | | | | | | of UE during | | | | | | 1xCS | | | | | | registration, | | | | | | or handover | | | | | | from E-UTRAN | | | | | | to CDMA2000 | | | | | | 1xRTT RAT. | | | | | | | | | | | | This IE is | | | | | | coded as the | | | | | | RAND (32bits) | | | | | | of the | | | | | | Authentication | | | | | | Challenge | | | | | | Parameter | | | | | | (RAND) in | | | | | | [25]. | +----------------+----------+-------+----------------+----------------+
...
IE/Group Name Presence Range IE Type and Reference Semantics Description
**Request Type**  
**>** Event M ENUMERATED(Direct, Change of service cell, Stop Change of
service cell)  
...
+---------+---------+---------+---------+---------+---------+---------+ | **I |** Pre | Range | **IE |** Se | * | **A | | E/Group | sence** | | type | mantics | _Critic | ssigned | | Name_ _| | | and | descri | ality_ _| Critic | | | | | refe | ption_ _| | ality_ _| | | | | rence_ _| | | | +---------+---------+---------+---------+---------+---------+---------+ | > | | 1 to | | | EACH | ignore | | __E-RAB | | \  List | | maxnoof | | | | | | > | | E | | | | | | Item_* | | -RABs> | | | | | +---------+---------+---------+---------+---------+---------+---------+ | > | M | | 9.2.1.2 | | -- | -- | | >E-RAB | | | | | | | | > ID | | | | | | | +---------+---------+---------+---------+---------+---------+---------+ | > | M | | 9.2.1.3 | | -- | -- | | >Cause | | | | | | | +---------+---------+---------+---------+---------+---------+---------+
* * *
Range bound Explanation maxnoofE-RABs Maximum no. of E-RAB allowed towards one
UE, the maximum value is 256.
* * *
...
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE type and | Semantics | | | | | reference | description | +----------------+----------+-------+----------------+----------------+ | PLMN Identity | M | | 9.2.3.8 | | +----------------+----------+-------+----------------+----------------+ | CHOICE _eNB | M | | | | | ID_ | | | | | +----------------+----------+-------+----------------+----------------+ | > _> Macro eNB | | | BIT STRING | Equal to the | | > ID_ | | | (20) | 20 leftmost | | | | | | bits of the | | | | | | _Cell | | | | | | Identity_ IE | | | | | | contained in | | | | | | the _E-UTRAN | | | | | | CGI_ IE (see | | | | | | section | | | | | | 9.2.1.38) of | | | | | | each cell | | | | | | served by the | | | | | | eNB | +----------------+----------+-------+----------------+----------------+ | > _> Home eNB | | | BIT STRING | Equal to the | | > ID_ | | | (28) | _Cell | | | | | | Identity_ IE | | | | | | contained in | | | | | | the _E-UTRAN | | | | | | CGI_ IE (see | | | | | | section | | | | | | 9.2.1.38) of | | | | | | the cell | | | | | | served by the | | | | | | eNB | +----------------+----------+-------+----------------+----------------+
#### 9.2.1.38 E-UTRAN CGI
This information element is used to globally identify a cell (see [2]).
* * *
...
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE Type and | Semantics | | | | | Reference | Description | +----------------+----------+-------+----------------+----------------+ | **UE Security | | | | | | Capabilities** | | | | | +----------------+----------+-------+----------------+----------------+ | **> Encryption | M | | BIT STRING | Each position | | Algorithms** | | | (16, ...) | in the bitmap | | | | | | represents an | | | | | | encryption | | | | | | algorithm: | | | | | | | | | | | | \"all bits | | | | | | equal to 0\" - | | | | | | UE supports no | | | | | | other | | | | | | algorithm than | | | | | | EEA0 | | | | | | | | | | | | \"first bit\" | | | | | | - 128-EEA1, | | | | | | | | | | | | \"second bit\" | | | | | | - 128-EEA2, | | | | | | other bits | | | | | | reserved for | | | | | | future use. | | | | | | Value '1' | | | | | | indicates | | | | | | support and | | | | | | value \'0\' | | | | | | indicates no | | | | | | support of the | | | | | | algorithm. | | | | | | | | | | | | Algorithms are | | | | | | defined in | | | | | | [15] | +----------------+----------+-------+----------------+----------------+ | **> Integrity | M | | BIT STRING | Each position | | Protection | | | (16, ...) | in the bitmap | | Algorithms** | | | | represents an | | | | | | integrity | | | | | | protection | | | | | | algorithm: | | | | | | | | | | | | \"first bit\" | | | | | | - 128-EIA1, | | | | | | | | | | | | \"second bit\" | | | | | | - 128-EIA2, | | | | | | | | | | | | other bits | | | | | | reserved for | | | | | | future use. | | | | | | | | | | | | Value '1' | | | | | | indicates | | | | | | support and | | | | | | value \'0\' | | | | | | indicates no | | | | | | support of the | | | | | | algorithm. | | | | | | | | | | | | Algorithms are | | | | | | defined in | | | | | | [15]. | +----------------+----------+-------+----------------+----------------+
#### 9.2.1.41 Security Key
The _Security Key_ IE is used to apply security in the eNB for different
scenarios as defined in [15].
* * *
IE/Group Name Presence Range IE Type and Reference Semantics Description
...
* * *
IE/Group Name Presence Range IE type and reference Semantics description
Criticality Assigned Criticality **Last Visited Cell List** 1 to MaxNrOfCells
Most recent information is added to the top of this list - - >Last Visited
Cell Information M 9.2.1.43 - -
* * *
* * *
...
information.
+---------+---------+-------+---------+---------+---------+---------+ | I | P | Range | IE type | Se | Crit | A | | E/Group | resence | | and | mantics | icality | ssigned | | Name | | | re | desc | | Crit | | | | | ference | ription | | icality | +---------+---------+-------+---------+---------+---------+---------+ | Choice | M | | | | - | - | | **Last | | | | | | | | Visited | | | | | | | | Cell | | | | | | | | Inform | | | | | | | | ation** | | | | | | | +---------+---------+-------+---------+---------+---------+---------+ | > | M | | 9. | | - | - | | >Last | | | 2.1.43a | | | | | > | | | | | | | | Visited | | | | | | | | > | | | | | | | | E-UTRAN | | | | | | | | > Cell | | | | | | | | > Info | | | | | | | | rmation | | | | | | | +---------+---------+-------+---------+---------+---------+---------+ | > | M | | OCTET | ** | - | - | | >Last | | | STRING | Defined | | | | > | | | | in | | | | Visited | | | | \ | | | | > UTRAN | | | | [19]** | | | | > Cell | | | | | | | | > Info | | | | | | | | rmation | | | | | | | +---------+---------+-------+---------+---------+---------+---------+ | > | M | | 9. | | | | | >Last | | | 2.1.43b | | | | | > | | | | | | | | Visited | | | | | | | | > GERAN | | | | | | | | > Cell | | | | | | | | > Info | | | | | | | | rmation | | | | | | | +---------+---------+-------+---------+---------+---------+---------+
...
+---------+---------+-------+---------+---------+---------+---------+ | I | P | Range | IE type | Se | Crit | A | | E/Group | resence | | and | mantics | icality | ssigned | | Name | | | re | desc | | Crit | | | | | ference | ription | | icality | +---------+---------+-------+---------+---------+---------+---------+ | Choice | M | | | | - | - | | Last | | | | | | | | Visited | | | | | | | | GERAN | | | | | | | | Cell | | | | | | | | Info | | | | | | | | rmation | | | | | | | +---------+---------+-------+---------+---------+---------+---------+ | > >Un | M | | NULL | | - | - | | defined | | | | | | | +---------+---------+-------+---------+---------+---------+---------+
...
**> TAI List** 1 to \  
>>TAI M 9.2.3.16  
**> Emergency Area ID List** 1 to \  
>>Emergency Area ID M 9.2.1.47
* * *
* * *
...
be broadcast.
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE Type and | Semantics | | | | | Reference | Description | +----------------+----------+-------+----------------+----------------+ | Repetition | M | | INTEGER | -Range 1 to | | Period | | | (0..4095) | 4095: each | | | | | | unit will | | | | | | represent a | | | | | | repetition of | | | | | | one second to | | | | | | a maximum of | | | | | | once per \~1 | | | | | | hour | | | | | | | | | | | | - 0: no | | | | | | repetition | +----------------+----------+-------+----------------+----------------+
...
**> Cell ID Broadcast** 1 to \  
>E-CGI M 9.2.1.38  
**> TAI Broadcast** 1 to \  
>>TAI M 9.2.3.16  
>>Completed Cell in TAI List 1 to \  
>>>E-CGI M  
**> Emergency Area ID Broadcast** 1 to \  
>>Emergency Area ID M 9.2.1.47  
>>Completed Cell in Emergency Area ID List 1 to \  
>>>E-CGI M
* * *
* * *
Range bound Explanation maxnoofCellID Maximum no. of Cell ID subject for
...
* * *
IE/Group Name Presence Range IE type and reference Semantics description
Source to Target Transparent Container M OCTET STRING _This IE includes a
transparent container from the source RAN node to the target RAN node. In
inter-system handovers from E-UTRAN, the IE is encoded according to the
specifications of the target system._
* * *
...
* * *
IE/Group Name Presence Range IE type and reference Semantics description
Target to Source Transparent Container M OCTET STRING
* * *
#### 9.2.1.58 SRVCC Operation Possible
This element indicates that both UE and MME are SRVCC-capable. E-UTRAN
behaviour on receipt of this IE is specified in [9].
* * *
...
The coding of this element is described in [23].
* * *
...
* * *
IE/Group Name Presence Range IE type and reference Semantics description UE
Identity Index Value M BIT STRING (10) Coded as specified in [20]
* * *
#### 9.2.3.11 IMSI
...
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE type and | Semantics | | | | | reference | description | +----------------+----------+-------+----------------+----------------+ | Choice **UE | | | | | | Paging | | | | | | Identity** | | | | | +----------------+----------+-------+----------------+----------------+ | > >IMSI | M | | 9.2.3.11 | | +----------------+----------+-------+----------------+----------------+ | > >S-TMSI | M | | 9.2.3.6 | | +----------------+----------+-------+----------------+----------------+
...
eNB. The EPC behaviour on receipt of this IE is specified in [11].
* * *
IE/Group Name Presence Range IE type and reference Semantics description
...
the other MMEs in the pool in order to load-balance MMEs within a pool
[defined 11].
* * *
IE/Group Name Presence Range IE type and reference Semantics description
...
rejected/permitted by the eNB in an MME overload situation as defined in [11],
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE type and | Semantics | | | | | reference | description | +----------------+----------+-------+----------------+----------------+ | Overload | M | | ENUMERATED | | | Action | | | | | | | | | (Reject all | | | | | | RRC connection | | | | | | establishments | | | | | | for | | | | | | non-emergency | | | | | | MO DT, Reject | | | | | | all RRC | | | | | | connection | | | | | | establishments | | | | | | for | | | | | | Signalling, | | | | | | Permit | | | | | | Emergency | | | | | | Sessions only, | | | | | | ...) | | +----------------+----------+-------+----------------+----------------+
...
* * *
IE/Group Name Presence Range IE type and reference Semantics description
Criticality Assigned Criticality **Choice RIM Routing Address** \-  
**> GERAN-Cell-ID** \-  
>>LAI M 9.2.3.1 -  
>>RAC M 9.2.3.2 -  
>>CI M OCTET STRING (2) -
...
+----------------+----------+-------+----------------+----------------+ | IE/Group Name | Presence | Range | IE type and | Semantics | | | | | reference | description | +----------------+----------+-------+----------------+----------------+ | **SON | | | | | | Configuration | | | | | | Transfer** | | | | | +----------------+----------+-------+----------------+----------------+ | >Target | M | | | | | eNB-ID | | | | | +----------------+----------+-------+----------------+----------------+ | >>Global eNB | M | | 9.2.1.37 | | | ID | | | | | +----------------+----------+-------+----------------+----------------+ | >>Selected | M | | TAI | | | TAI | | | | | | | | | 9.2.3.16 | | +----------------+----------+-------+----------------+----------------+ | >Source | M | | | | | eNB-ID | | | | | +----------------+----------+-------+----------------+----------------+ | >>Global eNB | M | | 9.2.1.37 | | | ID | | | | | +----------------+----------+-------+----------------+----------------+ | >>Selected | M | | TAI | | | TAI | | | | | | | | | 9.2.3.16 | | +----------------+----------+-------+----------------+----------------+ | >SON | M | | 9.2.3.27 | | | Information | | | | | +----------------+----------+-------+----------------+----------------+
#### 9.2.3.27 SON Information
This IE identifies the nature of the SON information transferred i.e. a
request or a reply.
* * *
IE/Group Name Presence Range IE type and reference Semantics description
Criticality Assigned Criticality **Choice SON Information** \-  
**> SON Information Request** ENUMERATED(X2 TNL Configuration Info, ...) -  
**> SON Information Reply** 9.2.3.28 -
* * *
#### 9.2.3.28 SON Information Reply
This IE contains the SON Information to be replied to the eNB.
* * *
IE/Group Name Presence Range IE type and reference Semantics description **SON
Information Reply**  
>X2 TNL Configuration Info O 9.2.3.29
* * *
...
+-------------+-------------+-------------+-------------+-------------+ | > | * | **Range** | **IE type |** Semantics | | **IE/Group | *Presence** | | and | de | | > Name**| | | reference** | scription**| +-------------+-------------+-------------+-------------+-------------+ | > **eNB | | **1 to | | | | > X2** | | \ Transport | | BX2TLAs>**| | | | > Layer | | | | | | > Addresses | | | | | +-------------+-------------+-------------+-------------+-------------+ | > | M | | 9.2.2.1 | **Transport | | >Transport | | | | Layer | | > Layer | | | | Addresses | | > Address | | | | for X2 SCTP | | | | | | e | | | | | | nd-point**. | +-------------+-------------+-------------+-------------+-------------+
* * *
...
NAS security parameters from E-UTRA_ IE defined in [24].
* * *
...
security parameters to E-UTRA_ IE defined in [24].
* * *
## 9.3 Message and Information Element Abstract Syntax (with ASN.1)
### 9.3.0 General
S1AP ASN.1 definition conforms to [4] and [5].
...
Variant as transfer syntax as specified in ref. [4].
## 9.5 Timers
TS1~RELOCprep~
...
TX2~RELOCOverall~
\- it is specified in reference [22].
...
APID from the node sending the \"first returned message\". Thereafter the two
APIDs are included in all messages over the** UE-associated logical connection
unless otherwise allowed by the specification. The \"last message\" is a
message sent by a node in order to complete the termination of a given UE-
associated logical connection, such that no other messages for the same
connection are expected in either direction.
...
behaviour of both involved RAN nodes may be either specified according to the
...
rules which are specified for the target radio system. In section 8.4.1.2, it
...
+-------------+-------------+-------------+-------------+-------------+ | * | **_Source |_** Target | | | | _Scenario_ _| to Target | to Source | | | | | Transparent | Transparent | | | | | Container_ | Container _| | | | | IE in S1AP: | IE in S1AP: | | | | | HANDOVER | HANDOVER | | | | | REQUIRED | COMMAND | | | | | message_ _| message_ * | | | +-------------+-------------+-------------+-------------+-------------+ | | Name of the | Definition | Name of the | Definition | | | IE | in | IE | in | | | | sp | | sp | | | | ecification | | ecification | +-------------+-------------+-------------+-------------+-------------+ | Intra | Source eNB | 36.413 | Target eNB | 36.413 | | E-UTRAN | to Target | | to Source | | | handover | eNB | | eNB | | | | Transparent | | Transparent | | | | Container | | Container | | +-------------+-------------+-------------+-------------+-------------+ | I | Source RNC | 25.413 | Target RNC | 25.413 | | nter-system | to Target | | to Source | | | handover to | RNC | | RNC | | | UTRAN or | Transparent | | Transparent | | | SRVCC | Container | | Container | | | operation | | | | | | to UTRAN | | | | | +-------------+-------------+-------------+-------------+-------------+ | I | Source BSS | 48.018 | Target BSS | 48.018 | | nter-system | to Target | | to Source | | | handover to | BSS | | BSS | | | GERAN (PS | Transparent | | Transparent | | | domain | Container | | Container | | | only) | | | | | +-------------+-------------+-------------+-------------+-------------+ | SRVCC | Old BSS to | 48.008 | Layer 3 | 48.008 | | operation | New BSS | | Information | | | to GERAN | information | | | | | without DTM | | | | | | support | | | | | +-------------+-------------+-------------+-------------+-------------+ | SRVCC | Source BSS | 48.018 | Target BSS | 48.018 | | operation | to Target | | to Source | | | to GERAN | BSS | 48.008 | BSS | 48.008 | | with DTM | Transparent | | Transparent | | | support | Container | | Container | | | | | | | | | | Old BSS to | | Layer 3 | | | | New BSS | | Information | | | | information | | | | +-------------+-------------+-------------+-------------+-------------+
...
message. In the table the content of the containers is showning how both
