...
>
> i) 1729.9 MHz to 1804.9 MHz (Band 9)
>
> j) 1690 MHz to 1790 MHz (Band 10)
>
> k) 1407.9 MHz to 1467.9 MHz (Band 11)
>
> l) 679 MHz to 736 MHz (Band 12)
>
...
+----------------------+----------------------+----------------------+ | **E-UTRA Channel |** Bearer Information | **Performance | | Bandwidth [MHz]** | Data Rate**| Criteria ^1,\ 2^** | +----------------------+----------------------+----------------------+ | 1.4 | **FRC A1-1 in Annex | Throughput \  NOTE 1: The performance criteria, Throughput \ the communication link shall be maintained, applies also if a bearer with
...
MHz≤ f \ Fc1: Center frequency of first carrier frequency used by the BS and
> repeater.
>
...
* * *
**Parameter** **Uncertainty for EUT dimension ≤ 1 m** **Uncertainty for EUT
dimension >1 m** Effective radiated RF power between 30 MHz to 180 MHz ±6 dB
