...
The TS 36.200 series specifies the Uu point for the 3G LTE mobile system, and
...
QPSK Quadrature Phase Shift KeyingRLC Radio Link Control
...
well as in the time and power domain, implicit support of interference
...
and four documents (TS 36.211 through 36.214). The relation between the
physical layer specifications in the context of the higher layers is shown in
Figure 2.
...
\- Physical downlink shared channel related procedures, including CQI
