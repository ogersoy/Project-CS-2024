...
[31] Void.
> [32] ETSI TS 102 223 V8.8.0: \"Smart Cards; Card Application Toolkit\".
>
...
[51] 3GPP TS 31.116: \"Remote APDU Structure for (U)SIM Toolkit applications\"
# 3 Definitions, abbreviations and symbols
## 3.1 Definitions
For the purposes of the present document, the terms and definitions given in
ETSI TS 102 223 [32] and TR 21.905 [33] apply.
...
ETSI TS 102 223 [32] clause 6.5.3.
...
level 8.59 O N I Data destination address 8.58 C Y J Text Attribute 8.70 C N K
...
PDN Connectivity Request message (see TS 24.301 [XX]) to the UICC, using the
...
case of GERAN/UTRAN if the terminal receives a LOCATION UPDATING REJECT
...
See ETSI TS 102 223 [32] clause 7.7.
...
[48]. ECI has a length of 28 bits. It is right padded with zeros (i.e. the
most significant bit of ECI is coded on the most significant bit of byte 8.
The least significant bit of ECI is coded on the 4^th^ bit of byte 11. The 4
least significant bits of byte 11 shall be set to 1).
## 8.20 IMEI
...
See ETSI TS 102 223 [32] clause 8.47.
## 8.48 URL
...
[32] clause 8.52, the following are defined:
\'01\' = CSD;
...
## 8.100 Activate descriptor
Not required by 3GPP.
## 8.101 Broadcast Network information
Not required by 3GPP.
# 9 Tag values
