...
by [0.0,1.0]. Note that prior to the codebook search, the impulse response
{width="0.3333333333333333in" height="0.2222222222222222in"} must include the
pre‑filter {width="0.4166666666666667in" height="0.2222222222222222in"}. That
is, {width="2.5694444444444446in" height="0.2361111111111111in"}.
...
In the present document, {width="0.1388888888888889in"
height="0.2222222222222222in"} is given by the quantified pitch gain bounded
by [0.0,0.8]. Note that prior to the codebook search, the impulse response
{width="0.3333333333333333in" height="0.2222222222222222in"} must include the
pre‑filter {width="0.4166666666666667in" height="0.2222222222222222in"}. That
is, {width="2.5694444444444446in" height="0.2361111111111111in"}.
