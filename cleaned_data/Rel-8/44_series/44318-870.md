...
>
> [31] RFC 2315, March 1998: \"PKCS #7: Cryptographic Message Syntax Version
> 1.5\"
>
...
\- if the stored Serving GANC table contains the GSM CGI or UTRAN Cell
...
cells or both. Upon sending this message the MS shall start timer TU4004.
...
MS is in the GA-RC-REGISTERED state but in GERAN/UTRAN mode, the MS shall:
\- ignore the GA-RRC PAGING REQUEST message, and
...
not permitted to include the 3G Cell Identity information element.
...
\- MS has not found GERAN/UTRAN coverage.\ In this case the LAI is taken from
...
\- Normal service over GERAN or UTRAN with GPRS support\ In this case the RAC
received in the GERAN or UTRAN System Information is included.
\- MS has not found GERAN/UTRAN coverage\ In this case the RAC is taken from
the SIM, if available.
...
3G Cell Identity information element.
...
handover while in GERAN/UTRAN mode and the UARFCN of the new UTRAN serving
cell is different from the UARFCN indicated during its last GAN Registration
or GAN Registration Update.
\- The MS establishes a new UTRAN serving cell as a result of Inter-RAT
handover to UTRAN while in GERAN/UTRAN mode.
\- The MS enters connected mode in a UTRAN cell while in GERAN/UTRAN mode and
the UARFCN of the serving UTRAN cell is different from the UARFCN indicated
during its last GAN Registration/GAN Registration Update or a UARFCN was not
provided during its last GAN Registration/GAN Registration Update.
...
Handover to a GERAN cell is initiated. The cells are ranked in descending
order of preference according to measured value.
...
Handover to an UTRAN cell is initiated. The cells are ranked in descending
order according to measured Ec/No value.
...
The GERAN Cell Identifier List information element shall be included if
handover to a GERAN cell is possible. The cells are ranked in descending order
of preference according to measured value.
...
The UTRAN Cell Identifier List information element shall be included if
handover to an UTRAN cell is possible. The cells are ranked in descending
order according to measured Ec/No value.
...
+----------------------------------------------------------------------+ | GCI, GERAN/UTRAN coverage Indicator (octet 3) | | | | 0 Normal Service in the GERAN/UTRAN | | | | 1 Limited Service in the GERAN/UTRAN | | | | 2 MS has not found GERAN/UTRAN coverage (LAI information taken from | | SIM, if available) | | | | 3 MS has found GERAN/UTRAN coverage, service state unknown | | | | 4-255 All other values are for future use | +----------------------------------------------------------------------+
