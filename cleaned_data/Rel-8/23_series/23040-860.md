...
(CBS)\".
[11] 3GPP TS 43.047: \"Example protocol stacks for interconnecting Service
...
Parameter indicating whether or not there are more messages to send TP‑RP
TP‑Reply‑Path M b Parameter indicating that Reply Path exists. TP‑UDHI
...
protocols are used ‑ SC to GMSC/IWMSC (see GSM TS 43.047 [11]), MAP (see 3GPP
TS 29.002 [15]) and via the radio interface (see 3GPP TS 24.011 [13])
RP‑MSIsdn RP‑international‑‑MS‑ISDN‑number +‑‑ MSIsdn‑Alert of the MS, see
...
Some example protocols are provided in GSM TS 43.047 [11] to assist SC and
PLMN operators. These are based on the following principles, which SC and PLMN
operators are recommended to follow even if they choose not to use one of the
examples given in GSM TS 43.047 [11]:
