...
The following Table 11 \"CLI Compact Profile Namespaces" specifies the defined
mandatory namespaces, i.e. the namespaces defined in the CLI Compact Profile
containing classes which are required for CLI Compact Profile conformance.
...
System.Reflection enables progammatic inspection of application metadata such
...
executable (clause 5.3.5 "Service termination"). From the MExE device point of
view the executable does not exist any more. Uninstalled Execution => Resident
This is a possible but unusual transition. A MExE executable that has been
used for uninstalled execution is installed without retransferring.
* * *
# D.2 Released state
