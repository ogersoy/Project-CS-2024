...
are defined in table 6.3.2. PS Information O~C~ This is a structured field and
holds PS specific parameters relevant to MMS. The complete structure is
defined in TS 32.251 [11]. 3GPP User Location Info O~C~ This field holds the
information about the location of the subscriber during the MMS transaction.
Only applicable to online charging. 3GPP RAT Type O~C~ This field holds
information about the radio access technology used for the MMS transaction.
Only applicable to online charging. PDP Address O~C~ This field holds the IP
