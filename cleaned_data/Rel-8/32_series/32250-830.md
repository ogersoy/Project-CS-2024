...
omitted when the service is provided by a GSM air interface.The field shall be
set to \"unknown\" for SMS delivery using E-UTRAN. Location Extension - - O~M~
The 12 most significant bits of the E-UTRAN Cell Identity are included if
...
System Type C M M This field is present when either the UTRAN or GERAN air-
interface is used. It is omitted when the service is provided by a GSM air
interface CAMELSMSInformation C C C Set of CAMEL information IEs. Each of
these IEs contains information related to CAMEL call leg related for the SMS.
Shall be present only if CAMEL is applied. The field shall be set to
\"unknown\" for SMS delivery using E-UTRAN. Location Extension - - O~M~ The 12
most significant bits of the E-UTRAN Cell Identity are included if E-UTRAN is
used to deliver the SMS.
* * *
