...
**32.715 Configuration Management (CM); Transport Network (TN) interface
...
# 1 Scope
The present document provides the NRM-specific part related to 3GPP TS 32.712
[1] Transport Network (TN) interface NRM IRP IS of the XML file format
definition for the 3GPP TS 32.612 [2] Bulk Configuration Management IRP IS.
...
This File Format Definition specification is related to 3GPP TS 32.712 V8.0.X.
# 2 References
...
[1] 3GPP TS 32.712: \"Telecommunication management; Configuration Management
...
(file name \"transportNrm.xsd\")
The following XML schema transportNrm.xsd is the NRM-specific schema for the
Transport Network Interface IRP NRM defined in 3GPP TS 32.712 [1]:
\\ \ \\ \ \\ \
\\ \
\
\\ \\
...
http://www.3gpp.org/ftp/specs/archive/32_series/32.715/schema/32715-800-XMLSchema.zip
#