...
# 1 Scope
The present document provides the NRM-specific part related to the Repeater
...
This File Format Definition specification is related to 3GPP TS 32.722.
# 2 References
...
(file name \"RepeaterNrm.xsd\")
The following XML schema RepeaterNrm.xsd is the NRM-specific schema for the
Repeater Network Resources IRP NRM defined in 3GPP TS 32.722 [1]:
\
\
\
\
...
http://www.3gpp.org/ftp/specs/archive/32_series/32.725/schema/32725-800-XMLSchema.zip
#