...
# 1 Scope
The present document provides the NRM-specific part related to the IMS NRM IRP
[1] of the XML file format definition for the Bulk Configuration Management
IRP IS [2].
...
This File Format Definition specification is related to 3GPP TS 32.732.
# 2 References
...
[1] 3GPP TS 32.732: \"**IP Multimedia Subsystem (IMS) Network Resource Model
...
Annex A of the present document defines the NRM-specific XML schema imsNrm.xsd
for the IMS NRM IRP IS defined in 3GPP TS 32.732 [1].
...
(file name \"imsNrm.xsd\")
The following XML schema imsNrm.xsd is the NRM-specific schema for the IMS NRM
IRP IS defined in 3GPP TS 32.732 [1]:
\
\
\
\
...
http://www.3gpp.org/ftp/specs/archive/32_series/32.735/schema/32735-800-XMLSchema.zip
#