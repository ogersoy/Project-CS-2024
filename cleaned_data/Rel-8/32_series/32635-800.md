...
definition\".**
# 1 Scope
The present document provides the NRM-specific part related to the Core
...
This File Format Definition specification is related to 3GPP TS 32.632 V8.0.X.
# 2 References
...
[1] 3GPP TS 32.632: \"Telecommunication management; Configuration Management
...
coreNrm.xsd for the Core Network Resources IRP NRM defined in 3GPP TS 32.632
[1].
...
(file name \"coreNrm.xsd\")
The following XML schema coreNrm.xsd is the NRM-specific schema for the Core
Network Resources IRP NRM defined in 3GPP TS 32.632 [1]:
\
\
\
\
...
http://www.3gpp.org/ftp/specs/archive/32_series/32.635/schema/32635-800-XMLSchema.zip
#