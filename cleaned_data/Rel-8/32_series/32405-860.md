...
i) This measurement provides the number of octets of MBMS data on MAC-m >
layer.
j) CC
k) On transmission by the RNC of a PDU on the MAC layer for MBMS. The > number
of octets of MAC layer for MBMS is calculated by sum of PDU > size including
PDU header.
