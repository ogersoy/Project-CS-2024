...
communication service between an UE and a UTRAN access point.
...
**CSG identities white list** : A list stored in the USIM containing all the
CSG identities of the CSGs to which the subscriber belongs.
