...
For TCH/AFS, TCH/WFS and O-TCH/WFS, the default transmission phase shall be
such that Codec Mode Indications are sent with speech frames having their
first burst sent on TDMA frames 0, 8, 17 (modulo 26) in the uplink and TDMA
frames 4, 13, 21 (modulo 26) in the downlink as defined in 3GPP TS 45.002 [3].
For TCH/AHS, O-TCH/AHS and O-TCH/WHS, the default transmission phase shall be
such that Mode Indications are sent with speech frames having their first
burst sent on TDMA frames 0, 8, 17 (modulo 26) or 1, 9, 18 (modulo 26)
depending on the subchannel in the uplink and TDMA frames 4, 13, 21 (modulo
26) or 5, 14, 22 (modulo 26) depending on the subchannel, in the downlink, as
defined in 3GPP TS 45.002 [3].
