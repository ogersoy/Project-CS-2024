...
NOTE1:- Generation of Correlation Number is FFS.
...
## 11.2A Start of Interception for IMS Conference Services
...
the target of interception is started.
...
Initiator (of the Party Join request) List of Conferees -- see note Supported
Bearers Conference URI Temporary Conference URI Failed Party Join Reason
(e.g., not available)
* * *
...
Party) Initiator (of the Party Leave Request) Conference URI Temporary
Conference URI Party Leave Reason -- see Note Failed Party Leave Reason
* * *
...
> carries the requested EPS bearer QoS, otherwise it carries the EPS bearer
> QoS associated to the established bearer.
...
The correlation number shall be generated by using existing parameters related
to the IP-CAN session.
NOTE 2: If interception has been activated for both parties of the Packet Data
communication both CC and IRI will be delivered for each party as separate
intercept activity.
