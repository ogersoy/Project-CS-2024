...
the Default GANC
The Location Exclude List contains information about forbidden Locations
...
Location Exclude List, the MS shall not initiate the GAN Registration
procedure. The Location Exclude List shall be deleted upon power cycle.
The AP Exclude List contains information about denied APs. If the MS is being
provided IP connectivity by an AP that is on the AP Exclude List, the MS shall
not initiate discovery or GAN registration, until the relevant AP has been
removed from the AP Exclude List. The AP Exclude List shall be deleted upon
power cycle.
...
the AP Exclude List and not initiate a new Register Request from this AP,
until the AP-ID is removed from the AP Exclude List i.e. as a result of power-
cycle.
...
Exclude List according to the received information elements Location Exclude
List indicator and Location Area Identification (i.e. the same as that
included in the GA-RC REGISTER REQUEST message) and not initiate a new
Register Request from the locations indicated by the updated Location Exclude
List, until they are removed from the Location Exclude List i.e. as a result
of power-cycle.
...
defined in sub-clause 4.5,
\- store the AP-ID in the AP Exclude List of and not initiate a new Register
Request from this AP, until the AP-ID is removed from the AP Exclude List i.e.
as a result of power-cycle.
\- \'Location not allowed\'
\- release the TCP connection established to the GANC, if still established,
\- release the secure connection towards the SEGW associated with the GANC, as
defined in sub-clause 4.5,
\- update the Location Exclude List according to the received information
elements Location Exclude List indicator and Location Area Identification and
not initiate a new Register Request from that Location, until the Location is
removed from the Location Exclude List i.e. as a result of power-cycle.
\- \'IMSI not allowed\'
\- release the TCP connection established to the GANC, if still established.
\- release the secure connection towards the SEGW associated with the GANC as
defined in sub-clause 4.5,
...
11.2.16**
58 Location Exclude List indicator **Location** Exclude **List indicator\ C
TLV 3  
11.2.58**
...
Congestion\' is returned to the MS.
#### 10.1.8.2 Location Exclude List indicator
The Location Exclude List indicator IE shall be included if the Register
...
11.2.16**
* * *
#### 10.1.9.1 Location Exclude List indicator
The Location Exclude List indicator IE shall be included if the Register
Reject Cause \'Location not allowed\' is returned to the MS.
...
Direction: GANC to MS
**Table 10.1.11.1: GA-RC REGISTER UPDATE DOWNLINK message c** ontent
* * *
IEI Information Element Type/Reference Presence Format Length Value Notes
        Length Indicator                                  **Length Indicator\                  M          V        2                
                                                          11.1.1**.1
...
Direction: GANC to MS
**Table 10.1.13.1: GA-CSR REQUEST ACCEPT message conte** nt
* * *
IEI Information Element Type/Reference Presence Format Length Value Notes
        Length Indicator                             **Length Indicator\         M          V        2                   
                                                     11.1.1**.1
...
establishment**.**
Direction: GANC to MS
**Table 10.1.18.1: GA-CSR ACTIVATE CH** ANNEL COMPLETE message content
* * *
IEI Information Element Type/Reference Presence Format Length Value Notes
        Length Indicator                                    **Length Indicator\         M          V        2                   
                                                            **11.1.1.1
...
message.
Direction: GANC to MS
**Table 10.1.26.1: GA-CSR CLASSMARK ENQUIRY messa** ge content
* * *
IEI Information Element Type/Reference Presence Format Length Value Notes
        Length Indicator                            **Length Indicator\         M          V        2                   
                                                    **11.1.1.1
...
Direction: MS to GANC
**Table 10.3.1.1: GA-RRC REQUEST messa** ge content
* * *
IEI Information Element Type/Reference Presence Format Length Value Notes
        Length Indicator                      **Length Indicator\             M          V        2                   
                                              11.1.1**.1
...
related resources for the indicated domain.
Direction: MS to GANC
**Table 10.3.6.1: GA-RR** C RELEASE COMPLETE message content
* * *
IEI Information Element Type/Reference Presence Format Length Value Notes
        Length Indicator                               **Length Indicator\         M          V        2                   
                                                       11.1.1**.1
...
The Location Exclude List indicator information element is used to indicate
...
+-------------------------------------------------+---+---+------------------+ | LBLI, Location Exclude List indicator (octet 3) | | | | | | | | | | Bits | | | | +-------------------------------------------------+---+---+------------------+ | 3 | 2 | 1 | | +-------------------------------------------------+---+---+------------------+ | 0 | 0 | 0 | MCC | +-------------------------------------------------+---+---+------------------+ | 0 | 0 | 1 | MCC and MNC | +-------------------------------------------------+---+---+------------------+ | 0 | 1 | 0 | MCC, MNC and LAC | +-------------------------------------------------+---+---+------------------+ | All other values are undefined in Release 1. | | | | +-------------------------------------------------+---+---+------------------+
