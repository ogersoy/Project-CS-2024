...
>
> APS, Ω(φ) :Uniform
{width="4.375in" height="3.0694444444444446in"}
...
height="2.0555555555555554in"}{width="3.2847222222222223in" height="2.0in"}
...
and channel PAS.
{width="4.819444444444445in" height="2.736111111111111in"}
...
rotations.
a){width="5.166666666666667in" height="1.9791666666666667in"}
b) {width="5.159722222222222in" height="2.0972222222222223in"}
...
{width="6.138888888888889in" height="4.3125in"}
...
{width="6.229166666666667in" height="3.1458333333333335in"}
...
{width="6.6875in" height="2.826388888888889in"}
...
{width="6.6875in" height="3.3055555555555554in"}
...
{width="6.027777777777778in" height="3.9375in"}
...
{width="6.923611111111111in" height="3.4305555555555554in"}
...
specified margins.
{width="6.923611111111111in" height="3.3541666666666665in"}
...
for Intel and SATIMO
{width="6.916666666666667in" height="4.506944444444445in"}
...
{width="6.6875in" height="4.048611111111111in"}
...
reference antennas)
{width="6.6875in" height="3.9444444444444446in"}
...
Figure 10.2.4-1.
{width="6.506944444444445in" height="3.0833333333333335in"}
...
{width="4.805555555555555in" height="3.451388888888889in"}
...
{width="4.798611111111111in" height="3.3541666666666665in"}
...
{width="2.625in" height="1.9722222222222223in"}{width="2.625in"
height="1.9722222222222223in"}
{width="2.8472222222222223in" height="1.9722222222222223in"}
...
measurements.
{width="4.388888888888889in" height="1.8333333333333333in"}
...
{width="3.7291666666666665in" height="2.7916666666666665in"}
...
a failure.
{width="5.194444444444445in" height="3.2222222222222223in"}
...
+----------------------------------+----------------------------------+ | {width="3.375in" | | height="1.9722222222222223in"} | height="1.9722222222222223in"} | | | | | (a) | (b) | +----------------------------------+----------------------------------+
...
(b)
+----------------------------------+----------------------------------+ | {width="3.5in" | | height="1.9722222222222223in"} | height="1.9722222222222223in"} | | | | | (a) | (b) | +==================================+==================================+ | {width="3.548611111111111in" | | height="1.4722222222222223in"} | height="1.4513888888888888in"} | | | | | (c) | (d) | +----------------------------------+----------------------------------+
...
+----------------------------------+----------------------------------+ | {width="3.1875in" | | height="2.361111111111111in"} | height="2.361111111111111in"} | | | | | (a) | (b) | +----------------------------------+----------------------------------+
...
+----------------------------------+----------------------------------+ | {width="3.2152777777777777in" | | eg){width="3.1527777777777777in" | height="2.3680555555555554in"} | | height="2.361111111111111in"} | | | | (b) | | (a) | | +----------------------------------+----------------------------------+
...
respectively.
{width="5.909722222222222in" height="4.333333333333333in"}
...
{width="5.895833333333333in" height="4.333333333333333in"}
...
+----------------------------------+----------------------------------+ | {width="3.1597222222222223in" | | height="1.9722222222222223in"} | height="1.9652777777777777in"} | | | | | (a) | (b) | +----------------------------------+----------------------------------+
...
+----------------------------------------------------------------------+ | {width="6.6875in" | | height="2.048611111111111in"} | +======================================================================+ | (a) (b) | +----------------------------------------------------------------------+ | {width="3.3541666666666665in" | | height="2.3680555555555554in"} | | | | (c) | +----------------------------------------------------------------------+
...
{width="3.6875in" height="3.5416666666666665in"}
