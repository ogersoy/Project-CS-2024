...
{width="6.520833333333333in" height="5.708333333333333in"}
Figure 4.4-1: MIMO OTA work plan
{width="4.829861111111111in" height="1.7180555555555554in"}{width="6.6875in"
height="3.875in"}
Figure 4.4-2: Extended MIMO OTA work plan
{width="6.701388888888889in" height="4.326388888888889in"}
...
Figure 5.1.2-1.
{width="2.0in" height="2.5069444444444446in"}
...
{width="4.527777777777778in" height="3.2708333333333335in"}
...
distribution.
{width="6.083333333333333in" height="1.8333333333333333in"}
...
{width="6.0in" height="3.8472222222222223in"}
...
{width="4.25in" height="2.638888888888889in"}
...
{width="2.75in" height="2.736111111111111in"}
Figure 6.3.1.2.1-2: OTA chamber antenna setup with eight uniformly spaced
chamber antennas
{width="3.7083333333333335in" height="3.4444444444444446in"}
...
{width="2.5in" height="2.7083333333333335in"}
...
{width="4.631944444444445in" height="3.6666666666666665in"}
(a) Experimental Setup
{width="2.701388888888889in" height="2.361111111111111in"}
...
{width="7.541666666666667in" height="2.2291666666666665in"}
...
{width="3.8958333333333335in" height="2.8541666666666665in"}
...
{width="3.4305555555555554in" height="2.7222222222222223in"}
...
{width="5.083333333333333in" height="2.736111111111111in"}
...
distance from the DUT, {width="0.1111111111111111in" height="0.125in"}, will
...
({width="0.3819444444444444in" height="0.16666666666666666in"}) m is used and
...
{width="6.0in" height="3.7708333333333335in"}
...
{width="4.340277777777778in" height="3.0416666666666665in"}
...
{width="4.5625in" height="1.9930555555555556in"}
...
{width="2.1041666666666665in" height="0.25in"}
where
...
{width="0.6388888888888888in" height="0.20833333333333334in"}is the highest
...
where {width="0.6944444444444444in" height="0.24305555555555555in"} is the
...
{width="4.541666666666667in" height="2.3125in"}
...
{width="2.6805555555555554in" height="0.8125in"}
where {width="0.125in" height="0.16666666666666666in"} is the rotation angle,
{width="0.24305555555555555in" height="0.20833333333333334in"}= 8 for angle
step of 45°, and,
{width="0.3819444444444444in" height="0.20833333333333334in"}is the recorded
...
{width="3.1458333333333335in" height="0.20833333333333334in"}
for {width="0.2013888888888889in" height="0.22916666666666666in"}measurement
...
Based on Figure B.3.1-3 and Appendix E.3 in TR 25.914 [11], the following
calibration procedure can be used:
...
the measured pattern. The detailed path loss {width="0.2013888888888889in"
...
{width="1.6180555555555556in" height="0.25in"}
...
{width="4.201388888888889in" height="1.4375in"}
...
is{width="0.4305555555555556in" height="0.20833333333333334in"}.To compare the
...
{width="6.333333333333333in" height="4.5625in"}
...
{width="2.6458333333333335in" height="0.3819444444444444in"}
...
Row Col A Col B Col C Col D Col E Description
* * *
1 Setup ID An identifier that indicates the conditions of the test setup; this
ID is unique for each measurement result submitted by a company 2 Lab R&S lab
where the test has been made (text) 3 ID 10001 unique identifier of form
nnmmmm; nn is the lab, mmmm is consecutive number freely assigned by the lab
nn (see schedule): 01=R&S, 02=SATIMO, 03=Nokia, 04=EMITE, 05=Bluetest, 06=ETS-
Lindgren, 07=Azimuth 08=Spirent, 09=Qualcomm, 10=NTT DCM, 11=Agilent,
12=Huawei, 13=CATR, 14=Samsung 4 Method 2-chan any of anechoic, reverb,
2-chan, 2-stage 5 Ch model 0 TR 37.976 6.2-2 Column B may be any of Umi, Uma;
0 means no additional channel model. Column C defines the channel model drop
(e.g. specific reference to TR 37.976) 6 Test ant. 2 number of test antennas *
...
{width="4.333333333333333in" height="2.9027777777777777in"}
...
> {width="0.9236111111111112in" height="0.4583333333333333in"}, where
{width="4.75in" height="0.4861111111111111in"}
{width="4.666666666666667in" height="0.4861111111111111in"}
{width="4.784722222222222in" height="0.4861111111111111in"}
Where:
