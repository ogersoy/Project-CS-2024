...
**hlr-id** parameter shall be populated with the value received within HSS-ID
AVP within SMSMI-Correlation-ID AVP within OFR.
...
the diagnosticInfo parameter, when present, within the sm-DeliveryFailureCause
within the MO-ForwardSM message.
...
UTF8String format.
**MSISDN** AVP shall be populated with the value received within the sm-RP-OA
parameter of MO-ForwardSM-Arg
**SM-RP-UI** AVP shall be populated with the value received within the sm-RP-
...
**Originating-SIP-URI** AVP shall be populated with the value received within
the sip-uri-A parameter within correlationID of MT-ForwardSM-Arg.
**Destination-SIP-URI** AVP shall be populated with the value received within
the sip-uri-B parameter within correlationID of MT-ForwardSM-Arg.
**TFR-Flags** AVP: Flags shall be set as follows:
**More-Messages- To-Send** shall be set to 1 if the moreMessagesToSend
parameter was present within MT-ForwardSM-Arg; otherwise shall be set to 0 or
...
2\. If the MAP DeleteSubscriberData does not contain any data related to SMS,
the IWF ignores the received data data. The IWF skips to step 4.If the MAP
DeleteSubscriberData contains data related to SMS, the IWF maps them into a
DSR towards the MME and ignores the other received data data .
