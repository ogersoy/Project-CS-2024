...
Restoration\" in ITU‑T Recommendation Q.1950 [23] (see 3GPP TS 29.205 [7])
with the following clarification.
...
MGC
+---------------------+----------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+----------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = Null | | | | | | | | TerminationID = Root | | +---------------------+----------------------+--------------------+
...
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = | | | | bearer1 | | | | | | | | Signal=actpro | | | | | | | | If indication on | | | | Protocol Negotiation | | | | Result requested: | | | | | | | | NotificationRequested | | | | (Event ID = x, \"Prot | | | | Negotiation Result\") | | | | | | | | If indication on Rate | | | | Change requested: | | | | | | | | NotificationRequested | | | | (Event ID = x, | | | | \"RateChange\") | | +---------------------+-------------------------+--------------------+
When the processing of command (1) is complete, the MGW initiates the
following procedure.
...
This procedure is the same as that defined in the clause \"Tunnel\" in ITU‑T
Recommendation Q.1950 [23] (see 3GPP TS 29.205 [7]) with the clarification
that BT/TunOpt = ? and BT/TunOpt = NO shall not be used.
...
This procedure is the same as that defined in the clause \"Insert
...
signal.
### 14.2.23 Stop Tone
This procedure is the same as that defined in the clause \"Insert Tone\" in
ITU‑T Recommendation Q.1950 [23] (see 3GPP TS 29.205 [7]) with the following
clarification. The signal descriptor shall not include any signal.
### 14.2.24 Stop DTMF Detection
This procedure is the same as that defined in the clause \"Detect Digit\" in
ITU‑T Recommendation Q.1950 [23] (see 3GPP TS 29.205 [7]) with the following
clarification. The eventDescriptor shall not include any event.
### 14.2.25 Stop DTMF
This procedure is the same as that defined in the clause \"Media Content
Insertion\" - \"Insert Digit\" in ITU‑T Recommendation Q.1950 [23] (see 3GPP
...
This procedure is the same as that defined in the clause \"Confirm Char\" in
ITU‑T Recommendation Q.1950 [23] (see 3GPP TS 29.205 [7]).
### 14.2.27 Modify Char
This procedure is the same as that defined in the clause \"Modify Char\" in
ITU‑T Recommendation Q.1950 [23] (see 3GPP TS 29.205 [7]).
### 14.2.28 Reserve Char
This procedure is the same as that defined in the clause \"Reserve Char\" in
ITU‑T Recommendation Q.1950 [23] (see 3GPP TS 29.205 [7]).
### 14.2.29 Bearer Modified
This procedure is the same as that defined in the clause \"BNC Modified\" in
ITU‑T Recommendation Q.1950 [23] (see 3GPP TS 29.205 [7]).
### 14.2.30 Bearer Modification Failed
This procedure is the same as that defined in the clause \"BNC Modification
...
+---------------------+--------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+--------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = bearer1 | | | | | | | | tfoenable = tfoactvalue | | | | | | | | If TFO codec list: | | | | | | | | Property= TFOcodeclist | | +---------------------+--------------------------+--------------------+
When the processing of command (1) is complete, the MGW initiates the
following procedure.
...
to MGW
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = | | | | bearer1 | | | | | | | | Property= TFOcodeclist | | | | | | | | NotificationRequested | | | | (Event ID = x, \"Codec | | | | modify\") | | | | | | | | NotificationRequested | | | | (Event ID = x, | | | | \"Distant List\") | | +---------------------+-------------------------+--------------------+
When the processing of command (1) is complete, the MGW initiates the
following procedure.
...
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = | | | | bearer1 | | | | | | | | Event ( Event Id = x, | | | | \"codec_modify | | | | (optimalcodec)\") | | +---------------------+-------------------------+--------------------+
When the processing of command (1) is complete, the MGC initiates the
following procedure.
...
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = | | | | bearer1 | | | | | | | | Event(Event ID = x, \" | | | | distant | | | | _codec_list(distlist) | | | | \") | | +---------------------+-------------------------+--------------------+
When the processing of command (1) is complete, the MGC initiates the
following procedure.
...
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = | | | | bearer1 | | | | | | | | Event (Event ID = x, \" | | | | protres | | | | (Result,Cause)\") | | +---------------------+-------------------------+--------------------+
When the processing of command (1) is complete, the MGC initiates the
following procedure.
...
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = | | | | bearer1 | | | | | | | | Event (Event ID = x, | | | | \"ratechg(rate)\") | | +---------------------+-------------------------+--------------------+
When the processing of command (1) is complete, the MGC initiates the
following procedure.
...
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = | | | | bearer1 | | | | | | | | Event (Event ID = x, | | | | \"mod_link_supp\") | | +---------------------+-------------------------+--------------------+
When the processing of command (1) is complete, the MGC initiates the
following procedure.
...
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = | | | | bearer1 | | | | | | | | Event (Event ID = x, | | | | \"connchange (connchng) | | | | \") | | +---------------------+-------------------------+--------------------+
When the processing of command (1) is complete, the MGC initiates the
following procedure.
...
+---------------------------+--------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------------+--------------------------+--------------------+ | Remote Descriptor { | Transaction ID = z | | | | | | | Iu IP Address = IPaddress | Context ID = c1 | | | | | | | Iu IP Port = UDPport | Termination ID = bearer1 | | | | | | | } | | | +---------------------------+--------------------------+--------------------+
When the processing of command (1) is complete, the MGW initiates the
following procedure.
...
+---------------------+----------------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+----------------------------------+--------------------+ | | If framing protocol used: | | | | | | | | UP mode = mode | | | | | | | | UPversion =version | | | | | | | | Delivery of erroneous SDUs=value | | | | | | | | Interface=interface | | | | | | | | Initdirerection=initdirection | | +---------------------+----------------------------------+--------------------+
...
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = | | | | bearer1 | | | | | | | | Event_ID (Event ID = | | | | x, \" tracact (res)\") | | +---------------------+-------------------------+--------------------+
When the processing of command (1) is complete, the MGC initiates the
following procedure.
Table 14.2.46.2: NOT.resp (Trace Activation result Notification) MGC to MGW
+---------------------+--------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+--------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = bearer1 | | +---------------------+--------------------------+--------------------+
### 14.2.47 Emergency Call Indication
This procedure is the same as that defined in the clause \" ECS_Indication \"
...
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = | | | | bearer1 | | | | | | | | NotificationRequested | | | | (Event ID = x, \"TFO | | | | Status\") | | +---------------------+-------------------------+--------------------+
...
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = z | | | | | | | | Context ID = c1 | | | | | | | | Termination ID = | | | | bearer1 | | | | | | | | Event_ID (Event ID = | | | | x, \" | | | | TFO_status(tfostatus) | | | | \") | | +---------------------+-------------------------+--------------------+
When the processing of command (1) is complete, the MGC initiates the
following procedure.
...
+----------------------+----------------------+----------------------+ | Address Information | Control information | Bearer information | +----------------------+----------------------+----------------------+ | If local resources | Transaction ID | If local resources | | are modified: | | are modified: | | | Termination ID | | | Local Descriptor { | | Local Descriptor { | | | Context ID | | | Port | | Codec List | | | If IP Interface | | | IP Address | Type: | RTP Payloads | | | | | | IP Version | IP interface = \"IP | RtcpbwRS | | | interface type\" | | | } | | RtcpbwRR | | | (NOTE 1) | | | If remote resources | | If SDPCapNeg is | | are modified: | If Resources for | signalled to the | | | multiple Codecs | gateway: | | Remote Descriptor { | shall be reserved: | | | | | SDPCapNeg | | Port | Reserve_Value | configuration | | | | | | IP Address | If CTM call and | } | | | Access Termination: | | | IP Version | | If remote resources | | | State= ctmstate | are modified: | | } | | | | | Transport= | Remote Descriptor { | | | ctmtransport | | | | | Codec List | | | Version= ctmtext | | | | version | RTP Payloads | | | | | | | If indication on | RtcpbwRS | | | Protocol Negotiation | | | | Result requested: | RtcpbwRR | | | | | | | N | If RTCP APP messages | | | otificationRequested | allowed | | | (Event ID = x, | | | | \"Prot Negotiation | Allowed RTCP APP | | | Result\") | message | | | | | | | If indication on | types | | | Rate Change | | | | requested: | If ICE is applied: | | | | | | | N | ICE received | | | otificationRequested | candidate | | | (Event ID = x, | | | | \"RateChange\") | ICE received | | | | password | | | If access | | | | termination and | ICE received Ufrag | | | notification on CTM | | | | negotiation result | (NOTE 4) | | | requested: | | | | | ICE received pacing | | | N | | | | otificationRequested | (NOTE 5) | | | (Event ID = x, \" | | | | connchange \") | If SDPCapNeg is | | | | signalled to the | | | If access | gateway: | | | termination and | | | | Listener context: | SDPCapNeg | | | number of desired | configuration | | | listener context | | | | terminations = | } | | | required listener | | | | context terminations | If data call other | | | | than SCUDIF | | | If diffserv required | multimedia call and | | | (NOTE 2):- | if Access | | | | Termination or | | | Diffserv Code Point | Anchor MGW Network | | | | Termination: | | | If tagging behaviour | | | | | PLMN bearer | | | Diffserv Tagging | capability = | | | Behaviour | PLMN capability | | | | | | | If Remote Source | If GSM data call | | | Address Filtering | other than SCUDIF | | | required (NOTE 2): | multimedia call and | | | | if Access | | | Remote Source | Termination or | | | Address Filtering | Anchor MGW Network | | | | Termination: | | | If Remote Source | | | | Address range | GSM channel coding = | | | required:- | coding | | | | | | | Remote Source | | | | Address Mask | | | | | | | | If Remote Source | | | | Port Filtering | | | | required:- | | | | | | | | Remote Source Port | | | | Filtering | | | | | | | | If individual port:- | | | | | | | | Remote Source Port | | | | | | | | If range of ports: | | | | | | | | Remote Source Port | | | | Range | | | | | | | | If Media Inactivity | | | | Detection Required | | | | (NOTE 2): | | | | | | | | N | | | | otificationRequested | | | | (Event ID = x, | | | | \"Media Inactivity | | | | Detection (Media | | | | Inactivity Detection | | | | Time, Media | | | | Inactivity Detection | | | | Direction) \") (NOTE | | | | 3) | | | | | | | | If Sustainable Data | | | | Rate Policing | | | | Required (NOTE 2):- | | | | | | | | Policing Required | | | | | | | | Sustainable Data | | | | Rate | | | | | | | | Maximum Burst Size | | | | | | | | If peak data rate | | | | policing (NOTE 2) | | | | | | | | Policing Required | | | | | | | | Peak Data Rate | | | | | | | | If Delay Variation | | | | required | | | | | | | | Delay Variation | | | | Tolerance | | | | | | | | If RTCP handling | | | | required (NOTE 2): | | | | | | | | RTCP allocation | | | | | | | | If ECN Endpoint | | | | support required | | | | | | | | ECN Enable = | | | | \"True\" | | | | | | | | Initiation Method = | | | | \"ECN Initiation | | | | | | | | Method\" | | | | | | | | If notification of | | | | ECN Failure | | | | | | | | Report: | | | | | | | | N | | | | otificationRequested | | | | (Event ID | | | | | | | | = x,\"ECN Failure\") | | +----------------------+----------------------+----------------------+ | NOTE 1: If this | | | | property is included | | | | within the Reserve | | | | Connection Point | | | | procedure or the | | | | Reserve and | | | | Configure RTP | | | | Connection Point | | | | then it shall not be | | | | modified by this | | | | procedure. | | | | | | | | NOTE 2: Only for | | | | terminations with | | | | border control | | | | functions support. | | | | | | | | NOTE 3: The event | | | | parameters \"Media | | | | Inactivity Detection | | | | Time\" and \"Media | | | | Inactivity Detection | | | | Direction\" are | | | | optional. | | | | | | | | NOTE 4: The support | | | | of ICE received | | | | candidate, ICE | | | | received password, | | | | ICE received Ufrag | | | | are optional for ICE | | | | lite, as specified | | | | in | | | | 3G | | | | PP TS 29.292 [60]. | | | | | | | | NOTE 5: The ICE | | | | received pacing is | | | | only applicable for | | | | full ICE, as | | | | specified in | | | | I | | | | ETF RFC 8445 [86]. | | | +----------------------+----------------------+----------------------+
When the processing of command (1) is complete, the MGW initiates the
following procedure.
...
MGC to MGW
+----------------------+----------------------+----------------------+ | Address Information | Control information | Bearer information | +----------------------+----------------------+----------------------+ | Local Descriptor { | Transaction ID | Local Descriptor { | | | | | | Port = ? | Termination ID = ? | Codec List | | | | | | IP Address = ? | If Context | RTP Payloads | | | Requested: | | | IP Version = IPv4 or | | RtcpbwRS | | IPv6 | Context ID = ? | | | | | RtcpbwRR | | } | If MPS call/session: | | | | | If ICE is applied: | | Remote Descriptor { | Priority Indicator = | | | | x | ICE host candidate | | Port | | request | | | If Context Provided: | | | IP Address | | ICE password request | | | Context ID = c1 | | | IP Version = IPv4 or | | ICE Ufrag request | | IPv6 | If IP Interface | | | | Type: | ICE pacing request | | } | | | | | IP interface = \"IP | If SDPCapNeg is | | | interface type\" | signalled to the | | | | gateway: | | | If Resources for | | | | multiple Codecs | SDPCapNeg | | | shall be reserved: | configuration | | | | | | | Reserve_Value | } | | | | | | | If CTM call and | Remote Descriptor { | | | Access Termination: | | | | | Codec List | | | State= ctmstate | | | | | RTP Payloads | | | Transport= | | | | ctmtransport | RtcpbwRS | | | | | | | Version= ctmtext | RtcpbwRR | | | version | | | | | If RTCP APP messages | | | N | allowed | | | otificationRequested | | | | (Event ID = x, | Allowed RTCP APP | | | | message | | | \"termination | | | | heartbeat\") | types | | | | | | | If indication on | If ICE is applied: | | | Bearer Released | | | | requested: | ICE received | | | | candidate | | | N | | | | otificationRequested | ICE received | | | (Event ID = x, \"BNC | password | | | Release (Cause)\") | | | | -- as defined in | ICE received Ufrag | | | ITU‑T Recommendation | | | | Q.1950 | (NOTE 3) | | | | | | | If multiple IP | If SDPCapNeg is | | | realms: IP realm | signalled to the | | | Identifier = | gateway: | | | required IP realm | | | | identifier | SDPCapNeg | | | | configuration | | | If indication on | | | | Protocol Negotiation | } | | | Result requested: | | | | | If data call other | | | N | than SCUDIF | | | otificationRequested | multimedia call and | | | (Event ID = x, | Anchor MGW Network | | | \"Prot Negotiation | Termination: | | | Result\") | | | | | PLMN bearer | | | If indication on | capability = | | | Rate Change | PLMN capability | | | requested: | | | | | If GSM data call | | | N | other than SCUDIF | | | otificationRequested | multimedia call and | | | (Event ID = x, | Anchor MGW Network | | | \"RateChange\") | Termination: | | | | | | | If access | GSM channel coding = | | | termination and | coding | | | notification on CTM | | | | negotiation result | | | | requested: | | | | | | | | N | | | | otificationRequested | | | | (Event ID = x, \" | | | | connchange \") | | | | | | | | If diffserv required | | | | (NOTE 1):- | | | | | | | | Diffserv Code Point | | | | | | | | If tagging behaviour | | | | | | | | Diffserv Tagging | | | | Behaviour | | | | | | | | If Remote Source | | | | Address Filtering | | | | required (NOTE 1):- | | | | | | | | Remote Source | | | | Address Filtering | | | | | | | | If Remote Source | | | | Address range | | | | required:- | | | | | | | | Remote Source | | | | Address Mask | | | | | | | | If Remote Source | | | | Port Filtering | | | | | | | | required:- | | | | | | | | Remote Source Port | | | | Filtering | | | | | | | | If individual port:- | | | | | | | | Remote Source Port | | | | | | | | If range of ports: | | | | | | | | Remote Source Port | | | | Range | | | | | | | | If Media Inactivity | | | | Detection Required | | | | (NOTE 1): | | | | | | | | N | | | | otificationRequested | | | | (Event ID = x, | | | | \"Media Inactivity | | | | Detection (Media | | | | Inactivity Detection | | | | Time, Media | | | | Inactivity Detection | | | | Direction) \") | | | | (NOTE2) | | | | | | | | If Sustainable Data | | | | Rate Policing | | | | Required (NOTE 1):- | | | | | | | | Policing Required | | | | | | | | Sustainable Data | | | | Rate | | | | | | | | Maximum Burst Size | | | | | | | | If peak data rate | | | | policing (NOTE 1) | | | | | | | | Policing Required | | | | | | | | Peak Data Rate | | | | | | | | If Delay Variation | | | | required | | | | | | | | Delay Variation | | | | Tolerance | | | | | | | | If RTCP handling | | | | required (NOTE 1): | | | | | | | | RTCP allocation | | | | | | | | If ECN Endpoint | | | | support required | | | | | | | | ECN Enable = | | | | \"True\" | | | | | | | | Initiation Method = | | | | \"ECN Initiation | | | | | | | | Method\" | | | | | | | | If notification of | | | | ECN Failure | | | | | | | | Report: | | | | | | | | N | | | | otificationRequested | | | | (Event ID | | | | | | | | = x,\"ECN Failure\") | | +----------------------+----------------------+----------------------+ | NOTE 1: Only for | | | | terminations with | | | | border control | | | | functions support. | | | | | | | | NOTE 2: The event | | | | parameters \"Media | | | | Inactivity Detection | | | | Time\" and \"Media | | | | Inactivity Detection | | | | Direction\" are | | | | optional. | | | | | | | | NOTE 3: The support | | | | of ICE received | | | | candidate, ICE | | | | received password, | | | | ICE received Ufrag | | | | are optional for ICE | | | | lite, as specified | | | | in | | | | 3G | | | | PP TS 29.292 [60]. | | | | | | | | NOTE 4: The ICE | | | | received pacing is | | | | only applicable for | | | | full ICE, as | | | | specified in | | | | I | | | | ETF RFC 8445 [86]. | | | +----------------------+----------------------+----------------------+
When the processing of command (1) is complete, the MGW initiates the
following procedure.
Table 14.2.53.2: ADD.resp(Reserve and Configure RTP Connection Point
Acknowledge) MGW to MGC
+----------------------+---------------------+----------------------+ | Address Information | Control information | Bearer information | +======================+=====================+======================+ | Local Descriptor { | Transaction ID | Local Descriptor { | | | | | | Port | Termination ID | Codec List | | | | | | IP Address | Context ID | RTP Payloads | | | | | | IP Version | | RtcpbwRS | | | | | | } | | RtcpbwRR | | | | | | Remote Descriptor { | | If ICE is applied: | | | | | | Port | | ICE host candidate | | | | | | IP Address | | ICE password | | | | | | IP Version | | ICE Ufrag | | | | | | } NOTE | | ICE pacing | | | | | | | | If ICE lite | | | | implementation | | | | | | | | ICE lite indication | | | | | | | | If SDPCapNeg is | | | | signalled to the | | | | gateway: | | | | | | | | SDPCapNeg | | | | configuration | | | | | | | | } | | | | | | | | Remote Descriptor { | | | | | | | | Codec List | | | | | | | | RTP Payloads | | | | | | | | RtcpbwRS | | | | | | | | RtcpbwRR | | | | | | | | If SDPCapNeg is | | | | signalled to the | | | | gateway: | | | | | | | | SDPCapNeg | | | | configuration | | | | | | | | } NOTE | +----------------------+---------------------+----------------------+ | NOTE: Sending of the | | | | Remote Descriptor is | | | | optional | | | +----------------------+---------------------+----------------------+
...
The MGC responds as in Table 14.2.54.2
...
+---------------------+-------------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+-------------------------+--------------------+ | | Transaction ID = x | | | | | | | | Context ID = C1 | | | | | | | | Termination ID = T1 | | | | | | | | Event_ID (Event ID = | | | | x, \"Media Inactivity | | | | Detection\") | | +---------------------+-------------------------+--------------------+
When the processing of command is complete, the MGC initiates the following
procedure.
14.2.55.2 NOT.resp (Media Inactivity) MGC to MGW
+---------------------+---------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+---------------------+--------------------+ | | Transaction ID = x | | | | | | | | Context ID = C1 | | | | | | | | Termination ID = T1 | | +---------------------+---------------------+--------------------+
14.2.56 ICE Connectivity Check Result Notification
The MGW sends a NOTIFY request command as defined in Table 14.2.56.1.
Table 14.2.56.1: ICE Connectivity Check Result Notification
...
The MSC Server responds as defined in Table 14.2.56.2
Table 14.2.56.2: ICE Connectivity Check Result Notification Ack
+---------------------+---------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+---------------------+--------------------+ | | Transaction ID = x | | | | | | | | Context ID = C1 | | | | | | | | Termination ID = T1 | | +---------------------+---------------------+--------------------+
14.2.57 ICE New Peer Reflexive Candidate Notification
The MGW sends a NOTIFY request command as defined in Table 14.2.57.1.
Table 14.2.57.1: ICE New Peer Reflexive Candidate Notification
...
The MSC Server responds as defined in Table 14.2.57.2
Table 14.2.57.2: ICE New Peer Reflexive Candidate Ack
+---------------------+---------------------+--------------------+ | Address Information | Control information | Bearer information | +---------------------+---------------------+--------------------+ | | Transaction ID = x | | | | | | | | Context ID = C1 | | | | | | | | Termination ID = T1 | | +---------------------+---------------------+--------------------+
# 15 UMTS packages
## 15.1 Mandatory UMTS packages
The following package shall be supported for the UMTS Bearer Independent
Circuit-Switched Core Network:
\- 3GUP (User Plane) package (see clause 15.1.1).
### 15.1.1 3GUP package.
...
\- If Initialisation Direction is set to \"outgoing\", then initialisations
received are from the terminating RAN and cannot be forwarded internally. RFCI
value correction can be performed at this termination, and initialisations can
be sent out to the RAN.
...
the network:
\- Circuit Switched Data package (see clause 15.2.1);
\- TFO package (see clause 15.2.2);
\- 3G Expanded Call Progress Tones Generator package (see clause 15.2.3);
\- Modification of Link Characteristics Bearer Capabiltity package (see clause
15.2.4);
\- Enhanced Circuit Switched Data package (see clause 15.2.5);
\- Cellular Text telephone Modem Text Transport package (see clause 15.2.6);
\- IP transport package (see clause 15.2.7);
\- Flexible Tone Generator Package (see clause 15.2.8);
\- Trace Package (see clause 15.2.9);
\- ASCI Group Call package (see clause 15.2.10);
...
Type: Octet string.
Possible values:
\- Specified in the clause \"Bearer capability\" in 3GPP TS 24.008 [3] ,
...
Type: Octet string.
Possible values:
\- The second octet of Chosen Channel as specified in the clause \"Chosen
...
\- Type: Enumeration.
\- Possible Values:
\- \"Success\" (0x0001): the protocol negotiation on the termination has been
successful.
\- \"Failure\" (0x0000): the protocol negotiation on the termination has
failed.
...
\- Type: Enumeration.
\- Possible Values:
\- \"Unsp\" (0x0001): the protocol negotiation has failed for an unspecified
reason.
\- \"V8V34\" (0x0002): the V.8 or the V.34 protocol negotiation has failed
(modem termination only).
Rate Change:
...
\- Type: Integer.
\- Possible Values: transmission rate in bits per second, rounded to the
nearest integer value. The value must be a valid bitrate; one of the following
rates: 2400, 4800, 9600, 14400, 28800, 57600. An invalid rate shall cause the
call to be released by the MSC Server.
#### 15.2.1.3 Signals
Activate Protocol:
...
calls. It is used to inform the modem whether it should act as originating or
terminating peer. This parameter is only included within signal towards the
radio access. This may either be an Access Termination or a CN Termination
toward another MGW that serves the radio access.
#### 15.2.1.4 Statistics
None.
#### 15.2.1.5 Procedures
...
the mobile side and the ISDN BC (standard H.248 properties, clause \"Bearer
...
Where:
\- UMTS_AMR_2 parameters are: ETSI, UMTS_AMR_2, ACS={12.2, 7.4, 5.9, 4.75},
SCS={12.2, 7.4, 5.9, 4.75}, OM=0 plus MACS=4
...
\- Possible Values:
\- Mc Single Codec;
\- Similar to as defined in ITU-T Recommendation Q.765.5 [24], for single
codec information (figure 14/Q.765.5), where the Codec Information is defined
either in ITU-T Recommendation Q.765.5 [24] or in another specification for
the given Organization Identifier. For 3GPP codecs these are defined in 3GPP
TS 26.103 [16]. The ACodec property in H.248 binary encoding or codecconfig
attribute in H.248 text encoding contain the contents of the ITU-T Single
Codec IE, excluding the Single Codec Identifier, Length Indication and
...
ITU-T Single Codec IE, excluding the Single Codec Identifier, Length
Indication and Compatibility Information.
The first Codec Type in the list is the Distant Used Codec, received from the
distant TFO partner (see 3GPP TS 28.062 [5]). .
...
\- Description: reports whether TFO has been established or broken. Upon TFO
activation, no notification is sent if TFO has not been established. A TFO_Off
notification is only reported when a TFO link previously established is
broken. The MGW should not report transient TFO status change.
\- Type: Boolean
\- Possible Values:
...
This package extends \"Circuit Switched Data Package\", as defined in clause
15.1.2. This package adds a new property to define the user bitrate at a Iu
termination.
#### 15.2.5.1 Properties
Bitrate
...
(see clauses 14.2.41 and 14.2.42).
...
specified in 3GPP TS 23.078 [22] clause 4.5.7.1.2
...
* * *
Profile name: Threegbicsn Version: 8
* * *
...
+-----------------------+-------------------+-----------------------+ | Context Attribute | Supported | Values Supported | +-----------------------+-------------------+-----------------------+ | Topology | Yes (NOTE 1) | See clause C.7.8 | | | | Topology Descriptor | +-----------------------+-------------------+-----------------------+ | Priority Indicator | Optional (NOTE 3) | 0-15 (NOTE 4) | +-----------------------+-------------------+-----------------------+ | Emergency Indicator | Yes | NA | +-----------------------+-------------------+-----------------------+ | IEPS Indicator (NOTE | No | NA | | 2) | | | +-----------------------+-------------------+-----------------------+ | ContextAttribute | No | NA | | Descriptor (NOTE 2) | | | +-----------------------+-------------------+-----------------------+ | ContextIDList | No | NA | | Parameter (NOTE 2) | | | +-----------------------+-------------------+-----------------------+ | NOTE 1: Stream ID in | | | | Topology Descriptor | | | | shall not be | | | | supported. | | | | | | | | NOTE 2: This field | | | | requires at least | | | | version 3 of the | | | | H.248.1 protocol. | | | | | | | | NOTE 3: This Context | | | | Attribute parameter | | | | is used for MPS as | | | | specified in 3GPP TS | | | | 22.153 [78]. | | | | | | | | NOTE 4: Priority | | | | values 11 -- 15 of | | | | the Priority | | | | Indicator are | | | | reserved for MPS. | | | +-----------------------+-------------------+-----------------------+
...
> clause C.6.1.2.2. Other usage un-specified.
...
* * *
NotifyRegulated: None NeverNotify: None NOTE: This field requires at least
...
+----------------------+----------------------+----------------------+ | Audited Properties: | Property Name and | Descriptor | | | Identity | | +----------------------+----------------------+----------------------+ | Termination ID | TerminationState: | TerminationState | | | | Descriptor | | | - TDM: ALL | | | | (indicating 1 TDM | | | | group) , individual | | | | termination (NOTE2) | | | | | | | | - ATM/IP: | | | | individual | | | | termination | | | | | | | | - Root (MGW Audit) | | +----------------------+----------------------+----------------------+ | Termination ID | For Packages: | _Packages Descriptor | | | | (NOTE1)_ | | | - Root | | +----------------------+----------------------+----------------------+ | Termination ID | None (MGW Audit) : | _Audit (empty) | | | | Descriptor_ | | | - Root | | +----------------------+----------------------+----------------------+ | Termination ID | IP Realm | TerminationState | | | Availability : | Descriptor | | | | | | | - ipra/* (ROOT) | | +----------------------+----------------------+----------------------+ | Termination ID | SDPCapNeg | TerminationState | | | Extensions: | Descriptor | | | | | | | - sdpe/* | | +----------------------+----------------------+----------------------+ | Audited Statistics: | None | | +----------------------+----------------------+----------------------+ | Audited Signals: | None | | +----------------------+----------------------+----------------------+ | Audited Events: | None | | +----------------------+----------------------+----------------------+ | Packages Audit | Yes | | | Possible | | | +----------------------+----------------------+----------------------+ | NOTE1: Support of | | | | this capability is | | | | optional. | | | | | | | | NOTE2: Auditing a | | | | single termination | | | | of a TDM group is an | | | | alternative to the | | | | wildcarded audit | | | | (TDM: ALL) to derive | | | | the service state of | | | | the TDM group (all | | | | the terminations of | | | | the TDM group share | | | | the same service | | | | state). | | | +----------------------+----------------------+----------------------+
...
+------------------+------------------+---------+------------------+ | Optional | | | | | Packages: | | | | +------------------+------------------+---------+------------------+ | Package Name | PackageID | Version | Support | | | | | dependent on: | +------------------+------------------+---------+------------------+ | Basic Call | bcg, (0x0023) | v1 | Services | | Progress Tones | | | provided by | | Generator with | | | network | | Directionality, | | | | | (see ITU-T | | | | | Recommendation | | | | | Q.1950 [23] | | | | | annex A.8) | | | | +------------------+------------------+---------+------------------+ | Expanded Call | xcg, (0x0024) | v1 | Services | | Progress tones | | | provided by | | Generator | | | network | | Package (see | | | | | ITU-T | | | | | Recommendation | | | | | Q.1950 [23] | | | | | annex A.9) | | | | +------------------+------------------+---------+------------------+ | Basic Services | srvtn, (0x0025) | v1 | Services | | Tones Generation | | | provided by | | Package (see | | | network | | ITU-T | | | | | Recommendation | | | | | Q.1950 [23] | | | | | annex A.10) | | | | +------------------+------------------+---------+------------------+ | Bearer Control | Bt, (0x0022) | v1 | Interworking | | Tunnelling | | | with BICC and IP | | Package (see | | | transport | | ITU-T | | | | | Recommendation | | | | | Q.1950 [23] | | | | | annex A.7) | | | | +------------------+------------------+---------+------------------+ | Expanded | xsrvtn, (0x0026) | v1 | Services | | Services Tones | | | provided by | | Generation | | | network | | Package (see | | | | | ITU-T | | | | | Recommendation | | | | | Q.1950 [23] | | | | | annex A.11) | | | | +------------------+------------------+---------+------------------+ | Intrusion Tones | Int, (0x0027) | v1 | Services | | Generation | | | provided by | | Package (see | | | network | | ITU-T | | | | | Recommendation | | | | | Q.1950 [23] | | | | | annex A.12) | | | | +------------------+------------------+---------+------------------+ | Business Tones | BIZTN, (0x0028) | v1 | Services | | Generation | | | provided by | | Package (see | | | network | | ITU-T | | | | | Recommendation | | | | | Q.1950 [23] | | | | | annex A.13) | | | | +------------------+------------------+---------+------------------+ | Tone Generator | tongen, (0x0003) | v1 | (NOTE) | | Package (see | | | | | ITU-T | | | | | Recommendation | | | | | H.248.1 [10] | | | | | annex E.3) | | | | +------------------+------------------+---------+------------------+ | Generic | an, (0x001d) | v1 | Variable | | Announcement | | | Announcements | | Package (see | | | | | ITU-T | | | | | Recommendation | | | | | H.248.7 [28]) | | | | | -- Variable | | | | | Announcements | | | | +------------------+------------------+---------+------------------+ | Text Telephony | txp, (0x0010) | v1 | Global text | | Package (see | | | telephony | | ITU-T | | | support | | Recommendation | | | | | H.248.2 [17]). | | | | +------------------+------------------+---------+------------------+ | Call | ctyp, (0x0011) | v2 | Global text | | Discrimination | | | telephony | | package (see | | | support | | ITU-T | | | | | Recommendation | | | | | H.248.2 [17]). | | | | +------------------+------------------+---------+------------------+ | Basic Continuity | ct, (0x000a) | v1 | Only required | | Package (see | | | for TDM side | | ITU-T | | | terminations | | Recommendation | | | | | H.248.1 [10] | | | | | annex E.10). | | | | +------------------+------------------+---------+------------------+ | Circuit Switched | threegcsd, | v1 | Circuit Switched | | Data package | (0x0030) | | Data support | | (see clause | | | | | 15.2.1); | | | | +------------------+------------------+---------+------------------+ | TFO package (see | threegtfoc, | v2 | TFO support | | clause 15.2.2); | (0x0031) | | | +------------------+------------------+---------+------------------+ | 3G Expanded Call | threegxcg, | v1 | Services | | Progress Tones | (0x0032) | | provided by | | Generator | | | network | | package (see | | | | | clause 15.2.3); | | | | +------------------+------------------+---------+------------------+ | Modification of | threegmlc, | v1 | | | Link | (0x0046) | | | | Characteristics | | | | | Bearer | | | | | Capability | | | | | package (see | | | | | clause 15.2.4); | | | | +------------------+------------------+---------+------------------+ | Enhanced Circuit | thre | v1 | Circuit Switched | | Switched Data | egcsden,(0x0082) | | Data support | | package (see | | | | | clause 15.2.5); | | | | +------------------+------------------+---------+------------------+ | Cellular Text | threegctm, | v1 | Global text | | telephone Modem | (0x0068) | | telephony | | Text Transport | | | support | | package (see | | | | | clause 15.2.6); | | | | +------------------+------------------+---------+------------------+ | Flexible Tone | threegflex, | v1 | Services | | Generator | (0x0084) | | provided by | | Package (see | | | network | | clause 15.2.8). | | | | +------------------+------------------+---------+------------------+ | Trace Package | calltrace, | v1 | | | (see clause | (0x0097) | | | | 15.2.9) | | | | +------------------+------------------+---------+------------------+ | ASCI Group call | threegasci, | v2 | VGCS and VBS | | package | (0x00b2) | | services | | | | | supported | | (see clause | | | | | 15.2.10) | | | | +------------------+------------------+---------+------------------+ | IP Domain | ipdc, (0x009d) | v1 | Multiple IP | | connection | | | realms supported | | package (see | | | | | ITU-T | | | | | Recommendation | | | | | H.248.41 [42]) | | | | +------------------+------------------+---------+------------------+ | Inactivity timer | it, (0x0045) | v1 | UDP transport | | package (see | | | supported | | ITU-T | | | | | Recommendation. | | | | | H248.14 [45]) | | | | +------------------+------------------+---------+------------------+ | 3GUP (User | threegup, | v1 | Mandatory for | | Plane) package | (0x002f) | | BICC and Iu | | (see clause | | | terminations | | 15.1.1) | | | | +------------------+------------------+---------+------------------+ | Bearer | bcp, (0x001e) | v2 | Mandatory for | | Characteristics | | | BICC | | Package (see | | | terminations | | ITU-T | | | | | Recommendation | | | | | Q.1950 [23] | | | | | annex A.3) | | | | +------------------+------------------+---------+------------------+ | Generic Bearer | Gb, (0x0021) | v1 | Mandatory only | | Connection | | | for BICC and Iu | | Package (see | | | terminations | | ITU-T | | | | | Recommendation | | | | | Q.1950 [23] | | | | | annex A.6) | | | | +------------------+------------------+---------+------------------+ | 3G Interface | threegint | v1 | | | Type package | (0x00e3) | | | | (see clause | | | | | 15.2.11) | | | | +------------------+------------------+---------+------------------+ | RTP Control | rtcph. (0x00b5) | v1 | Border control | | Protocol Package | | | functions | | (ITU-T | | | support | | Recommendation | | | | | H.248.57 [66]) | | | | +------------------+------------------+---------+------------------+ | Gate management | gm, (0x008c) | v2 | Border control | | Source | | | functions | | Address/Port | | | support | | Filtering | | | | | Package (ITU-T | | | | | Recommendation | | | | | H.248.43, Clause | | | | | 7 [67]) | | | | +------------------+------------------+---------+------------------+ | Traffic | tman, (0x008d) | v1 | Border control | | management | | | functions | | (ITU-T | | | support | | Recommendation | | | | | H.248.53 [69]) | | | | +------------------+------------------+---------+------------------+ | Diffserv (ITU-T | ds, (0x008b) | v2 | Border control | | Recommendation | | | functions | | H.248.52 [70]) | | | support | +------------------+------------------+---------+------------------+ | **Application | adid (0x009c) | v1 | Border control | | Data Inactivity | | | functions | | Detection | | | support | | (** ITU-T | | | | | Recommendation | | | | | **H.248.40 | | | | | [71])** | | | | +------------------+------------------+---------+------------------+ | **IP realm |** ipra | v1 | Border control | | availability | (0x00e0)**| | functions | | (ITU-T | | | support | | Recommendation | | | | | H.248.41 | | | | | Amendment 1) | | | | | [72]** | | | | +------------------+------------------+---------+------------------+ | **Explicit | ecnrous(0x010b) | v1 |** Support of ECN | | Congestion | | | feature**| | Notification** | | | | | for RTP-over-UDP | | | | | Support **(see** | | | | | ITU-T | | | | | Recommendation | | | | | H.248.82 | | | | | [79]**)** | | | | +------------------+------------------+---------+------------------+ | MG Act-as STUN | mgastuns | v1 | Support of | | Server (ITU-T | (0x00c2) | | incoming STUN | | Recommendation | | | connectivity | | H.248.50 [81]) | | | checks. | | | | | | | | | | Applicable for | | | | | ICE lite and | | | | | full ICE | +------------------+------------------+---------+------------------+ | Originate STUN | ostuncc (0x00c3) | v1 | Support of | | Continuity Check | | | originating STUN | | (see ITU-T | | | connectivity | | Recommendation | | | checks | | H.248.50 [81]) | | | | | | | | Only applicable | | | | | for full ICE | +------------------+------------------+---------+------------------+ | Enhanced Revised | eroas, (0x0109) | v1 | Support of the | | Offer/Answer SDP | | | SDP Capability | | Support ([ITU-T | | | Negotiation | | Recommendation | | | syntax | | H.248.80 [85]) | | | | +------------------+------------------+---------+------------------+ | NOTE: This | | | | | package is \"for | | | | | extension only\" | | | | | and shall not be | | | | | published over | | | | | the Mc | | | | | interface. | | | | +------------------+------------------+---------+------------------+
...
+-------------+-------------+-------------+-------------+-------------+ | Properties | Mandatory/ | Used in | Supported | Provisioned | | | | command: | Values: | Value: | | | Optional | | | | +-------------+-------------+-------------+-------------+-------------+ | None | - | - | - | - | +-------------+-------------+-------------+-------------+-------------+ | Signals | Mandatory/ | Used in | Duration | | | | | command: | Provisioned | | | | Optional | | Value: | | +-------------+-------------+-------------+-------------+-------------+ | None | - | - | - | | +-------------+-------------+-------------+-------------+-------------+ | | Signal | Mandatory/ | Supported | Duration | | | Parameters | | | Provisioned | | | | Optional | Values: | Value: | +-------------+-------------+-------------+-------------+-------------+ | | - | - | - | - | +-------------+-------------+-------------+-------------+-------------+ | Events | Mandatory/ | Used in | | | | | | command: | | | | | Optional | | | | +-------------+-------------+-------------+-------------+-------------+ | Inactivity | M | MOD, NOTIFY | | | | Timeout | | | | | | (it/ito, | | | | | | 0x0 | | | | | | 045/0x0001) | | | | | +-------------+-------------+-------------+-------------+-------------+ | | Event | Mandatory/ | Supported | Provisioned | | | | | | Value: | | | Parameters | Optional | Values: | | +-------------+-------------+-------------+-------------+-------------+ | | Maximum | M | Any integer | U | | | Inactivity | | | nspecified, | | | Time | | | if not sent | | | ( | | | a value | | | mit,0x0001) | | | must be | | | | | | p | | | | | | rovisioned. | +-------------+-------------+-------------+-------------+-------------+ | | Ob | Mandatory/ | Supported | Provisioned | | | servedEvent | | | Value: | | | | Optional | Values: | | | | Parameters | | | | +-------------+-------------+-------------+-------------+-------------+ | | None | - | - | - | +-------------+-------------+-------------+-------------+-------------+ | Statistics | Mandatory/ | Used in | Supported | | | | | command: | Values: | | | | Optional | | | | +-------------+-------------+-------------+-------------+-------------+ | None | - | - | - | | +-------------+-------------+-------------+-------------+-------------+ | Error Codes | Mandatory/ | | | | | | Optional | | | | +-------------+-------------+-------------+-------------+-------------+ | None | - | | | | +-------------+-------------+-------------+-------------+-------------+
...
### C.14.45 Originate STUN Continuity Check (ostuncc)
Table C.14.45.1: Originate STUN Continuity Check Package
...
### C.14.46 Enhanced Revised Offer/Answer SDP Support (eroas)
Table C.14.46: Enhanced Revised Offer/Answer SDP Support package
+-------------+-------------+-------------+-------------+-------------+ | Properties | Mandato | Used in | Supported | Provisioned | | | ry/Optional | command | Values | Value | +-------------+-------------+-------------+-------------+-------------+ | SDPCapNeg | M | AuditValue | \"cap-v0\" | \"cap-v0\" | | Extensions | | | | | | ( | | | | | | eroas/sdpe, | | | | | | 0x0 | | | | | | 109/0x0001) | | | | | +-------------+-------------+-------------+-------------+-------------+ | Signals | Mandato | Used in | **Duration | | | | ry/Optional | command | Provisioned | | | | | | Value** | | +-------------+-------------+-------------+-------------+-------------+ | None | - | - | **-** | | +-------------+-------------+-------------+-------------+-------------+ | | Signal | Mandato | Supported | **Duration | | | Parameters | ry/Optional | Values | Provisioned | | | | | | Value** | +-------------+-------------+-------------+-------------+-------------+ | | - | - | - | **-** | +-------------+-------------+-------------+-------------+-------------+ | Events | Mandato | **Used in | | | | | ry/Optional | command** | | | +-------------+-------------+-------------+-------------+-------------+ | None | - | **-** | | | +-------------+-------------+-------------+-------------+-------------+ | | Event | Mandato | Supported | ** | | | Parameters | ry/Optional | Values | Provisioned | | | | | | Value**| +-------------+-------------+-------------+-------------+-------------+ | | - | - | - |** -**| +-------------+-------------+-------------+-------------+-------------+ | | Ob | Mandato | Supported | Provisioned | | | servedEvent | ry/Optional | Values | Value | | | | | | | | | Parameters | | | | +-------------+-------------+-------------+-------------+-------------+ | | - | - | - | - | +-------------+-------------+-------------+-------------+-------------+ | Statistics | Mandato | Used in |** Supported | | | | ry/Optional | command | Values**| | +-------------+-------------+-------------+-------------+-------------+ | None | - | - | - | | +-------------+-------------+-------------+-------------+-------------+ | Error Codes |** Mandatory | | | | | | /Optional** | | | | +-------------+-------------+-------------+-------------+-------------+ | None | - | | | | +-------------+-------------+-------------+-------------+-------------+
