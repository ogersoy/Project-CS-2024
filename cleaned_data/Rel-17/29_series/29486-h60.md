...
Filelist 6.2.6.2.3  
LocalMbmsInfo 6.2.6.2.4 LocalMBMS
* * *
...
6.6.6.2.2  
HdMapDynamicInfoNotification 6.6.6.2.3  
NearbyUeInfo 6.6.6.2.4
* * *
...
AppplicationQosRequirement 6.7.6.3.4 Contains the application layer QoS
requirement.  
Notification 6.7.6.2.3 Contains the result of the establishment or update of
the session-oriented service.  
SessionOrientedData 6.7.6.2.2 Contains the data to trigger establishment or
...
* * *
Data type Reference Comments Applicability AverWindow 3GPP TS 29.571 [11]  
ExtMaxDataBurstVol 3GPP TS 29.571 [11]  
PacketDelBudget 3GPP TS 29.571 [11]  
PacketErrRate 3GPP TS 29.571 [11]  
QosResourceType 3GPP TS 29.571 [11]  
Result 6.1.6.3.3  
SupportedFeatures 3GPP TS 29.571 [11]  
TestNotification 3GPP TS 29.122 [22] Represents a notification that can be
sent to test whether a chosen notification mechanism works.
Notification_test_event Uinteger 3GPP TS 29.571 [11]  
...
ProvisioningRequirement 6.9.6.2.2
* * *
...
All rights reserved.
externalDocs:
description: 3GPP TS 29.486 V17.5.0 V2X Application Enabler (VAE) Services
...
description: Represents an individual Application Requirement resource for a
V2X UE ID or a V2X group ID.
type: object
properties:
ueId:
...
\- type: string
ReservationResult:
description: Represents the result of the network resource adaptation
corresponding to the V2X application requirement.
anyOf:
\- type: string
enum:
...
schemas:
V2xServiceInfo:
description: Represents an individual geographical area resource including the
designated V2X service identifier.
type: object
properties:
serviceIds:
type: array
...
description: Represents an individual HdMap DynamicInfo Subscription resource
for a V2X UE ID.
type: object
properties:
ueId:
...
description: Represents a notificaton of HD map dynamic info corresponding to
the subscription.
type: object
properties:
resourceUri:
...
\- location
\- distance
# A.8 VAE_SessionOrientedService
openapi: 3.0.0
info:
version: 1.0.0
...
schemas:
SessionOrientedData:
description: Represents an Individual Session Oriented Service Subscription
resource.
type: object
properties:
ueId:
...
\- appSerId
Notification:
description: Represents a notificaton of result of Session Oriented Service.
type: object
properties:
resourceUri:
\$ref: \'TS29571_CommonData.yaml#/components/schemas/Uri\'
...
suppFeat:
\$ref: \'TS29571_CommonData.yaml#/components/schemas/SupportedFeatures\'
# A.10 VAE_PC5ProvisioningRequirement
openapi: 3.0.0
info:
version: 1.0.0
