...
request was rejected, the PFDF shall indicate the reason using an appropriate
...
#### 6.4.8.1 General
In addition to subclause 6.4.3, Table 6.4.8.1.1 describes the extra JSON
...
the PCEF/TDF.
# B.2 Request for PFDs by Full Pull ("Pull mode")
