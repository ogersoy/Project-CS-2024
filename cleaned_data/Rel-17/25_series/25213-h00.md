...
signal S\'. The scrambling code shall be applied aligned with the radio
frames, i.e. the first scrambling chip corresponds to the beginning of a radio
frame.
...
the modulation mapper may contain values from the set 0, 1, and \"DTX\". In
the event that all 4 bits of the quadruple are DTX bits, the output from the
