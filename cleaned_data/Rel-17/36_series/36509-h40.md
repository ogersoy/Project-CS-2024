...
There are 2 exceptions to message type values for E-UTRA and NB-IoT test
commands, which are the ones related to SET UL MESSAGE REQUEST (message type
equal to 10101100) and SET UL MESSAGE RESPONSE (message type equal to
10101101).
...
binary coded in a fixed length of 24 bits in a fixed length of 24 bits, DLO23
...
indicator TS 24.007 [5], sub clause 11.2.3.1.2 M V ½ Message type M V 1 Use
