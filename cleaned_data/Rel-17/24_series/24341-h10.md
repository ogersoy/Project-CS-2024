...
When an ongoing SMS service over IP network is handed over from non-3GPP
access to 3GPP access, the UE sends the MO-SMSoIP-attempt-started indication
and the handover of ongoing SMSoIP from non-3GPP access indication to the non-
access stratum.
