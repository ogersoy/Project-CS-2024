...
If the UE has received the UE assistance indicator in an ATSSS rule and
decides to apply for an SDF a UL traffic distribution different from the
default UL traffic distribution indicated in the load balancing steering mode
of the ATSSS rule, the UE sends a PMFP UAD provisioning message to the UPF.
...
is indicated as load balancing or priority based.
...
priority and the access with low priority.
...
+---------------------------------------+-------------+ | Length of access selection descriptor | octet f+1 | +---------------------------------------+-------------+ | Steering functionality | octet f+2 | +---------------------------------------+-------------+ | Steering mode | octet f+3 | +---------------------------------------+-------------+ | Steering mode information | octet f+4* | +---------------------------------------+-------------+ | Steering mode additional indicator | octet z* | | | | | | (NOTE) | +---------------------------------------+-------------+ | Threshold values | octet z+1* | | | | | | octet s* | +---------------------------------------+-------------+
...
**1** |  |  |  |  |  |  |  |  |   
0 | Do not report the access availability (NOTE) |  |  |  |  |  |  |  |   
...
COMPLETE message 0 0 0 0 1 1 0 0 PMFP UAD PROVISIONING COMPLETE message
All other values are reserved
* * *
...
+---------------------------------------+-------+-------+-------+-----+---------+---+---+---+ | 8 | 7 | 6 | 5 | 4 | 3 | 2 | 1 | | +---------------------------------------+-------+-------+-------+-----+---------+---+---+---+ | Additional measurement indication IEI | 0 | 0 | 0 | ACR | octet 1 | | | | | | | | | | | | | | | | spare | spare | spare | | | | | | +---------------------------------------+-------+-------+-------+-----+---------+---+---+---+
...
+-------------+-------------+-------------+-------------+-------------+ | TIMER NUM. | TIMER VALUE | CAUSE OF | NORMAL STOP | ON | | | | START | | | | | | | | THE | | | | | | | | | | | | 1^st^, | | | | | | 2^nd^, | | | | | | 3^rd^, | | | | | | 4^th^ | | | | | | EXPIRY | | | | | | (NOTE 1) | +-------------+-------------+-------------+-------------+-------------+ | T201 | NOTE 2 | T | A PMFP ECHO | Abort of | | | | ransmission | RESPONSE | the | | | | of the | message | procedure. | | | | first PMFP | received | | | | | ECHO | for each | | | | | REQUEST | sent PMFP | | | | | message | ECHO | | | | | | REQUEST | | | | | | message | | +-------------+-------------+-------------+-------------+-------------+ | T203 | 1s | T | PMFP PLR | Abort of | | | | ransmission | COUNT | the | | | | of PMFP PLR | RESPONSE | procedure. | | | | COUNT | message | | | | | REQUEST | with the | | | | | message | same EPTI | | | | | | is received | | +-------------+-------------+-------------+-------------+-------------+ | T204 | 1s | T | PMFP PLR | Abort of | | | | ransmission | REPORT | the | | | | of PMFP PLR | RESPONSE | procedure. | | | | REPORT | message | | | | | REQUEST | with the | | | | | message | same EPTI | | | | | | is received | | +-------------+-------------+-------------+-------------+-------------+ | NOTE 1: | | | | | | Typically, | | | | | | the | | | | | | procedures | | | | | | are aborted | | | | | | on the | | | | | | fifth | | | | | | expiry of | | | | | | the | | | | | | relevant | | | | | | timer. | | | | | | Exceptions | | | | | | are | | | | | | described | | | | | | in the | | | | | | co | | | | | | rresponding | | | | | | procedure | | | | | | d | | | | | | escription. | | | | | | | | | | | | NOTE 2: The | | | | | | value of | | | | | | this timer | | | | | | is network | | | | | | dependent. | | | | | +-------------+-------------+-------------+-------------+-------------+
