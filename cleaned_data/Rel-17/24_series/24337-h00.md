...
3) the SDP information as follows:
a) for the media component(s) that are to be established on the controller UE
containing the port number set to the port numbers of the controller UE; and
b) for the media component(s) that are to be established on the controllee UE
...
2) send information to the MRF to allocate the media resource for the media to
be replicated; and
...
Figure A.4.2: Controller UE establishes a cllaborative session by transferring
a media from controller UE to controllee UE
...
From: sip:user1_public1\@home1.net; tag=13579
Event: dialog; call-id=\" cb03a0s09a2sdfglkj321576\"; from-tag=\"54321\"; to-
tag=\"123456\"; include-session-description
Call-ID: cb03a0s09a2sdfglkj490333
CSeq: 1 SUBSCRIBE
Max-Forwards: 70
P-Preferred-Identity:
...
INVITE
sip:user1_public3\@home1.net;gr=urn:uuid:f81d4fae-7dec-11d0-a765-00a0c91e6bf6
SIP/2.0
Via:
...
Contact: \;gr=urn:uuid:f81d4fae-7dec-11d0-a765-00a0c67t6br4>;+g.3gpp.iut-
controller
...
entities**)
INVITE sip:user1\@example.net;gr=urn:uuid:f81d4fae-7dec-11d0-a765-00a0c91ewxyz
SIP/2.0
Via: SIP/2.0/UDP 192.0.2.5;comp=sigcomp;branch=z9hG4bKnashds7
Max-Forwards: 70
Route:
...
entities**)
INVITE sip:user1\@example.net;gr=urn:uuid:f81d4fae-7dec-11d0-a765-00a0c91e6bf6
SIP/2.0
Via: SIP/2.0/UDP 192.0.2.5;comp=sigcomp;branch=z9hG4bKnashds7
Max-Forwards: 70
Route:
...
Content-Type=application/sdp
Contact:
sip:user1_public2\@home1.net;gr=urn:uuid:f81d4fae-7dec-11d0-a765-00a0c91e6bf6;+g.3gpp.
current-iut-controller=Active
v=0
s=-
m=audio 0 RTP/AVP 97
m=video 1302 RTP/AVP 98 99
...
MESSAGE sip:user2\@home1.net;gr=urn:uuid:f81d4fae-7dec-11d0-2222-222222222222
SIP/2.0
Via: SIP/2.0/UDP
