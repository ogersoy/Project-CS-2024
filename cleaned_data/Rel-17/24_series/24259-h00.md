...
used for the home network of the originating user and home2.net is used for
...
This message is used between MSC/VLR and the UE to get the access granted for
the incoming call. It contains the following information.
...
The UE initiates the INVITE request with the request-URI of the UE-1 to the IM
