...
No impact on the TIR service. The TIR service handles the Privacy header field
following the procedures in this specification.
...
subclause 4.9.2 and the _simservs_ XML schema specified in subclause 6.3 of
3GPP TS 24.623 [15].
...
**\- Presentation-restricted:** configures the service to behave as specified
in subclause 4.5.2.9 for the case TIR service in \"temporary mode\" with
default \"restricted\".
**\- Presentation-not-restricted:** configures the service to behave as
specified in subclause 4.5.2.9 for the case TIR service in \"temporary mode\"
...
removes the P-Asserted‑Identity header fields and the Privacy header field.
