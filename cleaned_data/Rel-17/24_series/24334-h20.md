...
\- If the DISCOVERY_RESPONSE creates a new discovery entry, start the TTL
timer T4009 with the received value for each Restricted Discovery Filter
information element received in the DISCOVERY_RESPONSE message.
...
follow:
\- If the DISCOVERY_RESPONSE creates a new discovery entry, start the validity
timer T4013 with the received value for the ProSe Query Code and the
...
\- check the non-IP type field in the non-IP data PDU and provide the non-IP
data in the non-IP payload field of the non-IP data PDU to the corresponding
upper layer entity; or
\- provide the upper layers with the non-IP data in the non-IP payload field
of the non-IP data PDU and with the non-IP type in the non-IP type field of
the non-IP data PDU.
...
after M consecutive retransmissions of DIRECT_COMMUNICATION_REQUEST or
DIRECT_COMMUNICATION_KEEPALIVE messages; or
...
d) zero or one \ element containing the parameter
defined in subclause 12.2.2.38;
da) zero or one \ element containing the parameter defined in
subclause 12.2.2.71;
...
+-----+-------------+-------------+----------+--------+--------+ | IEI | Information | Typ | Presence | Format | Length | | | Element | e/Reference | | | | +-----+-------------+-------------+----------+--------+--------+ | | DIREC | PC5-SP | M | V | 1 | | | T_SECURITY | Message | | | | | | MODE | Type | | | | | | COMMAND | | | | | | | message | 12.5.1.1. | | | | | | identity | | | | | +-----+-------------+-------------+----------+--------+--------+ | | Sequence | Sequence | M | V | 2 | | | Number | Number | | | | | | | | | | | | | | 12.5.1.2 | | | | +-----+-------------+-------------+----------+--------+--------+ | | UE Security | UE Security | M | V | 2 | | | C | C | | | | | | apabilities | apabilities | | | | | | | | | | | | | | 12.5.1.22 | | | | +-----+-------------+-------------+----------+--------+--------+ | | Nonce 2 | Nonce 2 | M | V | 16 | | | | | | | | | | | 12.5.1.31 | | | | +-----+-------------+-------------+----------+--------+--------+ | | Chosen | Chosen | M | V | 1 | | | Algorithms | Algorithms | | | | | | | | | | | | | | 12.5.1.23 | | | | +-----+-------------+-------------+----------+--------+--------+ | | LSB of | LSB of | M | V | 1 | | | K~D-sess~ | K~D-sess~ | | | | | | ID | | | | | | | | 12.5.1.24 | | | | +-----+-------------+-------------+----------+--------+--------+ | 16 | MSB of K~D~ | MSB of K~D~ | O | TV | 3 | | | ID | ID | | | | | | | | | | | | | | 12.5.1.27 | | | | +-----+-------------+-------------+----------+--------+--------+ | 18 | K~D~ | K~D~ | O | TV | 17 | | | Freshness | Freshness | | | | | | | | | | | | | | 12.5.1.30 | | | | +-----+-------------+-------------+----------+--------+--------+ | 24 | GPI | GPI | O | TLV | 3-n | | | | | | | | | | | 12.5.1.18 | | | | +-----+-------------+-------------+----------+--------+--------+ | 1 | User Info | User Info | O | TLV | 3-253 | | | | | | | | | | | 12.5.1.3 | | | | +-----+-------------+-------------+----------+--------+--------+ | 22 | Signature | Signature | O | TV | 130 | | | | | | | | | | | 12.5.1.33 | | | | +-----+-------------+-------------+----------+--------+--------+ | 23 | Encrypted | Encrypted | O | TLV | 3-n | | | Payload | Payload | | | | | | | | | | | | | | 12.5.1.34 | | | | +-----+-------------+-------------+----------+--------+--------+
...
included in the non-IP payload.
* * *
