...
and their semantics is described in clause 4.9.
...
the subscribers request by using the mechanisms specified in clause 4.5.0.
...
mechanisms specified in clause 4.5.0 should be used. The detailed information
for the services ICB, OCB and ACR can individually be registered at the
subscribers request by using the mechanisms specified in clause 4.5.0.
For erasure of information for the services ICB, OCB and ACR, the mechanisms
specified in clause 4.5.0 should be used. The detailed information for the
services ICB, OCB and ACR can individually be erased at the subscribers
request by using the mechanisms specified in clause 4.5.0.
#### 4.5.1B Interrogation
For interrogation of the services ICB, OCB and ACR, the mechanisms specified
in clause 4.5.0 should be used.
...
proxy as specified in clause 5.7.4 of 3GPP TS 24.229 [2] or an AS providing
3rd party call control, and specifically as a routeing B2BUA, as specified in
clause 5.7.5 of 3GPP TS 24.229 [2]. An AS providing the ICB service and
rejecting the request shall operate as a terminating UA, as specified in
clause 5.7.2 of 3GPP TS 24.229 [2].
...
according to the algorithm as specified in clause 4.9.1.2 evaluates to
...
presented or be accessable (e.g. via the block list maintenance) to the served
user.
...
procedures as specified in clause 4.5.2.6.2.
...
proxy as specified in clause 5.7.4 of 3GPP TS 24.229 [2] or an AS providing
3rd party call control, and specifically as a routeing B2BUA, as specified in
clause 5.7.5 of 3GPP TS 24.229 [2]. An AS providing the ACR service and
rejecting the request shall operate as a terminating UA, as specified in
clause 5.7.2 of 3GPP TS 24.229 [2].
...
are rejected as a consequence of the procedure in clause 4.5.2.6.2.
...
specified in clause 6.3 of 3GPP TS 24.623 [6].
#### 4.9.1.1 General
...
common policy draft (see IETF RFC 4745 [16], clause 10.2).
...
To create an allow list of identities towards which outgoing communications
are always allowed, rules where the action is allow=true can be created. User
or operator provided allow lists may be built. Operator defined rules shall
not be exposed over the Ut interface.
NOTE: Operator provided allow lists are provisioned over a proprietary
interface.
...
in clause 4.9.1.4 then the condition is provisioned for the user. The
