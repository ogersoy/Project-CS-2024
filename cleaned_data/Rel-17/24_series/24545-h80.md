...
* * *
Trigger Configurations /val-services/{valServiceId}/trigger-configurations GET
...
This method shall support the response data structures and response codes
specified in table B.4.1.2.3.3-1.
Table B.4.1.2.3.3-1: Data structures supported by the GET Response payload on
this resource
