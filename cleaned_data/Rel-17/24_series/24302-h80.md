...
If the UE supports N1 mode, the UE shall indicate the PDU session ID in the
IKE_AUTH request message. If N1 mode capability is disabled, the UE may
indicate the PDU session ID in the IKE_AUTH request message.
...
+------------------------+------------------------+-----------------+ | Access Network | Type of Access Network | | | Identity | | | +========================+========================+=================+ | ANID Prefix | Additional ANID | | | | strings | | +------------------------+------------------------+-----------------+ | SNN-service-code, | S | N/A, see NOTE 3 | | which is \"5G\" | NN-network-identifier, | | | constant character | see NOTE 2 | | | string, see NOTE 1 and | | | | NOTE 2 | | | +------------------------+------------------------+-----------------+ | | \"NSWO\", see NOTE 4 | N/A, see NOTE 3 | +------------------------+------------------------+-----------------+ | NOTE 1: The quotes are | | | | not part of the | | | | definition of the | | | | character string. | | | | | | | | NOTE 2: Serving | | | | network name (SNN) | | | | specified in | | | | 3GPP TS 24.501 [76] | | | | is used as 5G Access | | | | Network Identity. | | | | | | | | NOTE 3: Type of Access | | | | Network is not | | | | applicable for 5G | | | | Access Network | | | | Identity. | | | | | | | | NOTE 4: In case of | | | | NSWO in 5GS, Access | | | | Network Identity is | | | | set to \"5G:NSWO\", | | | | which is a constant | | | | character string. | | | +------------------------+------------------------+-----------------+
...
clause 11.2.2.1 is shown in figure H.2.4.2-2:
* * *
7 6 5 4 3 2 1 0  
...
identical to the format of the PLMN List information element defined in clause
H.2.4.2.
...
element defined in clause H.2.4.2.
