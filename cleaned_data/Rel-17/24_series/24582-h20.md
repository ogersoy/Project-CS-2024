...
The originating participating MCData function shall provide an endpoint for
UDP based communication towards the originating MCData client, and a second
endpoint for UDP based communication towards the controlling MCData function.
The originating participating MCData function shall act as a relay for the UDP
...
The terminating participating MCData function shall provide an endpoint for
UDP based communication towards the terminating MCData client, and a second
endpoint for UDP based communication towards the controlling MCData function.
The terminating participating MCData function shall act as a relay for the UDP
traffic between these two adjacent UDP communication endpoints using the IP
addresses and UDP ports exchanged in the SDP offers/answers.
## 13.3 Controlling MCData function procedures
The controlling MCData function shall provide an endpoint for UDP based
communication towards the MCData originating participating MCData function,
and a second endpoint for UDP based communication towards the terminating
participating MCData function. The controlling MCData function shall act as a
relay for the UDP traffic between these two adjacent UDP Communication
endpoints using the IP addresses and UDP ports exchanged in the SDP
offers/answers.
