...
informs the S‑CSCF to route the PUBLISH request to the PS ps.home1.net.
...
NOTE 1: Error conditions are not considered in the examples e.g. if
...
NOTE 2: The authentication proxy resides between UE (XCAP client) and AS (XCAP
...
>
> Content-Length: 0
5\. **XCAP DELETE request (XCAP client to XCAP server) - see example in table
A.8.3-5**
