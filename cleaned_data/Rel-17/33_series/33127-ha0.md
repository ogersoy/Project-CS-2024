...
the AMF detects one the the following events:
...
interception.
{width="6.695138888888889in" height="6.143285214348206in"}
...
Cell supplemental information (CSI) shall include the physical location (e.g.
geographical coordinates) information for the reported cell. If the reported
cell is not fixed to a permanent location, the report should indicate the cell
mobility type (e.g. nomadic cell, vehicle-mounted cell) as well as the time
period of the location validity.
...
provide the IRI-POI functions for STIR/SHAKEN and RCD/eCNAM. In addition, at
...
Accordingly, table 7.14.2-1 identifies the IRI-POIs for STIR/SHAKEN and RCD
while table 7.14.2-2 identifies the IRI-POIs for eCNAM.
