...
nbIoTcellFlag CM Support Qualifier The NB-IoT (see TS 36.300 [11]) is
...
* * *
Attribute name **Support Qualifier** **isReadable** **isWritable**
**isInvariant** **isNotifyable** earfcnDl M T T F T earfcnUl M T T F T
* * *
...
* * *
Attribute name Support Qualifier isReadable isWritable isInvariant
isNotifyable id M T F T F mbsfnAreaId M T T F T **Attribute related to role**  
cellIdList M T T F T
* * *
...
* * *
Attribute name Support Qualifier isReadable isWritable isInvariant
isNotifyable candidateDeNBCells M T T F T **Attribute related to role**  
servingCell M T T F T
* * *
...
* * *
Attribute name Support Qualifier isReadable isWritable isInvariant
isNotifyable maxNbrRNAllowed M T T F T **Attribute related to role**  
servedRN M T T F T
* * *
...
* * *
Attribute name Support Qualifier isReadable isWritable isInvariant
isNotifyable id M T F T F cOCStatus M T F F T isCOCAllowed M T T F T
* * *
...
* * *
Attribute Name Support Qualifier isReadable isWritable isInvariant
isNotifyable qciDscpMappingList M T T F T
* * *
...
### 4.3.23 EP_Xw
#### 4.3.23.1 Definition
This IOC represents the end point of Xw reference point defined in TS 36.300
[11].
#### 4.3.23.2 Attributes
No additional attributes to the ones inherited from the IOC EP_RP defined in
TS 28.622 [6].
...
#### 4.3.24.1 Definition
This IOC represents the managed WLAN mobility set for LWA and LWIP. For more
information about the WLAN mobility set, see 3GPP TS 36.300 [11].
#### 4.3.24.2 Attributes
* * *
Attribute name Support Qualifier isReadable isWritable **isInvariant**
isNotifyable
...
### 4.3.25 MemberWLAN \>
#### 4.3.25.1 Definition
This \> represents the information about a member WLAN of a WLAN
mobility set.
#### 4.3.25.2 Attributes
* * *
Attribute name Support Qualifier isReadable isWritable **isInvariant**
isNotifyable wLANId M T T F T wLANGeoLocation O T T F T isLWASupported M T T F
T isLWIPSupported M T T F T
* * *
...
### 4.3.26 PLMNId \>
#### 4.3.26.1 Definition
This \> represents the information of a PLMN identification.
#### 4.3.26.2 Attributes
* * *
Attribute name Support Qualifier isReadable isWritable **isInvariant**
isNotifyable mCC M T T F T mNC M T T F T
* * *
