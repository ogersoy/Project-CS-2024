...
TR 21.905 [50], TS 32.240 [1] and the following aply:
...
An observed IMEI ticket is generated whenever tracklisted, blocklisted or non-
allow listed mobile equipment is detected during an IMEI check. The purpose of
...
conditions:
\- the LCS-MO-CDR, when the MSC receives the RANAP \"Location report\" message
from the RNC;
\- the LCS-MT-CDR, when the MSC receives the RANAP \"Location report\" message
from the RNC;
\- the LCS-NI-CDR, when the MSC receives the RANAP \"Location report\" message
from the RNC.
...
IMEI Status M M The result of the IMEI check e.g. blocklisted, tracklisted,
