...
## 4.1 HeNB OAM Functional Architecture {#henb-oam-functional-architecture
.list-paragraph}
...
#### 5.1.2.2 Serving HeMS Discovery via Initial HeMS accessible inside
...
procedure is shown in Figure 5-7 and described next.
