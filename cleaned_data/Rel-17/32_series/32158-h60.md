...
not even with the \"id\" only. This is because these nodes do not represent
necessary path components to the scoped objects on the second level.
...
+----------------------------------------------------------------------+ | HTTP/1.1 201 Created | | | | Date: Tue, 06 Aug 2019 16:50:26 GMT | | | | Location: | | ht | | tp://example.org/SubNetwork=SN1/ManagedElement=ME1/XyzFunction=XYZF3 | | | | Content-Type: application/json | | | | { | | | | \"id\": \"XYZF3\", | | | | \"attributes\": { | | | | \"attrA\": \"ghi\", | | | | \"attrB\": 553 | | | | } | | | | } | +----------------------------------------------------------------------+
...
When 3GPP JSON Patch is used to request the changes described in the first two
examples in clause A.6.1 the MnS consumer may send the following
