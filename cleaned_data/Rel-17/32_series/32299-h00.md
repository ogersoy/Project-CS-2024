...
> CAN bearer has to be terminated in the CCR message or to inform blocklist
...
Callee-Information | 565 | X | - | X | - | refer [214] |  |  |  |  |   
...
PSCell-Info | 1324 | X | - | - | - | Grouped | V,M | - | - |  |   
...
VoLTE-Information | 1323 | X | - | X | - | Grouped | V,M | - | - |  |   
...
The _VoLTE-Information_ AVP (AVP code 1323) is of type Grouped, and it
contains the caller and callee Information of VoLTE.
It has the following ABNF grammar:
VoLTE-Information ::= \
[ Calling-Party-Address ]\ [ Callee-Information ]
...
### 7.2.254 Nr-Cgi AVP
The _Nr-Cgi_ AVP (AVP code 1325) is of type UTF8String and includes NR Global
Cell Identity, with the format as specified in clause 19.6A of TS 23.003
[224].
### 7.2.255 PSCell-Info AVP
The _PSCell-Info_ AVP (AVP code 1324) is of type Grouped and provides primary
of Secondary Cell Group (SCG)) cell information.
It has the following ABNF grammar:
> PSCell-Info :: = \
>
> [ Nr-Cgi ]
