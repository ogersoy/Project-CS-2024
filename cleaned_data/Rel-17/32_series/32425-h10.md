...
from RSRP _LEV _00 to RSRP _LEV _LEV _20, namely RSRP \0 samples. The distribution information is a key input
...
recommended.
# A.37 Monitoring of RS-SINR
RS-SINR is the ratio of the received signal level and the sum of interference
and noise, which is used in E-UTRAN to determine the quality of the radio
channel. This measurement is useful to eveluate the QoS of Reference Signal
through the RS-SINR distribution for each cell. It is helpful to
troubleshooting weak coverage cell or low radio access rate cell according to
the ratio of RS-SINR bins that is below predefined threshold and all of the
RS-SINR bins.
#