...
> renewal request is received from UE. It corresponds to \"Time expired with
> no renewal\" in ProSe-Reason-For-Cancellation AVP.
>
> \- Requestor cancellation: a CANCEL_PROXIMITY_REQUEST message is received
> from UE. It corresponds to \"Requestor cancellation\" in ProSe-Reason-For-
> Cancellation AVP.
...
\-- can be included based on operators requirement roamingChargingProfile [2]
RoamingChargingProfile OPTIONAL
}
\--
