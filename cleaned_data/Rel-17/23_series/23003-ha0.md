...
28.3.2.2.4, with the addition of the label \"sos\" before the labels
\"n3iwf.5gc\".
...
##### 28.3.2.2.5b Replacement field used in DNS-based Discovery of regulatory
requirements for emergency services via N3IWF
...
In roaming scenarios however, the NAI should contain both the VPLMN ID and the
...
5GCN (see clause 28.7.7). See clause 5.42 in 3GPPTS 23.501 [119].
In the 5G NSWO use case, the UE shall use a NAI in the following format:
\"\\@5gc-nswo.mnc\.mcc\.3gppnetwork.org\"
In the above use cases:
a) the username part is defined in clause 28.7.3; and
b) the label \'5gc-nswo\' in the realm part indicates the NAI is used for 5G
NSWO. \ and \ identify the PLMN to which the UE attempts to connect
via the 5G NSWO as described in clause 4.2.15 of 3GPP TS 23.501 [119].
