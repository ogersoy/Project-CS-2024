...
elements:
+---------------------------+--------+-----------------------------+ | Information element name | Status | Description | +---------------------------+--------+-----------------------------+ | O‑IM‑CSI | S | See clause 4.4.1.1. It | | | | shall be present if it was | | | | modified. | +---------------------------+--------+-----------------------------+ | D‑IM‑CSI | S | See clause 4.4.1.2. It | | | | shall be present if it was | | | | modified. | +---------------------------+--------+-----------------------------+ | VT‑IM‑CSI | S | See clause 4.4.1.3. It | | | | shall be present if it was | | | | modified. | +---------------------------+--------+-----------------------------+ | Specific CSI Deleted List | S | This IE indicates that one | | | | or more specific elements | | | | of IMS CAMEL Subscription | | | | Information have been | | | | deleted from the HSS. It | | | | shall indicate any of the | | | | following; | | | | | | | | - O‑IM‑CSI (with TDP | | | | criteria for O‑IM‑CSI); | | | | | | | | - D‑IM‑CSI; | | | | | | | | - VT‑IM‑CSI with TDP | | | | criteria for VT‑IM‑CSI; | | | | | | | | This IE shall be present if | | | | IM CSI is/are deleted. | +---------------------------+--------+-----------------------------+
...
This clause contains the detailed description of the information flows used by
CAMEL for control and interrogation of subscription data.
Each Information Element (IE) is marked as Mandatory (M), Conditional (C),
...
* * *
Information element name Status Description O‑IM‑CSI S See clause 4.4.1.1. It
shall be present if it was modified. VT‑IM‑CSI S See clause 4.4.1.3. It shall
be present if it was modified. D‑IM‑CSI S See clause 4.4.1.2. It shall be
...
This IE indicates the CAMEL phase supported in the HSS. O‑IM‑CSI C See clause
4.4.1.1. VT‑IM‑CSI C See clause 4.4.1.3. D‑IM‑CSI C See clause 4.4.1.2.
* * *
...
This clause contains the detailed description of the information flows used by
CAMEL for the retrieval of information about the location and state of a
subscriber.
Each Information Element (IE) is marked as Mandatory (M), Conditional (C),
