...
* * *
#### 10.1.2.22 Functional alias to group binding request
Table 10.1.2.22-1 describes the information flow functional alias to group
binding request from the MC service client to the MC service server.
Table 10.1.2.22-1: Functional alias to group binding request
* * *
Information element Status Description MC service ID M The MC service ID of
the originator who triggers the functional alias to group binding request. MC
service group ID list (see NOTE) M A list of MC service group IDs to which the
originator requests the functional alias to group binding. Functional alias
list (see NOTE) M A list of functional aliases. NOTE: MC service group IDs and
functional aliases have a one to one relationship.
* * *
#### 10.1.2.23 Functional alias to group binding response
Table 10.1.2.23-1 describes the information flow functional alias to group
binding response from the MC service client to the MC service server.
Table 10.1.2.23-1: Functional alias to group binding response
* * *
Information element Status Description MC service ID M The MC service ID of
the originator who triggers the functional alias to group binding request.
Result M Indicates the success or failure for the result
* * *
#### 10.1.2.24 Functional alias to group unbinding request
Table 10.1.2.24-1 describes the information flow functional alias to group
unbinding request from the MC service client to the MC service server.
Table 10.1.2.24-1: Functional alias to group unbinding request
* * *
Information element Status Description MC service ID M The MC service ID of
the originator who triggers the functional alias to group unbinding request.
MC service group ID list (see NOTE) M A list of MC service group IDs to which
the originator requests the functional alias to group unbinding. Functional
alias list (see NOTE) M A list of functional aliases. NOTE: MC service group
IDs and functional aliases have a one to one relationship.
* * *
#### 10.1.2.25 Functional alias to group unbinding response
Table 10.1.2.25-1 describes the information flow functional alias to group
unbinding response from the MC service client to the MC service server.
Table 10.1.2.25-1: Functional alias to group unbinding response
* * *
Information element Status Description MC service ID M The MC service ID of
the originator who triggers the functional alias to group unbinding request.
Result M Indicates the success or failure for the result
...
identity of regroup group. Functional alias binding information for each user
within the group.
* * *
...
* * *
Parameter description Activation status of each functional alias and the
corresponding MC service ID of the user who activated that functional alias
(subscription and notification procedures for functional alias are defined in
clause 10.13.10)
* * *
...
service client has affiliated to the requested MC service group(s). The
authorisation check includes whether the MC service user has activated a
certain functional alias which prevents de-affiliating or whether the MC
service user is the last user who has bound a certain functional alias to the
group which also prevents de-affiliating.
...
clause 10.9.3.1, or from PLMN operator.
...
procedure as described in clause 10.9.3.2, or from PLMN operator.
...
Editor\'s note: How the functional alias to group binding impacts existing
group call requests is FFS.
