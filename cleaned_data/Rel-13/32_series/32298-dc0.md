...
Reporting Area identifier and the indication on whether the UE is inside or
outside the Presence Reporting Area, as described in TS 29.274 [223].
...
Holds the SIP P-header \"P-Visited-Network-ID\".
...
This field contains the MTC IWF address from which device trigger is received
...
to/from SMS-SC is related to Device Trigger.
...
information: submission, delivery report, or SM Service Request.
...
This field indicates ProSe charging event, i.e. Annoucing, Monitoring, Match
Report.
...
\--
\-- list-Of-AccessTransferInformation applies when ATCF collocated with P-CSCF
\--
}
ICSCFRecord ::= SET
{
...
OPTIONAL
\--
\-- list-Of-AccessTransferInformation applies when ATCF collocated with IBCF
\--
}
TRFRecord ::= SET
{
