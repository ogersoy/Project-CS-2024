...
could not be processed sucessfully. Service-Information O~C~ This parameter
holds the individual service specific parameters as defined in the
corresponding \'middle tier\' TS. AVP O~C~ This field contains extended
Information.
* * *
### 6.4.4 Re-Auth-Request message
The DCCA RAR message format is defined according to the Diameter Base Protocol
in RFC 3588 [401] and DCCA specification in RFC 4006 [402]:
> \ ::= \
>
> \
>
...
field contains the AVP that could not be processed sucessfully. Redirect-Host
O~C~ Used by redirect agent function as specified in [401]. Contains the host
the request should be forwarded to. Redirect-Host-Usage O~C~ Used by redirect
agent function as specified in [401]. Dictates how the routing entry resulting
from the Redirect-Host is to be used. Redirect-Max-Cache-Time O~C~ Used by
redirect agent function as specified in [401]. Contains the maximum number of
seconds the peer and route table entries, created as a result of the Redirect-
Host, will be cached. Proxy-Info O~C~ This field contains information of the
host. Proxy-Host M This field contains the identity of the host that added the
Proxy-Info field. Proxy-State M This field contains state local information.
CC-Sub-Session-Id - Not used in 3GPP. G-S-U-Pool-Identifier - Not used in
3GPP. Service-Identifier - Not used in 3GPP. Rating-Group - Not used in 3GPP.
...
If packets are allowed to flow during a CCR/CCA[Update]C exchange, and the
...
receiving the command, monitors for traffic for a period of time controlled by
the Quota-Consumption-Time AVP and report each period as a single envelope for
each Quota-Consumption-Time expiry where there was traffic. The OCF may
request envelope reports for just time, time and volume, time and number of
events, or time and volume and number of events.
...
Access-Transfer-Information | 2709 | X | - | X | - | Grouped | V,M | P |  |  | N  
Access-Transfer-Type | 2710 | X | - | X | - | Enumerated | V,M | P |  |  | N  
...
Additional-Exception-Reports | 3936 | X | - | X | - | Enumerated | V,M | P |  |  | N  
Additional-Type-Information | 1205 | - | - | X | - | UTF8String | V,M | P |  |  | N  
**Address-Data** | 897 | X | - | X | - | UTF8String | V,M | P |  |  | N  
**Address-Domain** | 898 | X | - | X | - | Grouped | V,M | P |  |  | N  
**Addressee-Type** | 1208 | X | - | X | - | Enumerated | V,M | P |  |  | N  
**Address-Type** | 899 | X | - | X | - | Enumerated | V,M | P |  |  | N  
...
**Announcement-Identifier** | 3905 | - | - | - | X | Unsigned32 | V,M | P |  |  | N  
**Announcement-Information** | 3904 | - | - | - | X | Grouped | V,M | P |  |  | N  
**Announcement-Order** | 3906 | - | - | - | X | Unsigned32 | V,M | P |  |  | N  
**Announcing-UE-HPLMN-Identifier** | 3426 | X | - | X | - | UTF8string | V.M | P |  |  | N  
**Announcing-UE-VPLMN-Identifier** | 3427 | X | - | X | - | UTF8string | V.M | P |  |  | N  
**AoC-Cost-Information** | 2053 | - | - | X | X | Grouped | V,M | P |  |  | N  
**AoC-Format** | 2310 | - | - | X | - | Enumerated | V,M | P |  |  | N  
**AoC-Information** | **2054** | **-** | **-** | **X** | **X** | **Grouped** | **V.M** | **P** |  |  | **N**  
...
**APN-Rate-Control** | **3933** | **X** | **-** | **X** | **-** | **Grouped** | **V,M** | **P** |  |  | **N**  
**APN-Rate-Control-Downlink** | **3934** | **X** | **-** | **X** | **-** | **Grouped** | **V,M** | **P** |  |  | **N**  
**APN-Rate-Control-Uplink** | **3935** | **X** | **-** | **X** | **-** | **Grouped** | **V,M** | **P** |  |  | **N**  
**Applic-ID** | 1218 | - | - | X | - | UTF8String | V,M | P |  |  | N  
Application-Port-Identifer | 3010 | X | - | - | - | refer[231] |  |  |  |  |   
...
Application-Specific-Data | 3458 | X | - | - | - | OctetString | V,M | P |  |  | N  
**Associated-Party-Address** | 2035 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Associated-URI | 856 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Authorised-QoS | 849 | - | - | - | - | UTF8String | V,M | P |  |  | N  
Aux-Applic-Info | 1219 | - | - | X | - | UTF8String | V,M | P |  |  | N  
Base-Time-Interval | 1265 | - | - | - | X | Unsigned32 | V,M | P |  |  | N  
Basic-Service-Code | 3411 | - | - | X | - | Grouped | V,M | P |  |  | N  
Bearer-Capability | 3412 | - | - | X | - | OctetString | V,M | P |  |  | N  
Bearer-Service | 854 | X | - | X | - | OctetString | V,M | P |  |  | N  
BSSID | 2716 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Called-Asserted-Identity | 1250 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Called-Identity | 3916 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Called-Identity-Change | 3917 | X | - | X | - | Grouped | V,M | P |  |  | N  
...
Cellular-Network-Information | 3924 | X | - | X | - | OctetString | V,M | P |  |  | N  
CG-Address | 846 | X | - | X | - | Address | V,M | P |  |  | Y  
Change-Condition | 2037 | X | - | - | - | Integer32 | V,M | P |  |  | N  
Change-Time | 2038 | X | - | X | - | Time | V,M | P |  |  | N  
...
Client-Address | 2018 | X | - | X | - | Address | V,M | P |  |  | N  
CN-IP-Multicast-Distribution | 921 | X | - | - | - | refer [207] |  |  |  |  |   
CN-Operator-Selection-Entity | 3421 | X | - | - | - | Enumerated | V,M | P |  |  | N  
...
Coverage-Info | 3459 | X | - | - | - | Grouped | V,M | P |  |  | N  
Coverage-Status | 3428 | X | - | - | - | Enumerated | V,M | P |  |  | N  
CP-CIoT-EPS-Optimisation-Indicator | 3930 | X | - | - | - | Enumerated | V,M | P |  |  | N  
CPDT-Information | 3927 | X | - | - | - | Grouped | V,M | P |  |  | N  
...
Data-Coding-Scheme | 2001 | X | - | X | - | Integer32 | V,M | P |  |  | N  
DCD-Information | 2115 | X | - | X | - | refer[223] |  |  |  |  |   
Deferred-Location-Event-Type | 1230 | - | - | X | - | UTF8String | V,M | P |  |  | N  
Delivery-Report-Requested | 1216 | X | - | X | - | Enumerated | V,M | P |  |  | N  
Delivery-Status | 2104 | X | - | X | - | refer[223] |  |  |  |  |   
Destination-Interface | 2002 | X | - | X | - | Grouped | V,M | P |  |  | N  
Diagnostics | 2039 | X | - | X | - | Integer32 | V,M | P |  |  | N  
Domain-Name | 1200 | X | - | X | - | UTF8String | V,M | P |  |  | N  
...
Enhanced-Diagnostics | 3901 | X | - | X | - | Grouped | V,M | P |  |  | N  
...
EPDG-Address | 3425 | X | - | - | - | Address | V,M | P |  |  | N  
...
IMS-Visited-Network-Identifier | 2713 | X | - | X | - | UTF8String | V,M | P |  |  | N  
...
Instance-Id | 3402 | X | - | X | - | UTF8String | V,M | P |  |  | N  
...
Inter-UE-Transfer | 3902 | X | - | X | - | Enumerated | V,M | P |  |  | N  
IP-Realm-Default-Indication | 2603 | X | - | - | - | Enumerated | V,M | P |  |  | N  
ISUP-Cause | 3416 | X | - | X | - | Grouped | V,M | P |  |  | N  
ISUP-Cause-Diagnostics | 3422 | X | - | X | - | OctetString | V,M | P |  |  | N  
ISUP-Cause-Location | 3423 | X | - | X | - | Unsigned32 | V,M | P |  |  | N  
ISUP-Cause-Value | 3424 | X | - | X | - | Unsigned32 | V,M | P |  |  | N  
ISUP-Location-Number | 3414 | - | - | X | - | OctetString | V,M | P |  |  | N  
Language | 3914 | - | - | - | X | UTF8String | V,M | P |  |  | N  
Layer-2-Group-ID | 3429 | - | - | X | - | OctetString | V,M | P |  |  | N  
LCS-APN | 1231 | - | - | X | - | UTF8String | V,M | P |  |  | N  
...
Local-GW-Inserted-Indication | 2604 | X | - | - | - | Enumerated | V,M | P |  |  | N  
...
Location-Info | 3460 | X | - | - | - | Grouped | V,M | P |  |  | N  
Location-Type | 1244 | - | - | X | - | Grouped | V,M | P |  |  | N  
Low-Balance-Indication | 2020 | - | - | - | X | Enumerated | V,M | P |  |  | N  
Low-Priority-Indicator | 2602 | X | - | - | - | Enumerated | V,M | P |  |  | N  
...
Message-Class | 1213 | X | - | X | - | Grouped | V,M | P |  |  | N  
Message-ID | 1210 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Message-Size | 1212 | X | - | X | - | Unsigned32 | V,M | P |  |  | N  
Message-Type | 1211 | X | - | X | - | Enumerated | V,M | P |  |  | N  
...
Monitored-PLMN-Identifier | 3430 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Monitoring-Duration | 3130 | X | - | - | - | refer [245] |  |  |  |  |   
Monitoring-Event-Config-Status | 3142 | X | - | - | - | refer [245] |  |  |  |  |   
Monitoring-Event-Configuration-Activity | 3919 | X | - | - | - | Integer32 | V,M | P |  |  | N  
Monitoring-Event-Functionality | 3922 | X | - | - | - | Integer32 | V,M | P |  |  | N  
Monitoring-Event-Information | 3921 | X | - | - | - | Grouped | V,M | P |  |  | N  
Monitoring-Event-Report-Data | 3920 | X | - | - | - | Grouped | V,M | P |  |  | N  
Monitoring-Event-Report-Number | 3923 | X | - | - | - | Unsigned32 | V,M | P |  |  | N  
Monitoring-Type | 3127 | X | - | - | - | refer [245] |  |  |  |  |   
Monitoring-UE-HPLMN-Identifier | 3431 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Monitoring-UE-Identifier | 3432 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Monitoring-UE-VPLMN-Identifier | 3433 | X | - | X | - | UTF8String | V,M | P |  |  | N  
MONTE-Location-Type | 3136 | X | - | - | - | refer [245] |  |  |  |  |   
MSC-Address | 3417 | X | - | X | - | OctetString | V,M | P |  |  | N  
MSISDN | 701 | X | - | X | - | refer [221] |  |  |  |  |   
_MTC-IWF-Address_ | 3406 | X | - | - | - | Address | V,M | P |  |  | N  
_NBIFOM-Mode_ | 2830 | X | - | X | - | refer [215] |  |  |  |  |   
_NBIFOM-Support_ | 2831 | X | - | X | - | refer [215] |  |  |  |  |   
Neighbour-Node-Address | 2705 | X | - | - | - | Address | V,M | P |  |  | N  
Network-Call-Reference-Number | 3418 | - | - | X | - | OctetString | V,M | P |  |  | N  
Next-Tariff | 2057 | - | - | X | X | Grouped | V/M | P |  |  | N  
NIDD-Submission | 3928 | X | - | - | - | Grouped | V/M | P |  |  | N  
NNI-Information | 2703 | X | - | - | - | Grouped | V,M | P |  |  | N  
NNI-Type | 2704 | X | - | - | - | Enumerated | V,M | P |  |  | N  
...
Originator-Address | 886 | X | - | X | - | Grouped | V,M | P |  |  | N  
Originator-Interface | 2009 | X | - | X | - | Grouped | V,M | P |  |  | N  
Originator-Received-Address | 2027 | X | - | X | - | Grouped | V,M | P |  |  | N  
Originator-SCCP-Address | 2008 | X | - | X | - | Address | V,M | P |  |  | N  
...
PC3-Control-Protocol-Cause | 3434 | X | - | X | - | Integer32 | V,M | P |  |  | N  
PC3-EPC-Control-Protocol-Cause | 3435 | X | - | X | - | Integer32 | V,M | P |  |  | N  
PDN-Connection-Charging-ID | 2050 | X | - | X | - | Unsigned32 | V,M | P |  |  | N  
PDP-Address | 1227 | X | - | X | - | Address | V,M | P |  |  | Y  
PDP-Address-Prefix-Length | 2606 | X | - | X | - | Unsigned32 | V,M | P |  |  | Y  
PDP-Context-Type | 1247 | X | - | X | - | Enumerated | V,M | P |  |  | N  
Play-Alternative | 3913 | - | - | - | X | Enumerated | V,M | P |  |  | N  
...
Priority-Indication | 3006 | X | - | - | - | refer [231] |  |  |  |  |   
Priority-Level | 1046 | X | - | X | - | refer [215] |  |  |  |  |   
Privacy-Indicator | 3915 | - | - | - | X | Enumerated | V,M | P |  |  | N  
ProSe-3rd-Party-Application-ID | 3440 | X | - | X | - | UTF8String | V,M | P |  |  | N  
ProSe-App-Id | 3811 | X | - | X | - | refer [239] |  |  |  |  |   
ProSe-Direct-Communication-Reception-Data-Container | 3461 | X | - | - | - | Grouped | V,M | P |  |  | N  
ProSe-Direct-Communication- Transmission-Data-Container | 3441 | X | - | - | - | Grouped | V,M | P |  |  | N  
ProSe-Direct-Discovery-Model | 3442 | X | - | X | - | Enumerated | V,M | P |  |  | N  
ProSe-Event-Type | 3443 | X | - | X | - | Enumerated | V,M | P |  |  | N  
ProSe-Function-ID | 3602 | X | - | X | - | refer [238] |  |  |  |  |   
ProSe-Function-IP-Address | 3444 | X | - | X | - | Address | V,M | P |  |  | N  
ProSe-Function-PLMN-Identifier | 3457 | X | - | X | - | UTF8String | V,M | P |  |  | N  
ProSe-Functionality | 3445 | X | - | X | - | Enumerated | V,M | P |  |  | N  
ProSe-Group-IP-Multicast-Address | 3446 | X | - | - | - | Address | V,M | P |  |  | N  
ProSe-Information | 3447 | X | - | X | - | Grouped | V,M | P |  |  | N  
ProSe-Range-Class | 3448 | X | - | X | - | Enumerated | V,M | P |  |  | N  
ProSe-Reason-For-Cancellation | 3449 | X | - | X | - | Enumerated | V,M | P |  |  | N  
ProSe-Request-Timestamp | 3450 | X | - | X | - | Time | V,M | P |  |  | N  
ProSe-Role-Of-UE | 3451 | X | - | X | - | Enumerated | V,M | P |  |  | N  
ProSe-Source-IP-Address | 3452 | - | - | X | - | Address | V,M | P |  |  | N  
ProSe-UE-ID | 3453 | - | - | X | - | OctetString | V,M | P |  |  | N  
ProSe-Validity-Timer | 3815 | X | - | X | - | refer [239] |  |  |  |  |   
Proximity-Alert-Indication | 3454 | X | - | X | - | Enumerated | V,M | P |  |  | N  
Proximity-Alert-Timestamp | 3455 | X | - | X | - | Time | V,M | P |  |  | N  
Proximity-Cancellation-Timestamp | 3456 | X | - | X | - | Time | V,M | P |  |  | N  
...
Quota-Indicator | 3912 | - | - | - | X | Enumerated | V,M | P |  |  | N  
Radio-Frequency | 3462 | X | - | - | - | OctetString | V,M | P |  |  | N  
Radio-Parameter-Set-Info | 3463 | X | - | - | - | Grouped | V.M | P |  |  | N  
Radio-Parameter-Set-Values | 3464 | X | - | - | - | OctetString | V,M | P |  |  | N  
Radio-Resources-Indicator | 3465 | X | - | - | - | Integer32 | V,M | P |  |  | N  
RAI | 909 | X | - | X | - | refer [207] |  |  |  |  |   
RAN-NAS-Release-Cause | 2819 | X | - | X | - | refer [215] |  |  |  |  |   
Rate-Control-Max-Message-Size | 3937 | X | - | X | - | Unsigned32 | V,M | P |  |  | N  
Rate-Control-Max-Rate | 3938 | X | - | X | - | Unsigned32 | V,M | P |  |  | N  
Rate-Control-Time-Unit | 3939 | X | - | X | - | Unsigned32 | V,M | P |  |  | N  
...
Reason-Header | 3401 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Received-Talk-Burst-Time | 1284 | X | - | - | - | Unsigned32 | V,M | P |  |  | N  
Received-Talk-Burst-Volume | 1285 | X | - | - | - | Unsigned32 | V,M | P |  |  | N  
Recipient-Address | 1201 | X | - | X | - | Grouped | V,M | P |  |  | N  
Recipient-Info | 2026 | X | - | X | - | Grouped | V,M | P |  |  | N  
Recipient-Received-Address | 2028 | X | - | X | - | Grouped | V,M | P |  |  | N  
Recipient-SCCP-Address | 2010 | X | - | X | - | Address | V,M | P |  |  | N  
Reference-Number | 3007 | X | - | - | - | refer [231] |  |  |  |  |   
Refund-Information | 2022 | - | - | X | X | OctetString | V,M | P |  |  | N  
Related-Change-Condition-Information | 3925 | X | - | - | - | Grouped | V,M | P |  |  | N  
Related-Trigger | 3926 | - | - | X | - | Grouped | V,M | P |  |  | N  
Related-IMS-Charging-Identifier | 2711 | X | - | X |  | UTF8String | V,M | P |  |  | N  
Related-IMS-Charging-Identifier-Node | 2712 | X | - | X |  | Address | V,M | P |  |  | N  
Relationship-Mode | 2706 | X | - | - | - | Enumerated | V,M | P |  |  | N  
Remaining-Balance | 2021 | - | - | - | X | Grouped | V,M | P |  |  | N  
Reply-Applic-ID | 1223 | - | - | X | - | UTF8String | V,M | P |  |  | N  
Reply-Path-Requested | 2011 | X | - | X | - | Enumerated | V,M | P |  |  | N  
Reporting-Reason | 872 | - | - | X | - | Enumerated | V,M | P |  |  | N  
Requested-Party-Address | 1251 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Requested-PLMN-Identifier | 3436 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Requesting-EPUID | 3816 | X | - | X | - | refer [239] |  |  |  |  |   
Requestor-PLMN-Identifier | 3437 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Required-MBMS-Bearer-Capabilities | 901 | X | - | X | - | refer [207] |  |  |  |  |   
Role-Of-Node | 829 | X | - | X | - | Enumerated | V,M | P |  |  | N  
Role-Of-ProSe-Function | 3438 | X | - | X | - | Enumerated | V,M | P |  |  | N  
Route-Header-Received | 3403 | X | - | - | - | UTF8String | V,M | P |  |  | N  
Route-Header-Transmitted | 3404 | X | - | - | - | UTF8String | V,M | P |  |  | N  
...
SCSAddress | 3941 | X | - | X | - | Address | V,M | - |  |  |   
...
Serving-Node | 2401 | X | - | - | - | refer [231] |  |  |  |  |   
Serving-Node-Identity | 3929 | X | - | - | - | DiameterIdentity | V,M | P |  |  | N  
...
Session-Direction | 2707 | X | - | - | - | Enumerated | V,M | P |  |  | N  
Session-Priority | 650 | X | - | X | - | refer [204] |  |  |  |  |   
SGi-PtP-Tunnelling-Method | 3931 | X | - | X | - | Enumerated | V,M | P |  |  | N  
...
SM-Device-Trigger-Indicator | 3407 | X | - | - | - | Enumerated | V,M | P |  |  | N  
SM-Device-Trigger-Information | 3405 | X | - | - | - | Grouped | V,M | P |  |  | N  
SM-Discharge-Time | 2012 | X | - | X | - | Time | V,M | P |  |  | N  
SM-Message-Type | 2007 | X | - | X | - | Enumerated | V,M | P |  |  | N  
SM-Protocol-ID | 2013 | X | - | X | - | OctetString | V,M | P |  |  | N  
SM-Sequence-Number | 3408 | X | - | - | - | Unsigned32 | V,M | P |  |  | N  
SM-Service-Type | 2029 | - | - | X | - | Enumerated | V,M | P |  |  | N  
SM-Status | 2014 | X | - | X | - | OctetString | V,M | P |  |  | N  
SM-User-Data-Header | 2015 | X | - | X | - | OctetString | V,M | P |  |  | N  
SMS-Information | 2000 | X | - | X | - | Grouped | V,M | P |  |  | N  
SMS-Node | 2016 | X | - | X | - | Enumerated | V,M | P |  |  | N  
SMS-Result | 3409 | X | - | - | - | Unsigned32 | V,M | P |  |  | N  
SMSC-Address | 2017 | X | - | X | - | Address | V,M | P |  |  | N  
Sponsor-Identity | 531 | X | - | - | - | refer [214] |  |  |  |  |   
SSID | 1524 | X | - | X | - | refer [237] |  |  |  |  |   
Start-of-Charging | 3419 | - | - | X | - | Time | V,M | P |  |  | N  
Start-Time | 2041 | X | - | X | - | Time | V,M | P |  |  | N  
Status- AS-Code | 2702 | X | - | - | - | Enumerated | V,M | P |  |  | N  
Stop-Time | 2042 | X | - | X | - | Time | V,M | P |  |  | N  
Submission-Time | 1202 | X | - | X | - | Time | V,M | P |  |  | N  
Subscriber-Role | 2033 | - | - | - | - | Enumerated | V,M | P |  |  | N  
Supplementary-Service | 2048 | X | - | X | - | Grouped | V,M | P |  |  | N  
TAD-Identifier | 2717 | X | - | - | - | Enumerated | V,M | P |  |  | N  
...
Teleservice | 3413 | - | - | X | - | OctetString | V,M | P |  |  | N  
Terminal-Information | 1401 | X | - | X | - | refer [219] |  |  |  |  |   
Terminating-IOI | 840 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Time-First-Reception | 3466 | X | - | - | - | Time | V,M | P |  |  | N  
Time-First-Transmission | 3467 | X | - | - | - | Time | V,M | P |  |  | N  
Time-First-Usage | 2043 | X | - | - | - | Time | V,M | P |  |  | N  
Time-Indicator | 3911 | - | - | - | X | Unsigned32 | V,M | P |  |  | N  
...
Transcoder-Inserted-Indication | 2605 | X | - | - | - | Enumerated | V,M | P |  |  | N  
Transit-IOI-List | 2701 | X | - | X | - | UTF8String | V,M | P |  |  | N  
Transmitter-Info | 3468 | X | - | - | - | Grouped | V,M | P |  |  | N  
Trigger | 1264 | - | - | X | X | Grouped | V,M | P |  |  | N  
Trigger-Type | 870 | - | - | X | X | Enumerated | V,M | P |  |  | N  
Trunk-Group-Id | 851 | X | - | - | - | Grouped | V,M | P |  |  | N  
TWAG-Address | 3903 | X | - | - | - | Address | V,M | P |  |  | N  
TWAN-User-Location-Info | 2714 | X | - | X | - | Grouped | V,M | P |  |  | N  
...
UNI-PDU-CP-Only-Flag | 3932 | X | - | X | - | Enumerated | V,M | P |  |  | N  
Unit-Cost | 2061 | - | - | X | X | Grouped | V,M | P |  |  | N  
Unit-Quota-Threshold | 1226 | - | - | - | X | Unsigned32 | V,M | P |  |  | N  
Usage-Information-Report-Sequence-Number | 3439 | X | - | - | - | Integer32 | V,M | P |  |  | N  
...
UWAN-User-Location-Info | 3918 | X | - | X | - | Grouped | V,M | P |  |  | N  
VAS-Id | 1102 | - | - | X | - | refer [213] |  |  |  |  |   
Variable-Part | 3907 | - | - | - | X | Grouped | V,M | P |  |  | N  
Variable-Part-Order | 3908 | - | - | - | X | Unsigned32 | V,M | P |  |  | N  
Variable-Part-Type | 3909 | - | - | - | X | Unsigned32 | V,M | P |  |  | N  
Variable-Part-Value | 3910 | - | - | - | X | UTF8String | V,M | P |  |  | N  
VASP-Id | 1101 | - | - | X | - | refer [213] |  |  |  |  |   
VCS-Information | 3410 | X | - | X | - | Grouped | V,M | P |  |  | N  
Visited-PLMN-Id | 1407 | X | - | - | - | refer [230] |  |  |  |  |   
VLR-Number | 3420 | X | - | X | - | OctetString | V,M | P |  |  | N  
...
the party to which a voice call is destined after processing by the Proxy
Function. It is converted from the circuit-switched Called Party Number as per
TS 29.163 [234] for the Request-URI header. For a mobile originating call,
this AVP contains the Called Party Number after processing by the Proxy
Function (e.g. number normalization). It is included only when different from
the contents of the Requested-Party-Address AVP.
...
44 MO exception data counter receipt
...
and contains the contents of the SIP P-header \"P-Visited-Network-ID\".
...
Address AVP.
For VCS charging, it holds the address (SIP URI or Tel URI) which identifies
the party to which a voice call is destined before processing by the Proxy
Function. It is converted from the circuit-switched Called Party BCD Number as
per TS 29.163 [234] for the Request-URI header. This is included only for a
...
party or the VCS node is serving the calling, called, or forwarding party. The
...
and indicates whether the Short Message is related to Device Trigger. If this
AVP is not present, this means the Short Message is not related to Device
Trigger:
0 Not DeviceTrigger
1 Device Trigger
...
indicate a request of reporting the event that the user enters/leaves the area
as indicated in the Presence-Reporting-Area-Information AVP. This includes
reporting the initial status at the time the request is initiated. When used
in a CCR, the Presence-Reporting-Area-Identifier AVP and Presence-Reporting-
Area-Status AVP shall be provided in the Presence-Reporting-Area-Information
AVP with the event report.
74 CHANGE_IN_SERVING_PLMN_RATE_CONTROL\ This value is used to indicate that a
