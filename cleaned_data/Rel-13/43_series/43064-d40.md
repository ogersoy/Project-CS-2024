...
EGPRS PACKET CHANNEL REQUEST message indicating 'PEO One Phase Access Request'
...
EC-BCCH and EC-RACH re-uses the same coding scheme as the BCCH and RACH
respectively. Modified coding schemes, or specific coding schemes, are defined
for EC-SCH, EC-PCH, EC-AGCH and EC-PACCH, see 3GPP TS 45.003 [12].
...
[dB]^1^ CC1 0-6 CC2 6-12 CC3 12-15 CC4 15-20 NOTE^1^: The values apply for the
...
It is mandatory for the MS to support all defined Coverage Classes for all EC-
channels. The network shall support at least CC1 and CC4. The set of coverage
classes supported on EC-CCCH is broadcasted in System Information (EC-SI).
...
45.002 [11] and 3GPP TS 45.004 [13]. Support of Overlaid CDMA is mandatory for
a MS that supports EC-GSM-IoT and optional for a network that supports EC-GSM-
IoT.
...
In case of EC operation when using blind physical layer transmissions the
...
EGPRS2.
On PRACH, CPRACH, MPRACH, EC-RACH and PTCCH/U, access bursts are used. On all
other packet data logical channels, radio blocks comprising 4 normal bursts
...
In EC operation, basic TTI is always used, and no frames are allocated for the
PTCCH.
{width="6.688194444444444in" height="0.7597222222222222in"}
Figure 2b: Multiframe structure for EC-GSM-IoT.
...
a mobile station in EC operation on the same PDCH, see subclause 6.6.4.1.4.1.
