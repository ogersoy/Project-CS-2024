...
(TURN session key and key id) in compliance with IETF RFC 7635 [70]. The WAF
and the TURN server share a long-term secret K. This key is used by the WAF to
generate additional keys for encrypting the access token and ensuring message
integrity of the message. Additional details on this can be found in the IETF
RFC 7635 [70]. The provisioning of the long-term secret key in WAF and TURN
server is out of scope of this solution.
...
third party authorization as defined in IETF RFC 7635 [70]. A relayed
transport address is allocated in the TURN server.
