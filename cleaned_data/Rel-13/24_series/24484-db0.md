...
[6] 3GPP TS 24.382: \"Mission Critical Push to Talk (MCPTT) identity
...
and \"user-profile-index\" attribute (as defined in subclause 7.4.2.1) that
...
user profile configuration MO is downloaded to the MCPTT UE.
...
\ element then the MCPTT UE initial configuration document
...
element of subclause 8.2.68 in 3GPP TS 24.383 [4];
...
## 7.3 MCPTT UE configuration document
### 7.3.1 General
...
of subclause 5.2.34B in 3GPP TS 24.383 [4];
...
element of subclause 5.2.29B in 3GPP TS 24.383 [4];
\- the \ element of the \ element of the
\ element of the \ element, indicates the
MCPTT group used on initiation of an MCPTT imminent peril group call and
corresponds to the \"GroupID\" element of subclause 5.2.39B in 3GPP TS 24.383
[4];
...
subclause 5.2.48J4 in 3GPP TS 24.383 [4];
...
5.2.48C4 in 3GPP TS 24.383 [4]; and
\- the \ element of the \ list element of the
\ element indicates an MCPTT group ID of an MCPTT group that the
MCPTT user is authorised to affiliate with during on-network operation and
corresponds to the \"MCPTTGroupID\" element of subclause 5.2.48B4 in 3GPP TS
24.383 [4].
...
\"DiscoveryGroupID\" element of subclause 5.2.29C in 3GPP TS 24.383 [4]; and
\- the \ element of the \ element it
...
element of subclause 5.2.18 in 3GPP TS 24.383 [4].
...
5.2.19A in 3GPP TS 24.383 [4];
\- the \ list element of the \ element indicates
the name of an MCPTT group ID of an MCPTT group that the MCPTT user is
authorised to affiliate with during on-network operation and corresponds to
the \"DisplayName\" element of subclause 5.2.48B5 in 3GPP TS 24.383 [4]; and
...
\"DisplayName\" element of subclause 5.2.48C5 in 3GPP TS 24.383 [4]; and
\- the \ list element of the \ element indicates
the name of an off-network MCPTT group that the MCPTT user is authorised to
join during off-network operation and corresponds to the \"DisplayName\"
element of subclause 5.2.53A in 3GPP TS 24.383 [4].
...
configuration managed object specified in 3GPP TS 24.383 [4].
...
\"Status\" element of subclause 5.2.59 in 3GPP TS 24.383 [4]. When set to
...
subclause 5.2.7B in 3GPP TS 24.383 [4].
...
profile as defined in 3GPP TS 23.179 [8], and corresponds to the
\"PreSelectedIndication\" element of subclause 5.2.7C in 3GPP TS 24.383 [4].
...
subclause 5.2.10 in 3GPP TS 24.383 [4].
...
element of subclause 5.2.31 in 3GPP TS 24.383 [4].
...
element of subclause 5.2.44 in 3GPP TS 24.383 [4].
...
subclause 5.2.29D in 3GPP TS 24.383 [4];
...
subclause 5.2.19 in 3GPP TS 24.383 [4]; and
...
the \"Usage\" element of subclause 5.2.34D in 3GPP TS 24.383 [4] and indicates
...
\"Usage\" element of subclause 5.2.29F in 3GPP TS 24.383 [4] and indicates to
...
corresponds to the \"Usage\" element of subclause 5.2.39D in 3GPP TS 24.383
...
to the \"Usage\" element of subclause 5.2.43E in 3GPP TS 24.383 [4] and
...
corresponds to the \"Usage\" element of subclause 5.2.48J6 in 3GPP TS 24.383
...
7.4.2.7-1, and corresponds to the \"AllowedPresenceStatus\" element of
subclause 5.2.48E in 3GPP TS 24.383 [4].
Table 7.4.2.7-1: Values of \
...
table 7.4.2.7-2, and corresponds to the \"AllowedPresence\" element of
subclause 5.2.48F in 3GPP TS 24.383 [4].
Table 7.4.2.7-2: Values of \
...
as specified in table 7.4.2.7-3, and does not appear in the MCPTT user profile
configuration managed object specified in 3GPP TS 24.383 [4].
Table 7.4.2.7-3: Values of \
...
availability of other MCPTT users to participate in a private call.
The \ element is of type Boolean, as specified in
table 7.4.2.7-4, and does not appear in the MCPTT user profile configuration
managed object specified in 3GPP TS 24.383 [4].
Table 7.4.2.7-4: Values of \
...
The \ element is of type Boolean, as specified in
table 7.4.2.7-5, and does not appear in the MCPTT user profile configuration
managed object specified in 3GPP TS 24.383 [4].
Table 7.4.2.7-5: Values of \
\"true\" indicates that the MCPTT user is locally authorised to enable/disable
...
in table 7.4.2.7-6, and corresponds to the \"AuthorisedAlias\" element of
subclause 5.2.9 in 3GPP TS 24.383 [4].
Table 7.4.2.7-6: Values of \
...
delete aliases of an MCPTT user and its associated user profiles.
The \ element is of type Boolean, as specified in table
7.4.2.7-7, and corresponds to the \"Authorised\" element of subclause 5.2.13
in 3GPP TS 24.383 [4].
Table 7.4.2.7-7: Values of \
...
subclause 5.2.16 in 3GPP TS 24.383 [4].
* * *
...
The \ element is of type Boolean, as specified in
table 7.4.2.7-8, and corresponds to the \"ManualCommence\" element of
subclause 5.2.20 in 3GPP TS 24.383 [4].
Table 7.4.2.7-8: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
in 3GPP TS 24.379 [9].
The \ element is of type Boolean, as specified
in table 7.4.2.7-9, corresponds to the \"AutoCommence\" element of subclause
5.2.21 in 3GPP TS 24.383 [4].
Table 7.4.2.7-9: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
defined in 3GPP TS 24.379 [9].
The \ element is of type Boolean, as specified in
table 7.4.2.7-10, and corresponds to the \"AutoAnswer\" element of subclause
5.2.22 in 3GPP TS 24.383 [4].
Table 7.4.2.7-10: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
defined in 3GPP TS 24.379 [9].
The \ element is of type Boolean, as specified in
table 7.4.2.7-11, and corresponds to the \"FailRestrict\" element of subclause
5.2.23 in 3GPP TS 24.383 [4].
Table 7.4.2.7-11: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
without floor control) using the procedures defined in 3GPP TS 24.379 [9].
The \ element is of type Boolean, as specified in
table 7.4.2.7-12, and corresponds to the \"Enabled\" element of subclause
5.2.33 in 3GPP TS 24.383 [4].
Table 7.4.2.7-12: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
[9].
The \ element is of type Boolean, as specified
in table 7.4.2.7-13, and corresponds to the \"Authorised\" element of
subclause 5.2.27 in 3GPP TS 24.383 [4].
Table 7.4.2.7-13: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
24.379 [9].
The \ element is of type Boolean, as specified
in table 7.4.2.7-14, and corresponds to the \"CancelMCPTTGroup\" element of
subclause 5.2.35 in 3GPP TS 24.383 [4].
Table 7.4.2.7-14: Values of \
\"true\" instructs the MCPTT server performing the originating participating
...
specified in table 7.4.2.7-15, and corresponds to the \"CancelPriority\"
element of subclause 5.2.28 in 3GPP TS 24.383 [4].
Table 7.4.2.7-15: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to cancel
...
defined in 3GPP TS 24.379 [9].
The \ element is of type Boolean, as specified in
table 7.4.2.7-16, and corresponds to the \"Authorised\" element of subclause
5.2.37 in 3GPP TS 24.383 [4].
Table 7.4.2.7-16: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
24.379 [9].
The \ element is of type Boolean, as specified in
table 7.4.2.7-17, and corresponds to the \"Cancel\" element of subclause
5.2.38 in 3GPP TS 24.383 [4].
Table 7.4.2.7-17: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to cancel
...
24.379 [9].
The \ element is of type Boolean, as specified
in table 7.4.2.7-18, and corresponds to the \"Authorised\" element of
subclause 5.2.41 in 3GPP TS 24.383 [4].
Table 7.4.2.7-18: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
[9].
The \ element is of type Boolean, as specified
in table 7.4.2.7-19, and corresponds to the \"Cancel\" element of subclause
5.2.42 in 3GPP TS 24.383 [4].
Table 7.4.2.7-19: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to cancel
...
The \ element is of type Boolean, as specified in table
7.4.2.7-20, and corresponds to the \"Authorised\" element of subclause 5.2.50
in 3GPP TS 24.383 [4].
Table 7.4.2.7-20: Values of \
\"true\" instructs the MCPTT server performing the originating participating
...
The \ element is of type Boolean, as specified in
table 7.4.2.7-21, and corresponds to the \"ImminentPerilCallChange\" element
of subclause 5.2.57 in 3GPP TS 24.383 [4].
Table 7.4.2.7-21: Values of \
\"true\" instructs the MCPTT server performing the originating participating
...
The \ element is of type Boolean, as
specified in table 7.4.2.7-22, and corresponds to the
\"AllowedMediaProtection\" element of subclause 5.2.24 in 3GPP 24.383 [4];
Table 7.4.2.7-22: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
The \ element is of type Boolean,
as specified in table 7.4.2.7-23, and corresponds to the
\"AllowedFloorControlProtection\" element of subclause 5.2.25 in 3GPP 24.383
[4];
Table 7.4.2.7-23: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
on-network and off-network private calls
The \ element is of type Boolean, as
specified in table 7.4.2.7-24, and does not appear in the user profile
configuration managed object specified in 3GPP TS 24.383 [4].
Table 7.4.2.7-24: Values of \
\"true\" Instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
affiliated.
The \ element is of type Boolean, as
specified in table 7.4.2.7-25, and does not appear in the MCPTT user profile
configuration managed object specified in 3GPP TS 24.383 [4].
Table 7.4.2.7-25: Values of \
\"true\" Instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
specified MCPTT group(s).
The \ element is of type Boolean, as
specified in table 7.4.2.7-26, and does not appear in the MCPTT user profile
configuration managed object specified in 3GPP TS 24.383 [4].
Table 7.4.2.7-26: Values of \
\"true\" Instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
...
The \ element is of type Boolean, as specified
in table 7.4.2.7-27, and corresponds to the \"AuthorisedAny\" element of
subclause 5.2.14 in 3GPP TS 24.383 [4].
Table 7.4.2.7-27: Values of \
\"true\" instructs the MCPTT server performing the originating participating
MCPTT function for the MCPTT user, that the MCPTT user is authorised to
request a private call request using the procedures defined in 3GPP TS 24.379
...
taken in the absence of the element;
The \ element is of type Boolean, as specified in table
7.4.2.7-28, and corresponds to the \"AllowedRegroup\" element of subclause
5.2.48D in 3GPP TS 24.383 [4].
Table 7.4.2.7-28: Values of \
\"true\" instructs the MCPTT server performing the originating participating
...
TS 24.381 [5].
The \ element is of type Boolean, as
specified in table 7.4.2.7-29, and corresponds to the \"EnabledParticipation\"
element of subclause 5.2.48G in 3GPP TS 24.383 [4].
Table 7.4.2.7-29: Values of \
...
24.379 [9].
The \ element is of type Boolean, as specified
in table 7.4.2.7-30, and corresponds to the \"AllowedTransmission\" element of
subclause 5.2.48H in 3GPP TS 24.383 [4].
Table 7.4.2.7-30: Values of \
...
transmission in a private call
The \ element is of type Boolean, as
specified in table 7.4.2.7-31, and corresponds to the \"AllowedManualSwitch\"
element of subclause 5.2.48I in 3GPP TS 24.383 [4].
Table 7.4.2.7-31: Values of \
\"true\" instructs the MCPTT server performing the participating MCPTT
...
procedures defined in 3GPP TS 24.379 [9].
The \ element is of type Boolean,
as specified in table 7.4.2.7-32, and corresponds to the \"AllowedListen\"
element of subclause 5.2.54 in 3GPP TS 24.383 [4].
Table 7.4.2.7-32: Values of \
...
The \ element is of type Boolean, as specified
in table 7.4.2.7-33, and corresponds to the \"AllowedTransmission\" element of
subclause 5.2.55 in 3GPP TS 24.383 [4].
Table 7.4.2.7-33: Values of \
...
Boolean, as specified in table 7.4.2.7-34, and corresponds to the
\"EmergencyCallChange\" element of subclause 5.2.56 in 3GPP TS 24.383 [4].
Table 7.4.2.7-34: Values of \
...
The \ element is of type Boolean, as specified in table
7.4.2.7-35, and does not appear in the MCPTT user profile configuration
managed object specified in 3GPP TS 24.383 [4].
Table 7.4.2.7-35: Values of \
\"true\" instructs the MCPTT server performing the participating MCPTT
...
The \ element is of type Boolean, as
specified in table 7.4.2.7-36, and corresponds to the \"Authorised\" element
of subclause 5.2.46 in 3GPP TS 24.383 [4].
Table 7.4.2.7-36: Values of \
...
TS 24.381 [5].
The \ element is of type Boolean, as
specified in table 7.4.2.7-37, and corresponds to the \"Authorised\" element
of subclause 5.2.48 in 3GPP TS 24.383 [4].
Table 7.4.2.7-37: Values of \
\"true\" indicates that the MCPTT user is locally authorised to send a request
to create a user-broadcast group according to the procedures of 3GPP TS 24.381
[5].
* * *
\"false\" Indicates that the MCPTT user is not locally authorised to send a
request to create a user-broadcast group according to the procedures of 3GPP
TS 24.381 [5].
#### 7.4.2.8 Naming Conventions
The name of user profile configuration document shall be \"user-profile\".
#### 7.4.2.9 Global documents
The present document requires no global documents.
#### 7.4.2.10 Resource interdependencies
This Application Usage is interdependent on user profile data in the MCPTT
Database and the MCPTT Management Object.
#### 7.4.2.11 Access Permissions Policies
...
\".
#### 7.4.2.12 Subscription to Changes
...
documents of a MCPTT user according to XCAP URI construction convention of a
trailing \'/\', as specified in IETF RFC 5875 [11].
## 7.5 MCPTT service configuration document
### 7.5.1 General
...
B.5 of 3GPP TS 23.179 [8], and structure and procedures of OMA OMA-TS-
...
The schema definition is provided in subclause 7.5.2.3. Each mission critical
...
\
\
#### 7.5.2.4 Default Document Namespace
The default document namespace used in evaluating URIs shall be
\"urn:3gpp:ns:mcpttServiceConfig:1.0\".
#### 7.5.2.5 MIME type
The MIME type for the service configuration document shall be
\"vnd.3gpp.mcptt-service-config+xml\".
#### 7.5.2.6 Validation Constraints
If the AUID value of the document URI or node URI in the Request-URI is other
than that specified in subclause 7.5.2.2, then the configuration management
server shall return an HTTP 409 (Conflict) response including the XCAP error
element \. If included, the \"phrase\" attribute should be
set to \"invalid application id used\".
The service configuration document shall conform to the XML Schema described
in subclause 7.5.2.3.
The \ element is the root element of the XML
...
as specified in subclause 7.2.8 of 3GPP TS 24.383 [4];
In the \ element:
...
18) the \ element the maximum contains the maximum allowed
time of silence in a group session involving an MBMS bearer before the MBMS
subchannel shall be released;
19) the \ element contains the retransmission
interval of the Map Group To Bearer message;
20) the \ element contains the retransmission
interval of the Unmap Group To Bearer message;
...
counter in \ element;
22) the \ element contains the retransmission interval of the
Connect message. The number of times the Connect message is retransmitted is
controlled by the counter in \ element;
23) the \ element contains the retransmission interval of the
Disconnect message. The number of times the Disconnect message is
retransmitted is controlled by the counter in \ element;
24) the \ element of the \ element contains
the maximum number of times the Floor Idle shall be sent;
25) the \ element contains the retransmission
interval of the Unmap Group To Bearer message;
26) the \ element of the \ element
contains the maximum times the Floor Granted message shall be retransmitted.
27) the \ element contains the maximum number of times the
Connect message is retransmitted;
28) the \ element contains the maximum number of times the
...
specified in subclause 7.2.14 of 3GPP TS 24.383 [4];
2) the \ element of the \ element contains
...
subclause 7.2.16 of 3GPP TS 24.383 [4];
3) the \ element of the \ element contains the value
of the hang timer for off-network private calls, which corresponds to the
\"HangTime\" element as specified in subclause 7.2.13 of 3GPP TS 24.383 [4];
4) the \ element of the \
...
specified in subclause 7.2.12 of 3GPP TS 24.383 [4];
...
specified in subclause 7.2.17 of 3GPP TS 24.383 [4]. Absence of the \ element in the \ element indicates
...
element as specified in subclause 7.2.20 of 3GPP TS 24.383 [4];
...
element as specified in subclause 7.2.23 of 3GPP TS 24.383 [4];
...
7.2.24 of 3GPP TS 24.383 [4]; and
...
element as specified in subclause 7.2.26 of 3GPP TS 24.383 [4] and contains
...
#### 7.5.2.10 Resource interdependencies
There are no resource interdependencies.
#### 7.5.2.11 Authorization Policies
The authorization policies for manipulating a service configuration document
shall conform to those described in OMA OMA-TS-XDM_Core-V2_1-20120403-A [2]
subclause 5.1.5 \"_Authorization_ \".
#### 7.5.2.12 Subscription to Changes
